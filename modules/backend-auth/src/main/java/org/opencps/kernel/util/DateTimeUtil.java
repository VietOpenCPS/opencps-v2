...
public class DateTimeUtil {
	...
	public static final String _DATE_TIME_FULL_TO_NAME = "yyyyMMddHHmm";
	...
	public static Date convertStringToDateTimeAPI(String strDate) {

		DateFormat df = getDateTimeFormat(_DATE_TIME_FULL_TO_NAME);
	...
	public static Date convertStringToDate(String strDate, String pattern) {
		...
		DateFormat df = getDateTimeFormat(pattern);
...
//			year = calendar.get(Calendar.YEAR);
	...
	public static Date incrementHour(Date date, int amount) {
