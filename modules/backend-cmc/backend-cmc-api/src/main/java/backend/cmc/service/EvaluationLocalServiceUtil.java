 ...
 * {@link backend.cmc.service.impl.EvaluationLocalServiceImpl} and is the
 ...
 * @see backend.cmc.service.base.EvaluationLocalServiceBaseImpl
 * @see backend.cmc.service.impl.EvaluationLocalServiceImpl
 * @generated
 */
@ProviderType
public class EvaluationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link backend.cmc.service.impl.EvaluationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static backend.cmc.model.Evaluation addEvaluation(
		backend.cmc.model.Evaluation evaluation) {
		return getService().addEvaluation(evaluation);
	}

	public static backend.cmc.model.Evaluation addEvaluation(long groupId,
	...
	*/
	public static backend.cmc.model.Evaluation createEvaluation(
		long evaluationId) {
	...
	*/
	public static backend.cmc.model.Evaluation deleteEvaluation(
		backend.cmc.model.Evaluation evaluation) {
	...
	*/
	...
	public static backend.cmc.model.Evaluation fetchEvaluation(
		long evaluationId) {
	...
	*/
	public static backend.cmc.model.Evaluation fetchEvaluationByUuidAndGroupId(
	...
	* @throws PortalException if a evaluation with the primary key could not be found
	*/
	public static backend.cmc.model.Evaluation getEvaluation(long evaluationId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static backend.cmc.model.Evaluation getEvaluationByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static backend.cmc.model.Evaluation updateEvaluation(
		backend.cmc.model.Evaluation evaluation) {
	...
	*/
	...
	public static java.util.List<backend.cmc.model.Evaluation> getEvaluationbyEmployeeId(
		long employeeId) {
		return getService().getEvaluationbyEmployeeId(employeeId);
	}

	public static java.util.List<backend.cmc.model.Evaluation> getEvaluationbyEmployeeIdScore(
	...
	*/
	public static java.util.List<backend.cmc.model.Evaluation> getEvaluations(
		int start, int end) {
	...
	*/
	public static java.util.List<backend.cmc.model.Evaluation> getEvaluationsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<backend.cmc.model.Evaluation> getEvaluationsByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<backend.cmc.model.Evaluation> orderByComparator) {
		return getService()
