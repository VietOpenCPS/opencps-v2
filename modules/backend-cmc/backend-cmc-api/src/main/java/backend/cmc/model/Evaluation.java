 ...
 * @author sondt
 * @see EvaluationModel
 * @see backend.cmc.model.impl.EvaluationImpl
 * @see backend.cmc.model.impl.EvaluationModelImpl
 * @generated
 */
@ImplementationClassName("backend.cmc.model.impl.EvaluationImpl")
@ProviderType
public interface Evaluation extends EvaluationModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link backend.cmc.model.impl.EvaluationImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
