...
public class EvaluationLocalServiceWrapper implements EvaluationLocalService,
	...
	*/
	@Override
	public backend.cmc.model.Evaluation addEvaluation(
		backend.cmc.model.Evaluation evaluation) {
		return _evaluationLocalService.addEvaluation(evaluation);
	}

	@Override
	public backend.cmc.model.Evaluation addEvaluation(long groupId,
	...
	*/
	@Override
	public backend.cmc.model.Evaluation createEvaluation(long evaluationId) {
	...
	*/
	@Override
	public backend.cmc.model.Evaluation deleteEvaluation(
		backend.cmc.model.Evaluation evaluation) {
	...
	*/
	@Override
	public backend.cmc.model.Evaluation deleteEvaluation(long evaluationId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _evaluationLocalService.deleteEvaluation(evaluationId);
	}

	@Override
	public backend.cmc.model.Evaluation fetchEvaluation(long evaluationId) {
	...
	*/
	@Override
	public backend.cmc.model.Evaluation fetchEvaluationByUuidAndGroupId(
	...
	*/
	@Override
	public backend.cmc.model.Evaluation getEvaluation(long evaluationId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public backend.cmc.model.Evaluation getEvaluationByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public backend.cmc.model.Evaluation updateEvaluation(
		backend.cmc.model.Evaluation evaluation) {
	...
	*/
	...
	@Override
	public java.util.List<backend.cmc.model.Evaluation> getEvaluationbyEmployeeId(
		long employeeId) {
		return _evaluationLocalService.getEvaluationbyEmployeeId(employeeId);
	}

	@Override
	public java.util.List<backend.cmc.model.Evaluation> getEvaluationbyEmployeeIdScore(
	...
	*/
	@Override
	public java.util.List<backend.cmc.model.Evaluation> getEvaluations(
		int start, int end) {
	...
	*/
	@Override
	public java.util.List<backend.cmc.model.Evaluation> getEvaluationsByUuidAndCompanyId(
