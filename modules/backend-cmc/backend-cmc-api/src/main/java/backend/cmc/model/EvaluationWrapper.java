...
public class EvaluationWrapper implements Evaluation, ModelWrapper<Evaluation> {
	...
	@Override
	public backend.cmc.model.Evaluation toEscapedModel() {
		return new EvaluationWrapper(_evaluation.toEscapedModel());
	}

	@Override
	public backend.cmc.model.Evaluation toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<backend.cmc.model.Evaluation> toCacheModel() {
		return _evaluation.toCacheModel();
	}

	@Override
	public int compareTo(backend.cmc.model.Evaluation evaluation) {
