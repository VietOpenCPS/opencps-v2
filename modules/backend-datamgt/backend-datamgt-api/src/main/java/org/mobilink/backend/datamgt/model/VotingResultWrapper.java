...
public class VotingResultWrapper implements VotingResult,
	...
	*/
	...
	/**
	* Returns the to user uuid of this voting result.
	*
	* @return the to user uuid of this voting result
	*/
	@Override
	public java.lang.String getToUserUuid() {
		return _votingResult.getToUserUuid();
	}
	...
	*/
	...
	/**
	* Returns the to user ID of this voting result.
	*
	* @return the to user ID of this voting result
	*/
	@Override
	public long getToUserId() {
		return _votingResult.getToUserId();
	}
	...
	*/
	...
	/**
	* Sets the to user ID of this voting result.
	*
	* @param toUserId the to user ID of this voting result
	*/
	@Override
	public void setToUserId(long toUserId) {
		_votingResult.setToUserId(toUserId);
	}

	/**
	* Sets the to user uuid of this voting result.
	*
	* @param toUserUuid the to user uuid of this voting result
	*/
	@Override
	public void setToUserUuid(java.lang.String toUserUuid) {
		_votingResult.setToUserUuid(toUserUuid);
	}
