...
/**
 * Provides the local service interface for WorkspaceUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Binhth
 * @see WorkspaceUserLocalServiceUtil
...
public interface WorkspaceUserLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WorkspaceUserLocalServiceUtil} to access the workspace user local service. Add custom service methods to {@link org.mobilink.backend.datamgt.service.impl.WorkspaceUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Hits workspaceUserFilter(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WorkspaceUser> getWorkspaceUsers(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<WorkspaceUser> getWorkspaceUsersByUuidAndCompanyId(
	...
	*/
	...
	public WorkspaceUser addWorkspaceUser(long userId, long groupId,
		long workspaceId, long assignUserId, ServiceContext serviceContext)
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WorkspaceUser addWorkspaceUser(WorkspaceUser workspaceUser);
	...
	*/
	public WorkspaceUser createWorkspaceUser(long workspaceUserId);
	...
	*/
	...
	public WorkspaceUser deleteWorkspaceUser(long workspaceUserId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public WorkspaceUser deleteWorkspaceUser(WorkspaceUser workspaceUser);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkspaceUser fetchWorkspaceUser(long workspaceUserId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkspaceUser fetchWorkspaceUserByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkspaceUser getWorkspaceUser(long workspaceUserId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public WorkspaceUser getWorkspaceUserByUuidAndGroupId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WorkspaceUser updateWorkspaceUser(long userId, long groupId,
		long workspaceUserId, long workspaceId, long assignUserId,
		ServiceContext serviceContext) throws java.lang.Exception;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public WorkspaceUser updateWorkspaceUser(WorkspaceUser workspaceUser);
}