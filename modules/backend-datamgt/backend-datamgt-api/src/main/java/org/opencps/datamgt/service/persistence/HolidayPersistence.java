...
public interface HolidayPersistence extends BasePersistence<Holiday> {
	...
	* @return the matching holidaies
	*/
	public java.util.List<Holiday> findByF_GID_TYPE(long groupId,
		int holidayType);
	...
	*/
	public java.util.List<Holiday> findByF_GID_TYPE(long groupId,
		int holidayType, int start, int end);
	...
	* @return the matching holidaies
	*/
	public java.util.List<Holiday> findByF_NEWER_THAN(long groupId,
		Date holidayDate);
