...
public class HolidayUtil {
	...
	* @return the matching holidaies
	*/
	public static List<Holiday> findByF_GID_TYPE(long groupId, int holidayType) {
		return getPersistence().findByF_GID_TYPE(groupId, holidayType);
	}
	...
	*/
	public static List<Holiday> findByF_GID_TYPE(long groupId, int holidayType,
		int start, int end) {
		return getPersistence()
				   .findByF_GID_TYPE(groupId, holidayType, start, end);
	}
	...
	* @throws NoSuchHolidayException if a matching holiday could not be found
	*/
	public static Holiday findByF_GID_TYPE_First(long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_GID_TYPE_First(groupId, holidayType,
			orderByComparator);
	}
	...
	* @return the first matching holiday, or <code>null</code> if a matching holiday could not be found
	*/
	public static Holiday fetchByF_GID_TYPE_First(long groupId,
		int holidayType, OrderByComparator<Holiday> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_TYPE_First(groupId, holidayType,
			orderByComparator);
	}
	...
	* @throws NoSuchHolidayException if a matching holiday could not be found
	*/
	public static Holiday findByF_GID_TYPE_Last(long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_GID_TYPE_Last(groupId, holidayType,
			orderByComparator);
	}
	...
	* @return the last matching holiday, or <code>null</code> if a matching holiday could not be found
	*/
	public static Holiday fetchByF_GID_TYPE_Last(long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_TYPE_Last(groupId, holidayType,
			orderByComparator);
	}
	...
	* @throws NoSuchHolidayException if a holiday with the primary key could not be found
	*/
	public static Holiday[] findByF_GID_TYPE_PrevAndNext(long holidayId,
		long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_GID_TYPE_PrevAndNext(holidayId, groupId,
			holidayType, orderByComparator);
	}
	...
	* @param holidayType the holiday type
	*/
	public static void removeByF_GID_TYPE(long groupId, int holidayType) {
		getPersistence().removeByF_GID_TYPE(groupId, holidayType);
	}
	...
	* @return the number of matching holidaies
	*/
	public static int countByF_GID_TYPE(long groupId, int holidayType) {
		return getPersistence().countByF_GID_TYPE(groupId, holidayType);
	}
	...
	* @return the matching holidaies
	*/
	public static List<Holiday> findByF_NEWER_THAN(long groupId,
		Date holidayDate) {
		return getPersistence().findByF_NEWER_THAN(groupId, holidayDate);
	}
	...
	*/
	public static List<Holiday> findByF_NEWER_THAN(long groupId,
		...
		return getPersistence()
				   .findByF_NEWER_THAN(groupId, holidayDate, start, end);
	}
	...
	* @throws NoSuchHolidayException if a matching holiday could not be found
	*/
	public static Holiday findByF_NEWER_THAN_First(long groupId,
		Date holidayDate, OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_NEWER_THAN_First(groupId, holidayDate,
			orderByComparator);
	}
	...
	* @return the first matching holiday, or <code>null</code> if a matching holiday could not be found
	*/
	public static Holiday fetchByF_NEWER_THAN_First(long groupId,
		Date holidayDate, OrderByComparator<Holiday> orderByComparator) {
		return getPersistence()
				   .fetchByF_NEWER_THAN_First(groupId, holidayDate,
			orderByComparator);
	}
	...
	* @throws NoSuchHolidayException if a matching holiday could not be found
	*/
	public static Holiday findByF_NEWER_THAN_Last(long groupId,
		Date holidayDate, OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_NEWER_THAN_Last(groupId, holidayDate,
			orderByComparator);
	}
	...
	* @return the last matching holiday, or <code>null</code> if a matching holiday could not be found
	*/
	public static Holiday fetchByF_NEWER_THAN_Last(long groupId,
		Date holidayDate, OrderByComparator<Holiday> orderByComparator) {
		return getPersistence()
				   .fetchByF_NEWER_THAN_Last(groupId, holidayDate,
			orderByComparator);
	}
	...
	* @throws NoSuchHolidayException if a holiday with the primary key could not be found
	*/
	public static Holiday[] findByF_NEWER_THAN_PrevAndNext(long holidayId,
		long groupId, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_NEWER_THAN_PrevAndNext(holidayId, groupId,
			holidayDate, orderByComparator);
	}
	...
	* @param holidayDate the holiday date
	*/
	public static void removeByF_NEWER_THAN(long groupId, Date holidayDate) {
		getPersistence().removeByF_NEWER_THAN(groupId, holidayDate);
	}
	...
	* @return the number of matching holidaies
	*/
	public static int countByF_NEWER_THAN(long groupId, Date holidayDate) {
		return getPersistence().countByF_NEWER_THAN(groupId, holidayDate);
	}
	...
	* @return the matching holidaies
	*/
	public static List<Holiday> findByF_GID_TYPE_NEWER_THAN(long groupId,
		int holidayType, Date holidayDate) {
		return getPersistence()
				   .findByF_GID_TYPE_NEWER_THAN(groupId, holidayType,
			holidayDate);
	}
	...
	*/
	public static List<Holiday> findByF_GID_TYPE_NEWER_THAN(long groupId,
		...
		return getPersistence()
				   .findByF_GID_TYPE_NEWER_THAN(groupId, holidayType,
			holidayDate, start, end, orderByComparator);
	}
	...
	*/
	public static List<Holiday> findByF_GID_TYPE_NEWER_THAN(long groupId,
		...
		return getPersistence()
				   .findByF_GID_TYPE_NEWER_THAN(groupId, holidayType,
			holidayDate, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchHolidayException if a matching holiday could not be found
	*/
	public static Holiday findByF_GID_TYPE_NEWER_THAN_First(long groupId,
		int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_GID_TYPE_NEWER_THAN_First(groupId, holidayType,
			holidayDate, orderByComparator);
	}
	...
	* @return the first matching holiday, or <code>null</code> if a matching holiday could not be found
	*/
	public static Holiday fetchByF_GID_TYPE_NEWER_THAN_First(long groupId,
		int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_TYPE_NEWER_THAN_First(groupId, holidayType,
			holidayDate, orderByComparator);
	}
	...
	* @throws NoSuchHolidayException if a matching holiday could not be found
	*/
	public static Holiday findByF_GID_TYPE_NEWER_THAN_Last(long groupId,
		int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_GID_TYPE_NEWER_THAN_Last(groupId, holidayType,
			holidayDate, orderByComparator);
	}
	...
	* @return the last matching holiday, or <code>null</code> if a matching holiday could not be found
	*/
	public static Holiday fetchByF_GID_TYPE_NEWER_THAN_Last(long groupId,
		int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_TYPE_NEWER_THAN_Last(groupId, holidayType,
			holidayDate, orderByComparator);
	}
	...
	* @throws NoSuchHolidayException if a holiday with the primary key could not be found
	*/
	public static Holiday[] findByF_GID_TYPE_NEWER_THAN_PrevAndNext(
		long holidayId, long groupId, int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator)
		throws org.opencps.datamgt.exception.NoSuchHolidayException {
		return getPersistence()
				   .findByF_GID_TYPE_NEWER_THAN_PrevAndNext(holidayId, groupId,
	...
	* @param holidayDate the holiday date
	*/
	public static void removeByF_GID_TYPE_NEWER_THAN(long groupId,
		int holidayType, Date holidayDate) {
		getPersistence()
			.removeByF_GID_TYPE_NEWER_THAN(groupId, holidayType, holidayDate);
	}
	...
	* @return the number of matching holidaies
	*/
	public static int countByF_GID_TYPE_NEWER_THAN(long groupId,
		int holidayType, Date holidayDate) {
		return getPersistence()
				   .countByF_GID_TYPE_NEWER_THAN(groupId, holidayType,
			holidayDate);
	}
