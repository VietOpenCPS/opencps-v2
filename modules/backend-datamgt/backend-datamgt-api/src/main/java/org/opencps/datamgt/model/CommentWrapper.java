...
public class CommentWrapper implements Comment, ModelWrapper<Comment> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("createdByCurrentUser", getCreatedByCurrentUser());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		Long upvoteCount = (Long)attributes.get("upvoteCount");
		...
		Long createdByCurrentUser = (Long)attributes.get("createdByCurrentUser");

		if (createdByCurrentUser != null) {
			setCreatedByCurrentUser(createdByCurrentUser);
		}
	}
	...
	*/
	...
	/**
	* Returns the created by current user of this comment.
	*
	* @return the created by current user of this comment
	*/
	@Override
	public long getCreatedByCurrentUser() {
		return _comment.getCreatedByCurrentUser();
	}
	...
	*/
	...
	/**
	* Sets the created by current user of this comment.
	*
	* @param createdByCurrentUser the created by current user of this comment
	*/
	@Override
	public void setCreatedByCurrentUser(long createdByCurrentUser) {
		_comment.setCreatedByCurrentUser(createdByCurrentUser);
	}
