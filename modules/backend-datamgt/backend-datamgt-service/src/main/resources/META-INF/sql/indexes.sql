...
create index IX_A170B7BD on opencps_dictgroup (groupCode[$COLUMN_LENGTH:100$], groupId, dictCollectionId);
...
create index IX_2B17050F on opencps_holiday (holidayDate, groupId);
