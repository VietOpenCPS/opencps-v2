...
import org.mobilink.backend.datamgt.exception.NoSuchVotingResultException;
import org.mobilink.backend.datamgt.model.VotingResult;
import org.mobilink.backend.datamgt.model.impl.VotingResultImpl;
import org.mobilink.backend.datamgt.model.impl.VotingResultModelImpl;
 ...
 * @see org.mobilink.backend.datamgt.service.persistence.VotingResultUtil
 * @generated
 */
@ProviderType
public class VotingResultPersistenceImpl extends BasePersistenceImpl<VotingResult>
	...
	public VotingResult updateImpl(VotingResult votingResult) {
		...
		if (isNew || !VotingResultModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
