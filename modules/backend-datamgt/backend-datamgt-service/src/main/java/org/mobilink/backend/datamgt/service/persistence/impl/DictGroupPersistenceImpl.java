...
import org.mobilink.backend.datamgt.model.impl.DictGroupImpl;
import org.mobilink.backend.datamgt.model.impl.DictGroupModelImpl;
 ...
 * @see org.mobilink.backend.datamgt.service.persistence.DictGroupUtil
 * @generated
 */
@ProviderType
public class DictGroupPersistenceImpl extends BasePersistenceImpl<DictGroup>
	...
	public DictGroup updateImpl(DictGroup dictGroup) {
		...
		if (isNew || !DictGroupModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
