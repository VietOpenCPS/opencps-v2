...
import org.mobilink.backend.datamgt.model.CommentModel;
...
/**
 * The base model implementation for the Comment service. Represents a row in the &quot;m_comment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CommentModelImpl extends BaseModelImpl<Comment>
	 ...
	 */
	public static final String TABLE_NAME = "m_comment";
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "upvoteCount", Types.BIGINT },
			{ "userHasUpvoted", Types.VARCHAR },
			{ "createdByCurrentUser", Types.BIGINT }
		};
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("upvoteCount", Types.BIGINT);
		TABLE_COLUMNS_MAP.put("userHasUpvoted", Types.VARCHAR);
		TABLE_COLUMNS_MAP.put("createdByCurrentUser", Types.BIGINT);
	}

	public static final String TABLE_SQL_CREATE = "create table m_comment (uuid_ VARCHAR(75) null,commentId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,className VARCHAR(75) null,classPK VARCHAR(75) null,fullname VARCHAR(75) null,email VARCHAR(75) null,parent LONG,content VARCHAR(75) null,fileEntryId LONG,upvoteCount LONG,userHasUpvoted VARCHAR(75) null,createdByCurrentUser LONG)";
	public static final String TABLE_SQL_DROP = "drop table m_comment";
	public static final String ORDER_BY_JPQL = " ORDER BY comment.createDate ASC";
	public static final String ORDER_BY_SQL = " ORDER BY m_comment.createDate ASC";
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(backend.datamgt.service.util.ServiceProps.get(
				"lock.expiration.time.org.mobilink.backend.datamgt.model.Comment"));
	...
	public Object clone() {
		...
		commentImpl.setCreatedByCurrentUser(getCreatedByCurrentUser());
	...
	public CacheModel<Comment> toCacheModel() {
		...
		commentCacheModel.createdByCurrentUser = getCreatedByCurrentUser();
	...
	public String toString() {
		...
		sb.append(getCreatedByCurrentUser());
		sb.append("}");
	...
	public String toXmlString() {
		...
		sb.append("org.mobilink.backend.datamgt.model.Comment");
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>createdByCurrentUser</column-name><column-value><![CDATA[");
		sb.append(getCreatedByCurrentUser());
		sb.append("]]></column-value></column>");
