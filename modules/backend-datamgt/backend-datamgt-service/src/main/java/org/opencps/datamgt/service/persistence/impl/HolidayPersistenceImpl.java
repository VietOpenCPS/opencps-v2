...
public class HolidayPersistenceImpl extends BasePersistenceImpl<Holiday>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_GID_TYPE =
		new FinderPath(HolidayModelImpl.ENTITY_CACHE_ENABLED,
			...
			HolidayModelImpl.GROUPID_COLUMN_BITMASK |
			HolidayModelImpl.HOLIDAYTYPE_COLUMN_BITMASK |
			HolidayModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_GID_TYPE = new FinderPath(HolidayModelImpl.ENTITY_CACHE_ENABLED,
			HolidayModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_GID_TYPE",
			new String[] { Long.class.getName(), Integer.class.getName() });

	/**
	 * Returns all the holidaies where groupId = &#63; and holidayType = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<Holiday> findByF_GID_TYPE(long groupId, int holidayType) {
		return findByF_GID_TYPE(groupId, holidayType, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the holidaies where groupId = &#63; and holidayType = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link HolidayModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Holiday> findByF_GID_TYPE(long groupId, int holidayType,
		int start, int end) {
		return findByF_GID_TYPE(groupId, holidayType, start, end, null);
	}

	/**
	 * Returns an ordered range of all the holidaies where groupId = &#63; and holidayType = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link HolidayModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Holiday> findByF_GID_TYPE(long groupId, int holidayType,
		...
		return findByF_GID_TYPE(groupId, holidayType, start, end,
			orderByComparator, true);
	}
	...
	public List<Holiday> findByF_GID_TYPE(long groupId, int holidayType,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { groupId, holidayType };
		}
		else {
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_GID_TYPE_HOLIDAYTYPE_2);
	...
	/**
	 * Returns the first holiday in the ordered set where groupId = &#63; and holidayType = &#63;.
	 *
	 * @param groupId the group ID
	 * @param holidayType the holiday type
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Holiday findByF_GID_TYPE_First(long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = fetchByF_GID_TYPE_First(groupId, holidayType,
				orderByComparator);
	 ...
	 */
	@Override
	public Holiday fetchByF_GID_TYPE_First(long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator) {
		List<Holiday> list = findByF_GID_TYPE(groupId, holidayType, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last holiday in the ordered set where groupId = &#63; and holidayType = &#63;.
	 *
	 * @param groupId the group ID
	 * @param holidayType the holiday type
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Holiday findByF_GID_TYPE_Last(long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = fetchByF_GID_TYPE_Last(groupId, holidayType,
				orderByComparator);
	 ...
	 */
	@Override
	public Holiday fetchByF_GID_TYPE_Last(long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator) {
		int count = countByF_GID_TYPE(groupId, holidayType);

		if (count == 0) {
			return null;
		}

		List<Holiday> list = findByF_GID_TYPE(groupId, holidayType, count - 1,
	...
	/**
	 * Returns the holidaies before and after the current holiday in the ordered set where groupId = &#63; and holidayType = &#63;.
	 *
	 * @param holidayId the primary key of the current holiday
	 * @param groupId the group ID
	 * @param holidayType the holiday type
	 ...
	 */
	@Override
	public Holiday[] findByF_GID_TYPE_PrevAndNext(long holidayId, long groupId,
		int holidayType, OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = findByPrimaryKey(holidayId);
		...
		try {
			...
			array[0] = getByF_GID_TYPE_PrevAndNext(session, holiday, groupId,
					holidayType, orderByComparator, true);

			array[1] = holiday;

			array[2] = getByF_GID_TYPE_PrevAndNext(session, holiday, groupId,
					holidayType, orderByComparator, false);
	...
	protected Holiday getByF_GID_TYPE_PrevAndNext(Session session,
		Holiday holiday, long groupId, int holidayType,
		OrderByComparator<Holiday> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the holidaies where groupId = &#63; and holidayType = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param holidayType the holiday type
	 */
	@Override
	public void removeByF_GID_TYPE(long groupId, int holidayType) {
		for (Holiday holiday : findByF_GID_TYPE(groupId, holidayType,
	...
	/**
	 * Returns the number of holidaies where groupId = &#63; and holidayType = &#63;.
	 *
	 * @param groupId the group ID
	 * @param holidayType the holiday type
	 * @return the number of matching holidaies
	 */
	@Override
	public int countByF_GID_TYPE(long groupId, int holidayType) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_GID_TYPE;

		Object[] finderArgs = new Object[] { groupId, holidayType };
	...
	private static final String _FINDER_COLUMN_F_GID_TYPE_GROUPID_2 = "holiday.groupId = ? AND ";
	private static final String _FINDER_COLUMN_F_GID_TYPE_HOLIDAYTYPE_2 = "holiday.holidayType = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_NEWER_THAN =
		new FinderPath(HolidayModelImpl.ENTITY_CACHE_ENABLED,
			HolidayModelImpl.FINDER_CACHE_ENABLED, HolidayImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_NEWER_THAN",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_NEWER_THAN =
		new FinderPath(HolidayModelImpl.ENTITY_CACHE_ENABLED,
			HolidayModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByF_NEWER_THAN",
			new String[] { Long.class.getName(), Date.class.getName() });

	/**
	 * Returns all the holidaies where groupId = &#63; and holidayDate &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param holidayDate the holiday date
	 * @return the matching holidaies
	 */
	@Override
	public List<Holiday> findByF_NEWER_THAN(long groupId, Date holidayDate) {
		return findByF_NEWER_THAN(groupId, holidayDate, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the holidaies where groupId = &#63; and holidayDate &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link HolidayModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Holiday> findByF_NEWER_THAN(long groupId, Date holidayDate,
		int start, int end) {
		return findByF_NEWER_THAN(groupId, holidayDate, start, end, null);
	}

	/**
	 * Returns an ordered range of all the holidaies where groupId = &#63; and holidayDate &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link HolidayModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Holiday> findByF_NEWER_THAN(long groupId, Date holidayDate,
		int start, int end, OrderByComparator<Holiday> orderByComparator) {
		return findByF_NEWER_THAN(groupId, holidayDate, start, end,
			orderByComparator, true);
	}
	...
	public List<Holiday> findByF_NEWER_THAN(long groupId, Date holidayDate,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_NEWER_THAN;
		finderArgs = new Object[] {
				groupId, _getTime(holidayDate),
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Holiday holiday : list) {
					if ((groupId != holiday.getGroupId()) ||
							(holidayDate.getTime() > holiday.getHolidayDate()
																.getTime())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_NEWER_THAN_GROUPID_2);

			boolean bindHolidayDate = false;

			if (holidayDate == null) {
				query.append(_FINDER_COLUMN_F_NEWER_THAN_HOLIDAYDATE_1);
			}
			else {
				bindHolidayDate = true;

				query.append(_FINDER_COLUMN_F_NEWER_THAN_HOLIDAYDATE_2);
			}
	...
	/**
	 * Returns the first holiday in the ordered set where groupId = &#63; and holidayDate &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param holidayDate the holiday date
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Holiday findByF_NEWER_THAN_First(long groupId, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = fetchByF_NEWER_THAN_First(groupId, holidayDate,
				orderByComparator);
	 ...
	 */
	@Override
	public Holiday fetchByF_NEWER_THAN_First(long groupId, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator) {
		List<Holiday> list = findByF_NEWER_THAN(groupId, holidayDate, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last holiday in the ordered set where groupId = &#63; and holidayDate &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param holidayDate the holiday date
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Holiday findByF_NEWER_THAN_Last(long groupId, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = fetchByF_NEWER_THAN_Last(groupId, holidayDate,
				orderByComparator);
	 ...
	 */
	@Override
	public Holiday fetchByF_NEWER_THAN_Last(long groupId, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator) {
		int count = countByF_NEWER_THAN(groupId, holidayDate);

		if (count == 0) {
			return null;
		}

		List<Holiday> list = findByF_NEWER_THAN(groupId, holidayDate,
	...
	/**
	 * Returns the holidaies before and after the current holiday in the ordered set where groupId = &#63; and holidayDate &ge; &#63;.
	 *
	 * @param holidayId the primary key of the current holiday
	 * @param groupId the group ID
	 * @param holidayDate the holiday date
	 ...
	 */
	@Override
	public Holiday[] findByF_NEWER_THAN_PrevAndNext(long holidayId,
		long groupId, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = findByPrimaryKey(holidayId);
		...
		try {
			...
			array[0] = getByF_NEWER_THAN_PrevAndNext(session, holiday, groupId,
					holidayDate, orderByComparator, true);

			array[1] = holiday;

			array[2] = getByF_NEWER_THAN_PrevAndNext(session, holiday, groupId,
	...
	protected Holiday getByF_NEWER_THAN_PrevAndNext(Session session,
		Holiday holiday, long groupId, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the holidaies where groupId = &#63; and holidayDate &ge; &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param holidayDate the holiday date
	 */
	@Override
	public void removeByF_NEWER_THAN(long groupId, Date holidayDate) {
		for (Holiday holiday : findByF_NEWER_THAN(groupId, holidayDate,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(holiday);
		}
	}
	...
	/**
	 * Returns the number of holidaies where groupId = &#63; and holidayDate &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param holidayDate the holiday date
	 * @return the number of matching holidaies
	...
	public int countByF_NEWER_THAN(long groupId, Date holidayDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_NEWER_THAN;
	...
	private static final String _FINDER_COLUMN_F_NEWER_THAN_GROUPID_2 = "holiday.groupId = ? AND ";
	private static final String _FINDER_COLUMN_F_NEWER_THAN_HOLIDAYDATE_1 = "holiday.holidayDate IS NULL";
	private static final String _FINDER_COLUMN_F_NEWER_THAN_HOLIDAYDATE_2 = "holiday.holidayDate >= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_GID_TYPE_NEWER_THAN =
		new FinderPath(HolidayModelImpl.ENTITY_CACHE_ENABLED,
			HolidayModelImpl.FINDER_CACHE_ENABLED, HolidayImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_GID_TYPE_NEWER_THAN",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_GID_TYPE_NEWER_THAN =
		new FinderPath(HolidayModelImpl.ENTITY_CACHE_ENABLED,
			HolidayModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByF_GID_TYPE_NEWER_THAN",
			new String[] {
				Long.class.getName(), Integer.class.getName(),
				Date.class.getName()
			});
	 ...
	 */
	@Override
	public List<Holiday> findByF_GID_TYPE_NEWER_THAN(long groupId,
		int holidayType, Date holidayDate) {
		return findByF_GID_TYPE_NEWER_THAN(groupId, holidayType, holidayDate,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<Holiday> findByF_GID_TYPE_NEWER_THAN(long groupId,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_GID_TYPE_NEWER_THAN;
		finderArgs = new Object[] {
				groupId, holidayType, _getTime(holidayDate),
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_GROUPID_2);

			query.append(_FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_HOLIDAYTYPE_2);

			boolean bindHolidayDate = false;

			if (holidayDate == null) {
				query.append(_FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_HOLIDAYDATE_1);
			}
			else {
				bindHolidayDate = true;

				query.append(_FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_HOLIDAYDATE_2);
			}
	...
	public Holiday findByF_GID_TYPE_NEWER_THAN_First(long groupId,
		...
		OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = fetchByF_GID_TYPE_NEWER_THAN_First(groupId,
				holidayType, holidayDate, orderByComparator);
	...
	public Holiday fetchByF_GID_TYPE_NEWER_THAN_First(long groupId,
		int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator) {
		List<Holiday> list = findByF_GID_TYPE_NEWER_THAN(groupId, holidayType,
				holidayDate, 0, 1, orderByComparator);
	...
	public Holiday findByF_GID_TYPE_NEWER_THAN_Last(long groupId,
		...
		OrderByComparator<Holiday> orderByComparator)
		throws NoSuchHolidayException {
		Holiday holiday = fetchByF_GID_TYPE_NEWER_THAN_Last(groupId,
				holidayType, holidayDate, orderByComparator);
	...
	public Holiday fetchByF_GID_TYPE_NEWER_THAN_Last(long groupId,
		int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator) {
		int count = countByF_GID_TYPE_NEWER_THAN(groupId, holidayType,
				holidayDate);
		...
		List<Holiday> list = findByF_GID_TYPE_NEWER_THAN(groupId, holidayType,
				holidayDate, count - 1, count, orderByComparator);
	...
	public Holiday[] findByF_GID_TYPE_NEWER_THAN_PrevAndNext(long holidayId,
		...
		try {
			...
			array[0] = getByF_GID_TYPE_NEWER_THAN_PrevAndNext(session, holiday,
					groupId, holidayType, holidayDate, orderByComparator, true);

			array[1] = holiday;

			array[2] = getByF_GID_TYPE_NEWER_THAN_PrevAndNext(session, holiday,
					groupId, holidayType, holidayDate, orderByComparator, false);
	...
	protected Holiday getByF_GID_TYPE_NEWER_THAN_PrevAndNext(Session session,
		Holiday holiday, long groupId, int holidayType, Date holidayDate,
		OrderByComparator<Holiday> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_GID_TYPE_NEWER_THAN(long groupId, int holidayType,
		Date holidayDate) {
		for (Holiday holiday : findByF_GID_TYPE_NEWER_THAN(groupId,
				holidayType, holidayDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(holiday);
		}
	}
	...
	public int countByF_GID_TYPE_NEWER_THAN(long groupId, int holidayType,
		Date holidayDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_GID_TYPE_NEWER_THAN;
	...
	private static final String _FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_GROUPID_2 = "holiday.groupId = ? AND ";
	private static final String _FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_HOLIDAYTYPE_2 =
		"holiday.holidayType = ? AND ";
	private static final String _FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_HOLIDAYDATE_1 =
		"holiday.holidayDate IS NULL";
	private static final String _FINDER_COLUMN_F_GID_TYPE_NEWER_THAN_HOLIDAYDATE_2 =
		"holiday.holidayDate >= ?";
	...
	public Holiday updateImpl(Holiday holiday) {
		...
		if (!HolidayModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					holidayModelImpl.getGroupId(),
					holidayModelImpl.getHolidayType()
				};
			...
			if ((holidayModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						holidayModelImpl.getOriginalGroupId(),
						holidayModelImpl.getOriginalHolidayType()
					};
