...
public class DictGroupCacheModel implements CacheModel<DictGroup>,
	...
	public DictGroup toEntityModel() {
		...
		if (groupDescription == null) {
			dictGroupImpl.setGroupDescription("");
		}
		else {
