...
public class CommentLocalServiceImpl extends CommentLocalServiceBaseImpl {
	...
	public Comment addComment(
		...
		String fullname, String email, long parent, String content,
		long fileSize, InputStream inputStream, String fileName,
		String fileType, int upvoteCount, String pings, boolean opinion,
		...
		if (opinion) {
			latestComment = fetchByF_groupId_userId_className_classPK_opinion(
		...
		if (inputStream != null && fileSize > 0 &&
			...
			FileEntry fileEntry = DLAppLocalServiceUtil.addFileEntry(
				...
				fileName + StringPool.DASH + System.currentTimeMillis(),
				"Comment attachment", StringPool.BLANK, inputStream, fileSize,
				serviceContext);
	...
	public long countLuceneSearchEngine(
		Map<String, Object> params, SearchContext searchContext)
		throws ParseException, SearchException {

		// TODO Auto-generated method stub

		Indexer<Comment> indexer =
			IndexerRegistryUtil.nullSafeGetIndexer(Comment.class);
		...
		booleanQuery.addRequiredTerm(
			Field.ENTRY_CLASS_NAME, Comment.class.getName());
	...
	public Comment fetchByF_groupId_userId_className_classPK_opinion(
		...
		return commentPersistence.fetchByF_groupId_userId_className_classPK_opinion(
			groupId, userId, className, classPK, opinion);
	}
	...
	@Override
	public List<Comment> findByF_groupId_className_classPK(
		long groupId, String className, String classPK) {

		return commentPersistence.findByF_groupId_className_classPK(
	...
	public Hits luceneSearchEngine(
		Map<String, Object> params, Sort[] sorts, int start, int end,
...
//		}
	...
	public Comment updateComment(
		long userId, long commentId, String className, String classPK,
		String fullname, String email, long parent, String content,
		String pings, ServiceContext serviceContext)
	...
	@Override
	public Comment updateComment(
		long commentId, String className, String classPK, String email,
		int upvoteCount, ServiceContext serviceContext)
		...
		String userHasUpvoted = Validator.isNotNull(comment.getUpvotedUsers())
			? comment.getUpvotedUsers() : StringPool.BLANK;

		if ((!StringUtil.contains(userHasUpvoted, email) ||
			Validator.isNull(comment.getUpvotedUsers())) && upvoteCount >= 0) {

			userHasUpvoted += Validator.isNotNull(userHasUpvoted)
				? StringPool.COMMA + email : email;
		...
		else if (StringUtil.contains(userHasUpvoted, email) &&
			upvoteCount < 0) {
