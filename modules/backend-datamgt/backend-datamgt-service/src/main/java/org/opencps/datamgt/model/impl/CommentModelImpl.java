...
public class CommentModelImpl extends BaseModelImpl<Comment>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_comment (uuid_ VARCHAR(75) null,commentId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,className VARCHAR(500) null,classPK VARCHAR(75) null,fullname VARCHAR(75) null,email VARCHAR(500) null,parent LONG,content STRING null,fileEntryId LONG,pings VARCHAR(1000) null,upvoteCount INTEGER,userHasUpvoted VARCHAR(75) null,upvotedUsers VARCHAR(75) null,opinion BOOLEAN)";
