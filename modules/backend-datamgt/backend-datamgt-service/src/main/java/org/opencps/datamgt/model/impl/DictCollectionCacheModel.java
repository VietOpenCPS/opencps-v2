...
public class DictCollectionCacheModel implements CacheModel<DictCollection>,
	...
	public DictCollection toEntityModel() {
		...
		if (userName == null) {
			dictCollectionImpl.setUserName("");
		}
		else {
		...
		if (collectionCode == null) {
			dictCollectionImpl.setCollectionCode("");
		}
		else {
		...
		if (collectionName == null) {
			dictCollectionImpl.setCollectionName("");
		}
		else {
		...
		if (collectionNameEN == null) {
			dictCollectionImpl.setCollectionNameEN("");
		}
		else {
		...
		if (description == null) {
			dictCollectionImpl.setDescription("");
		}
		else {
		...
		if (dataForm == null) {
			dictCollectionImpl.setDataForm("");
		}
		else {
