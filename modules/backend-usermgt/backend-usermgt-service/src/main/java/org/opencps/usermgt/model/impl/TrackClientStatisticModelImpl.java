...
public class TrackClientStatisticModelImpl extends BaseModelImpl<TrackClientStatistic>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_track_client_statistic (uuid_ VARCHAR(75) null,trackClientStatisticId LONG not null primary key,createDate DATE null,modifiedDate DATE null,url VARCHAR(75) null,year INTEGER,month INTEGER,day INTEGER,region VARCHAR(75) null,desktop BOOLEAN,mobile BOOLEAN,tablet BOOLEAN,total LONG)";
