...
import org.opencps.usermgt.model.LGSPTokenModel;
...
public class LGSPTokenModelImpl extends BaseModelImpl<LGSPToken>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_lgsp_token (uuid_ VARCHAR(75) null,tokenId LONG not null primary key,createDate DATE null,modifiedDate DATE null,token TEXT null,tokenType VARCHAR(75) null,refreshToken VARCHAR(75) null,expiryDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table opencps_lgsp_token";
	public static final String ORDER_BY_JPQL = " ORDER BY lgspToken.tokenId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY opencps_lgsp_token.tokenId ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(org.opencps.backend.usermgt.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.org.opencps.usermgt.model.LGSPToken"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(org.opencps.backend.usermgt.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.org.opencps.usermgt.model.LGSPToken"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(org.opencps.backend.usermgt.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.org.opencps.usermgt.model.LGSPToken"),
			true);
	public static final long TOKENTYPE_COLUMN_BITMASK = 1L;
	public static final long UUID_COLUMN_BITMASK = 2L;
	public static final long TOKENID_COLUMN_BITMASK = 4L;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(org.opencps.backend.usermgt.service.util.ServiceProps.get(
				"lock.expiration.time.org.opencps.usermgt.model.LGSPToken"));
	...
	public String toXmlString() {
		...
		sb.append("org.opencps.usermgt.model.LGSPToken");
