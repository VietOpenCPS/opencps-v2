...
public class TrackClientStatisticPersistenceImpl extends BasePersistenceImpl<TrackClientStatistic>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T = new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED,
			TrackClientStatisticImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByU_Y_M_D_D_M_T",
			new String[] {
			...
			TrackClientStatisticModelImpl.YEAR_COLUMN_BITMASK |
			TrackClientStatisticModelImpl.MONTH_COLUMN_BITMASK |
			TrackClientStatisticModelImpl.DAY_COLUMN_BITMASK |
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_U_Y_M_D_D_M_T = new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByU_Y_M_D_D_M_T",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Integer.class.getName(),
				Boolean.class.getName(), Boolean.class.getName(),
	 ...
	 */
	@Override
	public TrackClientStatistic findByU_Y_M_D_D_M_T(String url, int year,
		int month, int day, boolean desktop, boolean mobile, boolean tablet)
		throws NoSuchTrackClientStatisticException {
		TrackClientStatistic trackClientStatistic = fetchByU_Y_M_D_D_M_T(url,
				year, month, day, desktop, mobile, tablet);
	 ...
	 */
	@Override
	public TrackClientStatistic fetchByU_Y_M_D_D_M_T(String url, int year,
		int month, int day, boolean desktop, boolean mobile, boolean tablet) {
		return fetchByU_Y_M_D_D_M_T(url, year, month, day, desktop, mobile,
			tablet, true);
	}
	...
	public TrackClientStatistic fetchByU_Y_M_D_D_M_T(String url, int year,
		...
		Object[] finderArgs = new Object[] {
				url, year, month, day, desktop, mobile, tablet
			};

		Object result = null;

		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T,
					finderArgs, this);
		}
		...
		if (result instanceof TrackClientStatistic) {
			...
			if (!Objects.equals(url, trackClientStatistic.getUrl()) ||
					(year != trackClientStatistic.getYear()) ||
					(month != trackClientStatistic.getMonth()) ||
					(day != trackClientStatistic.getDay()) ||
		...
		if (result == null) {
			...
			if (url == null) {
				query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_URL_1);
			}
			else if (url.equals("")) {
				query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_URL_3);
			}
			else {
				bindUrl = true;

				query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_URL_2);
			}

			query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_YEAR_2);

			query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_MONTH_2);

			query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_DAY_2);

			query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_DESKTOP_2);

			query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_MOBILE_2);

			query.append(_FINDER_COLUMN_U_Y_M_D_D_M_T_TABLET_2);
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"TrackClientStatisticPersistenceImpl.fetchByU_Y_M_D_D_M_T(String, int, int, int, boolean, boolean, boolean, boolean) with parameters (" +
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T,
					finderArgs);
	 ...
	 */
	@Override
	public TrackClientStatistic removeByU_Y_M_D_D_M_T(String url, int year,
		int month, int day, boolean desktop, boolean mobile, boolean tablet)
		throws NoSuchTrackClientStatisticException {
		TrackClientStatistic trackClientStatistic = findByU_Y_M_D_D_M_T(url,
				year, month, day, desktop, mobile, tablet);
	 ...
	 */
	@Override
	public int countByU_Y_M_D_D_M_T(String url, int year, int month, int day,
		boolean desktop, boolean mobile, boolean tablet) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_U_Y_M_D_D_M_T;
	...
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_URL_1 = "trackClientStatistic.url IS NULL AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_URL_2 = "trackClientStatistic.url = ? AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_URL_3 = "(trackClientStatistic.url IS NULL OR trackClientStatistic.url = '') AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_YEAR_2 = "trackClientStatistic.year = ? AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_MONTH_2 = "trackClientStatistic.month = ? AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_DAY_2 = "trackClientStatistic.day = ? AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_DESKTOP_2 = "trackClientStatistic.desktop = ? AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_MOBILE_2 = "trackClientStatistic.mobile = ? AND ";
	private static final String _FINDER_COLUMN_U_Y_M_D_D_M_T_TABLET_2 = "trackClientStatistic.tablet = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_D_M_Y = new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED,
			TrackClientStatisticImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByD_M_Y",
			new String[] {
				Integer.class.getName(), Integer.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y = new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED,
			TrackClientStatisticImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByD_M_Y",
			new String[] {
				Integer.class.getName(), Integer.class.getName(),
				Integer.class.getName()
			},
			...
			TrackClientStatisticModelImpl.YEAR_COLUMN_BITMASK |
			TrackClientStatisticModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_D_M_Y = new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<TrackClientStatistic> findByD_M_Y(int day, int month, int year) {
		return findByD_M_Y(day, month, year, QueryUtil.ALL_POS,
	...
	public List<TrackClientStatistic> findByD_M_Y(int day, int month, int year,
		int start, int end) {
		return findByD_M_Y(day, month, year, start, end, null);
	}
	...
	public List<TrackClientStatistic> findByD_M_Y(int day, int month, int year,
		int start, int end,
		OrderByComparator<TrackClientStatistic> orderByComparator) {
		return findByD_M_Y(day, month, year, start, end, orderByComparator, true);
	}
	...
	public List<TrackClientStatistic> findByD_M_Y(int day, int month, int year,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y;
			finderArgs = new Object[] { day, month, year };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_D_M_Y;
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (TrackClientStatistic trackClientStatistic : list) {
					if ((day != trackClientStatistic.getDay()) ||
							(month != trackClientStatistic.getMonth()) ||
							(year != trackClientStatistic.getYear())) {
						list = null;
	...
	public TrackClientStatistic findByD_M_Y_First(int day, int month, int year,
		OrderByComparator<TrackClientStatistic> orderByComparator)
		throws NoSuchTrackClientStatisticException {
		TrackClientStatistic trackClientStatistic = fetchByD_M_Y_First(day,
	...
	public TrackClientStatistic fetchByD_M_Y_First(int day, int month,
		...
		List<TrackClientStatistic> list = findByD_M_Y(day, month, year, 0, 1,
				orderByComparator);
	...
	public TrackClientStatistic findByD_M_Y_Last(int day, int month, int year,
		OrderByComparator<TrackClientStatistic> orderByComparator)
		throws NoSuchTrackClientStatisticException {
		TrackClientStatistic trackClientStatistic = fetchByD_M_Y_Last(day,
				month, year, orderByComparator);
	...
	public TrackClientStatistic fetchByD_M_Y_Last(int day, int month, int year,
		OrderByComparator<TrackClientStatistic> orderByComparator) {
		int count = countByD_M_Y(day, month, year);

		if (count == 0) {
			return null;
		}

		List<TrackClientStatistic> list = findByD_M_Y(day, month, year,
	...
	public TrackClientStatistic[] findByD_M_Y_PrevAndNext(
		...
		try {
			...
			array[0] = getByD_M_Y_PrevAndNext(session, trackClientStatistic,
					day, month, year, orderByComparator, true);

			array[1] = trackClientStatistic;

			array[2] = getByD_M_Y_PrevAndNext(session, trackClientStatistic,
					day, month, year, orderByComparator, false);
	...
	protected TrackClientStatistic getByD_M_Y_PrevAndNext(Session session,
		TrackClientStatistic trackClientStatistic, int day, int month,
		int year, OrderByComparator<TrackClientStatistic> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByD_M_Y(int day, int month, int year) {
		for (TrackClientStatistic trackClientStatistic : findByD_M_Y(day,
	...
	private static final String _FINDER_COLUMN_D_M_Y_DAY_2 = "trackClientStatistic.day = ? AND ";
	private static final String _FINDER_COLUMN_D_M_Y_MONTH_2 = "trackClientStatistic.month = ? AND ";
	private static final String _FINDER_COLUMN_D_M_Y_YEAR_2 = "trackClientStatistic.year = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_D_M_Y_D_M_T =
		new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED,
			TrackClientStatisticImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByD_M_Y_D_M_T",
			new String[] {
				Integer.class.getName(), Integer.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y_D_M_T =
		new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED,
			TrackClientStatisticImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByD_M_Y_D_M_T",
			new String[] {
				Integer.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Boolean.class.getName(),
				Boolean.class.getName(), Boolean.class.getName()
			...
			TrackClientStatisticModelImpl.TABLET_COLUMN_BITMASK |
			TrackClientStatisticModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_D_M_Y_D_M_T = new FinderPath(TrackClientStatisticModelImpl.ENTITY_CACHE_ENABLED,
			TrackClientStatisticModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByD_M_Y_D_M_T",
			new String[] {
				Integer.class.getName(), Integer.class.getName(),
				Integer.class.getName(), Boolean.class.getName(),
				Boolean.class.getName(), Boolean.class.getName()
	 ...
	 */
	@Override
	public List<TrackClientStatistic> findByD_M_Y_D_M_T(int day, int month,
		int year, boolean desktop, boolean mobile, boolean tablet) {
		return findByD_M_Y_D_M_T(day, month, year, desktop, mobile, tablet,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<TrackClientStatistic> findByD_M_Y_D_M_T(int day, int month,
		int year, boolean desktop, boolean mobile, boolean tablet, int start,
		int end) {
		return findByD_M_Y_D_M_T(day, month, year, desktop, mobile, tablet,
			start, end, null);
	}
	...
	public List<TrackClientStatistic> findByD_M_Y_D_M_T(int day, int month,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y_D_M_T;
			finderArgs = new Object[] { day, month, year, desktop, mobile, tablet };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_D_M_Y_D_M_T;
			finderArgs = new Object[] {
					day, month, year, desktop, mobile, tablet,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_D_M_Y_D_M_T_DAY_2);

			query.append(_FINDER_COLUMN_D_M_Y_D_M_T_MONTH_2);

			query.append(_FINDER_COLUMN_D_M_Y_D_M_T_YEAR_2);

			query.append(_FINDER_COLUMN_D_M_Y_D_M_T_DESKTOP_2);

			query.append(_FINDER_COLUMN_D_M_Y_D_M_T_MOBILE_2);

			query.append(_FINDER_COLUMN_D_M_Y_D_M_T_TABLET_2);
	...
	public TrackClientStatistic findByD_M_Y_D_M_T_First(int day, int month,
		...
		OrderByComparator<TrackClientStatistic> orderByComparator)
		throws NoSuchTrackClientStatisticException {
		TrackClientStatistic trackClientStatistic = fetchByD_M_Y_D_M_T_First(day,
				month, year, desktop, mobile, tablet, orderByComparator);
	...
	public TrackClientStatistic fetchByD_M_Y_D_M_T_First(int day, int month,
		int year, boolean desktop, boolean mobile, boolean tablet,
		OrderByComparator<TrackClientStatistic> orderByComparator) {
		List<TrackClientStatistic> list = findByD_M_Y_D_M_T(day, month, year,
				desktop, mobile, tablet, 0, 1, orderByComparator);
	...
	public TrackClientStatistic findByD_M_Y_D_M_T_Last(int day, int month,
		...
		OrderByComparator<TrackClientStatistic> orderByComparator)
		throws NoSuchTrackClientStatisticException {
		TrackClientStatistic trackClientStatistic = fetchByD_M_Y_D_M_T_Last(day,
				month, year, desktop, mobile, tablet, orderByComparator);
	...
	public TrackClientStatistic fetchByD_M_Y_D_M_T_Last(int day, int month,
		int year, boolean desktop, boolean mobile, boolean tablet,
		OrderByComparator<TrackClientStatistic> orderByComparator) {
		int count = countByD_M_Y_D_M_T(day, month, year, desktop, mobile, tablet);
		...
		List<TrackClientStatistic> list = findByD_M_Y_D_M_T(day, month, year,
				desktop, mobile, tablet, count - 1, count, orderByComparator);
	...
	public TrackClientStatistic[] findByD_M_Y_D_M_T_PrevAndNext(
		...
		try {
			...
			array[0] = getByD_M_Y_D_M_T_PrevAndNext(session,
					trackClientStatistic, day, month, year, desktop, mobile,
					tablet, orderByComparator, true);

			array[1] = trackClientStatistic;

			array[2] = getByD_M_Y_D_M_T_PrevAndNext(session,
					trackClientStatistic, day, month, year, desktop, mobile,
					tablet, orderByComparator, false);
	...
	protected TrackClientStatistic getByD_M_Y_D_M_T_PrevAndNext(
		Session session, TrackClientStatistic trackClientStatistic, int day,
	...
	public void removeByD_M_Y_D_M_T(int day, int month, int year,
		boolean desktop, boolean mobile, boolean tablet) {
		for (TrackClientStatistic trackClientStatistic : findByD_M_Y_D_M_T(
				day, month, year, desktop, mobile, tablet, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(trackClientStatistic);
		}
	}
	...
	public int countByD_M_Y_D_M_T(int day, int month, int year,
		boolean desktop, boolean mobile, boolean tablet) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_D_M_Y_D_M_T;
	...
	private static final String _FINDER_COLUMN_D_M_Y_D_M_T_DAY_2 = "trackClientStatistic.day = ? AND ";
	private static final String _FINDER_COLUMN_D_M_Y_D_M_T_MONTH_2 = "trackClientStatistic.month = ? AND ";
	private static final String _FINDER_COLUMN_D_M_Y_D_M_T_YEAR_2 = "trackClientStatistic.year = ? AND ";
	private static final String _FINDER_COLUMN_D_M_Y_D_M_T_DESKTOP_2 = "trackClientStatistic.desktop = ? AND ";
	private static final String _FINDER_COLUMN_D_M_Y_D_M_T_MOBILE_2 = "trackClientStatistic.mobile = ? AND ";
	private static final String _FINDER_COLUMN_D_M_Y_D_M_T_TABLET_2 = "trackClientStatistic.tablet = ?";
	...
	public void cacheResult(TrackClientStatistic trackClientStatistic) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T,
			new Object[] {
				trackClientStatistic.getUrl(), trackClientStatistic.getYear(),
				trackClientStatistic.getMonth(), trackClientStatistic.getDay(),
				trackClientStatistic.isDesktop(),
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				...
				trackClientStatisticModelImpl.getYear(),
				trackClientStatisticModelImpl.getMonth(),
				trackClientStatisticModelImpl.getDay(),
				trackClientStatisticModelImpl.isDesktop(),
				trackClientStatisticModelImpl.isMobile(),
				trackClientStatisticModelImpl.isTablet()
			};

		finderCache.putResult(FINDER_PATH_COUNT_BY_U_Y_M_D_D_M_T, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T, args,
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_U_Y_M_D_D_M_T, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T, args);
		}

		if ((trackClientStatisticModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_U_Y_M_D_D_M_T.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					trackClientStatisticModelImpl.getOriginalUrl(),
					trackClientStatisticModelImpl.getOriginalYear(),
					trackClientStatisticModelImpl.getOriginalMonth(),
					trackClientStatisticModelImpl.getOriginalDay(),
	...
	public TrackClientStatistic updateImpl(
		...
		if (!TrackClientStatisticModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_D_M_Y, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_D_M_Y_D_M_T, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y_D_M_T,
				args);
			...
			if ((trackClientStatisticModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						trackClientStatisticModelImpl.getOriginalDay(),
						trackClientStatisticModelImpl.getOriginalMonth(),
						trackClientStatisticModelImpl.getOriginalYear()
			...
			if ((trackClientStatisticModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_M_Y_D_M_T.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						trackClientStatisticModelImpl.getOriginalDay(),
						trackClientStatisticModelImpl.getOriginalMonth(),
						trackClientStatisticModelImpl.getOriginalYear(),
