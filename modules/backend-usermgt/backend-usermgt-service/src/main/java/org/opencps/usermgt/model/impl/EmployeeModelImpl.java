...
public class EmployeeModelImpl extends BaseModelImpl<Employee>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_employee (uuid_ VARCHAR(75) null,employeeId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,employeeNo VARCHAR(75) null,fullName VARCHAR(1024) null,title VARCHAR(1024) null,gender INTEGER,birthdate DATE null,telNo VARCHAR(75) null,mobile VARCHAR(75) null,email VARCHAR(512) null,workingStatus INTEGER,mappingUserId LONG,mainJobPostId LONG,photoFileEntryId LONG,recruitDate DATE null,leaveDate DATE null,fileCertId LONG,fileSignId LONG,fileCertPath VARCHAR(512) null,fileSignPath VARCHAR(512) null,scope VARCHAR(128) null)";
