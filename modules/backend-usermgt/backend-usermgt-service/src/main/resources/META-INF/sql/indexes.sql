create index IX_FEDE85E2 on m_jobposwork (groupId, jobPostId, checklistCat[$COLUMN_LENGTH:500$]);
...
create index IX_59E681BE on opencps_answer (groupId, className[$COLUMN_LENGTH:75$], classPK[$COLUMN_LENGTH:75$], synced, publish);
create index IX_A0B41C61 on opencps_answer (groupId, className[$COLUMN_LENGTH:75$], synced, publish);
...
create unique index IX_70B3C735 on opencps_applicant (contactEmail[$COLUMN_LENGTH:500$]);
...
create unique index IX_B6E00A35 on opencps_applicant (groupId, contactEmail[$COLUMN_LENGTH:500$]);
...
create index IX_F3E0B05E on opencps_jobpos (groupId, title[$COLUMN_LENGTH:500$]);
...
create index IX_7EE37926 on opencps_question (groupId, className[$COLUMN_LENGTH:75$], classPK[$COLUMN_LENGTH:75$], synced, publish);
create index IX_74A7AFF9 on opencps_question (groupId, className[$COLUMN_LENGTH:75$], synced, publish);
...
create index IX_F35D685E on opencps_workingunit (groupId, govAgencyCode[$COLUMN_LENGTH:100$]);
