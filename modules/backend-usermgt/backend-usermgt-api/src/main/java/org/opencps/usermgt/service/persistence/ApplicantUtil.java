...
public class ApplicantUtil {
	...
	* @return the matching applicants
	*/
	public static List<Applicant> findByF_GID_TYPE(long groupId,
		String applicantIdType) {
		return getPersistence().findByF_GID_TYPE(groupId, applicantIdType);
	}
	...
	*/
	public static List<Applicant> findByF_GID_TYPE(long groupId,
		...
		return getPersistence()
				   .findByF_GID_TYPE(groupId, applicantIdType, start, end);
	}
	...
	* @throws NoSuchApplicantException if a matching applicant could not be found
	*/
	public static Applicant findByF_GID_TYPE_First(long groupId,
		String applicantIdType, OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_GID_TYPE_First(groupId, applicantIdType,
			orderByComparator);
	}
	...
	* @return the first matching applicant, or <code>null</code> if a matching applicant could not be found
	*/
	public static Applicant fetchByF_GID_TYPE_First(long groupId,
		String applicantIdType, OrderByComparator<Applicant> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_TYPE_First(groupId, applicantIdType,
			orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a matching applicant could not be found
	*/
	public static Applicant findByF_GID_TYPE_Last(long groupId,
		String applicantIdType, OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_GID_TYPE_Last(groupId, applicantIdType,
			orderByComparator);
	}
	...
	* @return the last matching applicant, or <code>null</code> if a matching applicant could not be found
	*/
	public static Applicant fetchByF_GID_TYPE_Last(long groupId,
		String applicantIdType, OrderByComparator<Applicant> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_TYPE_Last(groupId, applicantIdType,
			orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a applicant with the primary key could not be found
	*/
	public static Applicant[] findByF_GID_TYPE_PrevAndNext(long applicantId,
		long groupId, String applicantIdType,
		OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_GID_TYPE_PrevAndNext(applicantId, groupId,
			applicantIdType, orderByComparator);
	}
	...
	* @param applicantIdType the applicant ID type
	*/
	public static void removeByF_GID_TYPE(long groupId, String applicantIdType) {
		getPersistence().removeByF_GID_TYPE(groupId, applicantIdType);
	}
	...
	* @return the number of matching applicants
	*/
	public static int countByF_GID_TYPE(long groupId, String applicantIdType) {
		return getPersistence().countByF_GID_TYPE(groupId, applicantIdType);
	}
	...
	* @return the matching applicants
	*/
	public static List<Applicant> findByF_APLC_IDS(String applicantIdNo) {
		return getPersistence().findByF_APLC_IDS(applicantIdNo);
	}
	...
	*/
	public static List<Applicant> findByF_APLC_IDS(String applicantIdNo,
		int start, int end) {
		return getPersistence().findByF_APLC_IDS(applicantIdNo, start, end);
	}
	...
	*/
	public static List<Applicant> findByF_APLC_IDS(String applicantIdNo,
		int start, int end, OrderByComparator<Applicant> orderByComparator) {
		return getPersistence()
				   .findByF_APLC_IDS(applicantIdNo, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a matching applicant could not be found
	*/
	public static Applicant findByF_APLC_IDS_First(String applicantIdNo,
		OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_APLC_IDS_First(applicantIdNo, orderByComparator);
	}
	...
	* @return the first matching applicant, or <code>null</code> if a matching applicant could not be found
	*/
	public static Applicant fetchByF_APLC_IDS_First(String applicantIdNo,
		OrderByComparator<Applicant> orderByComparator) {
		return getPersistence()
				   .fetchByF_APLC_IDS_First(applicantIdNo, orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a matching applicant could not be found
	*/
	public static Applicant findByF_APLC_IDS_Last(String applicantIdNo,
		OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_APLC_IDS_Last(applicantIdNo, orderByComparator);
	}
	...
	* @return the last matching applicant, or <code>null</code> if a matching applicant could not be found
	*/
	public static Applicant fetchByF_APLC_IDS_Last(String applicantIdNo,
		OrderByComparator<Applicant> orderByComparator) {
		return getPersistence()
				   .fetchByF_APLC_IDS_Last(applicantIdNo, orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a applicant with the primary key could not be found
	*/
	public static Applicant[] findByF_APLC_IDS_PrevAndNext(long applicantId,
		String applicantIdNo, OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_APLC_IDS_PrevAndNext(applicantId, applicantIdNo,
			orderByComparator);
	}
	...
	* @param applicantIdNo the applicant ID no
	*/
	public static void removeByF_APLC_IDS(String applicantIdNo) {
		getPersistence().removeByF_APLC_IDS(applicantIdNo);
	}
	...
	* @return the number of matching applicants
	*/
	public static int countByF_APLC_IDS(String applicantIdNo) {
		return getPersistence().countByF_APLC_IDS(applicantIdNo);
	}
	...
	* @return the matching applicants
	*/
	public static List<Applicant> findByF_EMAIL(String contactEmail) {
		return getPersistence().findByF_EMAIL(contactEmail);
	}
	...
	* @return the range of matching applicants
	*/
	public static List<Applicant> findByF_EMAIL(String contactEmail, int start,
		int end) {
		return getPersistence().findByF_EMAIL(contactEmail, start, end);
	}
	...
	*/
	public static List<Applicant> findByF_EMAIL(String contactEmail, int start,
		...
		return getPersistence()
				   .findByF_EMAIL(contactEmail, start, end, orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a matching applicant could not be found
	*/
	public static Applicant findByF_EMAIL_First(String contactEmail,
		OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_EMAIL_First(contactEmail, orderByComparator);
	}
	...
	* @return the first matching applicant, or <code>null</code> if a matching applicant could not be found
	*/
	public static Applicant fetchByF_EMAIL_First(String contactEmail,
		OrderByComparator<Applicant> orderByComparator) {
		return getPersistence()
				   .fetchByF_EMAIL_First(contactEmail, orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a matching applicant could not be found
	*/
	public static Applicant findByF_EMAIL_Last(String contactEmail,
		OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_EMAIL_Last(contactEmail, orderByComparator);
	}
	...
	* @return the last matching applicant, or <code>null</code> if a matching applicant could not be found
	*/
	public static Applicant fetchByF_EMAIL_Last(String contactEmail,
		OrderByComparator<Applicant> orderByComparator) {
		return getPersistence()
				   .fetchByF_EMAIL_Last(contactEmail, orderByComparator);
	}
	...
	* @throws NoSuchApplicantException if a applicant with the primary key could not be found
	*/
	public static Applicant[] findByF_EMAIL_PrevAndNext(long applicantId,
		String contactEmail, OrderByComparator<Applicant> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .findByF_EMAIL_PrevAndNext(applicantId, contactEmail,
			orderByComparator);
	}
	...
	* @param contactEmail the contact email
	*/
	public static void removeByF_EMAIL(String contactEmail) {
		getPersistence().removeByF_EMAIL(contactEmail);
	}
	...
	* @return the number of matching applicants
	*/
	public static int countByF_EMAIL(String contactEmail) {
		return getPersistence().countByF_EMAIL(contactEmail);
	}
	...
	* @throws NoSuchApplicantException if a matching applicant could not be found
	*/
	public static Applicant findByF_GID_MCN_MCPK(long groupId,
	...
	* @return the matching applicant, or <code>null</code> if a matching applicant could not be found
	*/
	public static Applicant fetchByF_GID_MCN_MCPK(long groupId,
		String mappingClassName, String mappingClassPK) {
		return getPersistence()
	...
	*/
	public static Applicant fetchByF_GID_MCN_MCPK(long groupId,
		...
		return getPersistence()
				   .fetchByF_GID_MCN_MCPK(groupId, mappingClassName,
			mappingClassPK, retrieveFromCache);
	}
	...
	* @return the applicant that was removed
	*/
	public static Applicant removeByF_GID_MCN_MCPK(long groupId,
		String mappingClassName, String mappingClassPK)
		throws org.opencps.usermgt.exception.NoSuchApplicantException {
		return getPersistence()
				   .removeByF_GID_MCN_MCPK(groupId, mappingClassName,
			mappingClassPK);
	}
	...
	* @return the number of matching applicants
	*/
	public static int countByF_GID_MCN_MCPK(long groupId,
		String mappingClassName, String mappingClassPK) {
		return getPersistence()
				   .countByF_GID_MCN_MCPK(groupId, mappingClassName,
			mappingClassPK);
	}
