...
public class ApplicantLocalServiceWrapper implements ApplicantLocalService,
	...
	*/
	...
	@Override
	public org.opencps.usermgt.model.Applicant fetchBy_GTelNo(Long groupId,
		String telNo) {
		return _applicantLocalService.fetchBy_GTelNo(groupId, telNo);
	}
	...
	*/
	...
	public org.opencps.usermgt.model.Applicant importApplicationDB(
		...
		return _applicantLocalService.importApplicationDB(groupId, userId,
			...
			wardName, contactName, profile, context);
	}
	...
	*/
	...
	public org.opencps.usermgt.model.Applicant updateApplication(
		...
		return _applicantLocalService.updateApplication(context, groupId,
			...
			applicantIdDate, address, cityCode, cityName, districtCode,
			districtName, wardCode, wardName, contactName, contactTelNo,
			contactEmail, profile, password, activeUser);
	}
