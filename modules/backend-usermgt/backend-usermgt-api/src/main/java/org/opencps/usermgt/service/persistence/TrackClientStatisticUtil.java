...
public class TrackClientStatisticUtil {
	...
	* @return the matching track client statistics
	*/
	public static List<TrackClientStatistic> findByD_M_Y_D_M_T(int day,
		int month, int year, boolean desktop, boolean mobile, boolean tablet) {
		return getPersistence()
				   .findByD_M_Y_D_M_T(day, month, year, desktop, mobile, tablet);
	}
	...
	*/
	public static List<TrackClientStatistic> findByD_M_Y_D_M_T(int day,
		...
		int start, int end) {
		return getPersistence()
				   .findByD_M_Y_D_M_T(day, month, year, desktop, mobile,
			tablet, start, end);
	}
	...
	*/
	public static List<TrackClientStatistic> findByD_M_Y_D_M_T(int day,
		...
		return getPersistence()
				   .findByD_M_Y_D_M_T(day, month, year, desktop, mobile,
			tablet, start, end, orderByComparator);
	}
	...
	*/
	public static List<TrackClientStatistic> findByD_M_Y_D_M_T(int day,
		...
		return getPersistence()
				   .findByD_M_Y_D_M_T(day, month, year, desktop, mobile,
			tablet, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchTrackClientStatisticException if a matching track client statistic could not be found
	*/
	public static TrackClientStatistic findByD_M_Y_D_M_T_First(int day,
		int month, int year, boolean desktop, boolean mobile, boolean tablet,
		OrderByComparator<TrackClientStatistic> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchTrackClientStatisticException {
		return getPersistence()
				   .findByD_M_Y_D_M_T_First(day, month, year, desktop, mobile,
			tablet, orderByComparator);
	}
	...
	* @return the first matching track client statistic, or <code>null</code> if a matching track client statistic could not be found
	*/
	public static TrackClientStatistic fetchByD_M_Y_D_M_T_First(int day,
		int month, int year, boolean desktop, boolean mobile, boolean tablet,
		OrderByComparator<TrackClientStatistic> orderByComparator) {
		return getPersistence()
				   .fetchByD_M_Y_D_M_T_First(day, month, year, desktop, mobile,
			tablet, orderByComparator);
	}
	...
	* @throws NoSuchTrackClientStatisticException if a matching track client statistic could not be found
	*/
	public static TrackClientStatistic findByD_M_Y_D_M_T_Last(int day,
		int month, int year, boolean desktop, boolean mobile, boolean tablet,
		OrderByComparator<TrackClientStatistic> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchTrackClientStatisticException {
		return getPersistence()
				   .findByD_M_Y_D_M_T_Last(day, month, year, desktop, mobile,
			tablet, orderByComparator);
	}
	...
	* @return the last matching track client statistic, or <code>null</code> if a matching track client statistic could not be found
	*/
	public static TrackClientStatistic fetchByD_M_Y_D_M_T_Last(int day,
		int month, int year, boolean desktop, boolean mobile, boolean tablet,
		OrderByComparator<TrackClientStatistic> orderByComparator) {
		return getPersistence()
				   .fetchByD_M_Y_D_M_T_Last(day, month, year, desktop, mobile,
			tablet, orderByComparator);
	}
	...
	* @throws NoSuchTrackClientStatisticException if a track client statistic with the primary key could not be found
	*/
	public static TrackClientStatistic[] findByD_M_Y_D_M_T_PrevAndNext(
		long trackClientStatisticId, int day, int month, int year,
		boolean desktop, boolean mobile, boolean tablet,
		OrderByComparator<TrackClientStatistic> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchTrackClientStatisticException {
		return getPersistence()
				   .findByD_M_Y_D_M_T_PrevAndNext(trackClientStatisticId, day,
	...
	* @param tablet the tablet
	*/
	public static void removeByD_M_Y_D_M_T(int day, int month, int year,
		boolean desktop, boolean mobile, boolean tablet) {
		getPersistence()
			.removeByD_M_Y_D_M_T(day, month, year, desktop, mobile, tablet);
	}
	...
	* @return the number of matching track client statistics
	*/
	public static int countByD_M_Y_D_M_T(int day, int month, int year,
		boolean desktop, boolean mobile, boolean tablet) {
		return getPersistence()
				   .countByD_M_Y_D_M_T(day, month, year, desktop, mobile, tablet);
	}
