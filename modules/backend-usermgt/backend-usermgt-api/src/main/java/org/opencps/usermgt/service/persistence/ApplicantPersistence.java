...
public interface ApplicantPersistence extends BasePersistence<Applicant> {
	...
	* @return the matching applicants
	*/
	public java.util.List<Applicant> findByF_MAPPING_ID(long mappingUserId);
	...
	* @return the matching applicants
	*/
	public java.util.List<Applicant> findByF_GID_TYPE(long groupId,
	...
	* @return the matching applicants
	*/
	public java.util.List<Applicant> findByF_EMAIL(String contactEmail);
