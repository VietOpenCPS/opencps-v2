...
public class EmployeeUtil {
	...
	* @return the matching employees
	*/
	public static List<Employee> findByFB_MUID(long mappingUserId) {
	...
	* @return the range of matching employees
	*/
	public static List<Employee> findByFB_MUID(long mappingUserId, int start,
		int end) {
		return getPersistence().findByFB_MUID(mappingUserId, start, end);
	}
	...
	*/
	public static List<Employee> findByFB_MUID(long mappingUserId, int start,
		...
		return getPersistence()
				   .findByFB_MUID(mappingUserId, start, end, orderByComparator);
	}
	...
	* @throws NoSuchEmployeeException if a matching employee could not be found
	*/
	public static Employee findByFB_MUID_First(long mappingUserId,
		OrderByComparator<Employee> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchEmployeeException {
		return getPersistence()
				   .findByFB_MUID_First(mappingUserId, orderByComparator);
	}
	...
	* @return the first matching employee, or <code>null</code> if a matching employee could not be found
	*/
	public static Employee fetchByFB_MUID_First(long mappingUserId,
		OrderByComparator<Employee> orderByComparator) {
		return getPersistence()
				   .fetchByFB_MUID_First(mappingUserId, orderByComparator);
	}
	...
	* @throws NoSuchEmployeeException if a matching employee could not be found
	*/
	public static Employee findByFB_MUID_Last(long mappingUserId,
		OrderByComparator<Employee> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchEmployeeException {
		return getPersistence()
				   .findByFB_MUID_Last(mappingUserId, orderByComparator);
	}
	...
	* @return the last matching employee, or <code>null</code> if a matching employee could not be found
	*/
	public static Employee fetchByFB_MUID_Last(long mappingUserId,
		OrderByComparator<Employee> orderByComparator) {
		return getPersistence()
				   .fetchByFB_MUID_Last(mappingUserId, orderByComparator);
	}
	...
	* @throws NoSuchEmployeeException if a employee with the primary key could not be found
	*/
	public static Employee[] findByFB_MUID_PrevAndNext(long employeeId,
		long mappingUserId, OrderByComparator<Employee> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchEmployeeException {
		return getPersistence()
				   .findByFB_MUID_PrevAndNext(employeeId, mappingUserId,
			orderByComparator);
	}
	...
	* @param mappingUserId the mapping user ID
	*/
	public static void removeByFB_MUID(long mappingUserId) {
		getPersistence().removeByFB_MUID(mappingUserId);
	}
	...
	* @throws NoSuchEmployeeException if a matching employee could not be found
	*/
	public static Employee findByF_WS_EMPNO(int workingStatus, String employeeNo)
		throws org.opencps.usermgt.exception.NoSuchEmployeeException {
		return getPersistence().findByF_WS_EMPNO(workingStatus, employeeNo);
	}
	...
	* @return the matching employee, or <code>null</code> if a matching employee could not be found
	*/
	public static Employee fetchByF_WS_EMPNO(int workingStatus,
		String employeeNo) {
		return getPersistence().fetchByF_WS_EMPNO(workingStatus, employeeNo);
	}
	...
	*/
	public static Employee fetchByF_WS_EMPNO(int workingStatus,
		String employeeNo, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByF_WS_EMPNO(workingStatus, employeeNo,
			retrieveFromCache);
	}
	...
	* @return the employee that was removed
	*/
	public static Employee removeByF_WS_EMPNO(int workingStatus,
		String employeeNo)
		throws org.opencps.usermgt.exception.NoSuchEmployeeException {
		return getPersistence().removeByF_WS_EMPNO(workingStatus, employeeNo);
	}
	...
	* @return the number of matching employees
	*/
	public static int countByF_WS_EMPNO(int workingStatus, String employeeNo) {
		return getPersistence().countByF_WS_EMPNO(workingStatus, employeeNo);
	}
	...
	* @return the matching employees
	*/
	public static List<Employee> findByG_EMPID(long groupId, long employeeId) {
		return getPersistence().findByG_EMPID(groupId, employeeId);
	}
	...
	*/
	public static List<Employee> findByG_EMPID(long groupId, long employeeId,
		int start, int end) {
		return getPersistence().findByG_EMPID(groupId, employeeId, start, end);
	}
	...
	*/
	public static List<Employee> findByG_EMPID(long groupId, long employeeId,
		int start, int end, OrderByComparator<Employee> orderByComparator) {
		return getPersistence()
				   .findByG_EMPID(groupId, employeeId, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchEmployeeException if a matching employee could not be found
	*/
	public static Employee findByG_EMPID_First(long groupId, long employeeId,
		OrderByComparator<Employee> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchEmployeeException {
		return getPersistence()
				   .findByG_EMPID_First(groupId, employeeId, orderByComparator);
	}
	...
	* @return the first matching employee, or <code>null</code> if a matching employee could not be found
	*/
	public static Employee fetchByG_EMPID_First(long groupId, long employeeId,
		OrderByComparator<Employee> orderByComparator) {
		return getPersistence()
				   .fetchByG_EMPID_First(groupId, employeeId, orderByComparator);
	}
	...
	* @throws NoSuchEmployeeException if a matching employee could not be found
	*/
	public static Employee findByG_EMPID_Last(long groupId, long employeeId,
		OrderByComparator<Employee> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchEmployeeException {
		return getPersistence()
				   .findByG_EMPID_Last(groupId, employeeId, orderByComparator);
	}
	...
	* @return the last matching employee, or <code>null</code> if a matching employee could not be found
	*/
	public static Employee fetchByG_EMPID_Last(long groupId, long employeeId,
		OrderByComparator<Employee> orderByComparator) {
		return getPersistence()
				   .fetchByG_EMPID_Last(groupId, employeeId, orderByComparator);
	}
	...
	* @return the matching employees
	*/
	public static List<Employee> findByG_EMPID(long groupId, long[] employeeIds) {
		return getPersistence().findByG_EMPID(groupId, employeeIds);
	}
	...
	* @return the range of matching employees
	*/
	public static List<Employee> findByG_EMPID(long groupId,
		long[] employeeIds, int start, int end) {
		return getPersistence().findByG_EMPID(groupId, employeeIds, start, end);
	}
	...
	*/
	public static List<Employee> findByG_EMPID(long groupId,
		...
		OrderByComparator<Employee> orderByComparator) {
		return getPersistence()
				   .findByG_EMPID(groupId, employeeIds, start, end,
			orderByComparator);
	}
	...
	* @param employeeId the employee ID
	*/
	public static void removeByG_EMPID(long groupId, long employeeId) {
		getPersistence().removeByG_EMPID(groupId, employeeId);
	}
	...
	* @return the number of matching employees
	*/
	public static int countByG_EMPID(long groupId, long employeeId) {
		return getPersistence().countByG_EMPID(groupId, employeeId);
	}
	...
	* @return the number of matching employees
	*/
	public static int countByG_EMPID(long groupId, long[] employeeIds) {
		return getPersistence().countByG_EMPID(groupId, employeeIds);
	}
