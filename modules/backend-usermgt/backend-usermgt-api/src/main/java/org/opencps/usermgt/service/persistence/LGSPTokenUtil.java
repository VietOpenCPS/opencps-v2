 ...
 * @see org.opencps.usermgt.service.persistence.impl.LGSPTokenPersistenceImpl
 * @generated
 */
@ProviderType
public class LGSPTokenUtil {
	...
	*/
	public static LGSPToken findByUuid_First(String uuid,
		OrderByComparator<LGSPToken> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchLGSPTokenException {
	...
	* @throws NoSuchLGSPTokenException if a matching lgsp token could not be found
	*/
	public static LGSPToken findByF_TYPE_EXPIRY(String tokenType)
		throws org.opencps.usermgt.exception.NoSuchLGSPTokenException {
	...
	*/
	public static LGSPToken fetchByF_TYPE_EXPIRY(String tokenType) {
		return getPersistence().fetchByF_TYPE_EXPIRY(tokenType);
	}
	...
	*/
	public static LGSPToken fetchByF_TYPE_EXPIRY(String tokenType,
		boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByF_TYPE_EXPIRY(tokenType, retrieveFromCache);
	}
	...
	*/
	public static LGSPToken removeByF_TYPE_EXPIRY(String tokenType)
		throws org.opencps.usermgt.exception.NoSuchLGSPTokenException {
		return getPersistence().removeByF_TYPE_EXPIRY(tokenType);
	}
