...
/**
 * Provides the local service interface for SyncScheduler. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavu
 * @see SyncSchedulerLocalServiceUtil
...
public interface SyncSchedulerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SyncSchedulerLocalServiceUtil} to access the sync scheduler local service. Add custom service methods to {@link org.opencps.usermgt.service.impl.SyncSchedulerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SyncScheduler getByClassNameAndSyncDate(String className,
		Date syncDate);
