...
public class JobPosWorkLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.usermgt.model.JobPosWork addJobPosWork(
		long userId, long groupId, long jobPostId, String checklistCat,
	...
	*/
	...
	public static org.opencps.usermgt.model.JobPosWork updateJobPosWork(
		long userId, long jobPosWorkId, long jobPostId, String checklistCat,
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws backend.auth.api.exception.UnauthenticationException,
			backend.auth.api.exception.UnauthorizationException,
			com.liferay.portal.kernel.exception.NoSuchUserException,
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(JobPosWorkLocalService.class);

		ServiceTracker<JobPosWorkLocalService, JobPosWorkLocalService> serviceTracker =
			new ServiceTracker<JobPosWorkLocalService, JobPosWorkLocalService>(bundle.getBundleContext(),
				JobPosWorkLocalService.class, null);
