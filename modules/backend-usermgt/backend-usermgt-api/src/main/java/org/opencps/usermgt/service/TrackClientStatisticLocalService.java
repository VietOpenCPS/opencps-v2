 ...
 *
 * @author khoavu
 * @see TrackClientStatisticLocalServiceUtil
...
public interface TrackClientStatisticLocalService extends BaseLocalService,
	...
	*/
	...
	public TrackClientStatistic createTrackClientStatistic(
	...
	*/
	...
	public TrackClientStatistic deleteTrackClientStatistic(
		long trackClientStatisticId) throws PortalException;
	...
	*/
	...
	public TrackClientStatistic fetchTrackClientStatistic(
		long trackClientStatisticId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TrackClientStatistic getTrackClientStatistic(
		long trackClientStatisticId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TrackClientStatistic> getTrackClientStatistics(int start,
		int end);
