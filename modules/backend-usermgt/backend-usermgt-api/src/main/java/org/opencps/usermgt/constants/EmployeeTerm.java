...
public class EmployeeTerm {
	...
	public static final String WORKING_STATUS_SORTABLE =
		"workingStatus_sortable";

	public static final String MAPPING_USER_ID_SORTABLE =
		"mappingUserId_sortable";

	public static final String MAIN_JOBPOST_ID_SORTABLE =
		"mainJobPostId_sortable";

	public static final String TITLE_SORTABLE = "title_sortable";

	public static final String EMP_ACTION_LOCK_SCREENNAME = "screenName";
	public static final String EMP_ACTION_LOCK_EMAIL = "email";
	public static final String EMP_ACTION_LOCK_EXIST = "exist";
	public static final String EMP_ACTION_LOCK_USERNAME = "USERNAME";
	public static final String EMP_ACTION_LOCK_USEREMAIL = "USEREMAIL";
	public static final String EMP_ACTION_LOCK_USERSTATUS = "USERSTATUS";
