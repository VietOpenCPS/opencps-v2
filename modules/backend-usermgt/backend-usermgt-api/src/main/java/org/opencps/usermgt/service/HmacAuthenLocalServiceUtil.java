...
public class HmacAuthenLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(HmacAuthenLocalService.class);

		ServiceTracker<HmacAuthenLocalService, HmacAuthenLocalService> serviceTracker =
			new ServiceTracker<HmacAuthenLocalService, HmacAuthenLocalService>(bundle.getBundleContext(),
				HmacAuthenLocalService.class, null);
