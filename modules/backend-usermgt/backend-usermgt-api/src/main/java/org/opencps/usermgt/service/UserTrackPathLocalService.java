...
/**
 * Provides the local service interface for UserTrackPath. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavu
 * @see UserTrackPathLocalServiceUtil
...
public interface UserTrackPathLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserTrackPathLocalServiceUtil} to access the user track path local service. Add custom service methods to {@link org.opencps.usermgt.service.impl.UserTrackPathLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public UserTrackPath addUserTrackPath(UserTrackPath userTrackPath);
	...
	*/
	...
	public UserTrackPath createUserTrackPath(long userTrackPathId);
	...
	*/
	...
	public UserTrackPath deleteUserTrackPath(long userTrackPathId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public UserTrackPath deleteUserTrackPath(UserTrackPath userTrackPath);
	...
	*/
	...
	public UserTrackPath fetchUserTrackPath(long userTrackPathId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserTrackPath fetchUserTrackPathByUuidAndCompanyId(String uuid,
		long companyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserTrackPath getUserTrackPath(long userTrackPathId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserTrackPath getUserTrackPathByUuidAndCompanyId(String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserTrackPath> getUserTrackPaths(int start, int end);
	...
	*/
	...
	public UserTrackPath updateUserTrackPath(long companyId,
		long userTrackPathId, long userLoginId, String path, Date pathDate);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public UserTrackPath updateUserTrackPath(UserTrackPath userTrackPath);
}