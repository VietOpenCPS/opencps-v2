...
/**
 * Provides the local service interface for LGSPToken. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavu
 * @see LGSPTokenLocalServiceUtil
...
public interface LGSPTokenLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LGSPTokenLocalServiceUtil} to access the lgsp token local service. Add custom service methods to {@link org.opencps.usermgt.service.impl.LGSPTokenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
