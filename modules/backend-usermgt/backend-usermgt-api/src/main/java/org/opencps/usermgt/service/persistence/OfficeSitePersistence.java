...
public interface OfficeSitePersistence extends BasePersistence<OfficeSite> {
	...
	*/
	public java.util.List<OfficeSite> findByUuid(String uuid);
	...
	*/
	public java.util.List<OfficeSite> findByUuid(String uuid, int start, int end);
	...
	*/
	public java.util.List<OfficeSite> findByUuid(String uuid, int start,
		int end,
	...
	* @return the matching office sites
	*/
	public java.util.List<OfficeSite> findByUuid_C(String uuid, long companyId);
