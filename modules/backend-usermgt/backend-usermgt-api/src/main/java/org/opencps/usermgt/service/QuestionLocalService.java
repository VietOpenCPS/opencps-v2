...
public interface QuestionLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QuestionLocalServiceUtil} to access the question local service. Add custom service methods to {@link org.opencps.usermgt.service.impl.QuestionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<Question> findByQuerySearch(long groupId, String keyword,
		String govAgencyCode, Integer publish, String questionType,
		Boolean answer, int start, int limit);
