...
@Component(immediate = true, property = {
	...
	"javax.portlet.display-name=Register BVH Portlet",
	"javax.portlet.init-param.template-path=/",
	"javax.portlet.init-param.view-template=/templates/applicant_bvh/register.ftl",
	"javax.portlet.name=" + FrontendWebPortalPortletKeys.REGISTERBVH_PORTLET_NAME,
	"javax.portlet.resource-bundle=content.Language",
	"javax.portlet.security-role-ref=power-user,user"
}, service = Portlet.class)
public class RegisterPortlet_bvh extends FreeMarkerPortlet {
