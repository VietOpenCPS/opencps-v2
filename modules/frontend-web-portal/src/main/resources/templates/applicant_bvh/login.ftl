...
<div class="">
	<form action="${loginURL}" method="post" class="eq-height-lg" name="login_form">
		...
		<div class="row">
			...
			<div class="col-sm-6">
				<button class="btn btn-active btn-sm" type="button" id="btn-register-applicant" onclick="register()" style="float: left;margin-left: -12px;margin-right:2px;">Đăng ký</button>
