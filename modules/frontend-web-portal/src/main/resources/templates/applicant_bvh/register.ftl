    ...
    <div class="row">
     ...
     <div class="row MT10 MB10">
      <div class="col-xs-12 col-sm-12 text-center">
       <div class="radio-inline"> <input type="radio" id="rdCitizen" name="applicantIdType" value="citizen" checked> <label>Công dân</label> </div>
       <div class="radio-inline"> <input type="radio" id="rdBusiness" name="applicantIdType" value="business"> <label>Doanh nghiệp</label> </div>
     </div>
   </div>
   <div class="row MT15">
