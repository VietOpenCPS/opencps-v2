...
@Component(immediate = true, property = {
	...
	"javax.portlet.display-name=frontend-web-customer-2 Portlet",
...
public class FrontendWebCustomerPortlet extends FreeMarkerPortlet {
	...
	private JSONObject generateURLJsonObject(RenderResponse renderResponse)
		...
		PortletURL customerDossierServiceconfigDKLR =
			renderResponse.createRenderURL();
		customerDossierServiceconfigDKLR.setWindowState(
			LiferayWindowState.EXCLUSIVE);
		customerDossierServiceconfigDKLR.setParameter(
