...
<div class="button-row MT20">
	...
	<button class="btn btn-active" id="btn-submit-dossier" data-bind="value : referenceUid"><i class="fa fa-paper-plane" style="display: none;"></i> Nộp hồ sơ</button>
...
$("#btn-submit-dossier").click(function(){
	...
	var cf = fnConfirm("Thông báo",
		...
		function(){
			...
			if(isNext){
				$.ajax({
					url : "${api.server}/dossiers/${dossierId}/submit",
					dataType : "json",
					type : "POST",
					headers: {
						"groupId": ${groupId},
