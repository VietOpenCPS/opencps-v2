						...
						<script type="text/x-kendo-template" id="templateDossierPart">
							...
							<div class="row-parts-head align-middle slide-toggle">
								...
								<div class="actions">
									...
									<a href="javascript:;" class="dossier-component-profile" data-placement="top" title="Số tệp tin" data-partno="#:id#" data-required="#=required#" data-number="#if(hasForm){# 1 #}else {# 0 #}#">
										<span class="number-in-circle" >#if(hasForm){# 1 #}else {# 0 #}#</span>
									</a>
