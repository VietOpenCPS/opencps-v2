...
<div class="steps align-space-between">
  ...
  <div class="step align-middle-lg done" id="step3">
    <span>3</span>
    <span>Nộp hồ sơ</span>
  </div>
</div>
				...
				<script type="text/x-kendo-template" id="templateDossierPart">
					...
					<div class="row-parts-head align-middle">
						...
						<div class="actions">
							...
							<a href="javascript:;" class="dossier-component-profile" data-toggle="tooltip" data-placement="top" title="Số tệp tin" data-partno="#:id#" data-required="#=required#" data-number="#if(hasForm){# 1 #}else {# 0 #}#">
