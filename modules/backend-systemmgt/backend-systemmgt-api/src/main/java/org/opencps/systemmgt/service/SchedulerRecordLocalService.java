...
/**
 * Provides the local service interface for SchedulerRecord. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SchedulerRecordLocalServiceUtil
...
public interface SchedulerRecordLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SchedulerRecordLocalServiceUtil} to access the scheduler record local service. Add custom service methods to {@link org.opencps.systemmgt.service.impl.SchedulerRecordLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public SchedulerRecord updateSchedulerRecord(long schedulerId,
		String schedulerType, Date onTime, Date nextTime, Date expiredTime,
