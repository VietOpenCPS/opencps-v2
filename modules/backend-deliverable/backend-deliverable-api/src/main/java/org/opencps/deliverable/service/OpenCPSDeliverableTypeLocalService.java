...
/**
 * Provides the local service interface for OpenCPSDeliverableType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhth
 * @see OpenCPSDeliverableTypeLocalServiceUtil
...
public interface OpenCPSDeliverableTypeLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OpenCPSDeliverableTypeLocalServiceUtil} to access the open cps deliverable type local service. Add custom service methods to {@link org.opencps.deliverable.service.impl.OpenCPSDeliverableTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OpenCPSDeliverableType addOpenCPSDeliverableType(
	...
	*/
	...
	public OpenCPSDeliverableType createOpenCPSDeliverableType(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OpenCPSDeliverableType deleteOpenCPSDeliverableType(
		long deliverableTypeId) throws PortalException;
	...
	*/
	...
	public OpenCPSDeliverableType fetchOpenCPSDeliverableType(
		long deliverableTypeId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpenCPSDeliverableType fetchOpenCPSDeliverableTypeByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpenCPSDeliverableType getOpenCPSDeliverableType(
		long deliverableTypeId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpenCPSDeliverableType getOpenCPSDeliverableTypeByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpenCPSDeliverableType> getOpenCPSDeliverableTypes(int start,
		int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpenCPSDeliverableType> getOpenCPSDeliverableTypesByUuidAndCompanyId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OpenCPSDeliverableType updateOpenCPSDeliverableType(
		OpenCPSDeliverableType openCPSDeliverableType);
}