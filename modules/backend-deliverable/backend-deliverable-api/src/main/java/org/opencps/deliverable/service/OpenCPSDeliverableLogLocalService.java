...
/**
 * Provides the local service interface for OpenCPSDeliverableLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhth
 * @see OpenCPSDeliverableLogLocalServiceUtil
...
public interface OpenCPSDeliverableLogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OpenCPSDeliverableLogLocalServiceUtil} to access the open cps deliverable log local service. Add custom service methods to {@link org.opencps.deliverable.service.impl.OpenCPSDeliverableLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
