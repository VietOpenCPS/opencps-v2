 ...
 */
@ProviderType
public class OpenCPSDeliverableLogSoap implements Serializable {
	public static OpenCPSDeliverableLogSoap toSoapModel(
		OpenCPSDeliverableLog model) {
		OpenCPSDeliverableLogSoap soapModel = new OpenCPSDeliverableLogSoap();
	...
	public static OpenCPSDeliverableLogSoap[] toSoapModels(
		OpenCPSDeliverableLog[] models) {
		OpenCPSDeliverableLogSoap[] soapModels = new OpenCPSDeliverableLogSoap[models.length];
	...
	public static OpenCPSDeliverableLogSoap[][] toSoapModels(
		OpenCPSDeliverableLog[][] models) {
		OpenCPSDeliverableLogSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new OpenCPSDeliverableLogSoap[models.length][models[0].length];
		}
		else {
			soapModels = new OpenCPSDeliverableLogSoap[0][0];
		}
	...
	public static OpenCPSDeliverableLogSoap[] toSoapModels(
		List<OpenCPSDeliverableLog> models) {
		List<OpenCPSDeliverableLogSoap> soapModels = new ArrayList<OpenCPSDeliverableLogSoap>(models.size());

		for (OpenCPSDeliverableLog model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new OpenCPSDeliverableLogSoap[soapModels.size()]);
	}

	public OpenCPSDeliverableLogSoap() {
	}
