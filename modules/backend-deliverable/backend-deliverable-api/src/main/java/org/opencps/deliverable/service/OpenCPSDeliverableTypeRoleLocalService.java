...
/**
 * Provides the local service interface for OpenCPSDeliverableTypeRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhth
 * @see OpenCPSDeliverableTypeRoleLocalServiceUtil
...
public interface OpenCPSDeliverableTypeRoleLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OpenCPSDeliverableTypeRoleLocalServiceUtil} to access the open cps deliverable type role local service. Add custom service methods to {@link org.opencps.deliverable.service.impl.OpenCPSDeliverableTypeRoleLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OpenCPSDeliverableTypeRole addOpenCPSDeliverableTypeRole(
	...
	*/
	...
	public OpenCPSDeliverableTypeRole createOpenCPSDeliverableTypeRole(
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OpenCPSDeliverableTypeRole deleteOpenCPSDeliverableTypeRole(
	...
	*/
	...
	public OpenCPSDeliverableTypeRole fetchOpenCPSDeliverableTypeRole(
		long deliverableTypeRoleId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpenCPSDeliverableTypeRole fetchOpenCPSDeliverableTypeRoleByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpenCPSDeliverableTypeRole getOpenCPSDeliverableTypeRole(
		long deliverableTypeRoleId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpenCPSDeliverableTypeRole getOpenCPSDeliverableTypeRoleByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpenCPSDeliverableTypeRole> getOpenCPSDeliverableTypeRoles(
		int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpenCPSDeliverableTypeRole> getOpenCPSDeliverableTypeRolesByUuidAndCompanyId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OpenCPSDeliverableTypeRole updateOpenCPSDeliverableTypeRole(
		OpenCPSDeliverableTypeRole openCPSDeliverableTypeRole);
}