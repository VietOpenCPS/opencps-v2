...
public class VotingWrapper implements Voting, ModelWrapper<Voting> {
	...
	@Override
	public backend.feedback.model.Voting toEscapedModel() {
		return new VotingWrapper(_voting.toEscapedModel());
	}

	@Override
	public backend.feedback.model.Voting toUnescapedModel() {
	...
	*/
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<backend.feedback.model.Voting> toCacheModel() {
		return _voting.toCacheModel();
	}

	@Override
	public int compareTo(backend.feedback.model.Voting voting) {
