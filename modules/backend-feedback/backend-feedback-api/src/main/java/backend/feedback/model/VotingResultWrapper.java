...
public class VotingResultWrapper implements VotingResult,
	...
	@Override
	public backend.feedback.model.VotingResult toEscapedModel() {
		return new VotingResultWrapper(_votingResult.toEscapedModel());
	}

	@Override
	public backend.feedback.model.VotingResult toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<backend.feedback.model.VotingResult> toCacheModel() {
		return _votingResult.toCacheModel();
	}

	@Override
	public int compareTo(backend.feedback.model.VotingResult votingResult) {
