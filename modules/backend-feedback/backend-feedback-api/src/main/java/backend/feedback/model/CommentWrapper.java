...
public class CommentWrapper implements Comment, ModelWrapper<Comment> {
	...
	@Override
	public backend.feedback.model.Comment toEscapedModel() {
		return new CommentWrapper(_comment.toEscapedModel());
	}

	@Override
	public backend.feedback.model.Comment toUnescapedModel() {
	...
	@Override
	public com.liferay.portal.kernel.model.CacheModel<backend.feedback.model.Comment> toCacheModel() {
		return _comment.toCacheModel();
	}

	@Override
	public int compareTo(backend.feedback.model.Comment comment) {
	...
	*/
	@Override
	public java.lang.String getUpvotedUsers() {
	...
	*/
	@Override
	public void setUpvotedUsers(java.lang.String upvotedUsers) {
