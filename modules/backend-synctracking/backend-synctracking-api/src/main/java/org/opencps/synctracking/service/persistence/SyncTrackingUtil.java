...
public class SyncTrackingUtil {
	...
	* @return the matching sync trackings
	*/
	public static List<SyncTracking> findByF_GID_API(long groupId, String api) {
		return getPersistence().findByF_GID_API(groupId, api);
	}
	...
	*/
	public static List<SyncTracking> findByF_GID_API(long groupId, String api,
		int start, int end) {
		return getPersistence().findByF_GID_API(groupId, api, start, end);
	}
	...
	*/
	public static List<SyncTracking> findByF_GID_API(long groupId, String api,
		int start, int end, OrderByComparator<SyncTracking> orderByComparator) {
		return getPersistence()
				   .findByF_GID_API(groupId, api, start, end, orderByComparator);
	}
	...
	*/
	public static List<SyncTracking> findByF_GID_API(long groupId, String api,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByF_GID_API(groupId, api, start, end,
			orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchSyncTrackingException if a matching sync tracking could not be found
	*/
	public static SyncTracking findByF_GID_API_First(long groupId, String api,
		OrderByComparator<SyncTracking> orderByComparator)
		throws org.opencps.synctracking.exception.NoSuchSyncTrackingException {
		return getPersistence()
				   .findByF_GID_API_First(groupId, api, orderByComparator);
	}
	...
	* @return the first matching sync tracking, or <code>null</code> if a matching sync tracking could not be found
	*/
	public static SyncTracking fetchByF_GID_API_First(long groupId, String api,
		OrderByComparator<SyncTracking> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_API_First(groupId, api, orderByComparator);
	}
	...
	* @throws NoSuchSyncTrackingException if a matching sync tracking could not be found
	*/
	public static SyncTracking findByF_GID_API_Last(long groupId, String api,
		OrderByComparator<SyncTracking> orderByComparator)
		throws org.opencps.synctracking.exception.NoSuchSyncTrackingException {
		return getPersistence()
				   .findByF_GID_API_Last(groupId, api, orderByComparator);
	}
	...
	* @return the last matching sync tracking, or <code>null</code> if a matching sync tracking could not be found
	*/
	public static SyncTracking fetchByF_GID_API_Last(long groupId, String api,
		OrderByComparator<SyncTracking> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_API_Last(groupId, api, orderByComparator);
	}
	...
	* @throws NoSuchSyncTrackingException if a sync tracking with the primary key could not be found
	*/
	public static SyncTracking[] findByF_GID_API_PrevAndNext(long trackingId,
		long groupId, String api,
		OrderByComparator<SyncTracking> orderByComparator)
		throws org.opencps.synctracking.exception.NoSuchSyncTrackingException {
		return getPersistence()
				   .findByF_GID_API_PrevAndNext(trackingId, groupId, api,
			orderByComparator);
	}
	...
	* @param api the api
	*/
	public static void removeByF_GID_API(long groupId, String api) {
		getPersistence().removeByF_GID_API(groupId, api);
	}
	...
	* @return the number of matching sync trackings
	*/
	public static int countByF_GID_API(long groupId, String api) {
		return getPersistence().countByF_GID_API(groupId, api);
	}
