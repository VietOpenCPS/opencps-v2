package org.opencps.synctracking.service.comparator;
...
public class QueueDVCQGComparator extends OrderByComparator<DossierTax> {
    private static final long serialVersionUID = 1L;

    private static final String _TABLE_NAME = "opencps_dossier_tax";
    ...
    public QueueDVCQGComparator() {

        this(false, _defaultColumnName, String.class);
    }

    public QueueDVCQGComparator(boolean ascending, String columnName, Class<?> columnType) {
    ...
    @Override
    public int compare(DossierTax publishQueue0, DossierTax publishQueue1) {

        int value = -1;

        Object value0 = getValue(publishQueue0.getClass(), publishQueue0);
        Object value1 = getValue(publishQueue1.getClass(), publishQueue1);
    ...
    private Log _log = LogFactoryUtil.getLog(QueueDVCQGComparator.class.getName());
