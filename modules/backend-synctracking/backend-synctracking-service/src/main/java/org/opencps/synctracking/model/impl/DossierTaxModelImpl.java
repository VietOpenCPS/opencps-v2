...
import org.opencps.synctracking.model.DossierTaxSoap;
...
public class DossierTaxModelImpl extends BaseModelImpl<DossierTax>
	 ...
	 */
	public static DossierTax toModel(DossierTaxSoap soapModel) {
		if (soapModel == null) {
			return null;
		}

		DossierTax model = new DossierTaxImpl();
		...
		model.setSoQuyetDinh(soapModel.getSoQuyetDinh());
		model.setNgayQuyetDinh(soapModel.getNgayQuyetDinh());
		model.setTenTieuMuc(soapModel.getTenTieuMuc());
		model.setSoTien(soapModel.getSoTien());
		model.setHoTenNguoiNopTien(soapModel.getHoTenNguoiNopTien());
		model.setSoCmtNguoiNopTien(soapModel.getSoCmtNguoiNopTien());
		model.setDiaChiNguoiNopTien(soapModel.getDiaChiNguoiNopTien());
		model.setTinhNguoiNopTien(soapModel.getTinhNguoiNopTien());
		model.setHuyenNguoiNopTien(soapModel.getHuyenNguoiNopTien());
		model.setXaNguoiNopTien(soapModel.getXaNguoiNopTien());
		model.setThoiGianThanhToan(soapModel.getThoiGianThanhToan());
		model.setSoTienNop(soapModel.getSoTienNop());
		model.setNoiDungThanhToan(soapModel.getNoiDungThanhToan());
		model.setTrangThaiThanhToan(soapModel.getTrangThaiThanhToan());
		model.setFileChungTu(soapModel.getFileChungTu());
		model.setNgayThueTraThongBao(soapModel.getNgayThueTraThongBao());
		model.setNgayTraThongBao(soapModel.getNgayTraThongBao());
		model.setNgayNhanBienLai(soapModel.getNgayNhanBienLai());
	 ...
	 */
	public static List<DossierTax> toModels(DossierTaxSoap[] soapModels) {
		if (soapModels == null) {
			return null;
		}

		List<DossierTax> models = new ArrayList<DossierTax>(soapModels.length);

		for (DossierTaxSoap soapModel : soapModels) {
