...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=frontend-public-chartjs Portlet",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/templates/view_public.ftl",
		"javax.portlet.name=" + FrontendWebChartjsPortletKeys.FrontendPublicChartjs,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class FrontendPublicChartjsPortlet extends FreeMarkerPortlet {
	private static Log _log = LogFactoryUtil.getLog(FrontendPublicChartjsPortlet.class);
