...
public class KeyPayV3Term {
	...
	public static final String KEYPAY_LATE_REFUND_TRANSACTION_ENDPOINT = "keypay_late_refund_transaction_endpoint";
	...
	public static final String QRCODE_STATIC = "qrcode_static";
	...
	public static final String TRANSACTION_REFUND_CODE = "transaction_refund_code";
	public static final String AMOUNT_REFUND = "amount_refund";
	public static final String UPDATE_AT = "update_at";
	public static final String QRCODE_REFUND = "qrcode_refund";
	
	public static final String TRANSACTION_REFUND_ID = "transaction_refund_id";
