...
public class PostConnectUtil {
	...
	* @return the matching post connects
	*/
	public static List<PostConnect> findByF_BY_DOS_ID(long dossierId) {
		return getPersistence().findByF_BY_DOS_ID(dossierId);
	}
	...
	*/
	public static List<PostConnect> findByF_BY_DOS_ID(long dossierId,
		int start, int end) {
		return getPersistence().findByF_BY_DOS_ID(dossierId, start, end);
	}
	...
	*/
	public static List<PostConnect> findByF_BY_DOS_ID(long dossierId,
		int start, int end, OrderByComparator<PostConnect> orderByComparator) {
		return getPersistence()
				   .findByF_BY_DOS_ID(dossierId, start, end, orderByComparator);
	}
	...
	* @throws NoSuchPostConnectException if a matching post connect could not be found
	*/
	public static PostConnect findByF_BY_DOS_ID_First(long dossierId,
		OrderByComparator<PostConnect> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchPostConnectException {
		return getPersistence()
				   .findByF_BY_DOS_ID_First(dossierId, orderByComparator);
	}
	...
	* @return the first matching post connect, or <code>null</code> if a matching post connect could not be found
	*/
	public static PostConnect fetchByF_BY_DOS_ID_First(long dossierId,
		OrderByComparator<PostConnect> orderByComparator) {
		return getPersistence()
				   .fetchByF_BY_DOS_ID_First(dossierId, orderByComparator);
	}
	...
	* @throws NoSuchPostConnectException if a matching post connect could not be found
	*/
	public static PostConnect findByF_BY_DOS_ID_Last(long dossierId,
		OrderByComparator<PostConnect> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchPostConnectException {
		return getPersistence()
				   .findByF_BY_DOS_ID_Last(dossierId, orderByComparator);
	}
	...
	* @return the last matching post connect, or <code>null</code> if a matching post connect could not be found
	*/
	public static PostConnect fetchByF_BY_DOS_ID_Last(long dossierId,
		OrderByComparator<PostConnect> orderByComparator) {
		return getPersistence()
				   .fetchByF_BY_DOS_ID_Last(dossierId, orderByComparator);
	}
	...
	* @throws NoSuchPostConnectException if a post connect with the primary key could not be found
	*/
	public static PostConnect[] findByF_BY_DOS_ID_PrevAndNext(
		long postConnectId, long dossierId,
		OrderByComparator<PostConnect> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchPostConnectException {
		return getPersistence()
				   .findByF_BY_DOS_ID_PrevAndNext(postConnectId, dossierId,
			orderByComparator);
	}
	...
	* @param dossierId the dossier ID
	*/
	public static void removeByF_BY_DOS_ID(long dossierId) {
		getPersistence().removeByF_BY_DOS_ID(dossierId);
	}
	...
	* @return the number of matching post connects
	*/
	public static int countByF_BY_DOS_ID(long dossierId) {
		return getPersistence().countByF_BY_DOS_ID(dossierId);
	}
