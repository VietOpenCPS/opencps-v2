...
public class ProcessPluginLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(ProcessPluginLocalService.class);

		ServiceTracker<ProcessPluginLocalService, ProcessPluginLocalService> serviceTracker =
			new ServiceTracker<ProcessPluginLocalService, ProcessPluginLocalService>(bundle.getBundleContext(),
				ProcessPluginLocalService.class, null);
