...
public class BookingUtil {
	...
	* @throws NoSuchBookingException if a matching booking could not be found
	*/
	public static Booking findByF_CLASS_NAME_PK(String className, long classPK)
		throws org.opencps.dossiermgt.exception.NoSuchBookingException {
		return getPersistence().findByF_CLASS_NAME_PK(className, classPK);
	}
	...
	* @return the matching booking, or <code>null</code> if a matching booking could not be found
	*/
	public static Booking fetchByF_CLASS_NAME_PK(String className, long classPK) {
		return getPersistence().fetchByF_CLASS_NAME_PK(className, classPK);
	}
	...
	* @return the matching booking, or <code>null</code> if a matching booking could not be found
	*/
	public static Booking fetchByF_CLASS_NAME_PK(String className,
		long classPK, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByF_CLASS_NAME_PK(className, classPK, retrieveFromCache);
	}
	...
	* @return the booking that was removed
	*/
	public static Booking removeByF_CLASS_NAME_PK(String className, long classPK)
		throws org.opencps.dossiermgt.exception.NoSuchBookingException {
		return getPersistence().removeByF_CLASS_NAME_PK(className, classPK);
	}
	...
	* @return the number of matching bookings
	*/
	public static int countByF_CLASS_NAME_PK(String className, long classPK) {
		return getPersistence().countByF_CLASS_NAME_PK(className, classPK);
	}
