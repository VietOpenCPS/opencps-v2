...
public class DossierMarkUtil {
	...
	* @return the matching dossier marks
	*/
	public static List<DossierMark> findByG_DID_MARK_RC(long groupId,
		long dossierId, int fileMark, String recordCount) {
		return getPersistence()
				   .findByG_DID_MARK_RC(groupId, dossierId, fileMark,
			recordCount);
	}
	...
	*/
	public static List<DossierMark> findByG_DID_MARK_RC(long groupId,
		long dossierId, int fileMark, String recordCount, int start, int end) {
		return getPersistence()
				   .findByG_DID_MARK_RC(groupId, dossierId, fileMark,
			recordCount, start, end);
	}
	...
	*/
	public static List<DossierMark> findByG_DID_MARK_RC(long groupId,
		...
		return getPersistence()
				   .findByG_DID_MARK_RC(groupId, dossierId, fileMark,
			recordCount, start, end, orderByComparator);
	}
	...
	*/
	public static List<DossierMark> findByG_DID_MARK_RC(long groupId,
		...
		return getPersistence()
				   .findByG_DID_MARK_RC(groupId, dossierId, fileMark,
			recordCount, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchDossierMarkException if a matching dossier mark could not be found
	*/
	public static DossierMark findByG_DID_MARK_RC_First(long groupId,
		long dossierId, int fileMark, String recordCount,
		OrderByComparator<DossierMark> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierMarkException {
		return getPersistence()
				   .findByG_DID_MARK_RC_First(groupId, dossierId, fileMark,
			recordCount, orderByComparator);
	}
	...
	* @return the first matching dossier mark, or <code>null</code> if a matching dossier mark could not be found
	*/
	public static DossierMark fetchByG_DID_MARK_RC_First(long groupId,
		long dossierId, int fileMark, String recordCount,
		OrderByComparator<DossierMark> orderByComparator) {
		return getPersistence()
				   .fetchByG_DID_MARK_RC_First(groupId, dossierId, fileMark,
			recordCount, orderByComparator);
	}
	...
	* @throws NoSuchDossierMarkException if a matching dossier mark could not be found
	*/
	public static DossierMark findByG_DID_MARK_RC_Last(long groupId,
		long dossierId, int fileMark, String recordCount,
		OrderByComparator<DossierMark> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierMarkException {
		return getPersistence()
				   .findByG_DID_MARK_RC_Last(groupId, dossierId, fileMark,
			recordCount, orderByComparator);
	}
	...
	* @return the last matching dossier mark, or <code>null</code> if a matching dossier mark could not be found
	*/
	public static DossierMark fetchByG_DID_MARK_RC_Last(long groupId,
		long dossierId, int fileMark, String recordCount,
		OrderByComparator<DossierMark> orderByComparator) {
		return getPersistence()
				   .fetchByG_DID_MARK_RC_Last(groupId, dossierId, fileMark,
			recordCount, orderByComparator);
	}
	...
	* @throws NoSuchDossierMarkException if a dossier mark with the primary key could not be found
	*/
	public static DossierMark[] findByG_DID_MARK_RC_PrevAndNext(
		long dossierMarkId, long groupId, long dossierId, int fileMark,
		String recordCount, OrderByComparator<DossierMark> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierMarkException {
		return getPersistence()
				   .findByG_DID_MARK_RC_PrevAndNext(dossierMarkId, groupId,
	...
	* @param recordCount the record count
	*/
	public static void removeByG_DID_MARK_RC(long groupId, long dossierId,
		int fileMark, String recordCount) {
		getPersistence()
			.removeByG_DID_MARK_RC(groupId, dossierId, fileMark, recordCount);
	}
	...
	* @return the number of matching dossier marks
	*/
	public static int countByG_DID_MARK_RC(long groupId, long dossierId,
		int fileMark, String recordCount) {
		return getPersistence()
				   .countByG_DID_MARK_RC(groupId, dossierId, fileMark,
			recordCount);
	}
