...
/**
 * The persistence interface for the dossier status mapping service.
 *
 * <p>
 ...
 * @see DossierStatusMappingUtil
 * @generated
 */
@ProviderType
public interface DossierStatusMappingPersistence extends BasePersistence<DossierStatusMapping> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DossierStatusMappingUtil} to access the dossier status mapping persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<DossierStatusMapping> findByF_GID_SC(long groupId,
		String statusCode);
	...
	*/
	public java.util.List<DossierStatusMapping> findByF_GID_SC(long groupId,
		String statusCode, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<DossierStatusMapping> orderByComparator);
	...
	* @return the matching dossier status mappings
	*/
	public java.util.List<DossierStatusMapping> findByF_GID_SCDVCQG(
	...
	*/
	public java.util.List<DossierStatusMapping> findByF_GID_SCDVCQG(
		long groupId, String statusCodeDVCQG, int start, int end);
	...
	*/
	public void cacheResult(
		java.util.List<DossierStatusMapping> dossierStatusMappings);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, DossierStatusMapping> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<DossierStatusMapping> findAll();
	...
	*/
	public java.util.List<DossierStatusMapping> findAll(int start, int end);
