 ...
 * {@link org.opencps.dossiermgt.service.impl.DynamicReportLocalServiceImpl} and is the
 ...
 * @see org.opencps.dossiermgt.service.base.DynamicReportLocalServiceBaseImpl
 * @see org.opencps.dossiermgt.service.impl.DynamicReportLocalServiceImpl
 * @generated
 */
@ProviderType
public class DynamicReportLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.DynamicReportLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static org.opencps.dossiermgt.model.DynamicReport addDynamicReport(
		org.opencps.dossiermgt.model.DynamicReport dynamicReport) {
	...
	*/
	public static org.opencps.dossiermgt.model.DynamicReport createDynamicReport(
	...
	*/
	public static org.opencps.dossiermgt.model.DynamicReport deleteDynamicReport(
		org.opencps.dossiermgt.model.DynamicReport dynamicReport) {
	...
	*/
	...
	/**
	* Returns the dynamic report matching the UUID and group.
	*
	* @param uuid the dynamic report's UUID
	* @param groupId the primary key of the group
	* @return the matching dynamic report, or <code>null</code> if a matching dynamic report could not be found
	*/
	public static org.opencps.dossiermgt.model.DynamicReport fetchDynamicReportByUuidAndGroupId(
		String uuid, long groupId) {
		return getService().fetchDynamicReportByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a dynamic report with the primary key could not be found
	*/
	public static org.opencps.dossiermgt.model.DynamicReport getDynamicReport(
		long dynamicReportId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	* @throws PortalException if a matching dynamic report could not be found
	*/
	public static org.opencps.dossiermgt.model.DynamicReport getDynamicReportByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getDynamicReportByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static java.util.List<org.opencps.dossiermgt.model.DynamicReport> getDynamicReports(
		int start, int end) {
		return getService().getDynamicReports(start, end);
	}

	/**
	* Returns all the dynamic reports matching the UUID and company.
	*
	* @param uuid the UUID of the dynamic reports
	* @param companyId the primary key of the company
	* @return the matching dynamic reports, or an empty list if no matches were found
	*/
	public static java.util.List<org.opencps.dossiermgt.model.DynamicReport> getDynamicReportsByUuidAndCompanyId(
		String uuid, long companyId) {
		return getService().getDynamicReportsByUuidAndCompanyId(uuid, companyId);
	}

	/**
	* Returns a range of dynamic reports matching the UUID and company.
	*
	* @param uuid the UUID of the dynamic reports
	* @param companyId the primary key of the company
	* @param start the lower bound of the range of dynamic reports
	* @param end the upper bound of the range of dynamic reports (not inclusive)
	* @param orderByComparator the comparator to order the results by (optionally <code>null</code>)
	* @return the range of matching dynamic reports, or an empty list if no matches were found
	*/
	public static java.util.List<org.opencps.dossiermgt.model.DynamicReport> getDynamicReportsByUuidAndCompanyId(
		String uuid, long companyId, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<org.opencps.dossiermgt.model.DynamicReport> orderByComparator) {
		return getService()
				   .getDynamicReportsByUuidAndCompanyId(uuid, companyId, start,
	...
	*/
	public static org.opencps.dossiermgt.model.DynamicReport updateDynamicReport(
		org.opencps.dossiermgt.model.DynamicReport dynamicReport) {
