...
public class DossierDocumentUtil {
	...
	* @return the matching dossier documents
	*/
	public static List<DossierDocument> findByF_DID_DOCTYPE(long groupId,
		long dossierId, String documentType) {
		return getPersistence()
				   .findByF_DID_DOCTYPE(groupId, dossierId, documentType);
	}
	...
	* @throws NoSuchDossierDocumentException if a matching dossier document could not be found
	*/
	public static DossierDocument findByF_DID_DOCTYPE_First(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierDocumentException {
		return getPersistence()
				   .findByF_DID_DOCTYPE_First(groupId, dossierId, documentType,
			orderByComparator);
	}
	...
	* @return the first matching dossier document, or <code>null</code> if a matching dossier document could not be found
	*/
	public static DossierDocument fetchByF_DID_DOCTYPE_First(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator) {
		return getPersistence()
				   .fetchByF_DID_DOCTYPE_First(groupId, dossierId,
	...
	* @throws NoSuchDossierDocumentException if a matching dossier document could not be found
	*/
	public static DossierDocument findByF_DID_DOCTYPE_Last(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierDocumentException {
		return getPersistence()
				   .findByF_DID_DOCTYPE_Last(groupId, dossierId, documentType,
			orderByComparator);
	}
	...
	* @return the last matching dossier document, or <code>null</code> if a matching dossier document could not be found
	*/
	public static DossierDocument fetchByF_DID_DOCTYPE_Last(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator) {
		return getPersistence()
				   .fetchByF_DID_DOCTYPE_Last(groupId, dossierId, documentType,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierDocumentException if a dossier document with the primary key could not be found
	*/
	public static DossierDocument[] findByF_DID_DOCTYPE_PrevAndNext(
		long DossierDocumentId, long groupId, long dossierId,
		String documentType,
		OrderByComparator<DossierDocument> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierDocumentException {
		return getPersistence()
				   .findByF_DID_DOCTYPE_PrevAndNext(DossierDocumentId, groupId,
	...
	* @param documentType the document type
	*/
	public static void removeByF_DID_DOCTYPE(long groupId, long dossierId,
		String documentType) {
		getPersistence().removeByF_DID_DOCTYPE(groupId, dossierId, documentType);
	}
	...
	* @return the number of matching dossier documents
	*/
	public static int countByF_DID_DOCTYPE(long groupId, long dossierId,
		String documentType) {
		return getPersistence()
				   .countByF_DID_DOCTYPE(groupId, dossierId, documentType);
	}
