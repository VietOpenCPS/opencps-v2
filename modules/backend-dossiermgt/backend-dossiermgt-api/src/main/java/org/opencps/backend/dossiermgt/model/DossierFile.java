 ...
 * @see org.opencps.backend.dossiermgt.model.impl.DossierFileImpl
 * @see org.opencps.backend.dossiermgt.model.impl.DossierFileModelImpl
 * @generated
 */
@ImplementationClassName("org.opencps.backend.dossiermgt.model.impl.DossierFileImpl")
@ProviderType
public interface DossierFile extends DossierFileModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link org.opencps.backend.dossiermgt.model.impl.DossierFileImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
