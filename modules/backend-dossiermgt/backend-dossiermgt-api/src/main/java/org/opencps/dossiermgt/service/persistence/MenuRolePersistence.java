...
public interface MenuRolePersistence extends BasePersistence<MenuRole> {
	...
	* @return the matching menu roles
	*/
	public java.util.List<MenuRole> findByF_CONFIG_ID(long menuConfigId);
	...
	* @return the matching menu roles
	*/
	public java.util.List<MenuRole> findByF_ROLE(long roleId);
	...
	* @return the range of matching menu roles
	*/
	public java.util.List<MenuRole> findByF_ROLE(long roleId, int start, int end);
	...
	* @return the ordered range of matching menu roles
	*/
	public java.util.List<MenuRole> findByF_ROLE(long roleId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<MenuRole> orderByComparator);
