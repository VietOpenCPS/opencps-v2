...
public class ProcessSequenceUtil {
	...
	* @return the matching process sequences
	*/
	public static List<ProcessSequence> findByF_GID_SID_SNOS(long groupId,
		long serviceProcessId, String sequenceNo) {
		return getPersistence()
				   .findByF_GID_SID_SNOS(groupId, serviceProcessId, sequenceNo);
	}
	...
	* @throws NoSuchProcessSequenceException if a matching process sequence could not be found
	*/
	public static ProcessSequence findByF_GID_SID_SNOS_First(long groupId,
		long serviceProcessId, String sequenceNo,
		OrderByComparator<ProcessSequence> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessSequenceException {
		return getPersistence()
				   .findByF_GID_SID_SNOS_First(groupId, serviceProcessId,
			sequenceNo, orderByComparator);
	}
	...
	* @return the first matching process sequence, or <code>null</code> if a matching process sequence could not be found
	*/
	public static ProcessSequence fetchByF_GID_SID_SNOS_First(long groupId,
		long serviceProcessId, String sequenceNo,
		OrderByComparator<ProcessSequence> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_SID_SNOS_First(groupId, serviceProcessId,
			sequenceNo, orderByComparator);
	}
	...
	* @throws NoSuchProcessSequenceException if a matching process sequence could not be found
	*/
	public static ProcessSequence findByF_GID_SID_SNOS_Last(long groupId,
		long serviceProcessId, String sequenceNo,
		OrderByComparator<ProcessSequence> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessSequenceException {
		return getPersistence()
				   .findByF_GID_SID_SNOS_Last(groupId, serviceProcessId,
			sequenceNo, orderByComparator);
	}
	...
	* @return the last matching process sequence, or <code>null</code> if a matching process sequence could not be found
	*/
	public static ProcessSequence fetchByF_GID_SID_SNOS_Last(long groupId,
		long serviceProcessId, String sequenceNo,
		OrderByComparator<ProcessSequence> orderByComparator) {
		return getPersistence()
				   .fetchByF_GID_SID_SNOS_Last(groupId, serviceProcessId,
			sequenceNo, orderByComparator);
	}
	...
	* @throws NoSuchProcessSequenceException if a process sequence with the primary key could not be found
	*/
	public static ProcessSequence[] findByF_GID_SID_SNOS_PrevAndNext(
		long processSequenceId, long groupId, long serviceProcessId,
		String sequenceNo, OrderByComparator<ProcessSequence> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessSequenceException {
		return getPersistence()
				   .findByF_GID_SID_SNOS_PrevAndNext(processSequenceId,
			groupId, serviceProcessId, sequenceNo, orderByComparator);
	}
	...
	*/
	public static List<ProcessSequence> findByF_GID_SID_SNOS(long groupId,
		...
		return getPersistence()
				   .findByF_GID_SID_SNOS(groupId, serviceProcessId, sequenceNos);
	}
	...
	*/
	public static List<ProcessSequence> findByF_GID_SID_SNOS(long groupId,
		...
		return getPersistence()
				   .findByF_GID_SID_SNOS(groupId, serviceProcessId,
			sequenceNos, start, end);
	}
	...
	*/
	public static List<ProcessSequence> findByF_GID_SID_SNOS(long groupId,
		...
		return getPersistence()
				   .findByF_GID_SID_SNOS(groupId, serviceProcessId,
			sequenceNos, start, end, orderByComparator);
	}
	...
	*/
	public static List<ProcessSequence> findByF_GID_SID_SNOS(long groupId,
		...
		return getPersistence()
				   .findByF_GID_SID_SNOS(groupId, serviceProcessId,
			sequenceNos, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @param sequenceNo the sequence no
	*/
	public static void removeByF_GID_SID_SNOS(long groupId,
		long serviceProcessId, String sequenceNo) {
		getPersistence()
			.removeByF_GID_SID_SNOS(groupId, serviceProcessId, sequenceNo);
	}
	...
	* @return the number of matching process sequences
	*/
	public static int countByF_GID_SID_SNOS(long groupId,
		long serviceProcessId, String sequenceNo) {
		return getPersistence()
				   .countByF_GID_SID_SNOS(groupId, serviceProcessId, sequenceNo);
	}
	...
	*/
	public static int countByF_GID_SID_SNOS(long groupId,
		long serviceProcessId, String[] sequenceNos) {
		return getPersistence()
				   .countByF_GID_SID_SNOS(groupId, serviceProcessId, sequenceNos);
	}
