...
public interface DeliverableTypePersistence extends BasePersistence<DeliverableType> {
	...
	* @return the matching deliverable types
	*/
	public java.util.List<DeliverableType> findByG(long groupId);
	...
	* @return the range of matching deliverable types
	*/
	public java.util.List<DeliverableType> findByG(long groupId, int start,
		int end);
	...
	* @return the matching deliverable types
	*/
	public java.util.List<DeliverableType> findByC(long companyId);
	...
	* @return the range of matching deliverable types
	*/
	public java.util.List<DeliverableType> findByC(long companyId, int start,
		int end);
	...
	* @return the matching deliverable types
	*/
	public java.util.List<DeliverableType> findByD_OR_D(long groupId);
	...
	* @return the matching deliverable types
	*/
	public java.util.List<DeliverableType> findByD_OR_D(long[] groupIds);
