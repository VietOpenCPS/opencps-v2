...
/**
 * Provides the local service interface for AccessToken. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see AccessTokenLocalServiceUtil
...
public interface AccessTokenLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AccessTokenLocalServiceUtil} to access the access token local service. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.AccessTokenLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AccessToken addAccessToken(long companyId, long groupId,
		String token, String className);
