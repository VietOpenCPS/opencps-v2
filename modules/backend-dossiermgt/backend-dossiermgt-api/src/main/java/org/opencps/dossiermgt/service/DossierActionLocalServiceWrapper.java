...
public class DossierActionLocalServiceWrapper
	...
	*/
	...
	@Override
	public java.util.List<org.opencps.dossiermgt.model.DossierAction> findOverdueByType(
		java.util.Date now, String type, String value) {
		return _dossierActionLocalService.findOverdueByType(now, type, value);
	}
	...
	@Override
	public java.util.List<org.opencps.dossiermgt.model.DossierAction> getByDID_U_FSC(
		long dossierId, long userId, String stepCode) {
		return _dossierActionLocalService.getByDID_U_FSC(dossierId, userId,
			stepCode);
	}
	...
	*/
	...
	public org.opencps.dossiermgt.model.DossierAction updateDossierAction(
		...
		return _dossierActionLocalService.updateDossierAction(groupId,
			...
			eventStatus, rollbackable, context);
	}
