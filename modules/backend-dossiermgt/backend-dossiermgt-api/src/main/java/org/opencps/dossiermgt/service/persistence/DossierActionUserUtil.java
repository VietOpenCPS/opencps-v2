...
public class DossierActionUserUtil {
	...
	* @return the matching dossier action users
	*/
	public static List<DossierActionUser> findByDID__DAI_SC_AS(long dossierId,
		long dossierActionId, String stepCode, int assigned) {
		return getPersistence()
				   .findByDID__DAI_SC_AS(dossierId, dossierActionId, stepCode,
			assigned);
	}
	...
	*/
	public static List<DossierActionUser> findByDID__DAI_SC_AS(long dossierId,
		...
		return getPersistence()
				   .findByDID__DAI_SC_AS(dossierId, dossierActionId, stepCode,
			assigned, start, end, orderByComparator);
	}
	...
	*/
	public static List<DossierActionUser> findByDID__DAI_SC_AS(long dossierId,
		...
		return getPersistence()
				   .findByDID__DAI_SC_AS(dossierId, dossierActionId, stepCode,
			assigned, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDID__DAI_SC_AS_First(long dossierId,
		long dossierActionId, String stepCode, int assigned,
		OrderByComparator<DossierActionUser> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .findByDID__DAI_SC_AS_First(dossierId, dossierActionId,
			stepCode, assigned, orderByComparator);
	}
	...
	* @return the first matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDID__DAI_SC_AS_First(
		long dossierId, long dossierActionId, String stepCode, int assigned,
		OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence()
				   .fetchByDID__DAI_SC_AS_First(dossierId, dossierActionId,
			stepCode, assigned, orderByComparator);
	}
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDID__DAI_SC_AS_Last(long dossierId,
		long dossierActionId, String stepCode, int assigned,
		OrderByComparator<DossierActionUser> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .findByDID__DAI_SC_AS_Last(dossierId, dossierActionId,
			stepCode, assigned, orderByComparator);
	}
	...
	* @return the last matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDID__DAI_SC_AS_Last(long dossierId,
		long dossierActionId, String stepCode, int assigned,
		OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence()
				   .fetchByDID__DAI_SC_AS_Last(dossierId, dossierActionId,
			stepCode, assigned, orderByComparator);
	}
	...
	*/
	public static List<DossierActionUser> findByDID__DAI_SC_AS(long dossierId,
		...
		return getPersistence()
				   .findByDID__DAI_SC_AS(dossierId, dossierActionId, stepCode,
			assigneds, start, end, orderByComparator);
	}
	...
	*/
	public static List<DossierActionUser> findByDID__DAI_SC_AS(long dossierId,
		...
		return getPersistence()
				   .findByDID__DAI_SC_AS(dossierId, dossierActionId, stepCode,
			assigneds, start, end, orderByComparator, retrieveFromCache);
	}
	...
	* @param assigned the assigned
	*/
	public static void removeByDID__DAI_SC_AS(long dossierId,
		long dossierActionId, String stepCode, int assigned) {
		getPersistence()
			.removeByDID__DAI_SC_AS(dossierId, dossierActionId, stepCode,
			assigned);
	}
	...
	* @return the number of matching dossier action users
	*/
	public static int countByDID__DAI_SC_AS(long dossierId,
		long dossierActionId, String stepCode, int assigned) {
		return getPersistence()
				   .countByDID__DAI_SC_AS(dossierId, dossierActionId, stepCode,
			assigned);
	}
	...
	* @return the matching dossier action users
	*/
	public static List<DossierActionUser> findByDOSSIER_UID(long dossierId,
		long userId) {
		return getPersistence().findByDOSSIER_UID(dossierId, userId);
	}
	...
	*/
	public static List<DossierActionUser> findByDOSSIER_UID(long dossierId,
		...
		return getPersistence().findByDOSSIER_UID(dossierId, userId, start, end);
	}
	...
	*/
	public static List<DossierActionUser> findByDOSSIER_UID(long dossierId,
		...
		OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence()
				   .findByDOSSIER_UID(dossierId, userId, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDOSSIER_UID_First(long dossierId,
		long userId, OrderByComparator<DossierActionUser> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .findByDOSSIER_UID_First(dossierId, userId, orderByComparator);
	}
	...
	* @return the first matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDOSSIER_UID_First(long dossierId,
		long userId, OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence()
				   .fetchByDOSSIER_UID_First(dossierId, userId,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDOSSIER_UID_Last(long dossierId,
		long userId, OrderByComparator<DossierActionUser> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .findByDOSSIER_UID_Last(dossierId, userId, orderByComparator);
	}
	...
	* @return the last matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDOSSIER_UID_Last(long dossierId,
		long userId, OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence()
				   .fetchByDOSSIER_UID_Last(dossierId, userId, orderByComparator);
	}
	...
	* @param userId the user ID
	*/
	public static void removeByDOSSIER_UID(long dossierId, long userId) {
		getPersistence().removeByDOSSIER_UID(dossierId, userId);
	}
	...
	* @return the number of matching dossier action users
	*/
	public static int countByDOSSIER_UID(long dossierId, long userId) {
		return getPersistence().countByDOSSIER_UID(dossierId, userId);
	}
	...
	* @return the matching dossier action users
	*/
	public static List<DossierActionUser> findByDSID(long dossierId) {
		return getPersistence().findByDSID(dossierId);
	}
	...
	* @return the range of matching dossier action users
	*/
	public static List<DossierActionUser> findByDSID(long dossierId, int start,
		int end) {
		return getPersistence().findByDSID(dossierId, start, end);
	}
	...
	*/
	public static List<DossierActionUser> findByDSID(long dossierId, int start,
		int end, OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence()
				   .findByDSID(dossierId, start, end, orderByComparator);
	}
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDSID_First(long dossierId,
		OrderByComparator<DossierActionUser> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence().findByDSID_First(dossierId, orderByComparator);
	}
	...
	* @return the first matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDSID_First(long dossierId,
		OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence().fetchByDSID_First(dossierId, orderByComparator);
	}
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDSID_Last(long dossierId,
		OrderByComparator<DossierActionUser> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence().findByDSID_Last(dossierId, orderByComparator);
	}
	...
	* @return the last matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDSID_Last(long dossierId,
		OrderByComparator<DossierActionUser> orderByComparator) {
		return getPersistence().fetchByDSID_Last(dossierId, orderByComparator);
	}
	...
	* @param dossierId the dossier ID
	*/
	public static void removeByDSID(long dossierId) {
		getPersistence().removeByDSID(dossierId);
	}
	...
	* @return the number of matching dossier action users
	*/
	public static int countByDSID(long dossierId) {
		return getPersistence().countByDSID(dossierId);
	}
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDID_RID(long dossierActionId,
		long roleId)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence().findByDID_RID(dossierActionId, roleId);
	}
	...
	* @return the matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDID_RID(long dossierActionId,
		long roleId) {
		return getPersistence().fetchByDID_RID(dossierActionId, roleId);
	}
	...
	*/
	public static DossierActionUser fetchByDID_RID(long dossierActionId,
		...
		return getPersistence()
				   .fetchByDID_RID(dossierActionId, roleId, retrieveFromCache);
	}
	...
	* @return the dossier action user that was removed
	*/
	public static DossierActionUser removeByDID_RID(long dossierActionId,
		long roleId)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence().removeByDID_RID(dossierActionId, roleId);
	}
	...
	* @return the number of matching dossier action users
	*/
	public static int countByDID_RID(long dossierActionId, long roleId) {
		return getPersistence().countByDID_RID(dossierActionId, roleId);
	}

	/**
	* Returns the dossier action user where dossierActionId = &#63; and userId = &#63; and dossierId = &#63; or throws a {@link NoSuchDossierActionUserException} if it could not be found.
	*
	* @param dossierActionId the dossier action ID
	* @param userId the user ID
	* @param dossierId the dossier ID
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDID_UID_D(long dossierActionId,
		long userId, long dossierId)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .findByDID_UID_D(dossierActionId, userId, dossierId);
	}

	/**
	* Returns the dossier action user where dossierActionId = &#63; and userId = &#63; and dossierId = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	*
	* @param dossierActionId the dossier action ID
	* @param userId the user ID
	* @param dossierId the dossier ID
	* @return the matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDID_UID_D(long dossierActionId,
		long userId, long dossierId) {
		return getPersistence()
				   .fetchByDID_UID_D(dossierActionId, userId, dossierId);
	}

	/**
	* Returns the dossier action user where dossierActionId = &#63; and userId = &#63; and dossierId = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	*
	* @param dossierActionId the dossier action ID
	* @param userId the user ID
	* @param dossierId the dossier ID
	...
	*/
	public static DossierActionUser fetchByDID_UID_D(long dossierActionId,
		long userId, long dossierId, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByDID_UID_D(dossierActionId, userId, dossierId,
			retrieveFromCache);
	}
	...
	/**
	* Removes the dossier action user where dossierActionId = &#63; and userId = &#63; and dossierId = &#63; from the database.
	*
	* @param dossierActionId the dossier action ID
	* @param userId the user ID
	* @param dossierId the dossier ID
	* @return the dossier action user that was removed
	*/
	public static DossierActionUser removeByDID_UID_D(long dossierActionId,
		long userId, long dossierId)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .removeByDID_UID_D(dossierActionId, userId, dossierId);
	}

	/**
	* Returns the number of dossier action users where dossierActionId = &#63; and userId = &#63; and dossierId = &#63;.
	*
	* @param dossierActionId the dossier action ID
	* @param userId the user ID
	* @param dossierId the dossier ID
	* @return the number of matching dossier action users
	*/
	public static int countByDID_UID_D(long dossierActionId, long userId,
		long dossierId) {
		return getPersistence()
				   .countByDID_UID_D(dossierActionId, userId, dossierId);
	}
