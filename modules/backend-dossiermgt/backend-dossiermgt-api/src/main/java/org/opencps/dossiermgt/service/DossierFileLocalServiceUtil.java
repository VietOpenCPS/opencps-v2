...
public class DossierFileLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<org.opencps.dossiermgt.model.DossierFile> getByG_DID_FTN_R(
		...
		return getService()
				   .getByG_DID_FTN_R(groupId, dossierIds, fileTemplateNo,
			removed);
	}
	...
	public static org.opencps.dossiermgt.model.DossierFile getByG_DID_PART_NAME(
		long groupId, long dossierId, String dossierPartNo,
		int dossierPartType, String displayName) {
		return getService()
				   .getByG_DID_PART_NAME(groupId, dossierId, dossierPartNo,
			dossierPartType, displayName);
	}

	public static org.opencps.dossiermgt.model.DossierFile getByGID_DID_PART_EFORM(
		long groupId, long dossierId, String dossierPartNo, boolean eform,
		boolean removed) {
		return getService()
				   .getByGID_DID_PART_EFORM(groupId, dossierId, dossierPartNo,
			eform, removed);
	}
	...
	*/
	...
	public static java.util.List<org.opencps.dossiermgt.model.DossierFile> getDossierFileByDID_FTNO_DPTS(
		long dossierId, String fileTemplateNo, int[] dossierPartType,
		boolean removed) {
		return getService()
	...
	public static org.opencps.dossiermgt.model.DossierFile getDossierFileByDID_FTNO_DPTS_First(
		long dossierId, String fileTemplateNo, int dossierPartType,
		boolean removed,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierFileException {
	...
	public static java.util.List<org.opencps.dossiermgt.model.DossierFile> getDossierFileByDID_FTNO_DPTS_NOT_NULL_FID(
		long dossierId, String fileTemplateNo, int[] dossierPartType,
		long fileEntryId, boolean removed) {
		return getService()
