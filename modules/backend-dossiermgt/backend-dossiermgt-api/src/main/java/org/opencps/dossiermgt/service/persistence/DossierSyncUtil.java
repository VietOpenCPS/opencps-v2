...
public class DossierSyncUtil {
	...
	* @throws NoSuchDossierSyncException if a matching dossier sync could not be found
	*/
	public static DossierSync findByG_DID_DAD_AC(long groupId, long dossierId,
		long dossierActionId, String actionCode)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
				   .findByG_DID_DAD_AC(groupId, dossierId, dossierActionId,
			actionCode);
	}
	...
	* @return the matching dossier sync, or <code>null</code> if a matching dossier sync could not be found
	*/
	public static DossierSync fetchByG_DID_DAD_AC(long groupId, long dossierId,
		long dossierActionId, String actionCode) {
		return getPersistence()
				   .fetchByG_DID_DAD_AC(groupId, dossierId, dossierActionId,
			actionCode);
	}
	...
	* @return the dossier sync that was removed
	*/
	public static DossierSync removeByG_DID_DAD_AC(long groupId,
		long dossierId, long dossierActionId, String actionCode)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
				   .removeByG_DID_DAD_AC(groupId, dossierId, dossierActionId,
			actionCode);
	}
	...
	* @return the number of matching dossier syncs
	*/
	public static int countByG_DID_DAD_AC(long groupId, long dossierId,
		long dossierActionId, String actionCode) {
		return getPersistence()
				   .countByG_DID_DAD_AC(groupId, dossierId, dossierActionId,
			actionCode);
	}
	...
	* @return the matching dossier syncs
	*/
	public static List<DossierSync> findByG_DID_ST(long groupId,
		long dossierId, int state) {
		return getPersistence().findByG_DID_ST(groupId, dossierId, state);
	}
	...
	*/
	public static List<DossierSync> findByG_DID_ST(long groupId,
		...
		return getPersistence()
				   .findByG_DID_ST(groupId, dossierId, state, start, end);
	}
	...
	* @throws NoSuchDossierSyncException if a matching dossier sync could not be found
	*/
	public static DossierSync findByG_DID_ST_First(long groupId,
		long dossierId, int state,
		OrderByComparator<DossierSync> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
				   .findByG_DID_ST_First(groupId, dossierId, state,
			orderByComparator);
	}
	...
	* @return the first matching dossier sync, or <code>null</code> if a matching dossier sync could not be found
	*/
	public static DossierSync fetchByG_DID_ST_First(long groupId,
		long dossierId, int state,
		OrderByComparator<DossierSync> orderByComparator) {
		return getPersistence()
				   .fetchByG_DID_ST_First(groupId, dossierId, state,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierSyncException if a matching dossier sync could not be found
	*/
	public static DossierSync findByG_DID_ST_Last(long groupId, long dossierId,
		int state, OrderByComparator<DossierSync> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
				   .findByG_DID_ST_Last(groupId, dossierId, state,
			orderByComparator);
	}
	...
	* @return the last matching dossier sync, or <code>null</code> if a matching dossier sync could not be found
	*/
	public static DossierSync fetchByG_DID_ST_Last(long groupId,
		long dossierId, int state,
		OrderByComparator<DossierSync> orderByComparator) {
		return getPersistence()
				   .fetchByG_DID_ST_Last(groupId, dossierId, state,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierSyncException if a dossier sync with the primary key could not be found
	*/
	public static DossierSync[] findByG_DID_ST_PrevAndNext(long DossierSyncId,
		long groupId, long dossierId, int state,
		OrderByComparator<DossierSync> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
				   .findByG_DID_ST_PrevAndNext(DossierSyncId, groupId,
			dossierId, state, orderByComparator);
	}
	...
	* @param state the state
	*/
	public static void removeByG_DID_ST(long groupId, long dossierId, int state) {
		getPersistence().removeByG_DID_ST(groupId, dossierId, state);
	}
	...
	* @return the number of matching dossier syncs
	*/
	public static int countByG_DID_ST(long groupId, long dossierId, int state) {
		return getPersistence().countByG_DID_ST(groupId, dossierId, state);
	}
	...
	* @return the matching dossier syncs
	*/
	public static List<DossierSync> findByG_DID(long groupId, long dossierId) {
	...
	* @throws NoSuchDossierSyncException if a matching dossier sync could not be found
	*/
	public static DossierSync findByG_DID_First(long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
	...
	* @return the first matching dossier sync, or <code>null</code> if a matching dossier sync could not be found
	*/
	public static DossierSync fetchByG_DID_First(long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchDossierSyncException if a matching dossier sync could not be found
	*/
	public static DossierSync findByG_DID_Last(long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
	...
	* @return the last matching dossier sync, or <code>null</code> if a matching dossier sync could not be found
	*/
	public static DossierSync fetchByG_DID_Last(long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchDossierSyncException if a dossier sync with the primary key could not be found
	*/
	public static DossierSync[] findByG_DID_PrevAndNext(long DossierSyncId,
		long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierSyncException {
		return getPersistence()
				   .findByG_DID_PrevAndNext(DossierSyncId, groupId, dossierId,
			orderByComparator);
	}
