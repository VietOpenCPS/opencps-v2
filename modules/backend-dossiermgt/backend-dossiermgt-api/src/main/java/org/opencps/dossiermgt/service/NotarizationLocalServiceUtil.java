...
/**
 * Provides the local service utility for Notarization. This utility wraps
 * {@link org.opencps.dossiermgt.service.impl.NotarizationLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class NotarizationLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.NotarizationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static org.opencps.dossiermgt.model.Notarization addNotarization(
		...
		return getService()
				   .addNotarization(groupId, dossierId, fileName, totalRecord,
			totalPage, totalCopy, totalFee, notarizationNo, notarizationYear,
	...
	*/
	public static org.opencps.dossiermgt.model.Notarization createNotarization(
		long notarizationId) {
		return getService().createNotarization(notarizationId);
	}
	...
	*/
	public static org.opencps.dossiermgt.model.Notarization deleteNotarization(
		long notarizationId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteNotarization(notarizationId);
	}
	...
	*/
	public static org.opencps.dossiermgt.model.Notarization deleteNotarization(
		org.opencps.dossiermgt.model.Notarization notarization) {
		return getService().deleteNotarization(notarization);
	}
	...
	* @throws PortalException if a notarization with the primary key could not be found
	*/
	public static org.opencps.dossiermgt.model.Notarization getNotarization(
		long notarizationId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getNotarization(notarizationId);
	}
	...
	*/
	public static java.util.List<org.opencps.dossiermgt.model.Notarization> getNotarizations(
		int start, int end) {
		return getService().getNotarizations(start, end);
	}
	...
	*/
	public static int getNotarizationsCount() {
		return getService().getNotarizationsCount();
	}
	...
	*/
	...
	public static void removeNotarization(long notarizationId)
		throws org.opencps.dossiermgt.exception.NoSuchNotarizationException {
		getService().removeNotarization(notarizationId);
	}

	public static org.opencps.dossiermgt.model.Notarization updateNotarization(
		...
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {
		return getService()
				   .updateNotarization(groupId, notarizationId, dossierId,
	...
	*/
	public static org.opencps.dossiermgt.model.Notarization updateNotarization(
		org.opencps.dossiermgt.model.Notarization notarization) {
		return getService().updateNotarization(notarization);
	}

	public static NotarizationLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<NotarizationLocalService, NotarizationLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(NotarizationLocalService.class);

		ServiceTracker<NotarizationLocalService, NotarizationLocalService> serviceTracker =
			new ServiceTracker<NotarizationLocalService, NotarizationLocalService>(bundle.getBundleContext(),
				NotarizationLocalService.class, null);
