...
public class ServiceInfoUtil {
	...
	* @return the matching service infos
	*/
	public static List<ServiceInfo> findByGI_PUB(long groupId, boolean public_) {
		return getPersistence().findByGI_PUB(groupId, public_);
	}
	...
	*/
	public static List<ServiceInfo> findByGI_PUB(long groupId, boolean public_,
		int start, int end) {
		return getPersistence().findByGI_PUB(groupId, public_, start, end);
	}
	...
	*/
	public static List<ServiceInfo> findByGI_PUB(long groupId, boolean public_,
		int start, int end, OrderByComparator<ServiceInfo> orderByComparator) {
		return getPersistence()
				   .findByGI_PUB(groupId, public_, start, end, orderByComparator);
	}
	...
	*/
	public static List<ServiceInfo> findByGI_PUB(long groupId, boolean public_,
		...
		boolean retrieveFromCache) {
		return getPersistence()
				   .findByGI_PUB(groupId, public_, start, end,
			orderByComparator, retrieveFromCache);
	}
	...
	* @throws NoSuchServiceInfoException if a matching service info could not be found
	*/
	public static ServiceInfo findByGI_PUB_First(long groupId, boolean public_,
		OrderByComparator<ServiceInfo> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceInfoException {
		return getPersistence()
				   .findByGI_PUB_First(groupId, public_, orderByComparator);
	}
	...
	* @return the first matching service info, or <code>null</code> if a matching service info could not be found
	*/
	public static ServiceInfo fetchByGI_PUB_First(long groupId,
		boolean public_, OrderByComparator<ServiceInfo> orderByComparator) {
		return getPersistence()
				   .fetchByGI_PUB_First(groupId, public_, orderByComparator);
	}
	...
	* @throws NoSuchServiceInfoException if a matching service info could not be found
	*/
	public static ServiceInfo findByGI_PUB_Last(long groupId, boolean public_,
		OrderByComparator<ServiceInfo> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceInfoException {
		return getPersistence()
				   .findByGI_PUB_Last(groupId, public_, orderByComparator);
	}
	...
	* @return the last matching service info, or <code>null</code> if a matching service info could not be found
	*/
	public static ServiceInfo fetchByGI_PUB_Last(long groupId, boolean public_,
		OrderByComparator<ServiceInfo> orderByComparator) {
		return getPersistence()
				   .fetchByGI_PUB_Last(groupId, public_, orderByComparator);
	}
	...
	* @throws NoSuchServiceInfoException if a service info with the primary key could not be found
	*/
	public static ServiceInfo[] findByGI_PUB_PrevAndNext(long serviceInfoId,
		long groupId, boolean public_,
		OrderByComparator<ServiceInfo> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceInfoException {
		return getPersistence()
				   .findByGI_PUB_PrevAndNext(serviceInfoId, groupId, public_,
			orderByComparator);
	}
	...
	* @param public_ the public_
	*/
	public static void removeByGI_PUB(long groupId, boolean public_) {
		getPersistence().removeByGI_PUB(groupId, public_);
	}
	...
	* @return the number of matching service infos
	*/
	public static int countByGI_PUB(long groupId, boolean public_) {
		return getPersistence().countByGI_PUB(groupId, public_);
	}
	...
	* @return the matching service infos
	*/
	public static List<ServiceInfo> findByGI_PUB_SID(long groupId,
		boolean public_, long serviceInfoId) {
		return getPersistence().findByGI_PUB_SID(groupId, public_, serviceInfoId);
	}
	...
	*/
	public static List<ServiceInfo> findByGI_PUB_SID(long groupId,
		boolean public_, long serviceInfoId, int start, int end) {
		return getPersistence()
				   .findByGI_PUB_SID(groupId, public_, serviceInfoId, start, end);
	}
	...
	*/
	public static List<ServiceInfo> findByGI_PUB_SID(long groupId,
		...
		OrderByComparator<ServiceInfo> orderByComparator) {
		return getPersistence()
				   .findByGI_PUB_SID(groupId, public_, serviceInfoId, start,
	...
	* @throws NoSuchServiceInfoException if a matching service info could not be found
	*/
	public static ServiceInfo findByGI_PUB_SID_First(long groupId,
		boolean public_, long serviceInfoId,
		OrderByComparator<ServiceInfo> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceInfoException {
		return getPersistence()
				   .findByGI_PUB_SID_First(groupId, public_, serviceInfoId,
			orderByComparator);
	}
	...
	* @return the first matching service info, or <code>null</code> if a matching service info could not be found
	*/
	public static ServiceInfo fetchByGI_PUB_SID_First(long groupId,
		boolean public_, long serviceInfoId,
		OrderByComparator<ServiceInfo> orderByComparator) {
		return getPersistence()
				   .fetchByGI_PUB_SID_First(groupId, public_, serviceInfoId,
			orderByComparator);
	}
	...
	* @throws NoSuchServiceInfoException if a matching service info could not be found
	*/
	public static ServiceInfo findByGI_PUB_SID_Last(long groupId,
		boolean public_, long serviceInfoId,
		OrderByComparator<ServiceInfo> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceInfoException {
		return getPersistence()
				   .findByGI_PUB_SID_Last(groupId, public_, serviceInfoId,
			orderByComparator);
	}
	...
	* @return the last matching service info, or <code>null</code> if a matching service info could not be found
	*/
	public static ServiceInfo fetchByGI_PUB_SID_Last(long groupId,
		boolean public_, long serviceInfoId,
		OrderByComparator<ServiceInfo> orderByComparator) {
		return getPersistence()
				   .fetchByGI_PUB_SID_Last(groupId, public_, serviceInfoId,
			orderByComparator);
	}
	...
	*/
	public static List<ServiceInfo> findByGI_PUB_SID(long groupId,
		boolean public_, long[] serviceInfoIds) {
		return getPersistence()
				   .findByGI_PUB_SID(groupId, public_, serviceInfoIds);
	}
	...
	*/
	public static List<ServiceInfo> findByGI_PUB_SID(long groupId,
		boolean public_, long[] serviceInfoIds, int start, int end) {
		return getPersistence()
				   .findByGI_PUB_SID(groupId, public_, serviceInfoIds, start,
			end);
	}
	...
	* @param serviceInfoId the service info ID
	*/
	public static void removeByGI_PUB_SID(long groupId, boolean public_,
		long serviceInfoId) {
		getPersistence().removeByGI_PUB_SID(groupId, public_, serviceInfoId);
	}
	...
	* @return the number of matching service infos
	*/
	public static int countByGI_PUB_SID(long groupId, boolean public_,
		long serviceInfoId) {
		return getPersistence()
				   .countByGI_PUB_SID(groupId, public_, serviceInfoId);
	}
	...
	*/
	public static int countByGI_PUB_SID(long groupId, boolean public_,
		long[] serviceInfoIds) {
		return getPersistence()
				   .countByGI_PUB_SID(groupId, public_, serviceInfoIds);
	}
