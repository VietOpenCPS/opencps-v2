...
public class ProcessStepUtil {
	...
	* @throws NoSuchProcessStepException if a matching process step could not be found
	*/
	public static ProcessStep findByGID_SID_STATUS(long groupId,
		long serviceProcessId, String dossierStatus, String dossierSubStatus)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepException {
		return getPersistence()
				   .findByGID_SID_STATUS(groupId, serviceProcessId,
	...
	* @return the matching process step, or <code>null</code> if a matching process step could not be found
	*/
	public static ProcessStep fetchByGID_SID_STATUS(long groupId,
		long serviceProcessId, String dossierStatus, String dossierSubStatus) {
		return getPersistence()
				   .fetchByGID_SID_STATUS(groupId, serviceProcessId,
			dossierStatus, dossierSubStatus);
	}
	...
	*/
	public static ProcessStep fetchByGID_SID_STATUS(long groupId,
		...
		return getPersistence()
				   .fetchByGID_SID_STATUS(groupId, serviceProcessId,
			dossierStatus, dossierSubStatus, retrieveFromCache);
	}
	...
	* @return the process step that was removed
	*/
	public static ProcessStep removeByGID_SID_STATUS(long groupId,
		long serviceProcessId, String dossierStatus, String dossierSubStatus)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepException {
		return getPersistence()
				   .removeByGID_SID_STATUS(groupId, serviceProcessId,
			dossierStatus, dossierSubStatus);
	}
	...
	* @return the number of matching process steps
	*/
	public static int countByGID_SID_STATUS(long groupId,
		long serviceProcessId, String dossierStatus, String dossierSubStatus) {
		return getPersistence()
				   .countByGID_SID_STATUS(groupId, serviceProcessId,
			dossierStatus, dossierSubStatus);
	}
	...
	* @return the matching process steps
	*/
	public static List<ProcessStep> findByG_SP_SCS(long groupId,
		long serviceProcessId, String stepCode) {
		return getPersistence()
				   .findByG_SP_SCS(groupId, serviceProcessId, stepCode);
	}
	...
	*/
	public static List<ProcessStep> findByG_SP_SCS(long groupId,
		...
		return getPersistence()
				   .findByG_SP_SCS(groupId, serviceProcessId, stepCode, start,
			end);
	}
	...
	* @throws NoSuchProcessStepException if a matching process step could not be found
	*/
	public static ProcessStep findByG_SP_SCS_First(long groupId,
		long serviceProcessId, String stepCode,
		OrderByComparator<ProcessStep> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepException {
		return getPersistence()
				   .findByG_SP_SCS_First(groupId, serviceProcessId, stepCode,
			orderByComparator);
	}
	...
	* @return the first matching process step, or <code>null</code> if a matching process step could not be found
	*/
	public static ProcessStep fetchByG_SP_SCS_First(long groupId,
		long serviceProcessId, String stepCode,
		OrderByComparator<ProcessStep> orderByComparator) {
		return getPersistence()
				   .fetchByG_SP_SCS_First(groupId, serviceProcessId, stepCode,
			orderByComparator);
	}
	...
	* @throws NoSuchProcessStepException if a matching process step could not be found
	*/
	public static ProcessStep findByG_SP_SCS_Last(long groupId,
		long serviceProcessId, String stepCode,
		OrderByComparator<ProcessStep> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepException {
		return getPersistence()
				   .findByG_SP_SCS_Last(groupId, serviceProcessId, stepCode,
			orderByComparator);
	}
	...
	* @return the last matching process step, or <code>null</code> if a matching process step could not be found
	*/
	public static ProcessStep fetchByG_SP_SCS_Last(long groupId,
		long serviceProcessId, String stepCode,
		OrderByComparator<ProcessStep> orderByComparator) {
		return getPersistence()
				   .fetchByG_SP_SCS_Last(groupId, serviceProcessId, stepCode,
			orderByComparator);
	}
	...
	* @throws NoSuchProcessStepException if a process step with the primary key could not be found
	*/
	public static ProcessStep[] findByG_SP_SCS_PrevAndNext(long processStepId,
		long groupId, long serviceProcessId, String stepCode,
		OrderByComparator<ProcessStep> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepException {
		return getPersistence()
				   .findByG_SP_SCS_PrevAndNext(processStepId, groupId,
	...
	*/
	public static List<ProcessStep> findByG_SP_SCS(long groupId,
		...
		return getPersistence()
				   .findByG_SP_SCS(groupId, serviceProcessId, stepCodes);
	}
	...
	*/
	public static List<ProcessStep> findByG_SP_SCS(long groupId,
		...
		return getPersistence()
				   .findByG_SP_SCS(groupId, serviceProcessId, stepCodes, start,
			end);
	}
	...
	* @param stepCode the step code
	*/
	public static void removeByG_SP_SCS(long groupId, long serviceProcessId,
		String stepCode) {
		getPersistence().removeByG_SP_SCS(groupId, serviceProcessId, stepCode);
	}
	...
	* @return the number of matching process steps
	*/
	public static int countByG_SP_SCS(long groupId, long serviceProcessId,
		String stepCode) {
		return getPersistence()
				   .countByG_SP_SCS(groupId, serviceProcessId, stepCode);
	}
	...
	*/
	public static int countByG_SP_SCS(long groupId, long serviceProcessId,
		String[] stepCodes) {
		return getPersistence()
				   .countByG_SP_SCS(groupId, serviceProcessId, stepCodes);
	}
