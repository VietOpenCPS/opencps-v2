...
/**
 * The base model interface for the DeliverableTypeRole service. Represents a row in the &quot;opencps_deliverabletyperole&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link org.opencps.dossiermgt.model.impl.DeliverableTypeRoleModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link org.opencps.dossiermgt.model.impl.DeliverableTypeRoleImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public interface DeliverableTypeRoleModel extends BaseModel<DeliverableTypeRole>,
	GroupedModel, ShardedModel, StagedAuditedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a deliverable type role model instance should use the {@link DeliverableTypeRole} interface instead.
	 */
