...
/**
 * Provides the local service interface for CsdlDcServiceInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see CsdlDcServiceInfoLocalServiceUtil
...
public interface CsdlDcServiceInfoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CsdlDcServiceInfoLocalServiceUtil} to access the csdl dc service info local service. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.CsdlDcServiceInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public CsdlDcServiceInfo findByServiceCodeAndStatus(String serviceCode,
		int status);
