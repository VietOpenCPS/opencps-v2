 ...
 */
@ProviderType
public class DeliverableLocalServiceWrapper
	implements DeliverableLocalService,
	...
	/**
	 * Adds the deliverable to the database. Also notifies the appropriate model
	 * listeners.
	 *
	 * @param deliverable
	 *            the deliverable
	...
	public org.opencps.dossiermgt.model.Deliverable addDeliverable(
		...
		return _deliverableLocalService.addDeliverable(
			groupId, deliverableType, deliverableCode, govAgencyCode,
			govAgencyName, applicationIdNo, applicationName, subject, issueDate,
			expireDate, revalidate, deliverableState, dossierId, fileEntryId,
			serviceContext);
	}
	...
	public org.opencps.dossiermgt.model.Deliverable addDeliverableSign(
		...
		return _deliverableLocalService.addDeliverableSign(
			...
			formData, fileAttachs, serviceContext);
	}
	...
	@Override
	public org.opencps.dossiermgt.model.Deliverable adminProcessDelete(
		Long id) {
	...
	/**
	 * Creates a new deliverable with the primary key. Does not add the
	 * deliverable to the database.
	 *
	 * @param deliverableId
	 *            the primary key for the new deliverable
	...
	/**
	 * Deletes the deliverable from the database. Also notifies the appropriate
	 * model listeners.
	 *
	 * @param deliverable
	 *            the deliverable
	...
	/**
	 * Deletes the deliverable with the primary key from the database. Also
	 * notifies the appropriate model listeners.
	 *
	 * @param deliverableId
	 *            the primary key of the deliverable
	 * @return the deliverable that was removed
	 * @throws PortalException
	 *             if a deliverable with the primary key could not be found
	 */
	@Override
	public org.opencps.dossiermgt.model.Deliverable deleteDeliverable(
		long deliverableId)
	 ...
	 * matching rows. <p> Useful when paginating results. Returns a maximum of
	 ...
	 * {@link org.opencps.dossiermgt.model.impl.DeliverableModelImpl}. If both
	 ...
	 * the matching rows. <p> Useful when paginating results. Returns a maximum
	...
	public long dynamicQueryCount(
		...
		return _deliverableLocalService.dynamicQueryCount(
	 ...
	 * @return the matching deliverable, or <code>null</code> if a matching
	...
	public org.opencps.dossiermgt.model.Deliverable fetchDeliverableByUuidAndGroupId(
		...
		return _deliverableLocalService.fetchDeliverableByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public java.util.List<org.opencps.dossiermgt.model.Deliverable> findDeliverableByState(
		...
		return _deliverableLocalService.findDeliverableByState(
	...
	public org.opencps.dossiermgt.model.Deliverable getByCodeAndState(
		...
		return _deliverableLocalService.getByCodeAndState(
	...
	public org.opencps.dossiermgt.model.Deliverable getByF_GID_DCODE(
		...
		return _deliverableLocalService.getByF_GID_DCODE(
	...
	public java.util.List<org.opencps.dossiermgt.model.Deliverable> getDeliverableByModifiedDate(
		...
		return _deliverableLocalService.getDeliverableByModifiedDate(
	 ...
	 * @throws PortalException
	 *             if a matching deliverable could not be found
	 */
	@Override
	public org.opencps.dossiermgt.model.Deliverable getDeliverableByUuidAndGroupId(
		...
		return _deliverableLocalService.getDeliverableByUuidAndGroupId(
			uuid, groupId);
	}
	...
	/**
	 * Returns a range of all the deliverables. <p> Useful when paginating
	 * results. Returns a maximum of <code>end - start</code> instances.
	 ...
	 * return the full result set. If <code>orderByComparator</code> is
	 * specified, then the query will include the given ORDER BY logic. If
	 * <code>orderByComparator</code> is absent and pagination is required
	 * (<code>start</code> and <code>end</code> are not
	 * {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the
	 * query will include the default ORDER BY logic from
	 ...
	 *
	 * @param start
	 *            the lower bound of the range of deliverables
	 * @param end
	 *            the upper bound of the range of deliverables (not inclusive)
	 ...
	 *
	 * @param uuid
	 *            the UUID of the deliverables
	 * @param companyId
	 *            the primary key of the company
	 * @return the matching deliverables, or an empty list if no matches were
	 *         found
	 */
	@Override
	public java.util.List<org.opencps.dossiermgt.model.Deliverable> getDeliverablesByUuidAndCompanyId(
		...
		return _deliverableLocalService.getDeliverablesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 *            the comparator to order the results by (optionally
	 *            <code>null</code>)
	 * @return the range of matching deliverables, or an empty list if no
	 *         matches were found
	 */
	@Override
	public java.util.List<org.opencps.dossiermgt.model.Deliverable> getDeliverablesByUuidAndCompanyId(
	...
	public com.liferay.portal.kernel.dao.orm.ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		return _deliverableLocalService.getExportActionableDynamicQuery(
			portletDataContext);
	}
	...
	public java.util.List<org.opencps.dossiermgt.model.Deliverable> getListDeliverable(
		...
		return _deliverableLocalService.getListDeliverable(
	...
	public void LuceneQuery(
		...
		_deliverableLocalService.LuceneQuery(
			pattern, paramValues, paramTypes, searchContext);
	}
	...
	public com.liferay.portal.kernel.search.Hits searchLucene(
		...
		return _deliverableLocalService.searchLucene(
	...
	/**
	 * Updates the deliverable in the database or adds it if it does not yet
	...
	public org.opencps.dossiermgt.model.Deliverable updateDeliverable(
		...
		return _deliverableLocalService.updateDeliverable(
	...
	public org.opencps.dossiermgt.model.Deliverable updateFormData(
		...
		return _deliverableLocalService.updateFormData(
			groupId, id, formData, serviceContext);
	}
