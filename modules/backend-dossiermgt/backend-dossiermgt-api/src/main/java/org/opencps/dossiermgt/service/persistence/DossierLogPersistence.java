...
public interface DossierLogPersistence extends BasePersistence<DossierLog> {
	...
	*/
	public java.util.List<DossierLog> findByUuid(String uuid);
	...
	*/
	public java.util.List<DossierLog> findByUuid(String uuid, int start, int end);
	...
	*/
	public java.util.List<DossierLog> findByUuid(String uuid, int start,
		int end,
	...
	* @return the matching dossier logs
	*/
	public java.util.List<DossierLog> findByUuid_C(String uuid, long companyId);
	...
	* @return the matching dossier logs
	*/
	public java.util.List<DossierLog> findByNotiType(String notificationType);
	...
	* @return the matching dossier logs
	*/
	public java.util.List<DossierLog> findByDID_NTYP(String notificationType,
		long dossierId);
	...
	* @return the matching dossier logs
	*/
	public java.util.List<DossierLog> findByG(long groupId);
	...
	* @return the range of matching dossier logs
	*/
	public java.util.List<DossierLog> findByG(long groupId, int start, int end);
