 ...
 * @see org.opencps.backend.dossiermgt.model.impl.DossierPartImpl
 * @see org.opencps.backend.dossiermgt.model.impl.DossierPartModelImpl
 * @generated
 */
@ImplementationClassName("org.opencps.backend.dossiermgt.model.impl.DossierPartImpl")
@ProviderType
public interface DossierPart extends DossierPartModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link org.opencps.backend.dossiermgt.model.impl.DossierPartImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
