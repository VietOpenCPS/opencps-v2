...
public interface ProcessStepPersistence extends BasePersistence<ProcessStep> {
	...
	*/
	public java.util.List<ProcessStep> findByUuid(String uuid);
	...
	*/
	public java.util.List<ProcessStep> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching process steps
	*/
	public java.util.List<ProcessStep> findByUuid_C(String uuid, long companyId);
	...
	* @return the range of matching process steps
	*/
	public java.util.List<ProcessStep> findByUuid_C(String uuid,
	...
	* @return the matching process steps
	*/
	public java.util.List<ProcessStep> findBySC_SPID(String stepCode,
		long serviceProcessId);
	...
	* @return the matching process steps
	*/
	public java.util.List<ProcessStep> findByDST_DSST(String dossierStatus,
	...
	* @return the matching process steps
	*/
	public java.util.List<ProcessStep> findByG_SP_SNO(long groupId,
