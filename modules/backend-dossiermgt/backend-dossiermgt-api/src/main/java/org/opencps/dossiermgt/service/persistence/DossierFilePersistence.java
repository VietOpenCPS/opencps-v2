...
public interface DossierFilePersistence extends BasePersistence<DossierFile> {
	...
	* @return the matching dossier files
	*/
	public java.util.List<DossierFile> findByG_DID_FTN_R_O(long groupId,
	...
	* @return the matching dossier files
	*/
	public java.util.List<DossierFile> findByF_GID_DID_R_O(long groupId,
	...
	* @return the matching dossier files
	*/
	public java.util.List<DossierFile> findByGID_DID_TEMP_PART_EFORM(
	...
	* @return the matching dossier files
	*/
	public java.util.List<DossierFile> findByDID_FTNO_DPTS(long dossierId,
		String fileTemplateNo, int dossierPartType, boolean removed);
	...
	* @return the matching dossier files
	*/
	public java.util.List<DossierFile> findByDID_FTNO_DPTS_NOT_NULL_FID(
		long dossierId, String fileTemplateNo, int dossierPartType,
		long fileEntryId, boolean removed);
	...
	* @return the matching dossier files
	*/
	public java.util.List<DossierFile> findByDID_GROUP(long groupId,
		long dossierId);
	...
	* @return the matching dossier files
	*/
	public java.util.List<DossierFile> findByG_DID_FILE(long groupId,
