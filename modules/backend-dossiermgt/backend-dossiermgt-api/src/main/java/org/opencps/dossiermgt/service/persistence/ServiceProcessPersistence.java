...
public interface ServiceProcessPersistence extends BasePersistence<ServiceProcess> {
	...
	*/
	public java.util.List<ServiceProcess> findByUuid(String uuid);
	...
	*/
	public java.util.List<ServiceProcess> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching service processes
	*/
	public java.util.List<ServiceProcess> findByUuid_C(String uuid,
		long companyId);
	...
	* @return the matching service processes
	*/
	public java.util.List<ServiceProcess> findBySVR_NO(String serverNo);
