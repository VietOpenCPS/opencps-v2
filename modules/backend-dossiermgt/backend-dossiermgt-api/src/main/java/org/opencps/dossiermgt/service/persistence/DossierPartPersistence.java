...
public interface DossierPartPersistence extends BasePersistence<DossierPart> {
	...
	*/
	public java.util.List<DossierPart> findByUuid(String uuid);
	...
	*/
	public java.util.List<DossierPart> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching dossier parts
	*/
	public java.util.List<DossierPart> findByUuid_C(String uuid, long companyId);
	...
	* @return the range of matching dossier parts
	*/
	public java.util.List<DossierPart> findByUuid_C(String uuid,
