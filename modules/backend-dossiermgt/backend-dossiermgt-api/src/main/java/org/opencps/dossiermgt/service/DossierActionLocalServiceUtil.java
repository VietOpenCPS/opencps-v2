...
public class DossierActionLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<org.opencps.dossiermgt.input.model.PersonDossierStatistic> findActionOverdue(
		java.util.Date fromDate, java.util.Date toDate, long groupId,
		int begin, int end) {
		return getService()
				   .findActionOverdue(fromDate, toDate, groupId, begin, end);
	}

	public static java.util.List<org.opencps.dossiermgt.input.model.PersonDossierStatistic> findActionUndue(
		java.util.Date fromDate, java.util.Date toDate, long groupId,
		int begin, int end) {
		return getService()
				   .findActionUndue(fromDate, toDate, groupId, begin, end);
	}
	...
	public static java.util.List<org.opencps.dossiermgt.model.DossierAction> getByDID_FSC_NOT_DAI(
		long dossierId, String stepCode, long dossierActionId) {
		return getService()
				   .getByDID_FSC_NOT_DAI(dossierId, stepCode, dossierActionId);
	}
	...
	public static java.util.List<org.opencps.dossiermgt.model.DossierAction> getByDID_U_FSC(
		long dossierId, long userId, String stepCode) {
		return getService().getByDID_U_FSC(dossierId, userId, stepCode);
	}
