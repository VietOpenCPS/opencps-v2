 ...
 * {@link org.opencps.dossiermgt.service.impl.DeliverableLocalServiceImpl} and
...
public class DeliverableLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS: Never modify this class directly. Add custom service
	 * methods to {@link
	 * org.opencps.dossiermgt.service.impl.DeliverableLocalServiceImpl} and
	...
	public static org.opencps.dossiermgt.model.Deliverable addDeliverable(
		...
		return getService().addDeliverable(
	...
	public static org.opencps.dossiermgt.model.Deliverable addDeliverableSign(
		...
		return getService().addDeliverableSign(
	...
	public static java.util.List<org.opencps.dossiermgt.model.Deliverable> getDeliverableByModifiedDate(
		...
		return getService().getDeliverableByModifiedDate(
	...
	public static java.util.List<org.opencps.dossiermgt.model.Deliverable> getDeliverablesByUuidAndCompanyId(
		...
		return getService().getDeliverablesByUuidAndCompanyId(
	...
	public static java.util.List<org.opencps.dossiermgt.model.Deliverable> getListDeliverable(
		...
		return getService().getListDeliverable(
	...
	public static void LuceneQuery(
		String pattern, String paramValues, String paramTypes,
		com.liferay.portal.kernel.search.SearchContext searchContext) {

		getService().LuceneQuery(
	...
	public static com.liferay.portal.kernel.search.Hits searchLucene(
		...
		return getService().searchLucene(
	...
	public static org.opencps.dossiermgt.model.Deliverable updateDeliverable(
		...
		return getService().updateDeliverable(
	...
	public static org.opencps.dossiermgt.model.Deliverable updateFormData(
		...
		return getService().updateFormData(
	...
	static {
		...
		ServiceTracker<DeliverableLocalService, DeliverableLocalService> serviceTracker =
			new ServiceTracker<DeliverableLocalService, DeliverableLocalService>(
				bundle.getBundleContext(), DeliverableLocalService.class, null);
