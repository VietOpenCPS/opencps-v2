...
public class PaymentFileUtil {
	...
	* @return the matching payment files
	*/
	public static List<PaymentFile> findByPT(int paymentStatus) {
		return getPersistence().findByPT(paymentStatus);
	}
	...
	* @return the range of matching payment files
	*/
	public static List<PaymentFile> findByPT(int paymentStatus, int start,
		int end) {
		return getPersistence().findByPT(paymentStatus, start, end);
	}
	...
	*/
	public static List<PaymentFile> findByPT(int paymentStatus, int start,
		...
		return getPersistence()
				   .findByPT(paymentStatus, start, end, orderByComparator);
	}
	...
	* @throws NoSuchPaymentFileException if a matching payment file could not be found
	*/
	public static PaymentFile findByPT_First(int paymentStatus,
		OrderByComparator<PaymentFile> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchPaymentFileException {
		return getPersistence().findByPT_First(paymentStatus, orderByComparator);
	}
	...
	* @return the first matching payment file, or <code>null</code> if a matching payment file could not be found
	*/
	public static PaymentFile fetchByPT_First(int paymentStatus,
		OrderByComparator<PaymentFile> orderByComparator) {
		return getPersistence().fetchByPT_First(paymentStatus, orderByComparator);
	}
	...
	* @throws NoSuchPaymentFileException if a matching payment file could not be found
	*/
	public static PaymentFile findByPT_Last(int paymentStatus,
		OrderByComparator<PaymentFile> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchPaymentFileException {
		return getPersistence().findByPT_Last(paymentStatus, orderByComparator);
	}
	...
	* @return the last matching payment file, or <code>null</code> if a matching payment file could not be found
	*/
	public static PaymentFile fetchByPT_Last(int paymentStatus,
		OrderByComparator<PaymentFile> orderByComparator) {
		return getPersistence().fetchByPT_Last(paymentStatus, orderByComparator);
	}
	...
	* @throws NoSuchPaymentFileException if a payment file with the primary key could not be found
	*/
	public static PaymentFile[] findByPT_PrevAndNext(long paymentFileId,
		int paymentStatus, OrderByComparator<PaymentFile> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchPaymentFileException {
		return getPersistence()
				   .findByPT_PrevAndNext(paymentFileId, paymentStatus,
			orderByComparator);
	}
	...
	* @param paymentStatus the payment status
	*/
	public static void removeByPT(int paymentStatus) {
		getPersistence().removeByPT(paymentStatus);
	}
	...
	* @return the number of matching payment files
	*/
	public static int countByPT(int paymentStatus) {
		return getPersistence().countByPT(paymentStatus);
	}
