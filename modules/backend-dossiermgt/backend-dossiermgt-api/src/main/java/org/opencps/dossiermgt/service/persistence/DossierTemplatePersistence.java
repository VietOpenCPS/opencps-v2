...
public interface DossierTemplatePersistence extends BasePersistence<DossierTemplate> {
	...
	*/
	public java.util.List<DossierTemplate> findByUuid(String uuid);
	...
	*/
	public java.util.List<DossierTemplate> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching dossier templates
	*/
	public java.util.List<DossierTemplate> findByUuid_C(String uuid,
		long companyId);
