...
public interface DossierSyncLocalService extends BaseLocalService,
	...
	*/
	...
	public List<DossierSync> findByDossierAndInfoType(long groupId,
	...
	*/
	...
	public DossierSync updateDossierSync(long groupId, long userId,
		long dossierId, String dossierReferenceUid, String syncRefUid,
		long dossierActionId, String actionCode, String actionName,
		String actionUser, String actionNote, int syncType, int infoType,
		String payload, String serverNo, int state);
}