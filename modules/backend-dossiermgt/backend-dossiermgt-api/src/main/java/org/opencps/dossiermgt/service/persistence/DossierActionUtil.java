...
public class DossierActionUtil {
	...
	* @return the matching dossier actions
	*/
	public static List<DossierAction> findByDID_U_SC(long dossierId,
		long userId, String stepCode) {
		return getPersistence().findByDID_U_SC(dossierId, userId, stepCode);
	}
	...
	*/
	public static List<DossierAction> findByDID_U_SC(long dossierId,
		...
		return getPersistence()
				   .findByDID_U_SC(dossierId, userId, stepCode, start, end);
	}
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDID_U_SC_First(long dossierId,
		long userId, String stepCode,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_U_SC_First(dossierId, userId, stepCode,
			orderByComparator);
	}
	...
	* @return the first matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByDID_U_SC_First(long dossierId,
		long userId, String stepCode,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDID_U_SC_First(dossierId, userId, stepCode,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDID_U_SC_Last(long dossierId,
		long userId, String stepCode,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_U_SC_Last(dossierId, userId, stepCode,
			orderByComparator);
	}
	...
	* @return the last matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByDID_U_SC_Last(long dossierId,
		long userId, String stepCode,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDID_U_SC_Last(dossierId, userId, stepCode,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierActionException if a dossier action with the primary key could not be found
	*/
	public static DossierAction[] findByDID_U_SC_PrevAndNext(
		long dossierActionId, long dossierId, long userId, String stepCode,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_U_SC_PrevAndNext(dossierActionId, dossierId,
	...
	* @param stepCode the step code
	*/
	public static void removeByDID_U_SC(long dossierId, long userId,
		String stepCode) {
		getPersistence().removeByDID_U_SC(dossierId, userId, stepCode);
	}
	...
	* @return the number of matching dossier actions
	*/
	public static int countByDID_U_SC(long dossierId, long userId,
		String stepCode) {
		return getPersistence().countByDID_U_SC(dossierId, userId, stepCode);
	}
	...
	* @return the matching dossier actions
	*/
	public static List<DossierAction> findByDID_SC_NOT_DAI(long dossierId,
		String stepCode, long dossierActionId) {
		return getPersistence()
				   .findByDID_SC_NOT_DAI(dossierId, stepCode, dossierActionId);
	}
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDID_SC_NOT_DAI_First(long dossierId,
		String stepCode, long dossierActionId,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_SC_NOT_DAI_First(dossierId, stepCode,
	...
	* @return the first matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByDID_SC_NOT_DAI_First(long dossierId,
		String stepCode, long dossierActionId,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDID_SC_NOT_DAI_First(dossierId, stepCode,
			dossierActionId, orderByComparator);
	}
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDID_SC_NOT_DAI_Last(long dossierId,
		String stepCode, long dossierActionId,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_SC_NOT_DAI_Last(dossierId, stepCode,
			dossierActionId, orderByComparator);
	}
	...
	* @return the last matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByDID_SC_NOT_DAI_Last(long dossierId,
		String stepCode, long dossierActionId,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDID_SC_NOT_DAI_Last(dossierId, stepCode,
			dossierActionId, orderByComparator);
	}
	...
	* @param dossierActionId the dossier action ID
	*/
	public static void removeByDID_SC_NOT_DAI(long dossierId, String stepCode,
		long dossierActionId) {
		getPersistence()
			.removeByDID_SC_NOT_DAI(dossierId, stepCode, dossierActionId);
	}
	...
	* @return the number of matching dossier actions
	*/
	public static int countByDID_SC_NOT_DAI(long dossierId, String stepCode,
		long dossierActionId) {
		return getPersistence()
				   .countByDID_SC_NOT_DAI(dossierId, stepCode, dossierActionId);
	}
	...
	*/
	...
	/**
	* Returns all the dossier actions where dossierId = &#63; and userId = &#63; and fromStepCode = &#63;.
	*
	* @param dossierId the dossier ID
	* @param userId the user ID
	* @param fromStepCode the from step code
	* @return the matching dossier actions
	*/
	public static List<DossierAction> findByDID_U_FSC(long dossierId,
		long userId, String fromStepCode) {
		return getPersistence().findByDID_U_FSC(dossierId, userId, fromStepCode);
	}

	/**
	* Returns a range of all the dossier actions where dossierId = &#63; and userId = &#63; and fromStepCode = &#63;.
	*
	* <p>
	* Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link DossierActionModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	* </p>
	...
	*/
	public static List<DossierAction> findByDID_U_FSC(long dossierId,
		long userId, String fromStepCode, int start, int end) {
		return getPersistence()
				   .findByDID_U_FSC(dossierId, userId, fromStepCode, start, end);
	}

	/**
	* Returns an ordered range of all the dossier actions where dossierId = &#63; and userId = &#63; and fromStepCode = &#63;.
	*
	* <p>
	* Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link DossierActionModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	* </p>
	...
	*/
	public static List<DossierAction> findByDID_U_FSC(long dossierId,
		...
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .findByDID_U_FSC(dossierId, userId, fromStepCode, start,
			end, orderByComparator);
	}
	...
	*/
	...
	/**
	* Returns the first dossier action in the ordered set where dossierId = &#63; and userId = &#63; and fromStepCode = &#63;.
	*
	* @param dossierId the dossier ID
	* @param userId the user ID
	* @param fromStepCode the from step code
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDID_U_FSC_First(long dossierId,
		long userId, String fromStepCode,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_U_FSC_First(dossierId, userId, fromStepCode,
			orderByComparator);
	}
	...
	* @return the first matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByDID_U_FSC_First(long dossierId,
		long userId, String fromStepCode,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDID_U_FSC_First(dossierId, userId, fromStepCode,
			orderByComparator);
	}

	/**
	* Returns the last dossier action in the ordered set where dossierId = &#63; and userId = &#63; and fromStepCode = &#63;.
	*
	* @param dossierId the dossier ID
	* @param userId the user ID
	* @param fromStepCode the from step code
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDID_U_FSC_Last(long dossierId,
		long userId, String fromStepCode,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_U_FSC_Last(dossierId, userId, fromStepCode,
			orderByComparator);
	}
	...
	* @return the last matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByDID_U_FSC_Last(long dossierId,
		long userId, String fromStepCode,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDID_U_FSC_Last(dossierId, userId, fromStepCode,
			orderByComparator);
	}

	/**
	* Returns the dossier actions before and after the current dossier action in the ordered set where dossierId = &#63; and userId = &#63; and fromStepCode = &#63;.
	*
	* @param dossierActionId the primary key of the current dossier action
	* @param dossierId the dossier ID
	* @param userId the user ID
	...
	* @throws NoSuchDossierActionException if a dossier action with the primary key could not be found
	*/
	public static DossierAction[] findByDID_U_FSC_PrevAndNext(
		long dossierActionId, long dossierId, long userId, String fromStepCode,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDID_U_FSC_PrevAndNext(dossierActionId, dossierId,
			userId, fromStepCode, orderByComparator);
	}

	/**
	* Removes all the dossier actions where dossierId = &#63; and userId = &#63; and fromStepCode = &#63; from the database.
	*
	* @param dossierId the dossier ID
	* @param userId the user ID
	* @param fromStepCode the from step code
	*/
	public static void removeByDID_U_FSC(long dossierId, long userId,
		String fromStepCode) {
		getPersistence().removeByDID_U_FSC(dossierId, userId, fromStepCode);
	}

	/**
	* Returns the number of dossier actions where dossierId = &#63; and userId = &#63; and fromStepCode = &#63;.
	*
	* @param dossierId the dossier ID
	* @param userId the user ID
	* @param fromStepCode the from step code
	* @return the number of matching dossier actions
	*/
	public static int countByDID_U_FSC(long dossierId, long userId,
		String fromStepCode) {
		return getPersistence().countByDID_U_FSC(dossierId, userId, fromStepCode);
	}
	...
	* @return the matching dossier actions
	*/
	public static List<DossierAction> findByG_DID(long groupId, long dossierId) {
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByG_DID_First(long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
	...
	* @return the first matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByG_DID_First(long groupId,
		long dossierId, OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByG_DID_Last(long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
	...
	* @return the last matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByG_DID_Last(long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchDossierActionException if a dossier action with the primary key could not be found
	*/
	public static DossierAction[] findByG_DID_PrevAndNext(
		long dossierActionId, long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByG_DID_PrevAndNext(dossierActionId, groupId,
	...
	* @return the matching dossier actions
	*/
	public static List<DossierAction> findByDD(Date dueDate, long nextActionId) {
		return getPersistence().findByDD(dueDate, nextActionId);
	}
	...
	*/
	public static List<DossierAction> findByDD(Date dueDate, long nextActionId,
		int start, int end) {
		return getPersistence().findByDD(dueDate, nextActionId, start, end);
	}
	...
	*/
	public static List<DossierAction> findByDD(Date dueDate, long nextActionId,
		int start, int end, OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .findByDD(dueDate, nextActionId, start, end,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDD_First(Date dueDate, long nextActionId,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDD_First(dueDate, nextActionId, orderByComparator);
	}
	...
	*/
	public static DossierAction fetchByDD_First(Date dueDate,
		long nextActionId, OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDD_First(dueDate, nextActionId, orderByComparator);
	}
	...
	* @throws NoSuchDossierActionException if a matching dossier action could not be found
	*/
	public static DossierAction findByDD_Last(Date dueDate, long nextActionId,
		OrderByComparator<DossierAction> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionException {
		return getPersistence()
				   .findByDD_Last(dueDate, nextActionId, orderByComparator);
	}
	...
	* @return the last matching dossier action, or <code>null</code> if a matching dossier action could not be found
	*/
	public static DossierAction fetchByDD_Last(Date dueDate, long nextActionId,
		OrderByComparator<DossierAction> orderByComparator) {
		return getPersistence()
				   .fetchByDD_Last(dueDate, nextActionId, orderByComparator);
	}
	...
	*/
	public static DossierAction[] findByDD_PrevAndNext(long dossierActionId,
		...
		return getPersistence()
			...
			nextActionId, orderByComparator);
	}
	...
	* @param nextActionId the next action ID
	*/
	public static void removeByDD(Date dueDate, long nextActionId) {
		getPersistence().removeByDD(dueDate, nextActionId);
	}
	...
	* @return the number of matching dossier actions
	*/
	public static int countByDD(Date dueDate, long nextActionId) {
		return getPersistence().countByDD(dueDate, nextActionId);
	}
