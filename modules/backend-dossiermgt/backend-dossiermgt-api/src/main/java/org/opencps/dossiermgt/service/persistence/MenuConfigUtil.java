...
public class MenuConfigUtil {
	...
	* @throws NoSuchMenuConfigException if a matching menu config could not be found
	*/
	public static MenuConfig findByF_BY_G_MENU(long groupId, String menuGroup)
		throws org.opencps.dossiermgt.exception.NoSuchMenuConfigException {
		return getPersistence().findByF_BY_G_MENU(groupId, menuGroup);
	}
	...
	* @return the matching menu config, or <code>null</code> if a matching menu config could not be found
	*/
	public static MenuConfig fetchByF_BY_G_MENU(long groupId, String menuGroup) {
		return getPersistence().fetchByF_BY_G_MENU(groupId, menuGroup);
	}
	...
	*/
	public static MenuConfig fetchByF_BY_G_MENU(long groupId, String menuGroup,
		boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByF_BY_G_MENU(groupId, menuGroup, retrieveFromCache);
	}
	...
	* @return the menu config that was removed
	*/
	public static MenuConfig removeByF_BY_G_MENU(long groupId, String menuGroup)
		throws org.opencps.dossiermgt.exception.NoSuchMenuConfigException {
		return getPersistence().removeByF_BY_G_MENU(groupId, menuGroup);
	}
	...
	* @return the number of matching menu configs
	*/
	public static int countByF_BY_G_MENU(long groupId, String menuGroup) {
		return getPersistence().countByF_BY_G_MENU(groupId, menuGroup);
	}
