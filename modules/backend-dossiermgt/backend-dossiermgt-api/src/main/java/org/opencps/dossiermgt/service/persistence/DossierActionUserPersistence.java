...
public interface DossierActionUserPersistence extends BasePersistence<DossierActionUser> {
	...
	* @return the matching dossier action users
	*/
	public java.util.List<DossierActionUser> findByDID__DAI_SC_AS(
	...
	*/
	public java.util.List<DossierActionUser> findByDID__DAI_SC_AS(
		long dossierId, long dossierActionId, String stepCode, int[] assigneds);
	...
	* @return the matching dossier action users
	*/
	public java.util.List<DossierActionUser> findByDSID(long dossierId);
