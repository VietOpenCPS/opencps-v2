...
public class DossierUtil {
	...
	* @return the matching dossiers
	*/
	public static List<Dossier> findByGID_GC_SC_DTN_DS_APP_DELEGATE(
		...
		return getPersistence()
				   .findByGID_GC_SC_DTN_DS_APP_DELEGATE(groupId, govAgencyCode,
	...
	* @throws NoSuchDossierException if a matching dossier could not be found
	*/
	public static Dossier findByGID_GC_SC_DTN_DS_APP_DELEGATE_First(
		long groupId, String govAgencyCode, String serviceCode,
		String dossierTemplateNo, String dossierStatus, String applicantIdNo,
		String applicantIdType, String delegateIdNo, int originality,
		OrderByComparator<Dossier> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierException {
		return getPersistence()
				   .findByGID_GC_SC_DTN_DS_APP_DELEGATE_First(groupId,
			govAgencyCode, serviceCode, dossierTemplateNo, dossierStatus,
	...
	* @return the first matching dossier, or <code>null</code> if a matching dossier could not be found
	*/
	public static Dossier fetchByGID_GC_SC_DTN_DS_APP_DELEGATE_First(
		long groupId, String govAgencyCode, String serviceCode,
		String dossierTemplateNo, String dossierStatus, String applicantIdNo,
		String applicantIdType, String delegateIdNo, int originality,
		OrderByComparator<Dossier> orderByComparator) {
		return getPersistence()
				   .fetchByGID_GC_SC_DTN_DS_APP_DELEGATE_First(groupId,
			govAgencyCode, serviceCode, dossierTemplateNo, dossierStatus,
			applicantIdNo, applicantIdType, delegateIdNo, originality,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierException if a matching dossier could not be found
	*/
	public static Dossier findByGID_GC_SC_DTN_DS_APP_DELEGATE_Last(
		long groupId, String govAgencyCode, String serviceCode,
		String dossierTemplateNo, String dossierStatus, String applicantIdNo,
		String applicantIdType, String delegateIdNo, int originality,
		OrderByComparator<Dossier> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierException {
		return getPersistence()
				   .findByGID_GC_SC_DTN_DS_APP_DELEGATE_Last(groupId,
			govAgencyCode, serviceCode, dossierTemplateNo, dossierStatus,
			applicantIdNo, applicantIdType, delegateIdNo, originality,
			orderByComparator);
	}
	...
	* @return the last matching dossier, or <code>null</code> if a matching dossier could not be found
	*/
	public static Dossier fetchByGID_GC_SC_DTN_DS_APP_DELEGATE_Last(
		long groupId, String govAgencyCode, String serviceCode,
		String dossierTemplateNo, String dossierStatus, String applicantIdNo,
		String applicantIdType, String delegateIdNo, int originality,
		OrderByComparator<Dossier> orderByComparator) {
		return getPersistence()
				   .fetchByGID_GC_SC_DTN_DS_APP_DELEGATE_Last(groupId,
			govAgencyCode, serviceCode, dossierTemplateNo, dossierStatus,
			applicantIdNo, applicantIdType, delegateIdNo, originality,
			orderByComparator);
	}
	...
	* @throws NoSuchDossierException if a dossier with the primary key could not be found
	*/
	public static Dossier[] findByGID_GC_SC_DTN_DS_APP_DELEGATE_PrevAndNext(
		...
		throws org.opencps.dossiermgt.exception.NoSuchDossierException {
		return getPersistence()
				   .findByGID_GC_SC_DTN_DS_APP_DELEGATE_PrevAndNext(dossierId,
	...
	* @param originality the originality
	*/
	public static void removeByGID_GC_SC_DTN_DS_APP_DELEGATE(long groupId,
		...
		getPersistence()
			.removeByGID_GC_SC_DTN_DS_APP_DELEGATE(groupId, govAgencyCode,
			serviceCode, dossierTemplateNo, dossierStatus, applicantIdNo,
			applicantIdType, delegateIdNo, originality);
	}
	...
	* @return the number of matching dossiers
	*/
	public static int countByGID_GC_SC_DTN_DS_APP_DELEGATE(long groupId,
		String govAgencyCode, String serviceCode, String dossierTemplateNo,
		String dossierStatus, String applicantIdNo, String applicantIdType,
		String delegateIdNo, int originality) {
		return getPersistence()
				   .countByGID_GC_SC_DTN_DS_APP_DELEGATE(groupId,
			govAgencyCode, serviceCode, dossierTemplateNo, dossierStatus,
			applicantIdNo, applicantIdType, delegateIdNo, originality);
	}
	...
	*/
	public static int countByGID_GC_SC_DTN_DS_APP_DELEGATE(long groupId,
		...
		return getPersistence()
				   .countByGID_GC_SC_DTN_DS_APP_DELEGATE(groupId,
			govAgencyCode, serviceCode, dossierTemplateNo, dossierStatuses,
			applicantIdNo, applicantIdType, delegateIdNo, originality);
	}
	...
	* @return the matching dossiers
	*/
	public static List<Dossier> findByG_GDID(long groupId, long groupDossierId) {
	...
	* @throws NoSuchDossierException if a matching dossier could not be found
	*/
	public static Dossier findByG_GDID_First(long groupId, long groupDossierId,
		OrderByComparator<Dossier> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierException {
		return getPersistence()
	...
	* @throws NoSuchDossierException if a matching dossier could not be found
	*/
	public static Dossier findByG_GDID_Last(long groupId, long groupDossierId,
		OrderByComparator<Dossier> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierException {
		return getPersistence()
	...
	* @return the last matching dossier, or <code>null</code> if a matching dossier could not be found
	*/
	public static Dossier fetchByG_GDID_Last(long groupId, long groupDossierId,
		OrderByComparator<Dossier> orderByComparator) {
		return getPersistence()
	...
	* @param groupDossierId the group dossier ID
	*/
	public static void removeByG_GDID(long groupId, long groupDossierId) {
	...
	* @return the number of matching dossiers
	*/
	public static int countByG_GDID(long groupId, long groupDossierId) {
