...
/**
 * The persistence utility for the service config mapping service. This utility wraps {@link org.opencps.dossiermgt.service.persistence.impl.ServiceConfigMappingPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see org.opencps.dossiermgt.service.persistence.impl.ServiceConfigMappingPersistenceImpl
 * @generated
 */
@ProviderType
public class ServiceConfigMappingUtil {
	...
	*/
	public static ServiceConfigMapping findByUuid_First(String uuid,
		OrderByComparator<ServiceConfigMapping> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceConfigMappingException {
	...
	* @return the matching service config mappings
	*/
	public static List<ServiceConfigMapping> findByG_ServiceCode(long groupId,
		String serviceCode) {
		return getPersistence().findByG_ServiceCode(groupId, serviceCode);
	}
	...
	*/
	public static List<ServiceConfigMapping> findByG_ServiceCode(long groupId,
		...
		return getPersistence()
				   .findByG_ServiceCode(groupId, serviceCode, start, end);
	}
	...
	* @throws NoSuchServiceConfigMappingException if a matching service config mapping could not be found
	*/
	public static ServiceConfigMapping findByG_ServiceCode_First(long groupId,
		String serviceCode,
		OrderByComparator<ServiceConfigMapping> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceConfigMappingException {
		return getPersistence()
				   .findByG_ServiceCode_First(groupId, serviceCode,
			orderByComparator);
	}
	...
	* @return the first matching service config mapping, or <code>null</code> if a matching service config mapping could not be found
	*/
	public static ServiceConfigMapping fetchByG_ServiceCode_First(
		long groupId, String serviceCode,
		OrderByComparator<ServiceConfigMapping> orderByComparator) {
		return getPersistence()
				   .fetchByG_ServiceCode_First(groupId, serviceCode,
			orderByComparator);
	}
	...
	* @throws NoSuchServiceConfigMappingException if a matching service config mapping could not be found
	*/
	public static ServiceConfigMapping findByG_ServiceCode_Last(long groupId,
		String serviceCode,
		OrderByComparator<ServiceConfigMapping> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceConfigMappingException {
		return getPersistence()
				   .findByG_ServiceCode_Last(groupId, serviceCode,
			orderByComparator);
	}
	...
	* @return the last matching service config mapping, or <code>null</code> if a matching service config mapping could not be found
	*/
	public static ServiceConfigMapping fetchByG_ServiceCode_Last(long groupId,
		String serviceCode,
		OrderByComparator<ServiceConfigMapping> orderByComparator) {
		return getPersistence()
				   .fetchByG_ServiceCode_Last(groupId, serviceCode,
			orderByComparator);
	}
	...
	* @throws NoSuchServiceConfigMappingException if a service config mapping with the primary key could not be found
	*/
	public static ServiceConfigMapping[] findByG_ServiceCode_PrevAndNext(
		long serviceConfigMappingId, long groupId, String serviceCode,
		OrderByComparator<ServiceConfigMapping> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchServiceConfigMappingException {
		return getPersistence()
				   .findByG_ServiceCode_PrevAndNext(serviceConfigMappingId,
			groupId, serviceCode, orderByComparator);
	}
	...
	* @param serviceCode the service code
	*/
	public static void removeByG_ServiceCode(long groupId, String serviceCode) {
		getPersistence().removeByG_ServiceCode(groupId, serviceCode);
	}
	...
	* @return the number of matching service config mappings
	*/
	public static int countByG_ServiceCode(long groupId, String serviceCode) {
		return getPersistence().countByG_ServiceCode(groupId, serviceCode);
	}
