...
/**
 * Provides the local service interface for PaymentFeeInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see PaymentFeeInfoLocalServiceUtil
...
public interface PaymentFeeInfoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PaymentFeeInfoLocalServiceUtil} to access the payment fee info local service. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.PaymentFeeInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public PaymentFeeInfo addPaymentFeeInfo(long groupId,
		long serviceConfigMappingId, String paymentFeeCode,
