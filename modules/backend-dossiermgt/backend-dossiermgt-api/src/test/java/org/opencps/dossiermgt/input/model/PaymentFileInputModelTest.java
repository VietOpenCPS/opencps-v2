...
public class PaymentFileInputModelTest {
	@Before
	public void setUp() {
	}
	@Test
	public void getGovAgencyTaxNoTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
	...
	@Test
	public void getConfirmFileEntryIdTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.getConfirmFileEntryId();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setConfirmFileEntryIdTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setConfirmFileEntryId(Long.valueOf(0));
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setConfirmNoteTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setConfirmNote("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void getConfirmNoteTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.getConfirmNote();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setEpaymentProfileTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setEpaymentProfile("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void setApproveDatetimeTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setApproveDatetime("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	public void getAccountUserNameTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.getAccountUserName();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void getConfirmPayloadTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.getConfirmPayload();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void getApproveDatetimeTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.getApproveDatetime();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void setInvoicePayloadTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setInvoicePayload("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void setConfirmPayloadTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setConfirmPayload("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void setAccountUserNameTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setAccountUserName("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void getInvoicePayloadTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.getInvoicePayload();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setEinvoiceTest() {
		try{
			PaymentFileInputModel object = new PaymentFileInputModel();
			object.setEinvoice("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
