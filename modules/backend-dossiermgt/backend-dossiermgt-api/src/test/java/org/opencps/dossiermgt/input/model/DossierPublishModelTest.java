...
public class DossierPublishModelTest {
	...
	@Test
	public void setLockStateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.setLockState("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void getProcessDateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.getProcessDate();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setProcessDateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.setProcessDate("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	public void setCorrecttingDateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.setCorrecttingDate("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void getEndorsementDateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.getEndorsementDate();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	public void setCancellingDateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.setCancellingDate("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setCorrectingDateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.setCorrectingDate("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void setEndorsementDateTest() {
		try{
			DossierPublishModel object = new DossierPublishModel();
			object.setEndorsementDate("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
