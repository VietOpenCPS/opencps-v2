...
create index IX_F6685C03 on opencps_reportlandtax (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_CB4E0745 on opencps_reportlandtax (uuid_[$COLUMN_LENGTH:75$], groupId);
