 ...
 * @generated
 */
public class DossierActionFinderBaseImpl extends BasePersistenceImpl<DossierAction> {
	public DossierActionFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return getDossierActionPersistence().getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(DossierActionFinderBaseImpl.class);
}