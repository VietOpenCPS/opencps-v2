...
public class DeliverableTypePersistenceImpl extends BasePersistenceImpl<DeliverableType>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED,
			DeliverableTypeImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED,
			DeliverableTypeImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG",
			new String[] { Long.class.getName() },
			DeliverableTypeModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DeliverableType> findByG(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public DeliverableType findByG_First(long groupId,
		OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = fetchByG_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType fetchByG_First(long groupId,
		OrderByComparator<DeliverableType> orderByComparator) {
		List<DeliverableType> list = findByG(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType findByG_Last(long groupId,
		OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = fetchByG_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType fetchByG_Last(long groupId,
		OrderByComparator<DeliverableType> orderByComparator) {
		...
		List<DeliverableType> list = findByG(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType[] findByG_PrevAndNext(long deliverableTypeId,
		long groupId, OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = findByPrimaryKey(deliverableTypeId);
		...
		try {
			...
			array[0] = getByG_PrevAndNext(session, deliverableType, groupId,
					orderByComparator, true);

			array[1] = deliverableType;

			array[2] = getByG_PrevAndNext(session, deliverableType, groupId,
					orderByComparator, false);
	...
	protected DeliverableType getByG_PrevAndNext(Session session,
		DeliverableType deliverableType, long groupId,
		OrderByComparator<DeliverableType> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG(long groupId) {
		for (DeliverableType deliverableType : findByG(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(deliverableType);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_GROUPID_2 = "deliverableType.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED,
			DeliverableTypeImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED,
			DeliverableTypeImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByC",
			new String[] { Long.class.getName() },
			DeliverableTypeModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_C = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DeliverableType> findByC(long companyId) {
	 ...
	 */
	@Override
	public List<DeliverableType> findByC(long companyId, int start, int end) {
	...
	public List<DeliverableType> findByC(long companyId, int start, int end,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DeliverableType deliverableType : list) {
					if ((companyId != deliverableType.getCompanyId())) {
						list = null;
	 ...
	 */
	@Override
	public DeliverableType findByC_First(long companyId,
		OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = fetchByC_First(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType fetchByC_First(long companyId,
		OrderByComparator<DeliverableType> orderByComparator) {
		List<DeliverableType> list = findByC(companyId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType findByC_Last(long companyId,
		OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = fetchByC_Last(companyId,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType fetchByC_Last(long companyId,
		OrderByComparator<DeliverableType> orderByComparator) {
		...
		List<DeliverableType> list = findByC(companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType[] findByC_PrevAndNext(long deliverableTypeId,
		...
		try {
			...
			array[0] = getByC_PrevAndNext(session, deliverableType, companyId,
					orderByComparator, true);

			array[1] = deliverableType;

			array[2] = getByC_PrevAndNext(session, deliverableType, companyId,
					orderByComparator, false);
	...
	protected DeliverableType getByC_PrevAndNext(Session session,
		DeliverableType deliverableType, long companyId,
		OrderByComparator<DeliverableType> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByC(long companyId) {
		for (DeliverableType deliverableType : findByC(companyId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(deliverableType);
		}
	}
	...
	private static final String _FINDER_COLUMN_C_COMPANYID_2 = "deliverableType.companyId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_D_OR_D = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED,
			DeliverableTypeImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByD_OR_D",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_D_OR_D =
		new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { Long.class.getName() },
			DeliverableTypeModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_D_OR_D = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByD_OR_D",
			new String[] { Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_D_OR_D = new FinderPath(DeliverableTypeModelImpl.ENTITY_CACHE_ENABLED,
			DeliverableTypeModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DeliverableType> findByD_OR_D(long groupId) {
		return findByD_OR_D(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<DeliverableType> findByD_OR_D(long groupId, int start, int end) {
		return findByD_OR_D(groupId, start, end, null);
	}
	...
	public List<DeliverableType> findByD_OR_D(long groupId, int start, int end,
		OrderByComparator<DeliverableType> orderByComparator) {
		return findByD_OR_D(groupId, start, end, orderByComparator, true);
	}
	...
	public List<DeliverableType> findByD_OR_D(long groupId, int start, int end,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_D_OR_D_GROUPID_2);
	 ...
	 */
	@Override
	public DeliverableType findByD_OR_D_First(long groupId,
		OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = fetchByD_OR_D_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType fetchByD_OR_D_First(long groupId,
		OrderByComparator<DeliverableType> orderByComparator) {
		List<DeliverableType> list = findByD_OR_D(groupId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType findByD_OR_D_Last(long groupId,
		OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = fetchByD_OR_D_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType fetchByD_OR_D_Last(long groupId,
		OrderByComparator<DeliverableType> orderByComparator) {
		int count = countByD_OR_D(groupId);

		if (count == 0) {
			return null;
		}

		List<DeliverableType> list = findByD_OR_D(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public DeliverableType[] findByD_OR_D_PrevAndNext(long deliverableTypeId,
		long groupId, OrderByComparator<DeliverableType> orderByComparator)
		throws NoSuchDeliverableTypeException {
		DeliverableType deliverableType = findByPrimaryKey(deliverableTypeId);
		...
		try {
			...
			array[0] = getByD_OR_D_PrevAndNext(session, deliverableType,
					groupId, orderByComparator, true);

			array[1] = deliverableType;

			array[2] = getByD_OR_D_PrevAndNext(session, deliverableType,
	...
	protected DeliverableType getByD_OR_D_PrevAndNext(Session session,
		DeliverableType deliverableType, long groupId,
		OrderByComparator<DeliverableType> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<DeliverableType> findByD_OR_D(long[] groupIds) {
		return findByD_OR_D(groupIds, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<DeliverableType> findByD_OR_D(long[] groupIds, int start,
		int end) {
		return findByD_OR_D(groupIds, start, end, null);
	}
	...
	public List<DeliverableType> findByD_OR_D(long[] groupIds, int start,
		...
		return findByD_OR_D(groupIds, start, end, orderByComparator, true);
	}
	...
	public List<DeliverableType> findByD_OR_D(long[] groupIds, int start,
		...
		if (groupIds.length == 1) {
			return findByD_OR_D(groupIds[0], start, end, orderByComparator);
		}
		...
		if (retrieveFromCache) {
			list = (List<DeliverableType>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_D_OR_D,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (DeliverableType deliverableType : list) {
					if (!ArrayUtil.contains(groupIds,
								deliverableType.getGroupId())) {
						list = null;
		...
		if (list == null) {
			...
			if (groupIds.length > 0) {
				...
				query.append(_FINDER_COLUMN_D_OR_D_GROUPID_7);
	 ...
	 */
	@Override
	public void removeByD_OR_D(long groupId) {
		for (DeliverableType deliverableType : findByD_OR_D(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(deliverableType);
		}
	}
	 ...
	 */
	@Override
	public int countByD_OR_D(long groupId) {
	 ...
	 */
	@Override
	public int countByD_OR_D(long[] groupIds) {
		if (groupIds == null) {
			groupIds = new long[0];
		}
		else if (groupIds.length > 1) {
	...
	private static final String _FINDER_COLUMN_D_OR_D_GROUPID_2 = "deliverableType.groupId = ?";
	private static final String _FINDER_COLUMN_D_OR_D_GROUPID_7 = "deliverableType.groupId IN (";
