...
/**
 * The extended model base implementation for the CsdlDcServiceInfo service. Represents a row in the &quot;opencps_csdldc_serviceinfo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 ...
 */
@ProviderType
public abstract class CsdlDcServiceInfoBaseImpl
	extends CsdlDcServiceInfoModelImpl implements CsdlDcServiceInfo {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public void persist() {
		if (this.isNew()) {
			CsdlDcServiceInfoLocalServiceUtil.addCsdlDcServiceInfo(this);
		}
		else {
			CsdlDcServiceInfoLocalServiceUtil.updateCsdlDcServiceInfo(this);
		}
	}
}