...
public class ServiceFileTemplatePersistenceImpl extends BasePersistenceImpl<ServiceFileTemplate>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_SCID_FORM =
		new FinderPath(ServiceFileTemplateModelImpl.ENTITY_CACHE_ENABLED,
			ServiceFileTemplateModelImpl.FINDER_CACHE_ENABLED,
			ServiceFileTemplateImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_SCID_FORM",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_SCID_FORM =
		new FinderPath(ServiceFileTemplateModelImpl.ENTITY_CACHE_ENABLED,
			ServiceFileTemplateModelImpl.FINDER_CACHE_ENABLED,
			ServiceFileTemplateImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_SCID_FORM",
			new String[] { Long.class.getName(), Boolean.class.getName() },
			ServiceFileTemplateModelImpl.SERVICEINFOID_COLUMN_BITMASK |
			ServiceFileTemplateModelImpl.EFORM_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_SCID_FORM = new FinderPath(ServiceFileTemplateModelImpl.ENTITY_CACHE_ENABLED,
			ServiceFileTemplateModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_SCID_FORM",
			new String[] { Long.class.getName(), Boolean.class.getName() });
	 ...
	 */
	@Override
	public List<ServiceFileTemplate> findByF_SCID_FORM(long serviceInfoId,
		boolean eForm) {
		return findByF_SCID_FORM(serviceInfoId, eForm, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ServiceFileTemplate> findByF_SCID_FORM(long serviceInfoId,
		...
		return findByF_SCID_FORM(serviceInfoId, eForm, start, end, null);
	}
	...
	public List<ServiceFileTemplate> findByF_SCID_FORM(long serviceInfoId,
		boolean eForm, int start, int end,
		OrderByComparator<ServiceFileTemplate> orderByComparator) {
		return findByF_SCID_FORM(serviceInfoId, eForm, start, end,
			orderByComparator, true);
	}
	...
	public List<ServiceFileTemplate> findByF_SCID_FORM(long serviceInfoId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_SCID_FORM;
			finderArgs = new Object[] { serviceInfoId, eForm };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_SCID_FORM;
			finderArgs = new Object[] {
					serviceInfoId, eForm,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ServiceFileTemplate serviceFileTemplate : list) {
					if ((serviceInfoId != serviceFileTemplate.getServiceInfoId()) ||
							(eForm != serviceFileTemplate.isEForm())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_SCID_FORM_SERVICEINFOID_2);

			query.append(_FINDER_COLUMN_F_SCID_FORM_EFORM_2);
	 ...
	 */
	@Override
	public ServiceFileTemplate findByF_SCID_FORM_First(long serviceInfoId,
		boolean eForm, OrderByComparator<ServiceFileTemplate> orderByComparator)
		throws NoSuchServiceFileTemplateException {
		ServiceFileTemplate serviceFileTemplate = fetchByF_SCID_FORM_First(serviceInfoId,
				eForm, orderByComparator);
	 ...
	 */
	@Override
	public ServiceFileTemplate fetchByF_SCID_FORM_First(long serviceInfoId,
		boolean eForm, OrderByComparator<ServiceFileTemplate> orderByComparator) {
		List<ServiceFileTemplate> list = findByF_SCID_FORM(serviceInfoId,
				eForm, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public ServiceFileTemplate findByF_SCID_FORM_Last(long serviceInfoId,
		boolean eForm, OrderByComparator<ServiceFileTemplate> orderByComparator)
		throws NoSuchServiceFileTemplateException {
		ServiceFileTemplate serviceFileTemplate = fetchByF_SCID_FORM_Last(serviceInfoId,
				eForm, orderByComparator);
	 ...
	 */
	@Override
	public ServiceFileTemplate fetchByF_SCID_FORM_Last(long serviceInfoId,
		boolean eForm, OrderByComparator<ServiceFileTemplate> orderByComparator) {
		int count = countByF_SCID_FORM(serviceInfoId, eForm);
		...
		List<ServiceFileTemplate> list = findByF_SCID_FORM(serviceInfoId,
				eForm, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public ServiceFileTemplate[] findByF_SCID_FORM_PrevAndNext(
		ServiceFileTemplatePK serviceFileTemplatePK, long serviceInfoId,
		boolean eForm, OrderByComparator<ServiceFileTemplate> orderByComparator)
		throws NoSuchServiceFileTemplateException {
		ServiceFileTemplate serviceFileTemplate = findByPrimaryKey(serviceFileTemplatePK);
		...
		try {
			...
			array[0] = getByF_SCID_FORM_PrevAndNext(session,
					serviceFileTemplate, serviceInfoId, eForm,
					orderByComparator, true);

			array[1] = serviceFileTemplate;

			array[2] = getByF_SCID_FORM_PrevAndNext(session,
					serviceFileTemplate, serviceInfoId, eForm,
	...
	protected ServiceFileTemplate getByF_SCID_FORM_PrevAndNext(
		Session session, ServiceFileTemplate serviceFileTemplate,
	 ...
	 */
	@Override
	public void removeByF_SCID_FORM(long serviceInfoId, boolean eForm) {
		for (ServiceFileTemplate serviceFileTemplate : findByF_SCID_FORM(
				serviceInfoId, eForm, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(serviceFileTemplate);
		}
	}
	 ...
	 */
	@Override
	public int countByF_SCID_FORM(long serviceInfoId, boolean eForm) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_SCID_FORM;

		Object[] finderArgs = new Object[] { serviceInfoId, eForm };
	...
	private static final String _FINDER_COLUMN_F_SCID_FORM_SERVICEINFOID_2 = "serviceFileTemplate.id.serviceInfoId = ? AND ";
	private static final String _FINDER_COLUMN_F_SCID_FORM_EFORM_2 = "serviceFileTemplate.eForm = ?";
	...
	public ServiceFileTemplate updateImpl(
		...
		if (!ServiceFileTemplateModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					serviceFileTemplateModelImpl.getServiceInfoId(),
					serviceFileTemplateModelImpl.isEForm()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_SCID_FORM, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_SCID_FORM,
				args);
			...
			if ((serviceFileTemplateModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_SCID_FORM.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						serviceFileTemplateModelImpl.getOriginalServiceInfoId(),
						serviceFileTemplateModelImpl.getOriginalEForm()
					};
