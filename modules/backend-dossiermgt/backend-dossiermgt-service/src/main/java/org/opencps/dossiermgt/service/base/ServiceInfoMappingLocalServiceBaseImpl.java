...
import org.opencps.dossiermgt.service.ServiceInfoMappingLocalService;
...
/**
 * Provides the base implementation for the service info mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ServiceInfoMappingLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ServiceInfoMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServiceInfoMappingLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ServiceInfoMappingLocalServiceUtil} to access the service info mapping local service.
	 */
	...
	public ServiceInfoMapping createServiceInfoMapping(
		long serviceInfoMappingId) {
		return serviceInfoMappingPersistence.create(serviceInfoMappingId);
	}
	...
	public ServiceInfoMapping deleteServiceInfoMapping(
		...
		return serviceInfoMappingPersistence.remove(serviceInfoMappingId);
	}
	...
	public ServiceInfoMapping deleteServiceInfoMapping(
		ServiceInfoMapping serviceInfoMapping) {
		return serviceInfoMappingPersistence.remove(serviceInfoMapping);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServiceInfoMapping.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceInfoMappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceInfoMappingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ServiceInfoMapping fetchServiceInfoMapping(long serviceInfoMappingId) {
		return serviceInfoMappingPersistence.fetchByPrimaryKey(serviceInfoMappingId);
	}
	 ...
	 */
	@Override
	public ServiceInfoMapping getServiceInfoMapping(long serviceInfoMappingId)
		throws PortalException {
		return serviceInfoMappingPersistence.findByPrimaryKey(serviceInfoMappingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(serviceInfoMappingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ServiceInfoMapping.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("serviceInfoMappingId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(serviceInfoMappingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ServiceInfoMapping.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName(
			"serviceInfoMappingId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return serviceInfoMappingLocalService.deleteServiceInfoMapping((ServiceInfoMapping)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return serviceInfoMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ServiceInfoMapping> getServiceInfoMappings(int start, int end) {
		return serviceInfoMappingPersistence.findAll(start, end);
	}
	...
	public int getServiceInfoMappingsCount() {
		return serviceInfoMappingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ServiceInfoMapping updateServiceInfoMapping(
		ServiceInfoMapping serviceInfoMapping) {
		return serviceInfoMappingPersistence.update(serviceInfoMapping);
	}
	 ...
	 */
	public ServiceInfoMappingLocalService getServiceInfoMappingLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ServiceInfoMapping",
			serviceInfoMappingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ServiceInfoMapping");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceInfoMappingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = serviceInfoMappingPersistence.getDataSource();
	...
	@BeanReference(type = ServiceInfoMappingLocalService.class)
	protected ServiceInfoMappingLocalService serviceInfoMappingLocalService;
