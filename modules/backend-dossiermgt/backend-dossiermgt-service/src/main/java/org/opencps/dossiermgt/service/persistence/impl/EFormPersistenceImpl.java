...
public class EFormPersistenceImpl extends BasePersistenceImpl<EForm>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_GID_STATE =
		new FinderPath(EFormModelImpl.ENTITY_CACHE_ENABLED,
			EFormModelImpl.FINDER_CACHE_ENABLED, EFormImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_GID_STATE",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_GID_STATE =
		new FinderPath(EFormModelImpl.ENTITY_CACHE_ENABLED,
			EFormModelImpl.FINDER_CACHE_ENABLED, EFormImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_GID_STATE",
			new String[] { Long.class.getName(), Integer.class.getName() },
			EFormModelImpl.GROUPID_COLUMN_BITMASK |
			EFormModelImpl.STATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_GID_STATE = new FinderPath(EFormModelImpl.ENTITY_CACHE_ENABLED,
			EFormModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_GID_STATE",
			new String[] { Long.class.getName(), Integer.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_GID_STATE =
		new FinderPath(EFormModelImpl.ENTITY_CACHE_ENABLED,
			EFormModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByF_GID_STATE",
			new String[] { Long.class.getName(), Integer.class.getName() });
	 ...
	 */
	@Override
	public List<EForm> findByF_GID_STATE(long groupId, int state) {
		return findByF_GID_STATE(groupId, state, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<EForm> findByF_GID_STATE(long groupId, int state, int start,
		int end) {
		return findByF_GID_STATE(groupId, state, start, end, null);
	}
	...
	public List<EForm> findByF_GID_STATE(long groupId, int state, int start,
		int end, OrderByComparator<EForm> orderByComparator) {
		return findByF_GID_STATE(groupId, state, start, end, orderByComparator,
			true);
	}
	...
	public List<EForm> findByF_GID_STATE(long groupId, int state, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_GID_STATE;
			finderArgs = new Object[] { groupId, state };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_GID_STATE;
			finderArgs = new Object[] {
					groupId, state,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_GID_STATE_GROUPID_2);

			query.append(_FINDER_COLUMN_F_GID_STATE_STATE_2);
	 ...
	 */
	@Override
	public EForm findByF_GID_STATE_First(long groupId, int state,
		OrderByComparator<EForm> orderByComparator) throws NoSuchEFormException {
		EForm eForm = fetchByF_GID_STATE_First(groupId, state, orderByComparator);
	 ...
	 */
	@Override
	public EForm fetchByF_GID_STATE_First(long groupId, int state,
		OrderByComparator<EForm> orderByComparator) {
		List<EForm> list = findByF_GID_STATE(groupId, state, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public EForm findByF_GID_STATE_Last(long groupId, int state,
		OrderByComparator<EForm> orderByComparator) throws NoSuchEFormException {
		EForm eForm = fetchByF_GID_STATE_Last(groupId, state, orderByComparator);
	 ...
	 */
	@Override
	public EForm fetchByF_GID_STATE_Last(long groupId, int state,
		OrderByComparator<EForm> orderByComparator) {
		int count = countByF_GID_STATE(groupId, state);

		if (count == 0) {
			return null;
		}

		List<EForm> list = findByF_GID_STATE(groupId, state, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public EForm[] findByF_GID_STATE_PrevAndNext(long eFormId, long groupId,
		int state, OrderByComparator<EForm> orderByComparator)
		throws NoSuchEFormException {
		EForm eForm = findByPrimaryKey(eFormId);
		...
		try {
			...
			array[0] = getByF_GID_STATE_PrevAndNext(session, eForm, groupId,
					state, orderByComparator, true);

			array[1] = eForm;

			array[2] = getByF_GID_STATE_PrevAndNext(session, eForm, groupId,
					state, orderByComparator, false);
	...
	protected EForm getByF_GID_STATE_PrevAndNext(Session session, EForm eForm,
	 ...
	 */
	@Override
	public List<EForm> findByF_GID_STATE(long groupId, int[] states) {
		return findByF_GID_STATE(groupId, states, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<EForm> findByF_GID_STATE(long groupId, int[] states, int start,
		int end) {
		return findByF_GID_STATE(groupId, states, start, end, null);
	}
	...
	public List<EForm> findByF_GID_STATE(long groupId, int[] states, int start,
		int end, OrderByComparator<EForm> orderByComparator) {
		return findByF_GID_STATE(groupId, states, start, end,
			orderByComparator, true);
	}
	...
	public List<EForm> findByF_GID_STATE(long groupId, int[] states, int start,
		...
		if (states == null) {
			...
			states = ArrayUtil.unique(states);

			Arrays.sort(states);
		}

		if (states.length == 1) {
			return findByF_GID_STATE(groupId, states[0], start, end,
				orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderArgs = new Object[] { groupId, StringUtil.merge(states) };
		}
		else {
			finderArgs = new Object[] {
					groupId, StringUtil.merge(states),
		...
		if (retrieveFromCache) {
			list = (List<EForm>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_F_GID_STATE,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (EForm eForm : list) {
					if ((groupId != eForm.getGroupId()) ||
							!ArrayUtil.contains(states, eForm.getState())) {
						list = null;
		...
		if (list == null) {
			...
			if (states.length > 0) {
				...
				query.append(_FINDER_COLUMN_F_GID_STATE_STATE_7);

				query.append(StringUtil.merge(states));
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_F_GID_STATE,
					finderArgs, list);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_F_GID_STATE,
					finderArgs);
	 ...
	 */
	@Override
	public void removeByF_GID_STATE(long groupId, int state) {
		for (EForm eForm : findByF_GID_STATE(groupId, state, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(eForm);
		}
	}
	 ...
	 */
	@Override
	public int countByF_GID_STATE(long groupId, int state) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_GID_STATE;

		Object[] finderArgs = new Object[] { groupId, state };
	 ...
	 */
	@Override
	public int countByF_GID_STATE(long groupId, int[] states) {
		if (states == null) {
			states = new int[0];
		}
		else if (states.length > 1) {
		...
		Object[] finderArgs = new Object[] { groupId, StringUtil.merge(states) };

		Long count = (Long)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_GID_STATE,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_GID_STATE,
					finderArgs, count);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_GID_STATE,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_F_GID_STATE_GROUPID_2 = "eForm.groupId = ? AND ";
	private static final String _FINDER_COLUMN_F_GID_STATE_STATE_2 = "eForm.state = ?";
	private static final String _FINDER_COLUMN_F_GID_STATE_STATE_7 = "eForm.state IN (";
	...
	public EForm updateImpl(EForm eForm) {
		...
		if (!EFormModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					eFormModelImpl.getGroupId(), eFormModelImpl.getState()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_GID_STATE, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_GID_STATE,
				args);
			...
			if ((eFormModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_GID_STATE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						eFormModelImpl.getOriginalGroupId(),
						eFormModelImpl.getOriginalState()
					};
