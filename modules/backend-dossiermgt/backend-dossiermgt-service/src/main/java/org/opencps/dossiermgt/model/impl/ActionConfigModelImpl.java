...
public class ActionConfigModelImpl extends BaseModelImpl<ActionConfig>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_actionconfig (uuid_ VARCHAR(75) null,actionConfigId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,actionCode VARCHAR(255) null,actionName VARCHAR(512) null,extraForm BOOLEAN,formConfig TEXT null,sampleData TEXT null,insideProcess BOOLEAN,userNote INTEGER,syncType INTEGER,eventType INTEGER,infoType INTEGER,pending BOOLEAN,rollbackable BOOLEAN,notificationType VARCHAR(255) null,documentType VARCHAR(255) null,mappingAction VARCHAR(255) null,dateOption INTEGER)";
