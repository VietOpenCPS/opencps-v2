...
import org.opencps.dossiermgt.service.DossierStatusMappingLocalService;
...
/**
 * Provides the base implementation for the dossier status mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierStatusMappingLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierStatusMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierStatusMappingLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierStatusMappingLocalServiceUtil} to access the dossier status mapping local service.
	 */
	...
	public DossierStatusMapping addDossierStatusMapping(
		...
		return dossierStatusMappingPersistence.update(dossierStatusMapping);
	}
	...
	public DossierStatusMapping createDossierStatusMapping(
		long dossierStatusMappingId) {
		return dossierStatusMappingPersistence.create(dossierStatusMappingId);
	}
	...
	@Override
	public DossierStatusMapping deleteDossierStatusMapping(
		long dossierStatusMappingId) throws PortalException {
		return dossierStatusMappingPersistence.remove(dossierStatusMappingId);
	}
	...
	public DossierStatusMapping deleteDossierStatusMapping(
		DossierStatusMapping dossierStatusMapping) {
		return dossierStatusMappingPersistence.remove(dossierStatusMapping);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierStatusMapping.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierStatusMappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierStatusMappingPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DossierStatusMapping fetchDossierStatusMapping(
		long dossierStatusMappingId) {
		return dossierStatusMappingPersistence.fetchByPrimaryKey(dossierStatusMappingId);
	}
	 ...
	 */
	@Override
	public DossierStatusMapping getDossierStatusMapping(
		long dossierStatusMappingId) throws PortalException {
		return dossierStatusMappingPersistence.findByPrimaryKey(dossierStatusMappingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierStatusMappingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierStatusMapping.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierStatusMappingLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierStatusMapping.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierStatusMappingLocalService.deleteDossierStatusMapping((DossierStatusMapping)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierStatusMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DossierStatusMapping> getDossierStatusMappings(int start,
		int end) {
		return dossierStatusMappingPersistence.findAll(start, end);
	}
	...
	public int getDossierStatusMappingsCount() {
		return dossierStatusMappingPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DossierStatusMapping updateDossierStatusMapping(
		DossierStatusMapping dossierStatusMapping) {
		return dossierStatusMappingPersistence.update(dossierStatusMapping);
	}
	 ...
	 */
	public DossierStatusMappingLocalService getDossierStatusMappingLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierStatusMapping",
			dossierStatusMappingLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierStatusMapping");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierStatusMappingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierStatusMappingPersistence.getDataSource();
	...
	@BeanReference(type = DossierStatusMappingLocalService.class)
	protected DossierStatusMappingLocalService dossierStatusMappingLocalService;
