...
import org.opencps.dossiermgt.service.DocumentTypeLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DocumentTypeLocalServiceImpl}.
 * </p>
 *
 * @author huymq
...
public abstract class DocumentTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DocumentTypeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DocumentTypeLocalServiceUtil} to access the document type local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DocumentType.class,
	...
	public DocumentType fetchDocumentTypeByUuidAndGroupId(String uuid,
		long groupId) {
		return documentTypePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(documentTypeLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return documentTypeLocalService.deleteDocumentType((DocumentType)persistedModel);
	}
	...
	public DocumentType getDocumentTypeByUuidAndGroupId(String uuid,
		...
		return documentTypePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	public DocumentTypeLocalService getDocumentTypeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DocumentType",
			documentTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DocumentType");
	}
	...
	@BeanReference(type = DocumentTypeLocalService.class)
