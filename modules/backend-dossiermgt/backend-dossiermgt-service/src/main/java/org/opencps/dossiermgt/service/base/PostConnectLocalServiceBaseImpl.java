...
import org.opencps.dossiermgt.service.PostConnectLocalService;
...
/**
 * Provides the base implementation for the post connect local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.PostConnectLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class PostConnectLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PostConnectLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.PostConnectLocalServiceUtil} to access the post connect local service.
	 */
	...
	public PostConnect createPostConnect(long postConnectId) {
		return postConnectPersistence.create(postConnectId);
	}
	...
	public PostConnect deletePostConnect(long postConnectId)
		...
		return postConnectPersistence.remove(postConnectId);
	}
	...
	public PostConnect deletePostConnect(PostConnect postConnect) {
		return postConnectPersistence.remove(postConnect);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PostConnect.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return postConnectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return postConnectPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return postConnectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PostConnect fetchPostConnect(long postConnectId) {
		return postConnectPersistence.fetchByPrimaryKey(postConnectId);
	}
	...
	public PostConnect fetchPostConnectByUuidAndGroupId(String uuid,
		long groupId) {
		return postConnectPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public PostConnect getPostConnect(long postConnectId)
		throws PortalException {
		return postConnectPersistence.findByPrimaryKey(postConnectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(postConnectLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PostConnect.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("postConnectId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(postConnectLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PostConnect.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<PostConnect>() {
				@Override
				public void performAction(PostConnect postConnect)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(PostConnect.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return postConnectLocalService.deletePostConnect((PostConnect)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return postConnectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PostConnect> getPostConnectsByUuidAndCompanyId(String uuid,
		long companyId) {
		return postConnectPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<PostConnect> getPostConnectsByUuidAndCompanyId(String uuid,
		...
		return postConnectPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public List<PostConnect> getPostConnects(int start, int end) {
		return postConnectPersistence.findAll(start, end);
	}
	...
	public int getPostConnectsCount() {
		return postConnectPersistence.countAll();
	}
	 ...
	 */
	public PostConnectLocalService getPostConnectLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.PostConnect",
			postConnectLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.PostConnect");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PostConnectLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = postConnectPersistence.getDataSource();
	...
	@BeanReference(type = PostConnectLocalService.class)
	protected PostConnectLocalService postConnectLocalService;
