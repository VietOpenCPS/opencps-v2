...
public class DossierMgtUtils {
	public static JSONObject convertDossierToJSON(Dossier dossier) {
		...
		obj.put(DossierTerm.APPLICANT_ID_DATE, dossier.getApplicantIdDate().getTime());
		...
		obj.put(DossierTerm.SUBMIT_DATE, dossier.getSubmitDate().getTime());
		obj.put(DossierTerm.RECEIVE_DATE, dossier.getReceiveDate().getTime());
		obj.put(DossierTerm.PROCESS_DATE, dossier.getProcessDate().getTime());
		obj.put(DossierTerm.DUE_DATE, dossier.getDueDate().getTime());
		obj.put(DossierTerm.RELEASE_DATE, dossier.getReleaseDate().getTime());
		obj.put(DossierTerm.FINISH_DATE, dossier.getFinishDate().getTime());
		obj.put(DossierTerm.EXTEND_DATE, dossier.getExtendDate().getTime());
