...
public class ActionConfigIndexer extends BaseIndexer<ActionConfig> {
	...
	protected Document doGetDocument(ActionConfig object) throws Exception {
		...
		document.addNumberSortable(ActionConfigTerm.CREATE_DOCUMENT, object.getCreateDocument() ? 1:0);
		document.addTextSortable(ActionConfigTerm.DOCUMENT_NAME, object.getDocumentName());
		document.addTextSortable(ActionConfigTerm.DOCUMENT_CODE, object.getDocumentCode());
		document.addNumberSortable(ActionConfigTerm.SEND_DOCUMENT, object.getSendDocument());
