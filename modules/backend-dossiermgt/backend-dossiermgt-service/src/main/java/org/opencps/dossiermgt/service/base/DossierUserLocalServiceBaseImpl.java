...
import org.opencps.dossiermgt.service.DossierUserLocalService;
...
/**
 * Provides the base implementation for the dossier user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierUserLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierUserLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierUserLocalServiceUtil} to access the dossier user local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierUser.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return dossierUserPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierUserLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierUserLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierUserLocalService.deleteDossierUser((DossierUser)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DossierUser> getDossierUsers(int start, int end) {
		return dossierUserPersistence.findAll(start, end);
	}
	...
	public int getDossierUsersCount() {
		return dossierUserPersistence.countAll();
	}
	 ...
	 */
	public DossierUserLocalService getDossierUserLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierUser",
			dossierUserLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierUser");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierUserLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierUserPersistence.getDataSource();
	...
	@BeanReference(type = DossierUserLocalService.class)
	protected DossierUserLocalService dossierUserLocalService;
