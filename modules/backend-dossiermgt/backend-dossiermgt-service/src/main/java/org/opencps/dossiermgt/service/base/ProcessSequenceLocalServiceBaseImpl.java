...
import org.opencps.dossiermgt.service.ProcessSequenceLocalService;
...
/**
 * Provides the base implementation for the process sequence local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ProcessSequenceLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ProcessSequenceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProcessSequenceLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ProcessSequenceLocalServiceUtil} to access the process sequence local service.
	 */
	...
	public ProcessSequence createProcessSequence(long processSequenceId) {
		return processSequencePersistence.create(processSequenceId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProcessSequence.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return processSequencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return processSequencePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProcessSequence fetchProcessSequence(long processSequenceId) {
		return processSequencePersistence.fetchByPrimaryKey(processSequenceId);
	}
	...
	public ProcessSequence fetchProcessSequenceByUuidAndGroupId(String uuid,
		long groupId) {
		return processSequencePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProcessSequence getProcessSequence(long processSequenceId)
		throws PortalException {
		return processSequencePersistence.findByPrimaryKey(processSequenceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(processSequenceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProcessSequence.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("processSequenceId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(processSequenceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProcessSequence.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ProcessSequence>() {
				@Override
				public void performAction(ProcessSequence processSequence)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ProcessSequence.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return processSequenceLocalService.deleteProcessSequence((ProcessSequence)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return processSequencePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProcessSequence> getProcessSequencesByUuidAndCompanyId(
		...
		return processSequencePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProcessSequence> getProcessSequencesByUuidAndCompanyId(
		...
		return processSequencePersistence.findByUuid_C(uuid, companyId, start,
	...
	public ProcessSequence getProcessSequenceByUuidAndGroupId(String uuid,
		...
		return processSequencePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProcessSequence> getProcessSequences(int start, int end) {
		return processSequencePersistence.findAll(start, end);
	}
	...
	public int getProcessSequencesCount() {
		return processSequencePersistence.countAll();
	}
	 ...
	 */
	public ProcessSequenceLocalService getProcessSequenceLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ProcessSequence",
			processSequenceLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ProcessSequence");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcessSequenceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = processSequencePersistence.getDataSource();
	...
	@BeanReference(type = ProcessSequenceLocalService.class)
	protected ProcessSequenceLocalService processSequenceLocalService;
