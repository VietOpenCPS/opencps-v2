...
import org.opencps.dossiermgt.service.ActionConfigLocalService;
...
/**
 * Provides the base implementation for the action config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ActionConfigLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ActionConfigLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ActionConfigLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ActionConfigLocalServiceUtil} to access the action config local service.
	 */
	...
	public ActionConfig createActionConfig(long actionConfigId) {
		return actionConfigPersistence.create(actionConfigId);
	}
	...
	public ActionConfig deleteActionConfig(long actionConfigId)
		...
		return actionConfigPersistence.remove(actionConfigId);
	}
	...
	public ActionConfig deleteActionConfig(ActionConfig actionConfig) {
		return actionConfigPersistence.remove(actionConfig);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ActionConfig.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return actionConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return actionConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ActionConfig fetchActionConfig(long actionConfigId) {
		return actionConfigPersistence.fetchByPrimaryKey(actionConfigId);
	}
	...
	public ActionConfig fetchActionConfigByUuidAndGroupId(String uuid,
		long groupId) {
		return actionConfigPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionConfig getActionConfig(long actionConfigId)
		throws PortalException {
		return actionConfigPersistence.findByPrimaryKey(actionConfigId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(actionConfigLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ActionConfig.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("actionConfigId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(actionConfigLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ActionConfig.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ActionConfig>() {
				@Override
				public void performAction(ActionConfig actionConfig)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ActionConfig.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return actionConfigLocalService.deleteActionConfig((ActionConfig)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return actionConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ActionConfig> getActionConfigsByUuidAndCompanyId(String uuid,
		long companyId) {
		return actionConfigPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ActionConfig> getActionConfigsByUuidAndCompanyId(String uuid,
		...
		return actionConfigPersistence.findByUuid_C(uuid, companyId, start,
	...
	public ActionConfig getActionConfigByUuidAndGroupId(String uuid,
		...
		return actionConfigPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ActionConfig> getActionConfigs(int start, int end) {
		return actionConfigPersistence.findAll(start, end);
	}
	...
	public int getActionConfigsCount() {
		return actionConfigPersistence.countAll();
	}
	 ...
	 */
	public ActionConfigLocalService getActionConfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ActionConfig",
			actionConfigLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ActionConfig");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ActionConfigLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = actionConfigPersistence.getDataSource();
	...
	@BeanReference(type = ActionConfigLocalService.class)
	protected ActionConfigLocalService actionConfigLocalService;
