...
import org.opencps.dossiermgt.model.impl.DynamicReportImpl;
import org.opencps.dossiermgt.model.impl.DynamicReportModelImpl;
 ...
 * @see org.opencps.dossiermgt.service.persistence.DynamicReportUtil
 * @generated
 */
@ProviderType
public class DynamicReportPersistenceImpl extends BasePersistenceImpl<DynamicReport>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			DynamicReportModelImpl.FINDER_CACHE_ENABLED,
			DynamicReportImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			DynamicReportModelImpl.FINDER_CACHE_ENABLED,
			DynamicReportImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByUuid", new String[] { String.class.getName() },
			DynamicReportModelImpl.UUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			DynamicReportModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DynamicReport> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<DynamicReport> findByUuid(String uuid, int start, int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DynamicReport dynamicReport : list) {
					if (!Objects.equals(uuid, dynamicReport.getUuid())) {
						list = null;
	...
	public DynamicReport findByUuid_First(String uuid,
		...
		DynamicReport dynamicReport = fetchByUuid_First(uuid, orderByComparator);
	...
	public DynamicReport fetchByUuid_First(String uuid,
		OrderByComparator<DynamicReport> orderByComparator) {
		List<DynamicReport> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public DynamicReport findByUuid_Last(String uuid,
		OrderByComparator<DynamicReport> orderByComparator)
		throws NoSuchDynamicReportException {
		DynamicReport dynamicReport = fetchByUuid_Last(uuid, orderByComparator);
	...
	public DynamicReport fetchByUuid_Last(String uuid,
		...
		List<DynamicReport> list = findByUuid(uuid, count - 1, count,
				orderByComparator);
	...
	public DynamicReport[] findByUuid_PrevAndNext(long dynamicReportId,
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, dynamicReport, uuid,
					orderByComparator, true);

			array[1] = dynamicReport;

			array[2] = getByUuid_PrevAndNext(session, dynamicReport, uuid,
	...
	protected DynamicReport getByUuid_PrevAndNext(Session session,
		DynamicReport dynamicReport, String uuid,
	...
	public void removeByUuid(String uuid) {
		for (DynamicReport dynamicReport : findByUuid(uuid, QueryUtil.ALL_POS,
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "dynamicReport.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "dynamicReport.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(dynamicReport.uuid IS NULL OR dynamicReport.uuid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			DynamicReportModelImpl.FINDER_CACHE_ENABLED,
			DynamicReportImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] { String.class.getName(), Long.class.getName() },
			DynamicReportModelImpl.UUID_COLUMN_BITMASK |
			DynamicReportModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			DynamicReportModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public DynamicReport findByUUID_G(String uuid, long groupId)
		throws NoSuchDynamicReportException {
		DynamicReport dynamicReport = fetchByUUID_G(uuid, groupId);
	...
	public DynamicReport fetchByUUID_G(String uuid, long groupId,
		...
		if (result instanceof DynamicReport) {
			...
			if (!Objects.equals(uuid, dynamicReport.getUuid()) ||
					(groupId != dynamicReport.getGroupId())) {
				result = null;
			}
		}
	...
	public DynamicReport removeByUUID_G(String uuid, long groupId)
		throws NoSuchDynamicReportException {
		DynamicReport dynamicReport = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_1 = "dynamicReport.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 = "dynamicReport.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(dynamicReport.uuid IS NULL OR dynamicReport.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_G_GROUPID_2 = "dynamicReport.groupId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			DynamicReportModelImpl.FINDER_CACHE_ENABLED,
			DynamicReportImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() },
			DynamicReportModelImpl.UUID_COLUMN_BITMASK |
			DynamicReportModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(DynamicReportModelImpl.ENTITY_CACHE_ENABLED,
			DynamicReportModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DynamicReport> findByUuid_C(String uuid, long companyId) {
	...
	public List<DynamicReport> findByUuid_C(String uuid, long companyId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DynamicReport dynamicReport : list) {
					if (!Objects.equals(uuid, dynamicReport.getUuid()) ||
							(companyId != dynamicReport.getCompanyId())) {
						list = null;
	...
	public DynamicReport findByUuid_C_First(String uuid, long companyId,
		OrderByComparator<DynamicReport> orderByComparator)
		throws NoSuchDynamicReportException {
		DynamicReport dynamicReport = fetchByUuid_C_First(uuid, companyId,
				orderByComparator);
	...
	public DynamicReport fetchByUuid_C_First(String uuid, long companyId,
		OrderByComparator<DynamicReport> orderByComparator) {
		List<DynamicReport> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	...
	public DynamicReport findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator<DynamicReport> orderByComparator)
		throws NoSuchDynamicReportException {
		DynamicReport dynamicReport = fetchByUuid_C_Last(uuid, companyId,
				orderByComparator);
	...
	public DynamicReport fetchByUuid_C_Last(String uuid, long companyId,
		...
		List<DynamicReport> list = findByUuid_C(uuid, companyId, count - 1,
	...
	public DynamicReport[] findByUuid_C_PrevAndNext(long dynamicReportId,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, dynamicReport, uuid,
					companyId, orderByComparator, true);

			array[1] = dynamicReport;

			array[2] = getByUuid_C_PrevAndNext(session, dynamicReport, uuid,
	...
	protected DynamicReport getByUuid_C_PrevAndNext(Session session,
		DynamicReport dynamicReport, String uuid, long companyId,
		OrderByComparator<DynamicReport> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (DynamicReport dynamicReport : findByUuid_C(uuid, companyId,
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "dynamicReport.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "dynamicReport.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(dynamicReport.uuid IS NULL OR dynamicReport.uuid = '') AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "dynamicReport.companyId = ?";
	...
	public void cacheResult(DynamicReport dynamicReport) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] { dynamicReport.getUuid(), dynamicReport.getGroupId() },
			dynamicReport);
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
				dynamicReportModelImpl.getUuid(),
	...
	protected void clearUniqueFindersCache(
		...
		if ((dynamicReportModelImpl.getColumnBitmask() &
			...
			Object[] args = new Object[] {
					dynamicReportModelImpl.getOriginalUuid(),
	...
	public DynamicReport updateImpl(DynamicReport dynamicReport) {
		...
		if (Validator.isNull(dynamicReport.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!DynamicReportModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { dynamicReportModelImpl.getUuid() };
			...
			args = new Object[] {
					dynamicReportModelImpl.getUuid(),
					dynamicReportModelImpl.getCompanyId()
				};
			...
			if ((dynamicReportModelImpl.getColumnBitmask() &
				...
				args = new Object[] { dynamicReportModelImpl.getUuid() };
			...
			if ((dynamicReportModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						dynamicReportModelImpl.getOriginalUuid(),
						dynamicReportModelImpl.getOriginalCompanyId()
					};
