...
public class NotarizationCounterNumberGenerator {
	...
	public static String generateCounterNumber(long groupId, long companyId, long notarizationId,
		...
		Notarization notarization = NotarizationLocalServiceUtil.fetchNotarization(notarizationId);
		long dossierId = notarization.getDossierId();
		Dossier dossier = DossierLocalServiceUtil.fetchDossier(dossierId);
				
		String notarizationNumber = StringPool.BLANK;
...
//						System.out.println(tmp);
			...
			notarizationNumber = seriNumberPattern;
		}
