...
public class DossierSyncPersistenceImpl extends BasePersistenceImpl<DossierSync>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_DID = new FinderPath(DossierSyncModelImpl.ENTITY_CACHE_ENABLED,
			DossierSyncModelImpl.FINDER_CACHE_ENABLED, DossierSyncImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_DID = new FinderPath(DossierSyncModelImpl.ENTITY_CACHE_ENABLED,
			DossierSyncModelImpl.FINDER_CACHE_ENABLED, DossierSyncImpl.class,
	...
	public DossierSync findByG_DID_First(long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator)
		throws NoSuchDossierSyncException {
		DossierSync dossierSync = fetchByG_DID_First(groupId, dossierId,
				orderByComparator);
	...
	public DossierSync fetchByG_DID_First(long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator) {
		List<DossierSync> list = findByG_DID(groupId, dossierId, 0, 1,
				orderByComparator);
	...
	public DossierSync findByG_DID_Last(long groupId, long dossierId,
		OrderByComparator<DossierSync> orderByComparator)
		throws NoSuchDossierSyncException {
		DossierSync dossierSync = fetchByG_DID_Last(groupId, dossierId,
				orderByComparator);
	...
	public DossierSync fetchByG_DID_Last(long groupId, long dossierId,
		...
		List<DossierSync> list = findByG_DID(groupId, dossierId, count - 1,
	...
	public DossierSync[] findByG_DID_PrevAndNext(long DossierSyncId,
		...
		try {
			...
			array[0] = getByG_DID_PrevAndNext(session, dossierSync, groupId,
					dossierId, orderByComparator, true);

			array[1] = dossierSync;

			array[2] = getByG_DID_PrevAndNext(session, dossierSync, groupId,
	...
	protected DossierSync getByG_DID_PrevAndNext(Session session,
	...
	public void removeByG_DID(long groupId, long dossierId) {
		for (DossierSync dossierSync : findByG_DID(groupId, dossierId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dossierSync);
		}
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_STS = new FinderPath(DossierSyncModelImpl.ENTITY_CACHE_ENABLED,
			DossierSyncModelImpl.FINDER_CACHE_ENABLED, DossierSyncImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_STS = new FinderPath(DossierSyncModelImpl.ENTITY_CACHE_ENABLED,
			DossierSyncModelImpl.FINDER_CACHE_ENABLED, DossierSyncImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBySTS",
			new String[] { Integer.class.getName() },
			DossierSyncModelImpl.STATE_COLUMN_BITMASK |
			DossierSyncModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_STS = new FinderPath(DossierSyncModelImpl.ENTITY_CACHE_ENABLED,
			DossierSyncModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBySTS",
			new String[] { Integer.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_STS = new FinderPath(DossierSyncModelImpl.ENTITY_CACHE_ENABLED,
			DossierSyncModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DossierSync> findBySTS(int state) {
		return findBySTS(state, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<DossierSync> findBySTS(int state, int start, int end) {
		return findBySTS(state, start, end, null);
	}
	...
	public List<DossierSync> findBySTS(int state, int start, int end,
		OrderByComparator<DossierSync> orderByComparator) {
		return findBySTS(state, start, end, orderByComparator, true);
	}
	...
	public List<DossierSync> findBySTS(int state, int start, int end,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_STS_STATE_2);
	...
	public DossierSync findBySTS_First(int state,
		OrderByComparator<DossierSync> orderByComparator)
		throws NoSuchDossierSyncException {
		DossierSync dossierSync = fetchBySTS_First(state, orderByComparator);
	...
	public DossierSync fetchBySTS_First(int state,
		OrderByComparator<DossierSync> orderByComparator) {
		List<DossierSync> list = findBySTS(state, 0, 1, orderByComparator);
	...
	public DossierSync findBySTS_Last(int state,
		OrderByComparator<DossierSync> orderByComparator)
		throws NoSuchDossierSyncException {
		DossierSync dossierSync = fetchBySTS_Last(state, orderByComparator);
	...
	public DossierSync fetchBySTS_Last(int state,
		OrderByComparator<DossierSync> orderByComparator) {
		int count = countBySTS(state);

		if (count == 0) {
			return null;
		}

		List<DossierSync> list = findBySTS(state, count - 1, count,
				orderByComparator);
	...
	public DossierSync[] findBySTS_PrevAndNext(long DossierSyncId, int state,
		...
		try {
			...
			array[0] = getBySTS_PrevAndNext(session, dossierSync, state,
					orderByComparator, true);

			array[1] = dossierSync;

			array[2] = getBySTS_PrevAndNext(session, dossierSync, state,
					orderByComparator, false);
	...
	protected DossierSync getBySTS_PrevAndNext(Session session,
		DossierSync dossierSync, int state,
		OrderByComparator<DossierSync> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<DossierSync> findBySTS(int[] states) {
		return findBySTS(states, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<DossierSync> findBySTS(int[] states, int start, int end) {
		return findBySTS(states, start, end, null);
	}
	...
	public List<DossierSync> findBySTS(int[] states, int start, int end,
		OrderByComparator<DossierSync> orderByComparator) {
		return findBySTS(states, start, end, orderByComparator, true);
	}
	...
	public List<DossierSync> findBySTS(int[] states, int start, int end,
		...
		if (states.length == 1) {
			return findBySTS(states[0], start, end, orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderArgs = new Object[] { StringUtil.merge(states) };
		}
		else {
			finderArgs = new Object[] {
					StringUtil.merge(states),
		...
		if (retrieveFromCache) {
			list = (List<DossierSync>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_STS,
					finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (DossierSync dossierSync : list) {
					if (!ArrayUtil.contains(states, dossierSync.getState())) {
						list = null;
		...
		if (list == null) {
			...
			if (states.length > 0) {
				...
				query.append(_FINDER_COLUMN_STS_STATE_7);
	...
	public void removeBySTS(int state) {
		for (DossierSync dossierSync : findBySTS(state, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(dossierSync);
		}
	}
	...
	public int countBySTS(int[] states) {
		...
		Object[] finderArgs = new Object[] { StringUtil.merge(states) };
	...
	private static final String _FINDER_COLUMN_STS_STATE_2 = "dossierSync.state = ?";
	private static final String _FINDER_COLUMN_STS_STATE_7 = "dossierSync.state IN (";
