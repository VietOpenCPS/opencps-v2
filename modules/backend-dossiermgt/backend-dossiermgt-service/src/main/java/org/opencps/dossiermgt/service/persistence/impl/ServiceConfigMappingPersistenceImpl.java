...
import org.opencps.dossiermgt.exception.NoSuchServiceConfigMappingException;
import org.opencps.dossiermgt.model.ServiceConfigMapping;
import org.opencps.dossiermgt.model.impl.ServiceConfigMappingImpl;
import org.opencps.dossiermgt.model.impl.ServiceConfigMappingModelImpl;
 ...
 * @see org.opencps.dossiermgt.service.persistence.ServiceConfigMappingUtil
 * @generated
 */
@ProviderType
public class ServiceConfigMappingPersistenceImpl extends BasePersistenceImpl<ServiceConfigMapping>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_SERVICECODE =
		new FinderPath(ServiceConfigMappingModelImpl.ENTITY_CACHE_ENABLED,
			ServiceConfigMappingModelImpl.FINDER_CACHE_ENABLED,
			ServiceConfigMappingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_ServiceCode",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_SERVICECODE =
		new FinderPath(ServiceConfigMappingModelImpl.ENTITY_CACHE_ENABLED,
			ServiceConfigMappingModelImpl.FINDER_CACHE_ENABLED,
			ServiceConfigMappingImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_ServiceCode",
			new String[] { Long.class.getName(), String.class.getName() },
			ServiceConfigMappingModelImpl.GROUPID_COLUMN_BITMASK |
			ServiceConfigMappingModelImpl.SERVICECODE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_SERVICECODE = new FinderPath(ServiceConfigMappingModelImpl.ENTITY_CACHE_ENABLED,
			ServiceConfigMappingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_ServiceCode",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public List<ServiceConfigMapping> findByG_ServiceCode(long groupId,
		String serviceCode) {
		return findByG_ServiceCode(groupId, serviceCode, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ServiceConfigMapping> findByG_ServiceCode(long groupId,
		...
		return findByG_ServiceCode(groupId, serviceCode, start, end, null);
	}
	...
	public List<ServiceConfigMapping> findByG_ServiceCode(long groupId,
		String serviceCode, int start, int end,
		OrderByComparator<ServiceConfigMapping> orderByComparator) {
		return findByG_ServiceCode(groupId, serviceCode, start, end,
	...
	public List<ServiceConfigMapping> findByG_ServiceCode(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_SERVICECODE;
			finderArgs = new Object[] { groupId, serviceCode };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_SERVICECODE;
			finderArgs = new Object[] {
					groupId, serviceCode,
				...
				for (ServiceConfigMapping serviceConfigMapping : list) {
					if ((groupId != serviceConfigMapping.getGroupId()) ||
							!Objects.equals(serviceCode,
								serviceConfigMapping.getServiceCode())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_SERVICECODE_GROUPID_2);

			boolean bindServiceCode = false;

			if (serviceCode == null) {
				query.append(_FINDER_COLUMN_G_SERVICECODE_SERVICECODE_1);
			}
			else if (serviceCode.equals("")) {
				query.append(_FINDER_COLUMN_G_SERVICECODE_SERVICECODE_3);
			}
			else {
				bindServiceCode = true;

				query.append(_FINDER_COLUMN_G_SERVICECODE_SERVICECODE_2);
			}
	...
	public ServiceConfigMapping findByG_ServiceCode_First(long groupId,
		...
		OrderByComparator<ServiceConfigMapping> orderByComparator)
		throws NoSuchServiceConfigMappingException {
		ServiceConfigMapping serviceConfigMapping = fetchByG_ServiceCode_First(groupId,
	...
	public ServiceConfigMapping fetchByG_ServiceCode_First(long groupId,
		String serviceCode,
		OrderByComparator<ServiceConfigMapping> orderByComparator) {
		List<ServiceConfigMapping> list = findByG_ServiceCode(groupId,
	...
	public ServiceConfigMapping findByG_ServiceCode_Last(long groupId,
		...
		OrderByComparator<ServiceConfigMapping> orderByComparator)
		throws NoSuchServiceConfigMappingException {
		ServiceConfigMapping serviceConfigMapping = fetchByG_ServiceCode_Last(groupId,
				serviceCode, orderByComparator);
	...
	public ServiceConfigMapping fetchByG_ServiceCode_Last(long groupId,
		String serviceCode,
		OrderByComparator<ServiceConfigMapping> orderByComparator) {
		int count = countByG_ServiceCode(groupId, serviceCode);
	...
	public ServiceConfigMapping[] findByG_ServiceCode_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_ServiceCode_PrevAndNext(session,
					serviceConfigMapping, groupId, serviceCode,
					orderByComparator, true);

			array[1] = serviceConfigMapping;

			array[2] = getByG_ServiceCode_PrevAndNext(session,
					serviceConfigMapping, groupId, serviceCode,
	...
	protected ServiceConfigMapping getByG_ServiceCode_PrevAndNext(
		Session session, ServiceConfigMapping serviceConfigMapping,
	...
	public void removeByG_ServiceCode(long groupId, String serviceCode) {
		for (ServiceConfigMapping serviceConfigMapping : findByG_ServiceCode(
				groupId, serviceCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(serviceConfigMapping);
		}
	}
	...
	public int countByG_ServiceCode(long groupId, String serviceCode) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_G_SERVICECODE;
	...
	private static final String _FINDER_COLUMN_G_SERVICECODE_GROUPID_2 = "serviceConfigMapping.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_SERVICECODE_SERVICECODE_1 = "serviceConfigMapping.serviceCode IS NULL";
	private static final String _FINDER_COLUMN_G_SERVICECODE_SERVICECODE_2 = "serviceConfigMapping.serviceCode = ?";
	private static final String _FINDER_COLUMN_G_SERVICECODE_SERVICECODE_3 = "(serviceConfigMapping.serviceCode IS NULL OR serviceConfigMapping.serviceCode = '')";
	...
	public ServiceConfigMapping updateImpl(
		...
		if (!ServiceConfigMappingModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					serviceConfigMappingModelImpl.getGroupId(),
					serviceConfigMappingModelImpl.getServiceCode()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_G_SERVICECODE, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_SERVICECODE,
				args);
			...
			if ((serviceConfigMappingModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_SERVICECODE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						serviceConfigMappingModelImpl.getOriginalGroupId(),
						serviceConfigMappingModelImpl.getOriginalServiceCode()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_G_SERVICECODE,
					args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_SERVICECODE,
					args);
