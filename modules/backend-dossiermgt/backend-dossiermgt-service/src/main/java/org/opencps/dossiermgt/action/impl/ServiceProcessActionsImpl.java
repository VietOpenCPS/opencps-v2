...
public class ServiceProcessActionsImpl implements ServiceProcessActions {
	...
	@Override
	public JSONObject getServiceProcesses(
		...
		hits = ServiceProcessLocalServiceUtil.searchLucene(
	...
	@Override
	public ServiceProcess getServiceProcessDetail(long serviceProcessId)
		throws PortalException {

		return ServiceProcessLocalServiceUtil.getServiceProcess(
			serviceProcessId);
	}
	...
	public ServiceProcess updateServiceProcess(
		...
		return ServiceProcessLocalServiceUtil.updateServiceProcess(
			groupId, serviceProcessId, processNo, processName, description,
			durationCount, durationUnit, counter, generateDossierNo,
			dossierNoPattern, generateDueDate, dueDatePattern, generatePassword,
			directNotification, serverNo, paymentFee, dossierGroupPattern,
			context);
	}

	@Override
	public ServiceProcess removeServiceProcess(
		long userId, long groupId, long serviceProcessId,
		ServiceContext serviceContext)
		throws PortalException {

		boolean flagProRole = deleteAllProcessRole(
			userId, groupId, serviceProcessId, serviceContext);
		boolean flagStep = deleteAllProcessStep(
			userId, groupId, serviceProcessId, serviceContext);
		boolean flagProAction = deleteAllProcessAction(
			userId, groupId, serviceProcessId, serviceContext);
		boolean flagSequence = deleteAllProcessSequence(
			userId, groupId, serviceProcessId, serviceContext);

		if (flagProRole && flagStep && flagProAction && flagSequence) {
			return ServiceProcessLocalServiceUtil.removeServiceProcess(
				serviceProcessId, groupId);
		}
		return null;
	}

	@Override
	public JSONObject getServiceProcessRoles(long serviceProcessId)
		throws PortalException {
	...
	public ServiceProcessRole updateServiceProcessRole(
		...
		return ServiceProcessRoleLocalServiceUtil.updateServiceProcessRole(
			groupId, serviceProcessId, roleId, moderator, condition, roleCode,
			roleName);
	}
	...
	public ServiceProcessRole removeServiceProcessRole(
		...
		return ServiceProcessRoleLocalServiceUtil.removeServiceProcessRole(
	...
	public JSONObject getProcessSteps(
		...
		hits = ProcessStepLocalServiceUtil.searchLucene(
			params, sorts, start, end, searchContext);
	...
	public ProcessStep updateProcessStep(
		...
		ProcessStep step = ProcessStepLocalServiceUtil.fetchBySC_GID(
			oldStepCode, groupId, serviceProcessId);
		...
		return ProcessStepLocalServiceUtil.updateProcessStep(
			groupId, processStepId, newStepCode, stepName, serviceProcessId,
			sequenceNo, dossierStatus, dossierSubStatus, durationCount,
			customProcessUrl, stepInstruction, briefNote, editable, lockState,
			checkInput, context);
	}
	...
	public ProcessStep deleteProcessStep(
		...
		return ProcessStepLocalServiceUtil.deleteProcessStep(
			step.getPrimaryKey());
	}

	@Override
	public JSONObject getProcessStepRoles(long processStepId)
		throws PortalException {
	...
	public ProcessStepRole updateProcessStepRole(
		...
		return ProcessStepRoleLocalServiceUtil.updateProcessStepRole(
			processStepId, roleId, moderator, condition, roleCode, roleName);
	}
	...
	public ProcessStepRole deleteProcessStepRole(
		...
		return ProcessStepRoleLocalServiceUtil.removeProcessStepRole(
	...
	public JSONObject getProcessActions(
		...
		hits = ProcessActionLocalServiceUtil.searchLucene(
			params, sorts, start, end, searchContext);
		count =
	...
	@Override
	public ProcessAction getProcessActionDetail(long processActionId)
		throws PortalException {
	...
	public ProcessAction updateProcessAction(
		...
		return ProcessActionLocalServiceUtil.updateProcessAction(
			groupId, processActionId, serviceProcessId, preStepCode,
			postStepCode, autoEvent, preCondition, actionCode, actionName,
			allowAssignUser, assignUserId, requestPayment, paymentFee,
			createDossierFiles, returnDossierFiles, makeBriefNote,
	...
	public ProcessAction deleteProcessAction(long processActionId)
		...
		return ProcessActionLocalServiceUtil.removeProcessAction(
			processActionId);
	}
	...
	public ProcessAction updateProcessAction(
		...
		return ProcessActionLocalServiceUtil.updateProcessAction(
			...
			allowAssignUser, assignUserId, requestPayment, paymentFee,
			createDossierFiles, returnDossierFiles, makeBriefNote,
			syncActionCode, rollbackable, createDossierNo, eSignature,
			signatureType, configNote, dossierTemplateNo, context);
	}

	@Override
	public ServiceProcess getServiceProcessByCode(
		long groupId, String serviceCode, String govAgencyCode,
		String dossierTemplateNo)
		throws PortalException {

		return ServiceProcessLocalServiceUtil.getServiceByCode(
			groupId, serviceCode, govAgencyCode, dossierTemplateNo);
	}

	@Override
	public long updateServiceProcessDB(
		...
		String dossierGroupPattern, ServiceContext serviceContext)
		throws PortalException {

		ServiceProcess service =
			ServiceProcessLocalServiceUtil.updateServiceProcessDB(
				userId, groupId, processNo, processName, description,
				durationCount, durationUnit, generatePassword, serverNo,
				serverName, dossierNoPattern, dueDatePattern,
				dossierGroupPattern, serviceContext);
	...
	@Override
	public void updateServiceProcessRoleDB(
		long userId, long groupId, long serviceProcessId, long roleId,
		String roleCode, String roleName, boolean moderator, String condition,
		ServiceContext serviceContext) {

		ServiceProcessRoleLocalServiceUtil.updateServiceProcessRoleDB(
			groupId, serviceProcessId, roleId, roleCode, roleName, moderator,
			condition, serviceContext);
	}

	@Override
	public long updateProcessStepDB(
		...
		Integer checkInput, ServiceContext serviceContext)
		throws PortalException {

		ProcessStep processStep =
			ProcessStepLocalServiceUtil.updateProcessStepDB(
				userId, groupId, serviceProcessId, stepCode, stepName,
				sequenceNo, groupName, dossierStatus, dossierSubStatus,
				durationCount, instructionNote, briefNote, roleAsStep,
				checkInput, serviceContext);
		if (processStep != null) {
	...
	@Override
	public void updateProcessStepRoleDB(
		long userId, long groupId, long processStepId, long roleId,
		String roleCode, String roleName, boolean moderator, String condition,
		ServiceContext serviceContext) {

		ProcessStepRoleLocalServiceUtil.updateProcessStepRoleDB(
			userId, groupId, processStepId, roleId, roleCode, roleName,
			moderator, condition, serviceContext);
	}

	@Override
	public void updateProcessActionDB(
		...
		ProcessActionLocalServiceUtil.updateProcessActionDB(
			userId, groupId, serviceProcessId, actionCode, actionName,
	...
	@Override
	public boolean deleteAllProcessAction(
		long userId, long groupId, long serviceProcessId,
		ServiceContext serviceContext) {
	...
	@Override
	public boolean deleteAllProcessRole(
		long userId, long groupId, long serviceProcessId,
		ServiceContext serviceContext) {
	...
	private static Log _log =
		LogFactoryUtil.getLog(ServiceProcessActionsImpl.class);

	@Override
	public boolean deleteAllProcessStep(
		long userId, long groupId, long serviceProcessId,
		ServiceContext serviceContext) {
	...
	@Override
	public boolean deleteAllProcessSequence(
		long userId, long groupId, long serviceProcessId,
		ServiceContext serviceContext) {
	...
	@Override
	public void updateProcessSequenceDB(
		...
		ProcessSequenceLocalServiceUtil.updateProcessSequenceDB(
			userId, groupId, serviceProcessId, sequenceNo, sequenceName,
