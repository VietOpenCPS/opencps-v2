...
import org.opencps.dossiermgt.service.base.ServiceConfigMappingLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link org.opencps.dossiermgt.service.ServiceConfigMappingLocalService} interface.
 *
 * <p>
...
public class ServiceConfigMappingLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link org.opencps.dossiermgt.service.ServiceConfigMappingLocalServiceUtil} to access the service config mapping local service.
	 */
	...
	public ServiceConfigMapping addServiceConfigMaping(long groupId, String serviceConfigCode, String serviceConfigName,
		...
		if (paymentFeeInfoObj != null) {
			for (int i = 0; i < paymentFeeInfoObj.length(); i++) {
				...
				paymentFeeInfoLocalService.addPaymentFeeInfo(groupId, serviceConfigMappingId, paymentFeeCode,
						paymentFeeName, type, amount, context);
