...
import org.opencps.dossiermgt.service.PublishQueueLocalService;
...
/**
 * Provides the base implementation for the publish queue local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.PublishQueueLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class PublishQueueLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements PublishQueueLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.PublishQueueLocalServiceUtil} to access the publish queue local service.
	 */
	...
	public PublishQueue addPublishQueue(PublishQueue publishQueue) {
		...
		return publishQueuePersistence.update(publishQueue);
	}
	...
	public PublishQueue createPublishQueue(long publishQueueId) {
		return publishQueuePersistence.create(publishQueueId);
	}
	...
	public PublishQueue deletePublishQueue(long publishQueueId)
		...
		return publishQueuePersistence.remove(publishQueueId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(PublishQueue.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return publishQueuePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return publishQueuePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public PublishQueue fetchPublishQueue(long publishQueueId) {
		return publishQueuePersistence.fetchByPrimaryKey(publishQueueId);
	}
	...
	public PublishQueue fetchPublishQueueByUuidAndGroupId(String uuid,
		long groupId) {
		return publishQueuePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public PublishQueue getPublishQueue(long publishQueueId)
		throws PortalException {
		return publishQueuePersistence.findByPrimaryKey(publishQueueId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(publishQueueLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PublishQueue.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("publishQueueId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(publishQueueLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PublishQueue.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return publishQueueLocalService.deletePublishQueue((PublishQueue)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return publishQueuePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public PublishQueue getPublishQueueByUuidAndGroupId(String uuid,
		...
		return publishQueuePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<PublishQueue> getPublishQueues(int start, int end) {
		return publishQueuePersistence.findAll(start, end);
	}
	...
	public int getPublishQueuesCount() {
		return publishQueuePersistence.countAll();
	}
	 ...
	 */
	public PublishQueueLocalService getPublishQueueLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.PublishQueue",
			publishQueueLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.PublishQueue");
	}
	...
	public String getOSGiServiceIdentifier() {
		return PublishQueueLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = publishQueuePersistence.getDataSource();
	...
	@BeanReference(type = PublishQueueLocalService.class)
	protected PublishQueueLocalService publishQueueLocalService;
