...
import org.opencps.dossiermgt.service.MenuRoleLocalService;
...
/**
 * Provides the base implementation for the menu role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.MenuRoleLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class MenuRoleLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MenuRoleLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.MenuRoleLocalServiceUtil} to access the menu role local service.
	 */
	...
	public MenuRole deleteMenuRole(MenuRole menuRole) {
		return menuRolePersistence.remove(menuRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MenuRole.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return menuRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return menuRolePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return menuRolePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return menuRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(menuRoleLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(menuRoleLocalService);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return menuRoleLocalService.deleteMenuRole((MenuRole)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return menuRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MenuRole> getMenuRoles(int start, int end) {
		return menuRolePersistence.findAll(start, end);
	}
	...
	public int getMenuRolesCount() {
		return menuRolePersistence.countAll();
	}
	 ...
	 */
	public MenuRoleLocalService getMenuRoleLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.MenuRole",
			menuRoleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.MenuRole");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MenuRoleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = menuRolePersistence.getDataSource();
	...
	@BeanReference(type = MenuRoleLocalService.class)
	protected MenuRoleLocalService menuRoleLocalService;
