...
import org.opencps.dossiermgt.service.MenuConfigLocalService;
...
/**
 * Provides the base implementation for the menu config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.MenuConfigLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class MenuConfigLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements MenuConfigLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.MenuConfigLocalServiceUtil} to access the menu config local service.
	 */
	...
	public MenuConfig addMenuConfig(MenuConfig menuConfig) {
		...
		return menuConfigPersistence.update(menuConfig);
	}
	...
	public MenuConfig createMenuConfig(long menuConfigId) {
		return menuConfigPersistence.create(menuConfigId);
	}
	...
	public MenuConfig deleteMenuConfig(long menuConfigId)
		...
		return menuConfigPersistence.remove(menuConfigId);
	}
	...
	public MenuConfig deleteMenuConfig(MenuConfig menuConfig) {
		return menuConfigPersistence.remove(menuConfig);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MenuConfig.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return menuConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return menuConfigPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return menuConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public MenuConfig fetchMenuConfig(long menuConfigId) {
		return menuConfigPersistence.fetchByPrimaryKey(menuConfigId);
	}
	...
	public MenuConfig fetchMenuConfigByUuidAndGroupId(String uuid, long groupId) {
		return menuConfigPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public MenuConfig getMenuConfig(long menuConfigId)
		throws PortalException {
		return menuConfigPersistence.findByPrimaryKey(menuConfigId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(menuConfigLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MenuConfig.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("menuConfigId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(menuConfigLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MenuConfig.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<MenuConfig>() {
				@Override
				public void performAction(MenuConfig menuConfig)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(MenuConfig.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return menuConfigLocalService.deleteMenuConfig((MenuConfig)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return menuConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MenuConfig> getMenuConfigsByUuidAndCompanyId(String uuid,
		long companyId) {
		return menuConfigPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<MenuConfig> getMenuConfigsByUuidAndCompanyId(String uuid,
		...
		return menuConfigPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public MenuConfig getMenuConfigByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return menuConfigPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<MenuConfig> getMenuConfigs(int start, int end) {
		return menuConfigPersistence.findAll(start, end);
	}
	...
	public int getMenuConfigsCount() {
		return menuConfigPersistence.countAll();
	}
	 ...
	 */
	public MenuConfigLocalService getMenuConfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.MenuConfig",
			menuConfigLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.MenuConfig");
	}
	...
	public String getOSGiServiceIdentifier() {
		return MenuConfigLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = menuConfigPersistence.getDataSource();
	...
	@BeanReference(type = MenuConfigLocalService.class)
	protected MenuConfigLocalService menuConfigLocalService;
