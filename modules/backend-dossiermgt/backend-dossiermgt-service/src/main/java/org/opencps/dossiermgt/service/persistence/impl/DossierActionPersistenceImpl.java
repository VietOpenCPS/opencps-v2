...
public class DossierActionPersistenceImpl extends BasePersistenceImpl<DossierAction>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_U_FSC =
		new FinderPath(DossierActionModelImpl.ENTITY_CACHE_ENABLED,
			DossierActionModelImpl.FINDER_CACHE_ENABLED,
			DossierActionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByDID_U_FSC",
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_U_FSC =
		new FinderPath(DossierActionModelImpl.ENTITY_CACHE_ENABLED,
			DossierActionModelImpl.FINDER_CACHE_ENABLED,
			DossierActionImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByDID_U_FSC",
			...
			DossierActionModelImpl.FROMSTEPCODE_COLUMN_BITMASK |
			DossierActionModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_DID_U_FSC = new FinderPath(DossierActionModelImpl.ENTITY_CACHE_ENABLED,
			DossierActionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByDID_U_FSC",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public List<DossierAction> findByDID_U_FSC(long dossierId, long userId,
		String fromStepCode) {
		return findByDID_U_FSC(dossierId, userId, fromStepCode,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<DossierAction> findByDID_U_FSC(long dossierId, long userId,
		String fromStepCode, int start, int end) {
		return findByDID_U_FSC(dossierId, userId, fromStepCode, start, end, null);
	}
	...
	public List<DossierAction> findByDID_U_FSC(long dossierId, long userId,
		String fromStepCode, int start, int end,
		OrderByComparator<DossierAction> orderByComparator) {
		return findByDID_U_FSC(dossierId, userId, fromStepCode, start, end,
			orderByComparator, true);
	}
	...
	public List<DossierAction> findByDID_U_FSC(long dossierId, long userId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_U_FSC;
			finderArgs = new Object[] { dossierId, userId, fromStepCode };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_U_FSC;
			finderArgs = new Object[] {
					dossierId, userId, fromStepCode,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_DID_U_FSC_DOSSIERID_2);

			query.append(_FINDER_COLUMN_DID_U_FSC_USERID_2);

			boolean bindFromStepCode = false;

			if (fromStepCode == null) {
				query.append(_FINDER_COLUMN_DID_U_FSC_FROMSTEPCODE_1);
			}
			else if (fromStepCode.equals("")) {
				query.append(_FINDER_COLUMN_DID_U_FSC_FROMSTEPCODE_3);
			}
			else {
				bindFromStepCode = true;

				query.append(_FINDER_COLUMN_DID_U_FSC_FROMSTEPCODE_2);
			}
	 ...
	 */
	@Override
	public DossierAction findByDID_U_FSC_First(long dossierId, long userId,
		String fromStepCode, OrderByComparator<DossierAction> orderByComparator)
		throws NoSuchDossierActionException {
		DossierAction dossierAction = fetchByDID_U_FSC_First(dossierId, userId,
				fromStepCode, orderByComparator);
	 ...
	 */
	@Override
	public DossierAction fetchByDID_U_FSC_First(long dossierId, long userId,
		String fromStepCode, OrderByComparator<DossierAction> orderByComparator) {
		List<DossierAction> list = findByDID_U_FSC(dossierId, userId,
				fromStepCode, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DossierAction findByDID_U_FSC_Last(long dossierId, long userId,
		String fromStepCode, OrderByComparator<DossierAction> orderByComparator)
		throws NoSuchDossierActionException {
		DossierAction dossierAction = fetchByDID_U_FSC_Last(dossierId, userId,
				fromStepCode, orderByComparator);
	 ...
	 */
	@Override
	public DossierAction fetchByDID_U_FSC_Last(long dossierId, long userId,
		String fromStepCode, OrderByComparator<DossierAction> orderByComparator) {
		int count = countByDID_U_FSC(dossierId, userId, fromStepCode);
		...
		List<DossierAction> list = findByDID_U_FSC(dossierId, userId,
				fromStepCode, count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public DossierAction[] findByDID_U_FSC_PrevAndNext(long dossierActionId,
		long dossierId, long userId, String fromStepCode,
		OrderByComparator<DossierAction> orderByComparator)
		throws NoSuchDossierActionException {
		DossierAction dossierAction = findByPrimaryKey(dossierActionId);
		...
		try {
			...
			array[0] = getByDID_U_FSC_PrevAndNext(session, dossierAction,
					dossierId, userId, fromStepCode, orderByComparator, true);

			array[1] = dossierAction;

			array[2] = getByDID_U_FSC_PrevAndNext(session, dossierAction,
					dossierId, userId, fromStepCode, orderByComparator, false);
	...
	protected DossierAction getByDID_U_FSC_PrevAndNext(Session session,
		DossierAction dossierAction, long dossierId, long userId,
		String fromStepCode,
		OrderByComparator<DossierAction> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByDID_U_FSC(long dossierId, long userId,
		String fromStepCode) {
		for (DossierAction dossierAction : findByDID_U_FSC(dossierId, userId,
				fromStepCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dossierAction);
		}
	}
	...
	public int countByDID_U_FSC(long dossierId, long userId, String fromStepCode) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_DID_U_FSC;

		Object[] finderArgs = new Object[] { dossierId, userId, fromStepCode };
	...
	private static final String _FINDER_COLUMN_DID_U_FSC_DOSSIERID_2 = "dossierAction.dossierId = ? AND ";
	private static final String _FINDER_COLUMN_DID_U_FSC_USERID_2 = "dossierAction.userId = ? AND ";
	private static final String _FINDER_COLUMN_DID_U_FSC_FROMSTEPCODE_1 = "dossierAction.fromStepCode IS NULL";
	private static final String _FINDER_COLUMN_DID_U_FSC_FROMSTEPCODE_2 = "dossierAction.fromStepCode = ?";
	private static final String _FINDER_COLUMN_DID_U_FSC_FROMSTEPCODE_3 = "(dossierAction.fromStepCode IS NULL OR dossierAction.fromStepCode = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_DID = new FinderPath(DossierActionModelImpl.ENTITY_CACHE_ENABLED,
			DossierActionModelImpl.FINDER_CACHE_ENABLED,
			DossierActionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_DID",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_DID = new FinderPath(DossierActionModelImpl.ENTITY_CACHE_ENABLED,
			DossierActionModelImpl.FINDER_CACHE_ENABLED,
			DossierActionImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_DID",
			new String[] { Long.class.getName(), Long.class.getName() },
			...
			DossierActionModelImpl.DOSSIERID_COLUMN_BITMASK |
			DossierActionModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_DID = new FinderPath(DossierActionModelImpl.ENTITY_CACHE_ENABLED,
			DossierActionModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	public DossierAction findByG_DID_First(long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator)
		throws NoSuchDossierActionException {
		DossierAction dossierAction = fetchByG_DID_First(groupId, dossierId,
				orderByComparator);
	...
	public DossierAction fetchByG_DID_First(long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator) {
		List<DossierAction> list = findByG_DID(groupId, dossierId, 0, 1,
				orderByComparator);
	...
	public DossierAction findByG_DID_Last(long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator)
		throws NoSuchDossierActionException {
		DossierAction dossierAction = fetchByG_DID_Last(groupId, dossierId,
				orderByComparator);
	...
	public DossierAction fetchByG_DID_Last(long groupId, long dossierId,
		...
		List<DossierAction> list = findByG_DID(groupId, dossierId, count - 1,
				count, orderByComparator);
	...
	public DossierAction[] findByG_DID_PrevAndNext(long dossierActionId,
		...
		try {
			...
			array[0] = getByG_DID_PrevAndNext(session, dossierAction, groupId,
					dossierId, orderByComparator, true);

			array[1] = dossierAction;

			array[2] = getByG_DID_PrevAndNext(session, dossierAction, groupId,
	...
	protected DossierAction getByG_DID_PrevAndNext(Session session,
		DossierAction dossierAction, long groupId, long dossierId,
		OrderByComparator<DossierAction> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_DID(long groupId, long dossierId) {
		for (DossierAction dossierAction : findByG_DID(groupId, dossierId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dossierAction);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_DID_GROUPID_2 = "dossierAction.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_DID_DOSSIERID_2 = "dossierAction.dossierId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_DD = new FinderPath(DossierActionModelImpl.ENTITY_CACHE_ENABLED,
			DossierActionModelImpl.FINDER_CACHE_ENABLED,
			DossierActionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByDD",
			new String[] {
	...
	public List<DossierAction> findByDD(Date dueDate, long nextActionId,
		...
		if (list == null) {
			...
			if (dueDate == null) {
				query.append(_FINDER_COLUMN_DD_DUEDATE_1);
			}
			else {
				bindDueDate = true;
	...
	public DossierAction updateImpl(DossierAction dossierAction) {
		...
		if (!DossierActionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_DID_U_FSC, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_U_FSC,
				args);
			...
			if ((dossierActionModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_U_FSC.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dossierActionModelImpl.getOriginalDossierId(),
						dossierActionModelImpl.getOriginalUserId(),
						dossierActionModelImpl.getOriginalFromStepCode()
