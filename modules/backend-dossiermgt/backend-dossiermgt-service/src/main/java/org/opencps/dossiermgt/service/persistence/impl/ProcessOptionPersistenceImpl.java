...
public class ProcessOptionPersistenceImpl extends BasePersistenceImpl<ProcessOption>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G = new FinderPath(ProcessOptionModelImpl.ENTITY_CACHE_ENABLED,
			ProcessOptionModelImpl.FINDER_CACHE_ENABLED,
			ProcessOptionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G = new FinderPath(ProcessOptionModelImpl.ENTITY_CACHE_ENABLED,
			ProcessOptionModelImpl.FINDER_CACHE_ENABLED,
			ProcessOptionImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG", new String[] { Long.class.getName() },
			ProcessOptionModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G = new FinderPath(ProcessOptionModelImpl.ENTITY_CACHE_ENABLED,
			ProcessOptionModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the process options where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching process options
	 */
	@Override
	public List<ProcessOption> findByG(long groupId) {
		return findByG(groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the process options where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProcessOptionModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<ProcessOption> findByG(long groupId, int start, int end) {
		return findByG(groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the process options where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProcessOptionModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first process option in the ordered set where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching process option
	 ...
	 */
	@Override
	public ProcessOption findByG_First(long groupId,
		OrderByComparator<ProcessOption> orderByComparator)
		throws NoSuchProcessOptionException {
		ProcessOption processOption = fetchByG_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public ProcessOption fetchByG_First(long groupId,
		OrderByComparator<ProcessOption> orderByComparator) {
		List<ProcessOption> list = findByG(groupId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last process option in the ordered set where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching process option
	 ...
	 */
	@Override
	public ProcessOption findByG_Last(long groupId,
		OrderByComparator<ProcessOption> orderByComparator)
		throws NoSuchProcessOptionException {
		ProcessOption processOption = fetchByG_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public ProcessOption fetchByG_Last(long groupId,
		OrderByComparator<ProcessOption> orderByComparator) {
		...
		List<ProcessOption> list = findByG(groupId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the process options before and after the current process option in the ordered set where groupId = &#63;.
	 *
	 * @param processOptionId the primary key of the current process option
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ProcessOption[] findByG_PrevAndNext(long processOptionId,
		long groupId, OrderByComparator<ProcessOption> orderByComparator)
		throws NoSuchProcessOptionException {
		ProcessOption processOption = findByPrimaryKey(processOptionId);
		...
		try {
			...
			array[0] = getByG_PrevAndNext(session, processOption, groupId,
					orderByComparator, true);

			array[1] = processOption;

			array[2] = getByG_PrevAndNext(session, processOption, groupId,
					orderByComparator, false);
	...
	protected ProcessOption getByG_PrevAndNext(Session session,
		ProcessOption processOption, long groupId,
		OrderByComparator<ProcessOption> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the process options where groupId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 */
	@Override
	public void removeByG(long groupId) {
		for (ProcessOption processOption : findByG(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(processOption);
		}
	}
	...
	/**
	 * Returns the number of process options where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the number of matching process options
	 */
	...
	private static final String _FINDER_COLUMN_G_GROUPID_2 = "processOption.groupId = ?";
	...
	public ProcessOption updateImpl(ProcessOption processOption) {
		...
		if (!ProcessOptionModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { processOptionModelImpl.getGroupId() };
