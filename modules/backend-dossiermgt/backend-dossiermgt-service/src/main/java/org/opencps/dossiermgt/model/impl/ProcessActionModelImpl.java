...
public class ProcessActionModelImpl extends BaseModelImpl<ProcessAction>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_processaction (uuid_ VARCHAR(75) null,processActionId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,serviceProcessId LONG,preStepCode VARCHAR(255) null,postStepCode VARCHAR(255) null,autoEvent VARCHAR(255) null,preCondition STRING null,actionCode VARCHAR(255) null,actionName VARCHAR(255) null,allowAssignUser INTEGER,assignUserId LONG,requestPayment INTEGER,paymentFee VARCHAR(500) null,createDossierFiles STRING null,returnDossierFiles STRING null,makeBriefNote VARCHAR(500) null,syncActionCode VARCHAR(128) null,rollbackable BOOLEAN,createDossierNo BOOLEAN,eSignature BOOLEAN,configNote TEXT null,dossierTemplateNo VARCHAR(255) null,signatureType VARCHAR(255) null,createDossiers VARCHAR(255) null,checkInput INTEGER,postAction VARCHAR(128) null)";
