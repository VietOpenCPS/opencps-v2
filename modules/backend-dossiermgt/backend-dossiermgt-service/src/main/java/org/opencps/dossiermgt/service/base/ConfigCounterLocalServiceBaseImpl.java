...
import org.opencps.dossiermgt.service.ConfigCounterLocalService;
...
/**
 * Provides the base implementation for the config counter local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ConfigCounterLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ConfigCounterLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ConfigCounterLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ConfigCounterLocalServiceUtil} to access the config counter local service.
	 */
	...
	public ConfigCounter addConfigCounter(ConfigCounter configCounter) {
		...
		return configCounterPersistence.update(configCounter);
	}
	...
	public ConfigCounter createConfigCounter(long configCounterId) {
		return configCounterPersistence.create(configCounterId);
	}
	...
	public ConfigCounter deleteConfigCounter(long configCounterId)
		...
		return configCounterPersistence.remove(configCounterId);
	}
	...
	public ConfigCounter deleteConfigCounter(ConfigCounter configCounter) {
		return configCounterPersistence.remove(configCounter);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ConfigCounter.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return configCounterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return configCounterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ConfigCounter fetchConfigCounter(long configCounterId) {
		return configCounterPersistence.fetchByPrimaryKey(configCounterId);
	}
	...
	public ConfigCounter fetchConfigCounterByUuidAndGroupId(String uuid,
		long groupId) {
		return configCounterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ConfigCounter getConfigCounter(long configCounterId)
		throws PortalException {
		return configCounterPersistence.findByPrimaryKey(configCounterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(configCounterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ConfigCounter.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("configCounterId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(configCounterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ConfigCounter.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ConfigCounter>() {
				@Override
				public void performAction(ConfigCounter configCounter)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ConfigCounter.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return configCounterLocalService.deleteConfigCounter((ConfigCounter)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return configCounterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ConfigCounter> getConfigCountersByUuidAndCompanyId(
		...
		return configCounterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ConfigCounter> getConfigCountersByUuidAndCompanyId(
		...
		return configCounterPersistence.findByUuid_C(uuid, companyId, start,
	...
	public ConfigCounter getConfigCounterByUuidAndGroupId(String uuid,
		...
		return configCounterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ConfigCounter> getConfigCounters(int start, int end) {
		return configCounterPersistence.findAll(start, end);
	}
	...
	public int getConfigCountersCount() {
		return configCounterPersistence.countAll();
	}
	 ...
	 */
	public ConfigCounterLocalService getConfigCounterLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ConfigCounter",
			configCounterLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ConfigCounter");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ConfigCounterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = configCounterPersistence.getDataSource();
	...
	@BeanReference(type = ConfigCounterLocalService.class)
	protected ConfigCounterLocalService configCounterLocalService;
