...
public class DossierLogPersistenceImpl extends BasePersistenceImpl<DossierLog>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G = new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, DossierLogImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G = new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, DossierLogImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG",
			new String[] { Long.class.getName() },
			DossierLogModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G = new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DossierLog> findByG(long groupId) {
	 ...
	 */
	@Override
	public List<DossierLog> findByG(long groupId, int start, int end) {
	...
	public List<DossierLog> findByG(long groupId, int start, int end,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DossierLog dossierLog : list) {
					if ((groupId != dossierLog.getGroupId())) {
						list = null;
	 ...
	 */
	@Override
	public DossierLog findByG_First(long groupId,
		OrderByComparator<DossierLog> orderByComparator)
		throws NoSuchDossierLogException {
		DossierLog dossierLog = fetchByG_First(groupId, orderByComparator);
	 ...
	 */
	@Override
	public DossierLog fetchByG_First(long groupId,
		OrderByComparator<DossierLog> orderByComparator) {
		List<DossierLog> list = findByG(groupId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public DossierLog findByG_Last(long groupId,
		OrderByComparator<DossierLog> orderByComparator)
		throws NoSuchDossierLogException {
		DossierLog dossierLog = fetchByG_Last(groupId, orderByComparator);
	 ...
	 */
	@Override
	public DossierLog fetchByG_Last(long groupId,
		OrderByComparator<DossierLog> orderByComparator) {
		...
		List<DossierLog> list = findByG(groupId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public DossierLog[] findByG_PrevAndNext(long dossierLogId, long groupId,
		OrderByComparator<DossierLog> orderByComparator)
		throws NoSuchDossierLogException {
		DossierLog dossierLog = findByPrimaryKey(dossierLogId);
		...
		try {
			...
			array[0] = getByG_PrevAndNext(session, dossierLog, groupId,
					orderByComparator, true);

			array[1] = dossierLog;

			array[2] = getByG_PrevAndNext(session, dossierLog, groupId,
					orderByComparator, false);
	...
	protected DossierLog getByG_PrevAndNext(Session session,
		DossierLog dossierLog, long groupId,
		OrderByComparator<DossierLog> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG(long groupId) {
		for (DossierLog dossierLog : findByG(groupId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(dossierLog);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_GROUPID_2 = "dossierLog.groupId = ?";
	...
	public DossierLog updateImpl(DossierLog dossierLog) {
		...
		if (!(dossierLog instanceof DossierLogModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(dossierLog.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(dossierLog);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in dossierLog proxy " +
					invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom DossierLog implementation " +
				dossierLog.getClass());
		}
		...
		if (!DossierLogModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else
		 if (isNew) {
			Object[] args = new Object[] { dossierLogModelImpl.getUuid() };
			...
			args = new Object[] { dossierLogModelImpl.getGroupId() };
