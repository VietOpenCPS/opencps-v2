...
import org.opencps.backend.dossiermgt.service.FileTemplateLocalService;
...
/**
 * Provides the base implementation for the file template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.backend.dossiermgt.service.impl.FileTemplateLocalServiceImpl}.
 * </p>
 *
 * @author huymq
...
public abstract class FileTemplateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FileTemplateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.backend.dossiermgt.service.FileTemplateLocalServiceUtil} to access the file template local service.
	 */
	...
	public FileTemplate addFileTemplate(FileTemplate fileTemplate) {
		...
		return fileTemplatePersistence.update(fileTemplate);
	}
	...
	public FileTemplate deleteFileTemplate(long fileTemplateId)
		...
		return fileTemplatePersistence.remove(fileTemplateId);
	}
	...
	public FileTemplate deleteFileTemplate(FileTemplate fileTemplate) {
		return fileTemplatePersistence.remove(fileTemplate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(FileTemplate.class,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return fileTemplatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public FileTemplate fetchFileTemplate(long fileTemplateId) {
		return fileTemplatePersistence.fetchByPrimaryKey(fileTemplateId);
	}
	 ...
	 */
	@Override
	public FileTemplate fetchFileTemplateByUuidAndGroupId(String uuid,
		long groupId) {
		return fileTemplatePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(fileTemplateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FileTemplate.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("fileTemplateId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(fileTemplateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FileTemplate.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<FileTemplate>() {
				@Override
				public void performAction(FileTemplate fileTemplate)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(FileTemplate.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return fileTemplateLocalService.deleteFileTemplate((FileTemplate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return fileTemplatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FileTemplate> getFileTemplatesByUuidAndCompanyId(String uuid,
		long companyId) {
		return fileTemplatePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<FileTemplate> getFileTemplatesByUuidAndCompanyId(String uuid,
		...
		return fileTemplatePersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public FileTemplate getFileTemplateByUuidAndGroupId(String uuid,
		long groupId) throws PortalException {
		return fileTemplatePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public void addServiceInfoFileTemplate(long serviceInfoId,
		long fileTemplateId) {
		serviceInfoPersistence.addFileTemplate(serviceInfoId, fileTemplateId);
	}
	...
	public void addServiceInfoFileTemplate(long serviceInfoId,
		...
		serviceInfoPersistence.addFileTemplate(serviceInfoId, fileTemplate);
	}
	...
	public void addServiceInfoFileTemplates(long serviceInfoId,
		...
		serviceInfoPersistence.addFileTemplates(serviceInfoId, fileTemplateIds);
	}
	...
	public void addServiceInfoFileTemplates(long serviceInfoId,
		...
		serviceInfoPersistence.addFileTemplates(serviceInfoId, fileTemplates);
	}
	...
	public void clearServiceInfoFileTemplates(long serviceInfoId) {
		serviceInfoPersistence.clearFileTemplates(serviceInfoId);
	}
	...
	public void deleteServiceInfoFileTemplate(long serviceInfoId,
		long fileTemplateId) {
		serviceInfoPersistence.removeFileTemplate(serviceInfoId, fileTemplateId);
	}
	...
	public void deleteServiceInfoFileTemplate(long serviceInfoId,
		FileTemplate fileTemplate) {
		serviceInfoPersistence.removeFileTemplate(serviceInfoId, fileTemplate);
	}
	...
	public void deleteServiceInfoFileTemplates(long serviceInfoId,
		long[] fileTemplateIds) {
		serviceInfoPersistence.removeFileTemplates(serviceInfoId,
			fileTemplateIds);
	}
	...
	public void deleteServiceInfoFileTemplates(long serviceInfoId,
		List<FileTemplate> fileTemplates) {
		serviceInfoPersistence.removeFileTemplates(serviceInfoId, fileTemplates);
	}
	...
	public long[] getServiceInfoPrimaryKeys(long fileTemplateId) {
		return fileTemplatePersistence.getServiceInfoPrimaryKeys(fileTemplateId);
	}
	...
	public List<FileTemplate> getServiceInfoFileTemplates(long serviceInfoId) {
		return serviceInfoPersistence.getFileTemplates(serviceInfoId);
	}
	...
	public List<FileTemplate> getServiceInfoFileTemplates(long serviceInfoId,
		int start, int end) {
		return serviceInfoPersistence.getFileTemplates(serviceInfoId, start, end);
	}
	...
	public List<FileTemplate> getServiceInfoFileTemplates(long serviceInfoId,
		...
		return serviceInfoPersistence.getFileTemplates(serviceInfoId, start,
			end, orderByComparator);
	}
	...
	public int getServiceInfoFileTemplatesCount(long serviceInfoId) {
		return serviceInfoPersistence.getFileTemplatesSize(serviceInfoId);
	}
	...
	public boolean hasServiceInfoFileTemplate(long serviceInfoId,
		long fileTemplateId) {
		return serviceInfoPersistence.containsFileTemplate(serviceInfoId,
			fileTemplateId);
	}
	...
	public boolean hasServiceInfoFileTemplates(long serviceInfoId) {
		return serviceInfoPersistence.containsFileTemplates(serviceInfoId);
	}
	...
	public void setServiceInfoFileTemplates(long serviceInfoId,
		long[] fileTemplateIds) {
		serviceInfoPersistence.setFileTemplates(serviceInfoId, fileTemplateIds);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.backend.dossiermgt.model.FileTemplate",
			fileTemplateLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.backend.dossiermgt.model.FileTemplate");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FileTemplateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = fileTemplatePersistence.getDataSource();
	...
	@BeanReference(type = FileTemplateLocalService.class)
