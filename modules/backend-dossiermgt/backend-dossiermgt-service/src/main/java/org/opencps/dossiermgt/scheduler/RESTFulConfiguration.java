...
public class RESTFulConfiguration {
	...
	public static final String SERVER_PASS = PropsUtil.get(ConfigProps.SERVER_SECRET);
	...
	public static final String CLIENT_PASS = PropsUtil.get(ConfigProps.CLIENT_SECRET);
