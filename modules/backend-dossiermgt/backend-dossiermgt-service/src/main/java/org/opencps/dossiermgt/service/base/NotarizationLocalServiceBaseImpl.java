...
import org.opencps.dossiermgt.service.NotarizationLocalService;
...
/**
 * Provides the base implementation for the notarization local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.NotarizationLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class NotarizationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NotarizationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.NotarizationLocalServiceUtil} to access the notarization local service.
	 */
	...
	public Notarization addNotarization(Notarization notarization) {
		...
		return notarizationPersistence.update(notarization);
	}
	...
	public Notarization createNotarization(long notarizationId) {
		return notarizationPersistence.create(notarizationId);
	}
	...
	public Notarization deleteNotarization(long notarizationId)
		...
		return notarizationPersistence.remove(notarizationId);
	}
	...
	public Notarization deleteNotarization(Notarization notarization) {
		return notarizationPersistence.remove(notarization);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Notarization.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return notarizationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return notarizationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Notarization fetchNotarization(long notarizationId) {
		return notarizationPersistence.fetchByPrimaryKey(notarizationId);
	}
	...
	public Notarization getNotarization(long notarizationId)
		throws PortalException {
		return notarizationPersistence.findByPrimaryKey(notarizationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(notarizationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Notarization.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("notarizationId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(notarizationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Notarization.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return notarizationLocalService.deleteNotarization((Notarization)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return notarizationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Notarization> getNotarizations(int start, int end) {
		return notarizationPersistence.findAll(start, end);
	}
	...
	public int getNotarizationsCount() {
		return notarizationPersistence.countAll();
	}
	 ...
	 */
	public NotarizationLocalService getNotarizationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.Notarization",
			notarizationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.Notarization");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NotarizationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = notarizationPersistence.getDataSource();
	...
	@BeanReference(type = NotarizationLocalService.class)
	protected NotarizationLocalService notarizationLocalService;
