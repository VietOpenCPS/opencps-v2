...
public class MenuConfigModelImpl extends BaseModelImpl<MenuConfig>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("viewScript", Types.VARCHAR);
	}

	public static final String TABLE_SQL_CREATE = "create table opencps_menuconfig (uuid_ VARCHAR(75) null,menuConfigId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,menuGroup VARCHAR(255) null,menuName VARCHAR(1024) null,order_ INTEGER,menuType INTEGER,queryParams VARCHAR(500) null,tableConfig TEXT null,buttonConfig TEXT null,icon VARCHAR(255) null,viewScript TEXT null)";
	...
	public Object clone() {
		...
		menuConfigImpl.setViewScript(getViewScript());
	...
	public CacheModel<MenuConfig> toCacheModel() {
		...
		menuConfigCacheModel.viewScript = getViewScript();

		String viewScript = menuConfigCacheModel.viewScript;

		if ((viewScript != null) && (viewScript.length() == 0)) {
			menuConfigCacheModel.viewScript = null;
		}
