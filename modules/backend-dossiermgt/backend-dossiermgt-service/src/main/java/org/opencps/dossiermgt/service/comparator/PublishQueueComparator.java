...
public class PublishQueueComparator extends OrderByComparator<PublishQueue> {

    private static final long serialVersionUID = 1L;

    private static final String _TABLE_NAME = "opencps_publish_queue";
    ...
    public PublishQueueComparator() {

        this(false, _defaultColumnName, String.class);
    }

    public PublishQueueComparator(boolean ascending, String columnName, Class<?> columnType) {
    ...
    @Override
    public int compare(PublishQueue publishQueue0, PublishQueue publishQueue1) {
    ...
    private Log _log = LogFactoryUtil.getLog(PublishQueueComparator.class.getName());
