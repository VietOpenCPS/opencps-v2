...
import org.opencps.dossiermgt.service.EFormLocalService;
...
/**
 * Provides the base implementation for the e form local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.EFormLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class EFormLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements EFormLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.EFormLocalServiceUtil} to access the e form local service.
	 */
	...
	public EForm createEForm(long eFormId) {
		return eFormPersistence.create(eFormId);
	}
	...
	public EForm deleteEForm(long eFormId) throws PortalException {
		return eFormPersistence.remove(eFormId);
	}
	...
	public EForm deleteEForm(EForm eForm) {
		return eFormPersistence.remove(eForm);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(EForm.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return eFormPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return eFormPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return eFormPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return eFormPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public EForm fetchEForm(long eFormId) {
		return eFormPersistence.fetchByPrimaryKey(eFormId);
	}
	...
	public EForm fetchEFormByUuidAndGroupId(String uuid, long groupId) {
		return eFormPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EForm getEForm(long eFormId) throws PortalException {
		return eFormPersistence.findByPrimaryKey(eFormId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(eFormLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EForm.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("eFormId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(eFormLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EForm.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("eFormId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<EForm>() {
				@Override
				public void performAction(EForm eForm)
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(EForm.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return eFormLocalService.deleteEForm((EForm)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return eFormPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EForm> getEFormsByUuidAndCompanyId(String uuid, long companyId) {
		return eFormPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EForm> getEFormsByUuidAndCompanyId(String uuid, long companyId,
		...
		return eFormPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public EForm getEFormByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return eFormPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EForm> getEForms(int start, int end) {
		return eFormPersistence.findAll(start, end);
	}
	...
	public int getEFormsCount() {
		return eFormPersistence.countAll();
	}
	 ...
	 */
	public EFormLocalService getEFormLocalService() {
	 ...
	 */
	public void setEFormLocalService(EFormLocalService eFormLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.EForm",
			eFormLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.EForm");
	}
	...
	public String getOSGiServiceIdentifier() {
		return EFormLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = eFormPersistence.getDataSource();
	...
	@BeanReference(type = EFormLocalService.class)
	protected EFormLocalService eFormLocalService;
