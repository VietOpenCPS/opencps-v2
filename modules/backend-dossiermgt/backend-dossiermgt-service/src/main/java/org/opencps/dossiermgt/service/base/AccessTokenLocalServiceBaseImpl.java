...
import org.opencps.dossiermgt.service.AccessTokenLocalService;
...
/**
 * Provides the base implementation for the access token local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.AccessTokenLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class AccessTokenLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccessTokenLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.AccessTokenLocalServiceUtil} to access the access token local service.
	 */
	...
	public AccessToken createAccessToken(long accessTokenId) {
		return accessTokenPersistence.create(accessTokenId);
	}
	...
	@Override
	public AccessToken deleteAccessToken(long accessTokenId)
		throws PortalException {
		return accessTokenPersistence.remove(accessTokenId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public AccessToken deleteAccessToken(AccessToken accessToken) {
		return accessTokenPersistence.remove(accessToken);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AccessToken.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return accessTokenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return accessTokenPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return accessTokenPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AccessToken fetchAccessToken(long accessTokenId) {
		return accessTokenPersistence.fetchByPrimaryKey(accessTokenId);
	}
	 ...
	 */
	@Override
	public AccessToken getAccessToken(long accessTokenId)
		throws PortalException {
		return accessTokenPersistence.findByPrimaryKey(accessTokenId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(accessTokenLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AccessToken.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("accessTokenId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(accessTokenLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AccessToken.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return accessTokenLocalService.deleteAccessToken((AccessToken)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return accessTokenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<AccessToken> getAccessTokens(int start, int end) {
		return accessTokenPersistence.findAll(start, end);
	}
	...
	public int getAccessTokensCount() {
		return accessTokenPersistence.countAll();
	}
	 ...
	 */
	public AccessTokenLocalService getAccessTokenLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.AccessToken",
			accessTokenLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.AccessToken");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AccessTokenLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = accessTokenPersistence.getDataSource();
	...
	@BeanReference(type = AccessTokenLocalService.class)
	protected AccessTokenLocalService accessTokenLocalService;
