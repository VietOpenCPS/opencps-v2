...
public class RegistrationModelImpl extends BaseModelImpl<Registration>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_registration (uuid_ VARCHAR(75) null,registrationId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,applicantName VARCHAR(275) null,applicantIdType VARCHAR(128) null,applicantIdNo VARCHAR(128) null,applicantIdDate DATE null,address VARCHAR(575) null,cityCode VARCHAR(128) null,cityName VARCHAR(275) null,districtCode VARCHAR(128) null,districtName VARCHAR(275) null,wardCode VARCHAR(128) null,wardName VARCHAR(275) null,contactName VARCHAR(275) null,contactTelNo VARCHAR(275) null,contactEmail VARCHAR(275) null,govAgencyCode VARCHAR(255) null,govAgencyName VARCHAR(275) null,registrationState INTEGER,registrationClass VARCHAR(255) null,submitting BOOLEAN,representativeEnterprise VARCHAR(255) null)";
