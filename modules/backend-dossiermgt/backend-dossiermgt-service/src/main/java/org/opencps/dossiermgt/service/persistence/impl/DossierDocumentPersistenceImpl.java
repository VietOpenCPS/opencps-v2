...
public class DossierDocumentPersistenceImpl extends BasePersistenceImpl<DossierDocument>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_DID_DOCTYPE =
		new FinderPath(DossierDocumentModelImpl.ENTITY_CACHE_ENABLED,
			DossierDocumentModelImpl.FINDER_CACHE_ENABLED,
			DossierDocumentImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_DID_DOCTYPE",
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_DID_DOCTYPE =
		new FinderPath(DossierDocumentModelImpl.ENTITY_CACHE_ENABLED,
			DossierDocumentModelImpl.FINDER_CACHE_ENABLED,
			DossierDocumentImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_DID_DOCTYPE",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			},
			DossierDocumentModelImpl.GROUPID_COLUMN_BITMASK |
			DossierDocumentModelImpl.DOSSIERID_COLUMN_BITMASK |
			DossierDocumentModelImpl.DOCUMENTTYPE_COLUMN_BITMASK |
			DossierDocumentModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_DID_DOCTYPE = new FinderPath(DossierDocumentModelImpl.ENTITY_CACHE_ENABLED,
			DossierDocumentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_DID_DOCTYPE",
			new String[] {
				Long.class.getName(), Long.class.getName(),
				String.class.getName()
			});
	...
	/**
	 * Returns all the dossier documents where groupId = &#63; and dossierId = &#63; and documentType = &#63;.
	 *
	 * @param groupId the group ID
	 * @param dossierId the dossier ID
	 ...
	 */
	@Override
	public List<DossierDocument> findByF_DID_DOCTYPE(long groupId,
		long dossierId, String documentType) {
		return findByF_DID_DOCTYPE(groupId, dossierId, documentType,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the dossier documents where groupId = &#63; and dossierId = &#63; and documentType = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link DossierDocumentModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<DossierDocument> findByF_DID_DOCTYPE(long groupId,
		long dossierId, String documentType, int start, int end) {
		return findByF_DID_DOCTYPE(groupId, dossierId, documentType, start,
			end, null);
	}

	/**
	 * Returns an ordered range of all the dossier documents where groupId = &#63; and dossierId = &#63; and documentType = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link DossierDocumentModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DossierDocument> findByF_DID_DOCTYPE(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_DID_DOCTYPE;
			finderArgs = new Object[] { groupId, dossierId, documentType };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_DID_DOCTYPE;
			finderArgs = new Object[] {
					groupId, dossierId, documentType,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DossierDocument dossierDocument : list) {
					if ((groupId != dossierDocument.getGroupId()) ||
							(dossierId != dossierDocument.getDossierId()) ||
							!Objects.equals(documentType,
								dossierDocument.getDocumentType())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_DID_DOCTYPE_GROUPID_2);

			query.append(_FINDER_COLUMN_F_DID_DOCTYPE_DOSSIERID_2);

			boolean bindDocumentType = false;

			if (documentType == null) {
				query.append(_FINDER_COLUMN_F_DID_DOCTYPE_DOCUMENTTYPE_1);
			}
			else if (documentType.equals("")) {
				query.append(_FINDER_COLUMN_F_DID_DOCTYPE_DOCUMENTTYPE_3);
			}
			else {
				bindDocumentType = true;

				query.append(_FINDER_COLUMN_F_DID_DOCTYPE_DOCUMENTTYPE_2);
			}
	...
	/**
	 * Returns the first dossier document in the ordered set where groupId = &#63; and dossierId = &#63; and documentType = &#63;.
	 *
	 * @param groupId the group ID
	 * @param dossierId the dossier ID
	 * @param documentType the document type
	 ...
	 */
	@Override
	public DossierDocument findByF_DID_DOCTYPE_First(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator)
		throws NoSuchDossierDocumentException {
		DossierDocument dossierDocument = fetchByF_DID_DOCTYPE_First(groupId,
				dossierId, documentType, orderByComparator);
	 ...
	 */
	@Override
	public DossierDocument fetchByF_DID_DOCTYPE_First(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator) {
		List<DossierDocument> list = findByF_DID_DOCTYPE(groupId, dossierId,
	...
	/**
	 * Returns the last dossier document in the ordered set where groupId = &#63; and dossierId = &#63; and documentType = &#63;.
	 *
	 * @param groupId the group ID
	 * @param dossierId the dossier ID
	 * @param documentType the document type
	 ...
	 */
	@Override
	public DossierDocument findByF_DID_DOCTYPE_Last(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator)
		throws NoSuchDossierDocumentException {
		DossierDocument dossierDocument = fetchByF_DID_DOCTYPE_Last(groupId,
				dossierId, documentType, orderByComparator);
	 ...
	 */
	@Override
	public DossierDocument fetchByF_DID_DOCTYPE_Last(long groupId,
		long dossierId, String documentType,
		OrderByComparator<DossierDocument> orderByComparator) {
		int count = countByF_DID_DOCTYPE(groupId, dossierId, documentType);
	...
	/**
	 * Returns the dossier documents before and after the current dossier document in the ordered set where groupId = &#63; and dossierId = &#63; and documentType = &#63;.
	 *
	 * @param DossierDocumentId the primary key of the current dossier document
	 * @param groupId the group ID
	 * @param dossierId the dossier ID
	 ...
	 */
	@Override
	public DossierDocument[] findByF_DID_DOCTYPE_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_DID_DOCTYPE_PrevAndNext(session, dossierDocument,
					groupId, dossierId, documentType, orderByComparator, true);

			array[1] = dossierDocument;

			array[2] = getByF_DID_DOCTYPE_PrevAndNext(session, dossierDocument,
					groupId, dossierId, documentType, orderByComparator, false);
	...
	protected DossierDocument getByF_DID_DOCTYPE_PrevAndNext(Session session,
	...
	/**
	 * Removes all the dossier documents where groupId = &#63; and dossierId = &#63; and documentType = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param dossierId the dossier ID
	 * @param documentType the document type
	 */
	@Override
	public void removeByF_DID_DOCTYPE(long groupId, long dossierId,
		String documentType) {
		for (DossierDocument dossierDocument : findByF_DID_DOCTYPE(groupId,
				dossierId, documentType, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(dossierDocument);
		}
	}
	...
	/**
	 * Returns the number of dossier documents where groupId = &#63; and dossierId = &#63; and documentType = &#63;.
	 *
	 * @param groupId the group ID
	 * @param dossierId the dossier ID
	 * @param documentType the document type
	 ...
	 */
	@Override
	public int countByF_DID_DOCTYPE(long groupId, long dossierId,
		String documentType) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_DID_DOCTYPE;

		Object[] finderArgs = new Object[] { groupId, dossierId, documentType };
	...
	private static final String _FINDER_COLUMN_F_DID_DOCTYPE_GROUPID_2 = "dossierDocument.groupId = ? AND ";
	private static final String _FINDER_COLUMN_F_DID_DOCTYPE_DOSSIERID_2 = "dossierDocument.dossierId = ? AND ";
		...
		if (!DossierDocumentModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					dossierDocumentModelImpl.getGroupId(),
					dossierDocumentModelImpl.getDossierId(),
					dossierDocumentModelImpl.getDocumentType()
				};

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_DID_DOCTYPE, args);
			...
			if ((dossierDocumentModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_DID_DOCTYPE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dossierDocumentModelImpl.getOriginalGroupId(),
						dossierDocumentModelImpl.getOriginalDossierId(),
						dossierDocumentModelImpl.getOriginalDocumentType()
					};
