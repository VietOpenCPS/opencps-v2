 ...
 * @author trungnt
 */
public class DossierFileComparator extends OrderByComparator<DossierFile> {
	...
	public DossierFileComparator() {

		this(false, _defaultColumnName, String.class);
	}

	public DossierFileComparator(boolean ascending, String columnName, Class<?> columnType) {
	...
	@Override
	public int compare(DossierFile dossierFile0, DossierFile dossierFile1) {
