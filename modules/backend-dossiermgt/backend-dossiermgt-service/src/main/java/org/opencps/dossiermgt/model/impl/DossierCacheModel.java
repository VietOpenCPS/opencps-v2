...
public class DossierCacheModel implements CacheModel<Dossier>, Externalizable {
	...
	public Dossier toEntityModel() {
		...
		if (metaData == null) {
			...
			dossierImpl.setMetaData(metaData);
		}
		...
		dossierImpl.setVnpostalStatus(vnpostalStatus);

		if (vnpostalProfile == null) {
			dossierImpl.setVnpostalProfile("");
		}
		else {
			dossierImpl.setVnpostalProfile(vnpostalProfile);
		}

		dossierImpl.setFromViaPostal(fromViaPostal);

		if (multipleCheck == null) {
			dossierImpl.setMultipleCheck("");
		}
		else {
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		vnpostalStatus = objectInput.readInt();
		vnpostalProfile = objectInput.readUTF();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeInt(vnpostalStatus);

		if (vnpostalProfile == null) {
			objectOutput.writeUTF("");
		}
		else {
			objectOutput.writeUTF(vnpostalProfile);
		}

		objectOutput.writeInt(fromViaPostal);
