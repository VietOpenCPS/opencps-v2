...
public class DossierActionModelImpl extends BaseModelImpl<DossierAction>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_dossieraction (uuid_ VARCHAR(75) null,dossierActionId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,dossierId LONG,serviceProcessId LONG,previousActionId LONG,fromStepCode VARCHAR(255) null,fromStepName VARCHAR(512) null,fromSequenceNo VARCHAR(255) null,actionCode VARCHAR(100) null,actionUser VARCHAR(255) null,actionName VARCHAR(512) null,actionNote TEXT null,actionOverdue INTEGER,syncActionCode VARCHAR(100) null,pending BOOLEAN,rollbackable BOOLEAN,stepCode VARCHAR(255) null,stepName VARCHAR(512) null,sequenceNo VARCHAR(255) null,dueDate DATE null,nextActionId LONG,payload TEXT null,stepInstruction VARCHAR(500) null,state_ INTEGER,eventStatus INTEGER)";
