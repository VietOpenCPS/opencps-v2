...
public class MenuRolePersistenceImpl extends BasePersistenceImpl<MenuRole>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_CONFIG_ID =
		new FinderPath(MenuRoleModelImpl.ENTITY_CACHE_ENABLED,
			MenuRoleModelImpl.FINDER_CACHE_ENABLED, MenuRoleImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_CONFIG_ID",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_CONFIG_ID =
		new FinderPath(MenuRoleModelImpl.ENTITY_CACHE_ENABLED,
			MenuRoleModelImpl.FINDER_CACHE_ENABLED, MenuRoleImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_CONFIG_ID",
			new String[] { Long.class.getName() },
			MenuRoleModelImpl.MENUCONFIGID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_CONFIG_ID = new FinderPath(MenuRoleModelImpl.ENTITY_CACHE_ENABLED,
			MenuRoleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_CONFIG_ID",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the menu roles where menuConfigId = &#63;.
	 *
	 * @param menuConfigId the menu config ID
	 * @return the matching menu roles
	 */
	@Override
	public List<MenuRole> findByF_CONFIG_ID(long menuConfigId) {
		return findByF_CONFIG_ID(menuConfigId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the menu roles where menuConfigId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link MenuRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<MenuRole> findByF_CONFIG_ID(long menuConfigId, int start,
		int end) {
		return findByF_CONFIG_ID(menuConfigId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the menu roles where menuConfigId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link MenuRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<MenuRole> findByF_CONFIG_ID(long menuConfigId, int start,
		...
		return findByF_CONFIG_ID(menuConfigId, start, end, orderByComparator,
			true);
	}
	...
	public List<MenuRole> findByF_CONFIG_ID(long menuConfigId, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_CONFIG_ID;
			finderArgs = new Object[] { menuConfigId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_CONFIG_ID;
			finderArgs = new Object[] {
					menuConfigId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_CONFIG_ID_MENUCONFIGID_2);
	...
	/**
	 * Returns the first menu role in the ordered set where menuConfigId = &#63;.
	 *
	 * @param menuConfigId the menu config ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching menu role
	 ...
	 */
	@Override
	public MenuRole findByF_CONFIG_ID_First(long menuConfigId,
		OrderByComparator<MenuRole> orderByComparator)
		throws NoSuchMenuRoleException {
		MenuRole menuRole = fetchByF_CONFIG_ID_First(menuConfigId,
				orderByComparator);
	 ...
	 */
	@Override
	public MenuRole fetchByF_CONFIG_ID_First(long menuConfigId,
		OrderByComparator<MenuRole> orderByComparator) {
		List<MenuRole> list = findByF_CONFIG_ID(menuConfigId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last menu role in the ordered set where menuConfigId = &#63;.
	 *
	 * @param menuConfigId the menu config ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching menu role
	 ...
	 */
	@Override
	public MenuRole findByF_CONFIG_ID_Last(long menuConfigId,
		OrderByComparator<MenuRole> orderByComparator)
		throws NoSuchMenuRoleException {
		MenuRole menuRole = fetchByF_CONFIG_ID_Last(menuConfigId,
				orderByComparator);
	 ...
	 */
	@Override
	public MenuRole fetchByF_CONFIG_ID_Last(long menuConfigId,
		OrderByComparator<MenuRole> orderByComparator) {
		int count = countByF_CONFIG_ID(menuConfigId);

		if (count == 0) {
			return null;
		}

		List<MenuRole> list = findByF_CONFIG_ID(menuConfigId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the menu roles before and after the current menu role in the ordered set where menuConfigId = &#63;.
	 *
	 * @param menuRoleId the primary key of the current menu role
	 * @param menuConfigId the menu config ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public MenuRole[] findByF_CONFIG_ID_PrevAndNext(long menuRoleId,
		long menuConfigId, OrderByComparator<MenuRole> orderByComparator)
		throws NoSuchMenuRoleException {
		MenuRole menuRole = findByPrimaryKey(menuRoleId);
		...
		try {
			...
			array[0] = getByF_CONFIG_ID_PrevAndNext(session, menuRole,
					menuConfigId, orderByComparator, true);

			array[1] = menuRole;

			array[2] = getByF_CONFIG_ID_PrevAndNext(session, menuRole,
					menuConfigId, orderByComparator, false);
	...
	protected MenuRole getByF_CONFIG_ID_PrevAndNext(Session session,
		MenuRole menuRole, long menuConfigId,
		OrderByComparator<MenuRole> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the menu roles where menuConfigId = &#63; from the database.
	 *
	 * @param menuConfigId the menu config ID
	 */
	@Override
	public void removeByF_CONFIG_ID(long menuConfigId) {
		for (MenuRole menuRole : findByF_CONFIG_ID(menuConfigId,
	...
	/**
	 * Returns the number of menu roles where menuConfigId = &#63;.
	 *
	 * @param menuConfigId the menu config ID
	 * @return the number of matching menu roles
	 */
	@Override
	public int countByF_CONFIG_ID(long menuConfigId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_CONFIG_ID;
	...
	private static final String _FINDER_COLUMN_F_CONFIG_ID_MENUCONFIGID_2 = "menuRole.menuConfigId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_ROLE = new FinderPath(MenuRoleModelImpl.ENTITY_CACHE_ENABLED,
			MenuRoleModelImpl.FINDER_CACHE_ENABLED, MenuRoleImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_ROLE",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_ROLE =
		new FinderPath(MenuRoleModelImpl.ENTITY_CACHE_ENABLED,
			MenuRoleModelImpl.FINDER_CACHE_ENABLED, MenuRoleImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_ROLE",
			new String[] { Long.class.getName() },
			MenuRoleModelImpl.ROLEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_ROLE = new FinderPath(MenuRoleModelImpl.ENTITY_CACHE_ENABLED,
			MenuRoleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_ROLE",
			new String[] { Long.class.getName() });
	 ...
	 */
	@Override
	public List<MenuRole> findByF_ROLE(long roleId) {
		return findByF_ROLE(roleId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<MenuRole> findByF_ROLE(long roleId, int start, int end) {
		return findByF_ROLE(roleId, start, end, null);
	}
	...
	public List<MenuRole> findByF_ROLE(long roleId, int start, int end,
		OrderByComparator<MenuRole> orderByComparator) {
		return findByF_ROLE(roleId, start, end, orderByComparator, true);
	}
	...
	public List<MenuRole> findByF_ROLE(long roleId, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_ROLE;
			finderArgs = new Object[] { roleId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_ROLE;
			finderArgs = new Object[] { roleId, start, end, orderByComparator };
		}
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_F_ROLE_ROLEID_2);
	 ...
	 */
	@Override
	public MenuRole findByF_ROLE_First(long roleId,
		OrderByComparator<MenuRole> orderByComparator)
		throws NoSuchMenuRoleException {
		MenuRole menuRole = fetchByF_ROLE_First(roleId, orderByComparator);
	 ...
	 */
	@Override
	public MenuRole fetchByF_ROLE_First(long roleId,
		OrderByComparator<MenuRole> orderByComparator) {
		List<MenuRole> list = findByF_ROLE(roleId, 0, 1, orderByComparator);
	 ...
	 */
	@Override
	public MenuRole findByF_ROLE_Last(long roleId,
		OrderByComparator<MenuRole> orderByComparator)
		throws NoSuchMenuRoleException {
		MenuRole menuRole = fetchByF_ROLE_Last(roleId, orderByComparator);
	 ...
	 */
	@Override
	public MenuRole fetchByF_ROLE_Last(long roleId,
		OrderByComparator<MenuRole> orderByComparator) {
		int count = countByF_ROLE(roleId);

		if (count == 0) {
			return null;
		}

		List<MenuRole> list = findByF_ROLE(roleId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public MenuRole[] findByF_ROLE_PrevAndNext(long menuRoleId, long roleId,
		OrderByComparator<MenuRole> orderByComparator)
		throws NoSuchMenuRoleException {
		MenuRole menuRole = findByPrimaryKey(menuRoleId);
		...
		try {
			...
			array[0] = getByF_ROLE_PrevAndNext(session, menuRole, roleId,
					orderByComparator, true);

			array[1] = menuRole;

			array[2] = getByF_ROLE_PrevAndNext(session, menuRole, roleId,
					orderByComparator, false);
	...
	protected MenuRole getByF_ROLE_PrevAndNext(Session session,
		MenuRole menuRole, long roleId,
		OrderByComparator<MenuRole> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByF_ROLE(long roleId) {
		for (MenuRole menuRole : findByF_ROLE(roleId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(menuRole);
		}
	}
	 ...
	 */
	@Override
	public int countByF_ROLE(long roleId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_ROLE;
	...
	private static final String _FINDER_COLUMN_F_ROLE_ROLEID_2 = "menuRole.roleId = ?";
	...
	public MenuRole updateImpl(MenuRole menuRole) {
		...
		if (!MenuRoleModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { menuRoleModelImpl.getMenuConfigId() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_CONFIG_ID, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_CONFIG_ID,
				args);

			args = new Object[] { menuRoleModelImpl.getRoleId() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_ROLE, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_ROLE,
				args);
			...
			if ((menuRoleModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_CONFIG_ID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						menuRoleModelImpl.getOriginalMenuConfigId()
					};
			...
			if ((menuRoleModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_ROLE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						menuRoleModelImpl.getOriginalRoleId()
					};
