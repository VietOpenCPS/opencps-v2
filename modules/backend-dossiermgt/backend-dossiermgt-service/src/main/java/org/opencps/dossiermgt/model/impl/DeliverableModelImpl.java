...
public class DeliverableModelImpl extends BaseModelImpl<Deliverable>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_deliverable (uuid_ VARCHAR(75) null,deliverableId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,deliverableCode VARCHAR(128) null,deliverableName VARCHAR(512) null,deliverableType VARCHAR(255) null,govAgencyCode VARCHAR(128) null,govAgencyName VARCHAR(512) null,applicantIdNo VARCHAR(128) null,applicantName VARCHAR(512) null,subject VARCHAR(512) null,formData TEXT null,formScript TEXT null,formReport TEXT null,formScriptFileId LONG,formReportFileId LONG,expireDate DATE null,issueDate DATE null,revalidate DATE null,deliverableState INTEGER,fileEntryId LONG,dossierId LONG,docSync INTEGER,fileAttachs VARCHAR(512) null)";
	...
	public void setDeliverableState(int deliverableState) {
		...
		if (!_setOriginalDeliverableState) {
			_setOriginalDeliverableState = true;
	...
	public int getOriginalDeliverableState() {
		return _originalDeliverableState;
	}
	...
	private int _originalDeliverableState;
