...
public class ServiceFileTemplateModelImpl extends BaseModelImpl<ServiceFileTemplate>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_services_filetemplates (uuid_ VARCHAR(75) null,serviceInfoId LONG not null,fileTemplateNo VARCHAR(128) not null,templateName VARCHAR(1000) null,fileEntryId LONG,eForm BOOLEAN,formScriptFileId LONG,formReportFileId LONG,eFormNoPattern VARCHAR(255) null,eFormNamePattern VARCHAR(255) null,primary key (serviceInfoId, fileTemplateNo))";
