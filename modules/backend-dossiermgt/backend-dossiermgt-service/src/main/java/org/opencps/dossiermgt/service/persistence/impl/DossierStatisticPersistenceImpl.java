...
public class DossierStatisticPersistenceImpl extends BasePersistenceImpl<DossierStatistic>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_M_Y_GC_DC =
		new FinderPath(DossierStatisticModelImpl.ENTITY_CACHE_ENABLED,
			...
			DossierStatisticModelImpl.GROUPID_COLUMN_BITMASK |
			DossierStatisticModelImpl.MONTH_COLUMN_BITMASK |
			DossierStatisticModelImpl.YEAR_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_M_Y_GC_DC = new FinderPath(DossierStatisticModelImpl.ENTITY_CACHE_ENABLED,
			DossierStatisticModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<DossierStatistic> findByG_M_Y_GC_DC(long groupId, int month,
		int year) {
	...
	public List<DossierStatistic> findByG_M_Y_GC_DC(long groupId, int month,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DossierStatistic dossierStatistic : list) {
					if ((groupId != dossierStatistic.getGroupId()) ||
							(month != dossierStatistic.getMonth()) ||
							(year != dossierStatistic.getYear())) {
						list = null;
	 ...
	 */
	@Override
	public DossierStatistic findByG_M_Y_GC_DC_First(long groupId, int month,
		int year, OrderByComparator<DossierStatistic> orderByComparator)
		throws NoSuchDossierStatisticException {
		DossierStatistic dossierStatistic = fetchByG_M_Y_GC_DC_First(groupId,
	 ...
	 */
	@Override
	public DossierStatistic fetchByG_M_Y_GC_DC_First(long groupId, int month,
		int year, OrderByComparator<DossierStatistic> orderByComparator) {
		List<DossierStatistic> list = findByG_M_Y_GC_DC(groupId, month, year,
	 ...
	 */
	@Override
	public DossierStatistic findByG_M_Y_GC_DC_Last(long groupId, int month,
		int year, OrderByComparator<DossierStatistic> orderByComparator)
		throws NoSuchDossierStatisticException {
		DossierStatistic dossierStatistic = fetchByG_M_Y_GC_DC_Last(groupId,
				month, year, orderByComparator);
	 ...
	 */
	@Override
	public DossierStatistic fetchByG_M_Y_GC_DC_Last(long groupId, int month,
		int year, OrderByComparator<DossierStatistic> orderByComparator) {
	 ...
	 */
	@Override
	public DossierStatistic[] findByG_M_Y_GC_DC_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_M_Y_GC_DC_PrevAndNext(session, dossierStatistic,
					groupId, month, year, orderByComparator, true);

			array[1] = dossierStatistic;

			array[2] = getByG_M_Y_GC_DC_PrevAndNext(session, dossierStatistic,
	...
	protected DossierStatistic getByG_M_Y_GC_DC_PrevAndNext(Session session,
		DossierStatistic dossierStatistic, long groupId, int month, int year,
		OrderByComparator<DossierStatistic> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByG_M_Y_GC_DC(long groupId, int month, int year) {
		for (DossierStatistic dossierStatistic : findByG_M_Y_GC_DC(groupId,
	...
	private static final String _FINDER_COLUMN_G_M_Y_GC_DC_GROUPID_2 = "dossierStatistic.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_M_Y_GC_DC_MONTH_2 = "dossierStatistic.month = ? AND ";
	private static final String _FINDER_COLUMN_G_M_Y_GC_DC_YEAR_2 = "dossierStatistic.year = ? AND dossierStatistic.govAgencyCode is null and dossierStatistic.domainCode is null";
	...
	public DossierStatistic updateImpl(DossierStatistic dossierStatistic) {
		...
		if (!DossierStatisticModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] {
					dossierStatisticModelImpl.getGroupId(),
					dossierStatisticModelImpl.getMonth(),
					dossierStatisticModelImpl.getYear()
				};
			...
			if ((dossierStatisticModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						dossierStatisticModelImpl.getOriginalGroupId(),
						dossierStatisticModelImpl.getOriginalMonth(),
						dossierStatisticModelImpl.getOriginalYear()
					};
