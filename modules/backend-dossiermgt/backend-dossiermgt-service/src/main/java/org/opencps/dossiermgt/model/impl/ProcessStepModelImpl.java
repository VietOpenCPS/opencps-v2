...
public class ProcessStepModelImpl extends BaseModelImpl<ProcessStep>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_processstep (uuid_ VARCHAR(75) null,processStepId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,stepCode VARCHAR(255) null,serviceProcessId LONG,stepName VARCHAR(500) null,sequenceNo VARCHAR(255) null,dossierStatus VARCHAR(255) null,dossierSubStatus VARCHAR(255) null,durationCount DOUBLE,customProcessUrl VARCHAR(255) null,stepInstruction TEXT null,briefNote TEXT null,editable BOOLEAN,restrictDossier VARCHAR(255) null,lockState VARCHAR(255) null,groupName VARCHAR(255) null,roleAsStep VARCHAR(255) null,checkInput INTEGER)";
