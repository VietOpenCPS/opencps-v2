...
import org.opencps.dossiermgt.service.CsdlDcUserLocalService;
...
/**
 * Provides the base implementation for the csdl dc user local service.
 *
 * <p>
 ...
 */
@ProviderType
public abstract class CsdlDcUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CsdlDcUserLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.CsdlDcUserLocalServiceUtil} to access the csdl dc user local service.
	 */
	...
	public CsdlDcUser addCsdlDcUser(CsdlDcUser csdlDcUser) {
		...
		return csdlDcUserPersistence.update(csdlDcUser);
	}
	...
	public CsdlDcUser createCsdlDcUser(long idDcUser) {
		return csdlDcUserPersistence.create(idDcUser);
	}
	...
	public CsdlDcUser deleteCsdlDcUser(long idDcUser) throws PortalException {
		return csdlDcUserPersistence.remove(idDcUser);
	}
	...
	public CsdlDcUser deleteCsdlDcUser(CsdlDcUser csdlDcUser) {
		return csdlDcUserPersistence.remove(csdlDcUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CsdlDcUser.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return csdlDcUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return csdlDcUserPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return csdlDcUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public CsdlDcUser fetchCsdlDcUser(long idDcUser) {
		return csdlDcUserPersistence.fetchByPrimaryKey(idDcUser);
	}
	...
	public CsdlDcUser fetchCsdlDcUserByUuidAndGroupId(String uuid, long groupId) {
		return csdlDcUserPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public CsdlDcUser getCsdlDcUser(long idDcUser) throws PortalException {
		return csdlDcUserPersistence.findByPrimaryKey(idDcUser);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(csdlDcUserLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CsdlDcUser.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("idDcUser");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(csdlDcUserLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CsdlDcUser.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("idDcUser");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return csdlDcUserLocalService.deleteCsdlDcUser((CsdlDcUser)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return csdlDcUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CsdlDcUser> getCsdlDcUsersByUuidAndCompanyId(String uuid,
		long companyId) {
		return csdlDcUserPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<CsdlDcUser> getCsdlDcUsersByUuidAndCompanyId(String uuid,
		...
		return csdlDcUserPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public CsdlDcUser getCsdlDcUserByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return csdlDcUserPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<CsdlDcUser> getCsdlDcUsers(int start, int end) {
		return csdlDcUserPersistence.findAll(start, end);
	}
	...
	public int getCsdlDcUsersCount() {
		return csdlDcUserPersistence.countAll();
	}
	 ...
	 */
	public CsdlDcUserLocalService getCsdlDcUserLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.CsdlDcUser",
			csdlDcUserLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.CsdlDcUser");
	}
	...
	public String getOSGiServiceIdentifier() {
		return CsdlDcUserLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = csdlDcUserPersistence.getDataSource();
	...
	@BeanReference(type = CsdlDcUserLocalService.class)
	protected CsdlDcUserLocalService csdlDcUserLocalService;
