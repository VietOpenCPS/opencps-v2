...
/**
 * Provides the base implementation for the dossier document local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierDocumentLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierDocumentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierDocumentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierDocumentLocalServiceUtil} to access the dossier document local service.
	 */
	...
	public DossierDocument addDossierDocument(DossierDocument dossierDocument) {
		...
		return dossierDocumentPersistence.update(dossierDocument);
	}
	...
	public DossierDocument createDossierDocument(long DossierDocumentId) {
		return dossierDocumentPersistence.create(DossierDocumentId);
	}
	...
	public DossierDocument deleteDossierDocument(long DossierDocumentId)
		...
		return dossierDocumentPersistence.remove(DossierDocumentId);
	}
	...
	public DossierDocument deleteDossierDocument(
		...
		return dossierDocumentPersistence.remove(dossierDocument);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierDocument.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierDocumentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierDocumentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DossierDocument fetchDossierDocument(long DossierDocumentId) {
		return dossierDocumentPersistence.fetchByPrimaryKey(DossierDocumentId);
	}
	...
	public DossierDocument fetchDossierDocumentByUuidAndGroupId(String uuid,
		long groupId) {
		return dossierDocumentPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DossierDocument getDossierDocument(long DossierDocumentId)
		throws PortalException {
		return dossierDocumentPersistence.findByPrimaryKey(DossierDocumentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierDocumentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierDocument.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("DossierDocumentId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierDocumentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierDocument.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierDocumentLocalService.deleteDossierDocument((DossierDocument)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierDocumentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public DossierDocument getDossierDocumentByUuidAndGroupId(String uuid,
		...
		return dossierDocumentPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DossierDocument> getDossierDocuments(int start, int end) {
		return dossierDocumentPersistence.findAll(start, end);
	}
	...
	public int getDossierDocumentsCount() {
		return dossierDocumentPersistence.countAll();
	}
	 ...
	 */
	public DossierDocumentLocalService getDossierDocumentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierDocument",
			dossierDocumentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierDocument");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierDocumentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierDocumentPersistence.getDataSource();
	...
	@BeanReference(type = DossierDocumentLocalService.class)
	protected DossierDocumentLocalService dossierDocumentLocalService;
