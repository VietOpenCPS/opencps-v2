...
import org.opencps.dossiermgt.service.StepConfigLocalService;
...
/**
 * Provides the base implementation for the step config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.StepConfigLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class StepConfigLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements StepConfigLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.StepConfigLocalServiceUtil} to access the step config local service.
	 */
	...
	public StepConfig addStepConfig(StepConfig stepConfig) {
		...
		return stepConfigPersistence.update(stepConfig);
	}
	...
	public StepConfig createStepConfig(long stepConfigId) {
		return stepConfigPersistence.create(stepConfigId);
	}
	...
	public StepConfig deleteStepConfig(long stepConfigId)
		...
		return stepConfigPersistence.remove(stepConfigId);
	}
	...
	public StepConfig deleteStepConfig(StepConfig stepConfig) {
		return stepConfigPersistence.remove(stepConfig);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(StepConfig.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stepConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return stepConfigPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stepConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public StepConfig fetchStepConfig(long stepConfigId) {
		return stepConfigPersistence.fetchByPrimaryKey(stepConfigId);
	}
	...
	public StepConfig fetchStepConfigByUuidAndGroupId(String uuid, long groupId) {
		return stepConfigPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public StepConfig getStepConfig(long stepConfigId)
		throws PortalException {
		return stepConfigPersistence.findByPrimaryKey(stepConfigId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stepConfigLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StepConfig.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("stepConfigId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(stepConfigLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StepConfig.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<StepConfig>() {
				@Override
				public void performAction(StepConfig stepConfig)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(StepConfig.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return stepConfigLocalService.deleteStepConfig((StepConfig)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return stepConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<StepConfig> getStepConfigsByUuidAndCompanyId(String uuid,
		long companyId) {
		return stepConfigPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<StepConfig> getStepConfigsByUuidAndCompanyId(String uuid,
		...
		return stepConfigPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public StepConfig getStepConfigByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return stepConfigPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<StepConfig> getStepConfigs(int start, int end) {
		return stepConfigPersistence.findAll(start, end);
	}
	...
	public int getStepConfigsCount() {
		return stepConfigPersistence.countAll();
	}
	 ...
	 */
	public StepConfigLocalService getStepConfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.StepConfig",
			stepConfigLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.StepConfig");
	}
	...
	public String getOSGiServiceIdentifier() {
		return StepConfigLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stepConfigPersistence.getDataSource();
	...
	@BeanReference(type = StepConfigLocalService.class)
	protected StepConfigLocalService stepConfigLocalService;
