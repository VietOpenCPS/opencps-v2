...
public class ServiceProcessModelImpl extends BaseModelImpl<ServiceProcess>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_serviceprocess (uuid_ VARCHAR(75) null,serviceProcessId LONG not null primary key,companyId LONG,groupId LONG,userId LONG,userName VARCHAR(255) null,createDate DATE null,modifiedDate DATE null,processNo VARCHAR(255) null,processName STRING null,description TEXT null,durationCount DOUBLE,durationUnit INTEGER,counter LONG,generateDossierNo BOOLEAN,dossierNoPattern TEXT null,generateDueDate BOOLEAN,dueDatePattern VARCHAR(500) null,generatePassword BOOLEAN,directNotification BOOLEAN,serverNo VARCHAR(255) null,serverName TEXT null,requestPayment BOOLEAN,paymentFee VARCHAR(255) null,dossierGroupPattern VARCHAR(128) null,counterCode VARCHAR(128) null)";
	...
	public CacheModel<ServiceProcess> toCacheModel() {
		...
		serviceProcessCacheModel.dossierGroupPattern = getDossierGroupPattern();

		String dossierGroupPattern = serviceProcessCacheModel.dossierGroupPattern;

		if ((dossierGroupPattern != null) &&
				(dossierGroupPattern.length() == 0)) {
