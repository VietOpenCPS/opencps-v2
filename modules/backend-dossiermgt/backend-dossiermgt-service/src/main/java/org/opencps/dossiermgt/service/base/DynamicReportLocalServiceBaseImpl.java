...
import org.opencps.dossiermgt.service.DynamicReportLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DynamicReportLocalServiceImpl}.
 * </p>
 *
 * @author huymq
...
public abstract class DynamicReportLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DynamicReportLocalServiceUtil} to access the dynamic report local service.
	 */
	 ...
	 */
	@Override
	public DynamicReport fetchDynamicReportByUuidAndGroupId(String uuid,
		long groupId) {
		return dynamicReportPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DynamicReport>() {
				@Override
				public void performAction(DynamicReport dynamicReport)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DynamicReport.class.getName())));
	 ...
	 */
	@Override
	public List<DynamicReport> getDynamicReportsByUuidAndCompanyId(
		String uuid, long companyId) {
		return dynamicReportPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DynamicReport> getDynamicReportsByUuidAndCompanyId(
		...
		return dynamicReportPersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public DynamicReport getDynamicReportByUuidAndGroupId(String uuid,
		long groupId) throws PortalException {
		return dynamicReportPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DynamicReport",
			dynamicReportLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DynamicReport");
	}
