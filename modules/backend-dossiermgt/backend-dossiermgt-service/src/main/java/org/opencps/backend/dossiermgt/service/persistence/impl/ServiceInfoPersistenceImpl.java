...
import org.opencps.backend.dossiermgt.model.impl.ServiceInfoImpl;
import org.opencps.backend.dossiermgt.model.impl.ServiceInfoModelImpl;
 ...
 * @see org.opencps.backend.dossiermgt.service.persistence.ServiceInfoUtil
 * @generated
 */
@ProviderType
public class ServiceInfoPersistenceImpl extends BasePersistenceImpl<ServiceInfo>
	...
	protected ServiceInfo removeImpl(ServiceInfo serviceInfo) {
		...
		serviceInfoToFileTemplateTableMapper.deleteLeftPrimaryKeyTableMappings(serviceInfo.getPrimaryKey());
	...
	public long[] getFileTemplatePrimaryKeys(long pk) {
		long[] pks = serviceInfoToFileTemplateTableMapper.getRightPrimaryKeys(pk);
	 ...
	 */
	@Override
	public List<org.opencps.backend.dossiermgt.model.FileTemplate> getFileTemplates(
		long pk) {
		return getFileTemplates(pk, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	}
	...
	public List<org.opencps.backend.dossiermgt.model.FileTemplate> getFileTemplates(
		...
		return getFileTemplates(pk, start, end, null);
	}
	...
	public List<org.opencps.backend.dossiermgt.model.FileTemplate> getFileTemplates(
		...
		return serviceInfoToFileTemplateTableMapper.getRightBaseModels(pk,
			start, end, orderByComparator);
	}
	...
	public boolean containsFileTemplate(long pk, long fileTemplatePK) {
		return serviceInfoToFileTemplateTableMapper.containsTableMapping(pk,
			fileTemplatePK);
	}
	...
	public void addFileTemplate(long pk, long fileTemplatePK) {
		ServiceInfo serviceInfo = fetchByPrimaryKey(pk);

		if (serviceInfo == null) {
			serviceInfoToFileTemplateTableMapper.addTableMapping(companyProvider.getCompanyId(),
				pk, fileTemplatePK);
		}
		else {
			serviceInfoToFileTemplateTableMapper.addTableMapping(serviceInfo.getCompanyId(),
				pk, fileTemplatePK);
		}
	}
	...
	public void addFileTemplates(long pk, long[] fileTemplatePKs) {
		...
		serviceInfoToFileTemplateTableMapper.addTableMappings(companyId, pk,
			fileTemplatePKs);
	}
	...
	public void addFileTemplates(long pk,
		...
		addFileTemplates(pk,
			ListUtil.toLongArray(fileTemplates,
				org.opencps.backend.dossiermgt.model.FileTemplate.FILE_TEMPLATE_ID_ACCESSOR));
	}
	...
	public void clearFileTemplates(long pk) {
		serviceInfoToFileTemplateTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}
	...
	public void removeFileTemplate(long pk, long fileTemplatePK) {
		serviceInfoToFileTemplateTableMapper.deleteTableMapping(pk,
			fileTemplatePK);
	}
	...
	public void removeFileTemplates(long pk, long[] fileTemplatePKs) {
		serviceInfoToFileTemplateTableMapper.deleteTableMappings(pk,
			fileTemplatePKs);
	}
	...
	public void setFileTemplates(long pk, long[] fileTemplatePKs) {
		Set<Long> newFileTemplatePKsSet = SetUtil.fromArray(fileTemplatePKs);
		Set<Long> oldFileTemplatePKsSet = SetUtil.fromArray(serviceInfoToFileTemplateTableMapper.getRightPrimaryKeys(
					pk));

		Set<Long> removeFileTemplatePKsSet = new HashSet<Long>(oldFileTemplatePKsSet);

		removeFileTemplatePKsSet.removeAll(newFileTemplatePKsSet);

		serviceInfoToFileTemplateTableMapper.deleteTableMappings(pk,
			ArrayUtil.toLongArray(removeFileTemplatePKsSet));

		newFileTemplatePKsSet.removeAll(oldFileTemplatePKsSet);
		...
		serviceInfoToFileTemplateTableMapper.addTableMappings(companyId, pk,
			ArrayUtil.toLongArray(newFileTemplatePKsSet));
	}
	...
	public void setFileTemplates(long pk,
		List<org.opencps.backend.dossiermgt.model.FileTemplate> fileTemplates) {
		try {
			long[] fileTemplatePKs = new long[fileTemplates.size()];

			for (int i = 0; i < fileTemplates.size(); i++) {
				org.opencps.backend.dossiermgt.model.FileTemplate fileTemplate = fileTemplates.get(i);

				fileTemplatePKs[i] = fileTemplate.getPrimaryKey();
			}

			setFileTemplates(pk, fileTemplatePKs);
		}
		catch (Exception e) {
			throw processException(e);
		}
	...
	public void afterPropertiesSet() {
		serviceInfoToFileTemplateTableMapper = TableMapperFactory.getTableMapper("opencps_services_filetemplates",
				"companyId", "serviceInfoId", "fileTemplateId", this,
				fileTemplatePersistence);
	}
	...
	protected TableMapper<ServiceInfo, org.opencps.backend.dossiermgt.model.FileTemplate> serviceInfoToFileTemplateTableMapper;
