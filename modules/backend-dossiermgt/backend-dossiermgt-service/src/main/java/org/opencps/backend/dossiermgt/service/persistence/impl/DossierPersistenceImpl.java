...
import org.opencps.backend.dossiermgt.exception.NoSuchDossierException;
import org.opencps.backend.dossiermgt.model.Dossier;
import org.opencps.backend.dossiermgt.model.impl.DossierImpl;
import org.opencps.backend.dossiermgt.model.impl.DossierModelImpl;
 ...
 * @see org.opencps.backend.dossiermgt.service.persistence.DossierUtil
 * @generated
 */
@ProviderType
public class DossierPersistenceImpl extends BasePersistenceImpl<Dossier>
	...
	protected Dossier toUnwrappedModel(Dossier dossier) {
		...
		dossierImpl.setOptionCode(dossier.getOptionCode());
		dossierImpl.setOptionName(dossier.getOptionName());
		...
		dossierImpl.setPaymentRedirectURL(dossier.getPaymentRedirectURL());
		dossierImpl.setOverDue(dossier.getOverDue());
