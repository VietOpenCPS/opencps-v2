...
public class DossierModelImpl extends BaseModelImpl<Dossier>
	...
	public static final long DOCUMENTNO_COLUMN_BITMASK = 8L;
	public static final long DOSSIERACTIONID_COLUMN_BITMASK = 16L;
	public static final long DOSSIERCOUNTER_COLUMN_BITMASK = 32L;
	public static final long DOSSIERID_COLUMN_BITMASK = 64L;
	public static final long DOSSIERNO_COLUMN_BITMASK = 128L;
	public static final long DOSSIERSTATUS_COLUMN_BITMASK = 256L;
	public static final long DOSSIERTEMPLATENO_COLUMN_BITMASK = 512L;
	public static final long GOVAGENCYCODE_COLUMN_BITMASK = 1024L;
	public static final long GROUPDOSSIERID_COLUMN_BITMASK = 2048L;
	public static final long GROUPID_COLUMN_BITMASK = 4096L;
	public static final long MODIFIEDDATE_COLUMN_BITMASK = 8192L;
	public static final long ORIGINDOSSIERID_COLUMN_BITMASK = 16384L;
	public static final long ORIGINDOSSIERNO_COLUMN_BITMASK = 32768L;
	public static final long ORIGINALITY_COLUMN_BITMASK = 65536L;
	public static final long POSTALCODERECEIVED_COLUMN_BITMASK = 131072L;
	public static final long POSTALCODESEND_COLUMN_BITMASK = 262144L;
	public static final long PROCESSNO_COLUMN_BITMASK = 524288L;
	public static final long REFERENCEUID_COLUMN_BITMASK = 1048576L;
	...
	public void setDocumentNo(String documentNo) {
		_columnBitmask |= DOCUMENTNO_COLUMN_BITMASK;

		if (_originalDocumentNo == null) {
			_originalDocumentNo = _documentNo;
		}
	...
	public String getOriginalDocumentNo() {
		return GetterUtil.getString(_originalDocumentNo);
	}
	...
	public void setOriginDossierNo(String originDossierNo) {
		_columnBitmask |= ORIGINDOSSIERNO_COLUMN_BITMASK;

		if (_originalOriginDossierNo == null) {
			_originalOriginDossierNo = _originDossierNo;
		}

		_originDossierNo = originDossierNo;
	}

	public String getOriginalOriginDossierNo() {
		return GetterUtil.getString(_originalOriginDossierNo);
	}

	@Override
	public String getGroupDossierId() {
		if (_groupDossierId == null) {
			return "";
		}
		else {
	...
	public void setGroupDossierId(String groupDossierId) {
		_columnBitmask |= GROUPDOSSIERID_COLUMN_BITMASK;

		if (_originalGroupDossierId == null) {
			_originalGroupDossierId = _groupDossierId;
		}

		_groupDossierId = groupDossierId;
	}

	public String getOriginalGroupDossierId() {
		return GetterUtil.getString(_originalGroupDossierId);
	}
	...
	public void setVnpostalStatus(int vnpostalStatus) {
		_columnBitmask |= VNPOSTALSTATUS_COLUMN_BITMASK;

		if (!_setOriginalVnpostalStatus) {
			_setOriginalVnpostalStatus = true;

			_originalVnpostalStatus = _vnpostalStatus;
		}

		_vnpostalStatus = vnpostalStatus;
	}

	public int getOriginalVnpostalStatus() {
		return _originalVnpostalStatus;
	}

	@Override
	public String getVnpostalProfile() {
		if (_vnpostalProfile == null) {
			return "";
		}
		else {
	...
	public Object clone() {
		...
		dossierImpl.setGroupDossierId(getGroupDossierId());
		dossierImpl.setMetaData(getMetaData());
		dossierImpl.setSystemId(getSystemId());
		...
		dossierImpl.setMultipleCheck(getMultipleCheck());
		dossierImpl.setPostalCodeSend(getPostalCodeSend());
		dossierImpl.setPostalCodeReceived(getPostalCodeReceived());
	...
	public void resetOriginalValues() {
		...
		dossierModelImpl._originalDocumentNo = dossierModelImpl._documentNo;
	...
	public CacheModel<Dossier> toCacheModel() {
		...
		dossierCacheModel.groupDossierId = getGroupDossierId();

		String groupDossierId = dossierCacheModel.groupDossierId;

		if ((groupDossierId != null) && (groupDossierId.length() == 0)) {
			dossierCacheModel.groupDossierId = null;
		}

		dossierCacheModel.metaData = getMetaData();

		String metaData = dossierCacheModel.metaData;

		if ((metaData != null) && (metaData.length() == 0)) {
			dossierCacheModel.metaData = null;
		}

		dossierCacheModel.systemId = getSystemId();

		dossierCacheModel.dossierCounter = getDossierCounter();

		String dossierCounter = dossierCacheModel.dossierCounter;

		if ((dossierCounter != null) && (dossierCounter.length() == 0)) {
			dossierCacheModel.dossierCounter = null;
		}

		dossierCacheModel.vnpostalStatus = getVnpostalStatus();

		dossierCacheModel.vnpostalProfile = getVnpostalProfile();

		String vnpostalProfile = dossierCacheModel.vnpostalProfile;

		if ((vnpostalProfile != null) && (vnpostalProfile.length() == 0)) {
			dossierCacheModel.vnpostalProfile = null;
		}

		dossierCacheModel.fromViaPostal = getFromViaPostal();

		dossierCacheModel.multipleCheck = getMultipleCheck();

		String multipleCheck = dossierCacheModel.multipleCheck;

		if ((multipleCheck != null) && (multipleCheck.length() == 0)) {
			dossierCacheModel.multipleCheck = null;
		}

		dossierCacheModel.postalCodeSend = getPostalCodeSend();

		String postalCodeSend = dossierCacheModel.postalCodeSend;

		if ((postalCodeSend != null) && (postalCodeSend.length() == 0)) {
			dossierCacheModel.postalCodeSend = null;
		}

		dossierCacheModel.postalCodeReceived = getPostalCodeReceived();

		String postalCodeReceived = dossierCacheModel.postalCodeReceived;

		if ((postalCodeReceived != null) && (postalCodeReceived.length() == 0)) {
			dossierCacheModel.postalCodeReceived = null;
		}
	...
	public String toString() {
		...
		sb.append(getGroupDossierId());
		sb.append(", metaData=");
		sb.append(getMetaData());
		sb.append(", systemId=");
		sb.append(getSystemId());
		sb.append(", dossierCounter=");
		sb.append(getDossierCounter());
		...
		sb.append(getMultipleCheck());
		sb.append(", postalCodeSend=");
		sb.append(getPostalCodeSend());
		sb.append(", postalCodeReceived=");
		sb.append(getPostalCodeReceived());
		sb.append("}");
	...
	public String toXmlString() {
		StringBundler sb = new StringBundler(316);
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>groupDossierId</column-name><column-value><![CDATA[");
		sb.append(getGroupDossierId());
		sb.append("]]></column-value></column>");
		sb.append(
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>dossierCounter</column-name><column-value><![CDATA[");
		sb.append(getDossierCounter());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>vnpostalStatus</column-name><column-value><![CDATA[");
		sb.append(getVnpostalStatus());
		sb.append("]]></column-value></column>");
		sb.append(
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>multipleCheck</column-name><column-value><![CDATA[");
		sb.append(getMultipleCheck());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>postalCodeSend</column-name><column-value><![CDATA[");
		sb.append(getPostalCodeSend());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>postalCodeReceived</column-name><column-value><![CDATA[");
		sb.append(getPostalCodeReceived());
		sb.append("]]></column-value></column>");
	...
	private String _originalOriginDossierNo;
	private String _groupDossierId;
	private String _originalGroupDossierId;
