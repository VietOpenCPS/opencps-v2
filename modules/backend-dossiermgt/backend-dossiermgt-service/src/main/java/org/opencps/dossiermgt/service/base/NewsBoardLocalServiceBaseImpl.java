...
import org.opencps.dossiermgt.service.NewsBoardLocalService;
...
/**
 * Provides the base implementation for the news board local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.NewsBoardLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class NewsBoardLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements NewsBoardLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.NewsBoardLocalServiceUtil} to access the news board local service.
	 */
	...
	public NewsBoard deleteNewsBoard(NewsBoard newsBoard) {
		return newsBoardPersistence.remove(newsBoard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(NewsBoard.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return newsBoardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return newsBoardPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return newsBoardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public NewsBoard fetchNewsBoardByUuidAndGroupId(String uuid, long groupId) {
		return newsBoardPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(newsBoardLocalService);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(newsBoardLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<NewsBoard>() {
				@Override
				public void performAction(NewsBoard newsBoard)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(NewsBoard.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return newsBoardLocalService.deleteNewsBoard((NewsBoard)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return newsBoardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<NewsBoard> getNewsBoardsByUuidAndCompanyId(String uuid,
		long companyId) {
		return newsBoardPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<NewsBoard> getNewsBoardsByUuidAndCompanyId(String uuid,
		...
		return newsBoardPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public NewsBoard getNewsBoardByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return newsBoardPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<NewsBoard> getNewsBoards(int start, int end) {
		return newsBoardPersistence.findAll(start, end);
	}
	...
	public int getNewsBoardsCount() {
		return newsBoardPersistence.countAll();
	}
	 ...
	 */
	public NewsBoardLocalService getNewsBoardLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.NewsBoard",
			newsBoardLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.NewsBoard");
	}
	...
	public String getOSGiServiceIdentifier() {
		return NewsBoardLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = newsBoardPersistence.getDataSource();
	...
	@BeanReference(type = NewsBoardLocalService.class)
	protected NewsBoardLocalService newsBoardLocalService;
