...
public class PublishQueuePersistenceImpl extends BasePersistenceImpl<PublishQueue>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_SN_NOT =
		new FinderPath(PublishQueueModelImpl.ENTITY_CACHE_ENABLED,
			PublishQueueModelImpl.FINDER_CACHE_ENABLED, PublishQueueImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByDID_SN_NOT",
			new String[] {
				Long.class.getName(), String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_DID_SN_NOT =
		new FinderPath(PublishQueueModelImpl.ENTITY_CACHE_ENABLED,
			PublishQueueModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByDID_SN_NOT",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public List<PublishQueue> findByDID_SN_NOT(long dossierId, String serverNo) {
		return findByDID_SN_NOT(dossierId, serverNo, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<PublishQueue> findByDID_SN_NOT(long dossierId, String serverNo,
		int start, int end) {
		return findByDID_SN_NOT(dossierId, serverNo, start, end, null);
	}
	...
	public List<PublishQueue> findByDID_SN_NOT(long dossierId, String serverNo,
		int start, int end, OrderByComparator<PublishQueue> orderByComparator) {
		return findByDID_SN_NOT(dossierId, serverNo, start, end,
			orderByComparator, true);
	}
	...
	public List<PublishQueue> findByDID_SN_NOT(long dossierId, String serverNo,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_SN_NOT;
		finderArgs = new Object[] {
				dossierId, serverNo,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_DID_SN_NOT_DOSSIERID_2);

			boolean bindServerNo = false;

			if (serverNo == null) {
				query.append(_FINDER_COLUMN_DID_SN_NOT_SERVERNO_1);
			}
			else if (serverNo.equals("")) {
				query.append(_FINDER_COLUMN_DID_SN_NOT_SERVERNO_3);
			}
			else {
				bindServerNo = true;

				query.append(_FINDER_COLUMN_DID_SN_NOT_SERVERNO_2);
			}
	...
	public PublishQueue findByDID_SN_NOT_First(long dossierId, String serverNo,
		OrderByComparator<PublishQueue> orderByComparator)
		throws NoSuchPublishQueueException {
		PublishQueue publishQueue = fetchByDID_SN_NOT_First(dossierId,
	...
	public PublishQueue fetchByDID_SN_NOT_First(long dossierId,
		...
		List<PublishQueue> list = findByDID_SN_NOT(dossierId, serverNo, 0, 1,
				orderByComparator);
	...
	public PublishQueue findByDID_SN_NOT_Last(long dossierId, String serverNo,
		OrderByComparator<PublishQueue> orderByComparator)
		throws NoSuchPublishQueueException {
		PublishQueue publishQueue = fetchByDID_SN_NOT_Last(dossierId, serverNo,
				orderByComparator);
	...
	public PublishQueue fetchByDID_SN_NOT_Last(long dossierId, String serverNo,
		OrderByComparator<PublishQueue> orderByComparator) {
		int count = countByDID_SN_NOT(dossierId, serverNo);

		if (count == 0) {
			return null;
		}

		List<PublishQueue> list = findByDID_SN_NOT(dossierId, serverNo,
				count - 1, count, orderByComparator);
	...
	public PublishQueue[] findByDID_SN_NOT_PrevAndNext(long publishQueueId,
		...
		try {
			...
			array[0] = getByDID_SN_NOT_PrevAndNext(session, publishQueue,
					dossierId, serverNo, orderByComparator, true);

			array[1] = publishQueue;

			array[2] = getByDID_SN_NOT_PrevAndNext(session, publishQueue,
					dossierId, serverNo, orderByComparator, false);
	...
	protected PublishQueue getByDID_SN_NOT_PrevAndNext(Session session,
		PublishQueue publishQueue, long dossierId, String serverNo,
		OrderByComparator<PublishQueue> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByDID_SN_NOT(long dossierId, String serverNo) {
		for (PublishQueue publishQueue : findByDID_SN_NOT(dossierId, serverNo,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(publishQueue);
		}
	}
	...
	public int countByDID_SN_NOT(long dossierId, String serverNo) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_DID_SN_NOT;
	...
	private static final String _FINDER_COLUMN_DID_SN_NOT_DOSSIERID_2 = "publishQueue.dossierId = ? AND ";
	private static final String _FINDER_COLUMN_DID_SN_NOT_SERVERNO_1 = "publishQueue.serverNo IS NOT NULL";
	private static final String _FINDER_COLUMN_DID_SN_NOT_SERVERNO_2 = "publishQueue.serverNo != ?";
	private static final String _FINDER_COLUMN_DID_SN_NOT_SERVERNO_3 = "(publishQueue.serverNo IS NULL OR publishQueue.serverNo != '')";
