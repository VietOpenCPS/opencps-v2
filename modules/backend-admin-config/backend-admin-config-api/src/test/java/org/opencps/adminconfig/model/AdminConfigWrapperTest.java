...
public class AdminConfigWrapperTest {
	@Before
	public void setUp() {
	}
	@Test
	public void equalsTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.equals(null);
		}catch (Exception e) {
		}
	...
	@Test
	public void setExpandoBridgeAttributesTest13() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.setExpandoBridgeAttributes(new ServiceContext());
		}catch (Exception e) {
	...
	@Test
	public void setExpandoBridgeAttributesTest14() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.setExpandoBridgeAttributes(new ServiceContext());
		}catch (Exception e) {
	...
	@Test
	public void isPublicManagerTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.isPublicManager();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void getWrappedModelTest24() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.getWrappedModel();
		}catch (Exception e) {
	...
	@Test
	public void toEscapedModelTest30() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.toEscapedModel();
		}catch (Exception e) {
	...
	@Test
	public void toUnescapedModelTest34() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.toUnescapedModel();
		}catch (Exception e) {
	...
	public void getExpandoBridgeTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.getExpandoBridge();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void isCachedModelTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.isCachedModel();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setBundleNameTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.setBundleName("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	public void setColumnsTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.setColumns("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	@Test
	public void isExtFormTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.isExtForm();
		}catch (Exception e) {
	...
	@Test
	public void setHeadersNameTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.setHeadersName("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void setExtFormTest() {
		try{
			AdminConfigWrapper object = new AdminConfigWrapper(null);
			object.setExtForm(true);
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
