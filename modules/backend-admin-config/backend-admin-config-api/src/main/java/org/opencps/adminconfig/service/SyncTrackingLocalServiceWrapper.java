...
public class SyncTrackingLocalServiceWrapper implements SyncTrackingLocalService,
	...
	*/
	@Override
	public org.opencps.adminconfig.model.SyncTracking addSyncTracking(
	...
	*/
	@Override
	public org.opencps.adminconfig.model.SyncTracking createSyncTracking(
		long trackingId) {
	...
	*/
	@Override
	public org.opencps.adminconfig.model.SyncTracking deleteSyncTracking(
		long trackingId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	@Override
	public org.opencps.adminconfig.model.SyncTracking fetchSyncTracking(
		long trackingId) {
	...
	*/
	@Override
	public org.opencps.adminconfig.model.SyncTracking fetchSyncTrackingByUuidAndGroupId(
	...
	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByApiAndDate(
		String api, java.util.Date fromDate, java.util.Date toDate, int start,
		int end) {
		return _syncTrackingLocalService.getByApiAndDate(api, fromDate, toDate,
			start, end);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByApiAndDossierNoAndDate(
		String api, String dossierNo, java.util.Date fromDate,
		java.util.Date toDate, int start, int end) {
		return _syncTrackingLocalService.getByApiAndDossierNoAndDate(api,
			dossierNo, fromDate, toDate, start, end);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByApiAndServiceCodeAndDate(
		String api, String serviceCode, java.util.Date fromDate,
		java.util.Date toDate, int start, int end) {
		return _syncTrackingLocalService.getByApiAndServiceCodeAndDate(api,
			serviceCode, fromDate, toDate, start, end);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByApiAndServiceCodeAndDossierNoAndDate(
		String api, String dossierNo, String serviceCode,
		java.util.Date fromDate, java.util.Date toDate, int start, int end) {
		return _syncTrackingLocalService.getByApiAndServiceCodeAndDossierNoAndDate(api,
			dossierNo, serviceCode, fromDate, toDate, start, end);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByDate(
		java.util.Date fromDate, java.util.Date toDate, int start, int end) {
		return _syncTrackingLocalService.getByDate(fromDate, toDate, start, end);
	}

	@Override
	public org.opencps.adminconfig.model.SyncTracking getByDossierNo(
		String dossierNo) {
		return _syncTrackingLocalService.getByDossierNo(dossierNo);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByDossierNoAndDate(
		String dossierNo, java.util.Date fromDate, java.util.Date toDate,
		int start, int end) {
		return _syncTrackingLocalService.getByDossierNoAndDate(dossierNo,
			fromDate, toDate, start, end);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByDossierNoAndServiceCodeAndDate(
		String dossierNo, String serviceCode, java.util.Date fromDate,
		java.util.Date toDate, int start, int end) {
		return _syncTrackingLocalService.getByDossierNoAndServiceCodeAndDate(dossierNo,
			serviceCode, fromDate, toDate, start, end);
	}

	@Override
	public org.opencps.adminconfig.model.SyncTracking getByReferenceUid(
		String referenceUid) {
		return _syncTrackingLocalService.getByReferenceUid(referenceUid);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByReferenceUidAndDate(
		String referenceUid, java.util.Date fromDate, java.util.Date toDate,
		int start, int end) {
		return _syncTrackingLocalService.getByReferenceUidAndDate(referenceUid,
			fromDate, toDate, start, end);
	}

	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getByServiceCodeAndDate(
		String serviceCode, java.util.Date fromDate, java.util.Date toDate,
		int start, int end) {
		return _syncTrackingLocalService.getByServiceCodeAndDate(serviceCode,
			fromDate, toDate, start, end);
	}
	...
	*/
	@Override
	public org.opencps.adminconfig.model.SyncTracking getSyncTracking(
		long trackingId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public org.opencps.adminconfig.model.SyncTracking getSyncTrackingByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getSyncTrackings(
		int start, int end) {
	...
	*/
	@Override
	public java.util.List<org.opencps.adminconfig.model.SyncTracking> getSyncTrackingsByUuidAndCompanyId(
	...
	*/
	...
	@Override
	public org.opencps.adminconfig.model.SyncTracking updateSyncTracking(
		...
		return _syncTrackingLocalService.updateSyncTracking(userId, groupId,
			trackingId, dossierNo, referenceUid, serviceCode, stateSync, api,
