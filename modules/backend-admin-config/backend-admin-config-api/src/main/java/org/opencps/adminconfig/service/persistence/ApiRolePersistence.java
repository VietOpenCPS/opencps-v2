...
/**
 * The persistence interface for the api role service.
 *
 * <p>
 ...
 */
@ProviderType
public interface ApiRolePersistence extends BasePersistence<ApiRole> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApiRoleUtil} to access the api role persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<ApiRole> findByF_GID(long groupId);
	...
	*/
	public java.util.List<ApiRole> findByF_GID(long groupId, int start, int end);
	...
	*/
	public java.util.List<ApiRole> findByF_GID(long groupId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<ApiRole> orderByComparator);
	...
	*/
	public void cacheResult(java.util.List<ApiRole> apiRoles);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, ApiRole> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<ApiRole> findAll();
	...
	*/
	public java.util.List<ApiRole> findAll(int start, int end);
