...
/**
 * Provides the local service interface for ReportRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhth
 * @see ReportRoleLocalServiceUtil
...
public interface ReportRoleLocalService extends BaseLocalService,
	...
	*/
	...
	public ReportRole addReportRole(ReportRole reportRole);
	...
	*/
	...
	public ReportRole createReportRole(long reportRoleId);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ReportRole deleteReportRole(long reportRoleId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ReportRole deleteReportRole(ReportRole reportRole);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ReportRole getReportRole(long reportRoleId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ReportRole> getReportRoles(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public ReportRole updateReportRole(ReportRole reportRole);
}