...
/**
 * Provides the local service interface for AdminConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author binhth
 * @see AdminConfigLocalServiceUtil
...
public interface AdminConfigLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AdminConfigLocalServiceUtil} to access the admin config local service. Add custom service methods to {@link org.opencps.adminconfig.service.impl.AdminConfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AdminConfig createAdminConfig(long id);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AdminConfig deleteAdminConfig(AdminConfig adminConfig);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AdminConfig deleteAdminConfig(long id) throws PortalException;
	...
	*/
	...
	public AdminConfig fetchAdminConfig(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AdminConfig getAdminConfig(long id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AdminConfig> getAdminConfigs(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AdminConfig updateAdminConfig(AdminConfig adminConfig);
}