...
import org.opencps.adminconfig.model.impl.SyncTrackingImpl;
import org.opencps.adminconfig.model.impl.SyncTrackingModelImpl;
 ...
 * @see org.opencps.adminconfig.service.persistence.SyncTrackingUtil
 * @generated
 */
@ProviderType
public class SyncTrackingPersistenceImpl extends BasePersistenceImpl<SyncTracking>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_F_REFERENCEUID = new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByF_ReferenceUid",
			new String[] { String.class.getName() },
			SyncTrackingModelImpl.REFERENCEUID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_REFERENCEUID = new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_ReferenceUid",
			new String[] { String.class.getName() });
	...
	public SyncTracking findByF_ReferenceUid(String referenceUid)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_ReferenceUid(referenceUid);
	...
	public SyncTracking fetchByF_ReferenceUid(String referenceUid) {
		return fetchByF_ReferenceUid(referenceUid, true);
	}
	...
	public SyncTracking fetchByF_ReferenceUid(String referenceUid,
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_F_REFERENCEUID,
					finderArgs, this);
		}
		...
		if (result instanceof SyncTracking) {
			...
			if (!Objects.equals(referenceUid, syncTracking.getReferenceUid())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			if (referenceUid == null) {
				...
				query.append(_FINDER_COLUMN_F_REFERENCEUID_REFERENCEUID_3);
			}
			else {
				bindReferenceUid = true;

				query.append(_FINDER_COLUMN_F_REFERENCEUID_REFERENCEUID_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_F_REFERENCEUID,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"SyncTrackingPersistenceImpl.fetchByF_ReferenceUid(String, boolean) with parameters (" +
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_F_REFERENCEUID,
					finderArgs);
	...
	public SyncTracking removeByF_ReferenceUid(String referenceUid)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = findByF_ReferenceUid(referenceUid);
	...
	public int countByF_ReferenceUid(String referenceUid) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_REFERENCEUID;
	...
	private static final String _FINDER_COLUMN_F_REFERENCEUID_REFERENCEUID_1 = "syncTracking.referenceUid IS NULL";
	private static final String _FINDER_COLUMN_F_REFERENCEUID_REFERENCEUID_2 = "syncTracking.referenceUid = ?";
	private static final String _FINDER_COLUMN_F_REFERENCEUID_REFERENCEUID_3 = "(syncTracking.referenceUid IS NULL OR syncTracking.referenceUid = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_F_DOSSIERNO = new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByF_DossierNo",
			new String[] { String.class.getName() },
			SyncTrackingModelImpl.DOSSIERNO_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_DOSSIERNO = new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_DossierNo",
			new String[] { String.class.getName() });
	...
	public SyncTracking findByF_DossierNo(String dossierNo)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_DossierNo(dossierNo);
	...
	public SyncTracking fetchByF_DossierNo(String dossierNo) {
		return fetchByF_DossierNo(dossierNo, true);
	}
	...
	public SyncTracking fetchByF_DossierNo(String dossierNo,
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_F_DOSSIERNO,
					finderArgs, this);
		}
		...
		if (result instanceof SyncTracking) {
			...
			if (!Objects.equals(dossierNo, syncTracking.getDossierNo())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			if (dossierNo == null) {
				query.append(_FINDER_COLUMN_F_DOSSIERNO_DOSSIERNO_1);
			}
			else if (dossierNo.equals("")) {
				query.append(_FINDER_COLUMN_F_DOSSIERNO_DOSSIERNO_3);
			}
			else {
				bindDossierNo = true;

				query.append(_FINDER_COLUMN_F_DOSSIERNO_DOSSIERNO_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_F_DOSSIERNO,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"SyncTrackingPersistenceImpl.fetchByF_DossierNo(String, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_F_DOSSIERNO,
					finderArgs);
	...
	public SyncTracking removeByF_DossierNo(String dossierNo)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = findByF_DossierNo(dossierNo);
	...
	public int countByF_DossierNo(String dossierNo) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_DOSSIERNO;
	...
	private static final String _FINDER_COLUMN_F_DOSSIERNO_DOSSIERNO_1 = "syncTracking.dossierNo IS NULL";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_DOSSIERNO_2 = "syncTracking.dossierNo = ?";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_DOSSIERNO_3 = "(syncTracking.dossierNo IS NULL OR syncTracking.dossierNo = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_PROTOCOL =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_Protocol",
			new String[] {
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_Protocol",
			new String[] { String.class.getName() },
			SyncTrackingModelImpl.PROTOCOL_COLUMN_BITMASK |
			SyncTrackingModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_PROTOCOL = new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_Protocol",
			new String[] { String.class.getName() });
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_Protocol(String protocol) {
		return findByF_Protocol(protocol, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_Protocol(String protocol, int start,
		int end) {
		return findByF_Protocol(protocol, start, end, null);
	}
	...
	public List<SyncTracking> findByF_Protocol(String protocol, int start,
		...
		return findByF_Protocol(protocol, start, end, orderByComparator, true);
	}
	...
	public List<SyncTracking> findByF_Protocol(String protocol, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL;
			finderArgs = new Object[] { protocol };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_PROTOCOL;
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (SyncTracking syncTracking : list) {
					if (!Objects.equals(protocol, syncTracking.getProtocol())) {
						list = null;
		...
		if (list == null) {
			...
			if (protocol == null) {
				...
				query.append(_FINDER_COLUMN_F_PROTOCOL_PROTOCOL_3);
			}
			else {
				bindProtocol = true;

				query.append(_FINDER_COLUMN_F_PROTOCOL_PROTOCOL_2);
			}
	...
	public SyncTracking findByF_Protocol_First(String protocol,
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_Protocol_First(protocol,
				orderByComparator);
	...
	public SyncTracking fetchByF_Protocol_First(String protocol,
		OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_Protocol(protocol, 0, 1,
				orderByComparator);
	...
	public SyncTracking findByF_Protocol_Last(String protocol,
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_Protocol_Last(protocol,
				orderByComparator);
	...
	public SyncTracking fetchByF_Protocol_Last(String protocol,
		OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_Protocol(protocol);

		if (count == 0) {
			return null;
		}

		List<SyncTracking> list = findByF_Protocol(protocol, count - 1, count,
				orderByComparator);
	...
	public SyncTracking[] findByF_Protocol_PrevAndNext(long trackingId,
		...
		try {
			...
			array[0] = getByF_Protocol_PrevAndNext(session, syncTracking,
					protocol, orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_Protocol_PrevAndNext(session, syncTracking,
	...
	protected SyncTracking getByF_Protocol_PrevAndNext(Session session,
		SyncTracking syncTracking, String protocol,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_Protocol(String protocol) {
		for (SyncTracking syncTracking : findByF_Protocol(protocol,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(syncTracking);
		}
	}
	...
	public int countByF_Protocol(String protocol) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_PROTOCOL;
	...
	private static final String _FINDER_COLUMN_F_PROTOCOL_PROTOCOL_1 = "syncTracking.protocol IS NULL";
	private static final String _FINDER_COLUMN_F_PROTOCOL_PROTOCOL_2 = "syncTracking.protocol = ?";
	private static final String _FINDER_COLUMN_F_PROTOCOL_PROTOCOL_3 = "(syncTracking.protocol IS NULL OR syncTracking.protocol = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_PROTOCOL_DOSSIERNO =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_Protocol_DossierNo",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_DOSSIERNO =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			...
			SyncTrackingModelImpl.DOSSIERNO_COLUMN_BITMASK |
			SyncTrackingModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_PROTOCOL_DOSSIERNO = new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByF_Protocol_DossierNo",
			new String[] { String.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_Protocol_DossierNo(String protocol,
		String dossierNo) {
		return findByF_Protocol_DossierNo(protocol, dossierNo,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<SyncTracking> findByF_Protocol_DossierNo(String protocol,
		String dossierNo, int start, int end) {
		return findByF_Protocol_DossierNo(protocol, dossierNo, start, end, null);
	}
	...
	public List<SyncTracking> findByF_Protocol_DossierNo(String protocol,
		String dossierNo, int start, int end,
		OrderByComparator<SyncTracking> orderByComparator) {
		return findByF_Protocol_DossierNo(protocol, dossierNo, start, end,
			orderByComparator, true);
	}
	...
	public List<SyncTracking> findByF_Protocol_DossierNo(String protocol,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_DOSSIERNO;
			finderArgs = new Object[] { protocol, dossierNo };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_PROTOCOL_DOSSIERNO;
			finderArgs = new Object[] {
					protocol, dossierNo,
		...
		if (list == null) {
			...
			if (protocol == null) {
				...
				query.append(_FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_PROTOCOL_3);
			}
			else {
				bindProtocol = true;

				query.append(_FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_PROTOCOL_2);
			}

			boolean bindDossierNo = false;

			if (dossierNo == null) {
				query.append(_FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_DOSSIERNO_1);
			}
			else if (dossierNo.equals("")) {
				query.append(_FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_DOSSIERNO_3);
			}
			else {
				bindDossierNo = true;

				query.append(_FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_DOSSIERNO_2);
			}
	...
	public SyncTracking findByF_Protocol_DossierNo_First(String protocol,
		String dossierNo, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_Protocol_DossierNo_First(protocol,
	...
	public SyncTracking fetchByF_Protocol_DossierNo_First(String protocol,
		String dossierNo, OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_Protocol_DossierNo(protocol,
				dossierNo, 0, 1, orderByComparator);
	...
	public SyncTracking findByF_Protocol_DossierNo_Last(String protocol,
		String dossierNo, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_Protocol_DossierNo_Last(protocol,
				dossierNo, orderByComparator);
	...
	public SyncTracking fetchByF_Protocol_DossierNo_Last(String protocol,
		String dossierNo, OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_Protocol_DossierNo(protocol, dossierNo);
		...
		List<SyncTracking> list = findByF_Protocol_DossierNo(protocol,
				dossierNo, count - 1, count, orderByComparator);
	...
	public SyncTracking[] findByF_Protocol_DossierNo_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_Protocol_DossierNo_PrevAndNext(session,
					syncTracking, protocol, dossierNo, orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_Protocol_DossierNo_PrevAndNext(session,
					syncTracking, protocol, dossierNo, orderByComparator, false);
	...
	protected SyncTracking getByF_Protocol_DossierNo_PrevAndNext(
		Session session, SyncTracking syncTracking, String protocol,
		String dossierNo, OrderByComparator<SyncTracking> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_Protocol_DossierNo(String protocol, String dossierNo) {
		for (SyncTracking syncTracking : findByF_Protocol_DossierNo(protocol,
	...
	public int countByF_Protocol_DossierNo(String protocol, String dossierNo) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_PROTOCOL_DOSSIERNO;

		Object[] finderArgs = new Object[] { protocol, dossierNo };
	...
	private static final String _FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_PROTOCOL_1 = "syncTracking.protocol IS NULL AND ";
	private static final String _FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_PROTOCOL_2 = "syncTracking.protocol = ? AND ";
	private static final String _FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_PROTOCOL_3 = "(syncTracking.protocol IS NULL OR syncTracking.protocol = '') AND ";
	private static final String _FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_DOSSIERNO_1 = "syncTracking.dossierNo IS NULL";
	private static final String _FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_DOSSIERNO_2 = "syncTracking.dossierNo = ?";
	private static final String _FINDER_COLUMN_F_PROTOCOL_DOSSIERNO_DOSSIERNO_3 = "(syncTracking.dossierNo IS NULL OR syncTracking.dossierNo = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_PROTOCOL_SERVICECODE =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_Protocol_ServiceCode",
			new String[] {
				String.class.getName(), String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_SERVICECODE =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByF_Protocol_ServiceCode",
			...
			SyncTrackingModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_PROTOCOL_SERVICECODE = new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByF_Protocol_ServiceCode",
			new String[] { String.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_Protocol_ServiceCode(String protocol,
		String serviceCode) {
		return findByF_Protocol_ServiceCode(protocol, serviceCode,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_Protocol_ServiceCode(String protocol,
		...
		return findByF_Protocol_ServiceCode(protocol, serviceCode, start, end,
			null);
	}
	...
	public List<SyncTracking> findByF_Protocol_ServiceCode(String protocol,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_SERVICECODE;
			finderArgs = new Object[] { protocol, serviceCode };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_PROTOCOL_SERVICECODE;
			finderArgs = new Object[] {
					protocol, serviceCode,
		...
		if (list == null) {
			...
			if (protocol == null) {
				...
				query.append(_FINDER_COLUMN_F_PROTOCOL_SERVICECODE_PROTOCOL_3);
			}
			else {
				bindProtocol = true;

				query.append(_FINDER_COLUMN_F_PROTOCOL_SERVICECODE_PROTOCOL_2);
			}

			boolean bindServiceCode = false;

			if (serviceCode == null) {
				query.append(_FINDER_COLUMN_F_PROTOCOL_SERVICECODE_SERVICECODE_1);
			}
			else if (serviceCode.equals("")) {
				query.append(_FINDER_COLUMN_F_PROTOCOL_SERVICECODE_SERVICECODE_3);
			}
			else {
				bindServiceCode = true;

				query.append(_FINDER_COLUMN_F_PROTOCOL_SERVICECODE_SERVICECODE_2);
			}
	...
	public SyncTracking findByF_Protocol_ServiceCode_First(String protocol,
		String serviceCode, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_Protocol_ServiceCode_First(protocol,
	...
	public SyncTracking fetchByF_Protocol_ServiceCode_First(String protocol,
		String serviceCode, OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_Protocol_ServiceCode(protocol,
	...
	public SyncTracking findByF_Protocol_ServiceCode_Last(String protocol,
		String serviceCode, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_Protocol_ServiceCode_Last(protocol,
				serviceCode, orderByComparator);
	...
	public SyncTracking fetchByF_Protocol_ServiceCode_Last(String protocol,
		String serviceCode, OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_Protocol_ServiceCode(protocol, serviceCode);
	...
	public SyncTracking[] findByF_Protocol_ServiceCode_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_Protocol_ServiceCode_PrevAndNext(session,
					syncTracking, protocol, serviceCode, orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_Protocol_ServiceCode_PrevAndNext(session,
					syncTracking, protocol, serviceCode, orderByComparator,
					false);
	...
	protected SyncTracking getByF_Protocol_ServiceCode_PrevAndNext(
		Session session, SyncTracking syncTracking, String protocol,
		String serviceCode, OrderByComparator<SyncTracking> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_Protocol_ServiceCode(String protocol,
		String serviceCode) {
		for (SyncTracking syncTracking : findByF_Protocol_ServiceCode(
				protocol, serviceCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(syncTracking);
		}
	}
	...
	public int countByF_Protocol_ServiceCode(String protocol, String serviceCode) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_PROTOCOL_SERVICECODE;

		Object[] finderArgs = new Object[] { protocol, serviceCode };
	...
	private static final String _FINDER_COLUMN_F_PROTOCOL_SERVICECODE_PROTOCOL_1 =
		"syncTracking.protocol IS NULL AND ";
	private static final String _FINDER_COLUMN_F_PROTOCOL_SERVICECODE_PROTOCOL_2 =
		"syncTracking.protocol = ? AND ";
	private static final String _FINDER_COLUMN_F_PROTOCOL_SERVICECODE_PROTOCOL_3 =
		"(syncTracking.protocol IS NULL OR syncTracking.protocol = '') AND ";
	private static final String _FINDER_COLUMN_F_PROTOCOL_SERVICECODE_SERVICECODE_1 =
		"syncTracking.serviceCode IS NULL";
	private static final String _FINDER_COLUMN_F_PROTOCOL_SERVICECODE_SERVICECODE_2 =
		"syncTracking.serviceCode = ?";
	private static final String _FINDER_COLUMN_F_PROTOCOL_SERVICECODE_SERVICECODE_3 =
		"(syncTracking.serviceCode IS NULL OR syncTracking.serviceCode = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_CREATED_BETWEEN",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByF_CREATED_BETWEEN",
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_CREATED_BETWEEN(Date createDate,
		Date modifiedDate) {
		return findByF_CREATED_BETWEEN(createDate, modifiedDate,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_CREATED_BETWEEN(Date createDate,
		...
		return findByF_CREATED_BETWEEN(createDate, modifiedDate, start, end,
			null);
	}
	...
	public List<SyncTracking> findByF_CREATED_BETWEEN(Date createDate,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_CREATED_BETWEEN;
		finderArgs = new Object[] {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (SyncTracking syncTracking : list) {
					if ((createDate.getTime() > syncTracking.getCreateDate()
																.getTime()) ||
		...
		if (list == null) {
			...
			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_CREATED_BETWEEN_First(Date createDate,
		...
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_CREATED_BETWEEN_First(createDate,
	...
	public SyncTracking fetchByF_CREATED_BETWEEN_First(Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_CREATED_BETWEEN(createDate,
	...
	public SyncTracking findByF_CREATED_BETWEEN_Last(Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_CREATED_BETWEEN_Last(createDate,
				modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_CREATED_BETWEEN_Last(Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_CREATED_BETWEEN(createDate, modifiedDate);
	...
	public SyncTracking[] findByF_CREATED_BETWEEN_PrevAndNext(long trackingId,
		...
		try {
			...
			array[0] = getByF_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, createDate, modifiedDate, orderByComparator,
					true);

			array[1] = syncTracking;

			array[2] = getByF_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, createDate, modifiedDate, orderByComparator,
					false);
	...
	protected SyncTracking getByF_CREATED_BETWEEN_PrevAndNext(Session session,
		SyncTracking syncTracking, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_CREATED_BETWEEN(Date createDate, Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_CREATED_BETWEEN(createDate,
	...
	public int countByF_CREATED_BETWEEN(Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_CREATED_BETWEEN_CREATEDATE_1 = "syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_CREATED_BETWEEN_CREATEDATE_2 = "syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_CREATED_BETWEEN_MODIFIEDDATE_1 = "syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_CREATED_BETWEEN_MODIFIEDDATE_2 = "syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_DOSSIERNO_CREATED_BETWEEN",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByF_DOSSIERNO_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), Date.class.getName(),
				Date.class.getName()
			});
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_DOSSIERNO_CREATED_BETWEEN(
		String dossierNo, Date createDate, Date modifiedDate) {
		return findByF_DOSSIERNO_CREATED_BETWEEN(dossierNo, createDate,
			modifiedDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_DOSSIERNO_CREATED_BETWEEN(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_DOSSIERNO_CREATED_BETWEEN;
		finderArgs = new Object[] {
		...
		if (list == null) {
			...
			if (dossierNo == null) {
				query.append(_FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1);
			}
			else if (dossierNo.equals("")) {
				query.append(_FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3);
			}
			else {
				bindDossierNo = true;

				query.append(_FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_DOSSIERNO_CREATED_BETWEEN_First(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_DOSSIERNO_CREATED_BETWEEN_First(dossierNo,
	...
	public SyncTracking fetchByF_DOSSIERNO_CREATED_BETWEEN_First(
		String dossierNo, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_DOSSIERNO_CREATED_BETWEEN(dossierNo,
	...
	public SyncTracking findByF_DOSSIERNO_CREATED_BETWEEN_Last(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_DOSSIERNO_CREATED_BETWEEN_Last(dossierNo,
				createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_DOSSIERNO_CREATED_BETWEEN_Last(
		String dossierNo, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_DOSSIERNO_CREATED_BETWEEN(dossierNo, createDate,
				modifiedDate);
	...
	public SyncTracking[] findByF_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, dossierNo, createDate, modifiedDate,
					orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, dossierNo, createDate, modifiedDate,
					orderByComparator, false);
	...
	protected SyncTracking getByF_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String dossierNo,
		Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_DOSSIERNO_CREATED_BETWEEN(String dossierNo,
		Date createDate, Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_DOSSIERNO_CREATED_BETWEEN(
				dossierNo, createDate, modifiedDate, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(syncTracking);
		}
	}
	...
	public int countByF_DOSSIERNO_CREATED_BETWEEN(String dossierNo,
		Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_DOSSIERNO_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1 =
		"syncTracking.dossierNo IS NULL AND ";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2 =
		"syncTracking.dossierNo = ? AND ";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3 =
		"(syncTracking.dossierNo IS NULL OR syncTracking.dossierNo = '') AND ";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_REFERENCE_UID_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_REFERENCE_UID_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByF_REFERENCE_UID_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), Date.class.getName(),
				Date.class.getName()
			});
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_REFERENCE_UID_CREATED_BETWEEN(
		String referenceUid, Date createDate, Date modifiedDate) {
		return findByF_REFERENCE_UID_CREATED_BETWEEN(referenceUid, createDate,
			modifiedDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_REFERENCE_UID_CREATED_BETWEEN(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_REFERENCE_UID_CREATED_BETWEEN;
		finderArgs = new Object[] {
				referenceUid, _getTime(createDate), _getTime(modifiedDate),
		...
		if (list == null) {
			...
			if (referenceUid == null) {
				...
				query.append(_FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_REFERENCEUID_3);
			}
			else {
				bindReferenceUid = true;

				query.append(_FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_REFERENCEUID_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_REFERENCE_UID_CREATED_BETWEEN_First(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_REFERENCE_UID_CREATED_BETWEEN_First(referenceUid,
				createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_REFERENCE_UID_CREATED_BETWEEN_First(
		String referenceUid, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_REFERENCE_UID_CREATED_BETWEEN(referenceUid,
				createDate, modifiedDate, 0, 1, orderByComparator);
	...
	public SyncTracking findByF_REFERENCE_UID_CREATED_BETWEEN_Last(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_REFERENCE_UID_CREATED_BETWEEN_Last(referenceUid,
				createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_REFERENCE_UID_CREATED_BETWEEN_Last(
		String referenceUid, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_REFERENCE_UID_CREATED_BETWEEN(referenceUid,
	...
	public SyncTracking[] findByF_REFERENCE_UID_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_REFERENCE_UID_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, referenceUid, createDate, modifiedDate,
					orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_REFERENCE_UID_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, referenceUid, createDate, modifiedDate,
					orderByComparator, false);
	...
	protected SyncTracking getByF_REFERENCE_UID_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String referenceUid,
		Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_REFERENCE_UID_CREATED_BETWEEN(String referenceUid,
		Date createDate, Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_REFERENCE_UID_CREATED_BETWEEN(
				referenceUid, createDate, modifiedDate, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(syncTracking);
		}
	}
	...
	public int countByF_REFERENCE_UID_CREATED_BETWEEN(String referenceUid,
		Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_REFERENCE_UID_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_REFERENCEUID_1 =
		"syncTracking.referenceUid IS NULL AND ";
	private static final String _FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_REFERENCEUID_2 =
		"syncTracking.referenceUid = ? AND ";
	private static final String _FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_REFERENCEUID_3 =
		"(syncTracking.referenceUid IS NULL OR syncTracking.referenceUid = '') AND ";
	private static final String _FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_REFERENCE_UID_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_SERVICECODE_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_SERVICECODE_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_SERVICECODE_CREATED_BETWEEN(
		String serviceCode, Date createDate, Date modifiedDate) {
		return findByF_SERVICECODE_CREATED_BETWEEN(serviceCode, createDate,
			modifiedDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_SERVICECODE_CREATED_BETWEEN(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_SERVICECODE_CREATED_BETWEEN;
		finderArgs = new Object[] {
		...
		if (list == null) {
			...
			if (serviceCode == null) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_SERVICECODE_1);
			}
			else if (serviceCode.equals("")) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_SERVICECODE_3);
			}
			else {
				bindServiceCode = true;

				query.append(_FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_SERVICECODE_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_SERVICECODE_CREATED_BETWEEN_First(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_SERVICECODE_CREATED_BETWEEN_First(serviceCode,
				createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_SERVICECODE_CREATED_BETWEEN_First(
		String serviceCode, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_SERVICECODE_CREATED_BETWEEN(serviceCode,
				createDate, modifiedDate, 0, 1, orderByComparator);
	...
	public SyncTracking findByF_SERVICECODE_CREATED_BETWEEN_Last(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_SERVICECODE_CREATED_BETWEEN_Last(serviceCode,
				createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_SERVICECODE_CREATED_BETWEEN_Last(
		String serviceCode, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_SERVICECODE_CREATED_BETWEEN(serviceCode,
				createDate, modifiedDate);
	...
	public SyncTracking[] findByF_SERVICECODE_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_SERVICECODE_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, serviceCode, createDate, modifiedDate,
					orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_SERVICECODE_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, serviceCode, createDate, modifiedDate,
					orderByComparator, false);
	...
	protected SyncTracking getByF_SERVICECODE_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String serviceCode,
		Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_SERVICECODE_CREATED_BETWEEN(String serviceCode,
		Date createDate, Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_SERVICECODE_CREATED_BETWEEN(
				serviceCode, createDate, modifiedDate, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(syncTracking);
		}
	}
	...
	public int countByF_SERVICECODE_CREATED_BETWEEN(String serviceCode,
		Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_SERVICECODE_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_SERVICECODE_1 =
		"syncTracking.serviceCode IS NULL AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_SERVICECODE_2 =
		"syncTracking.serviceCode = ? AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_SERVICECODE_3 =
		"(syncTracking.serviceCode IS NULL OR syncTracking.serviceCode = '') AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), String.class.getName(),
				Date.class.getName(), Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		String serviceCode, String dossierNo, Date createDate, Date modifiedDate) {
		return findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(serviceCode,
			dossierNo, createDate, modifiedDate, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		...
		Date modifiedDate, int start, int end) {
		return findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(serviceCode,
			dossierNo, createDate, modifiedDate, start, end, null);
	}
	...
	public List<SyncTracking> findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN;
		finderArgs = new Object[] {
				serviceCode, dossierNo, _getTime(createDate),
		...
		if (list == null) {
			...
			if (serviceCode == null) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_1);
			}
			else if (serviceCode.equals("")) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_3);
			}
			else {
				bindServiceCode = true;

				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_2);
			}

			boolean bindDossierNo = false;

			if (dossierNo == null) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1);
			}
			else if (dossierNo.equals("")) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3);
			}
			else {
				bindDossierNo = true;

				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_First(
		...
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_First(serviceCode,
	...
	public SyncTracking fetchByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_First(
		String serviceCode, String dossierNo, Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(serviceCode,
	...
	public SyncTracking findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_Last(
		...
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_Last(serviceCode,
				dossierNo, createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_Last(
		String serviceCode, String dossierNo, Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(serviceCode,
	...
	public SyncTracking[] findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, serviceCode, dossierNo, createDate,
					modifiedDate, orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, serviceCode, dossierNo, createDate,
	...
	protected SyncTracking getByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String serviceCode,
		String dossierNo, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		String serviceCode, String dossierNo, Date createDate, Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
	...
	public int countByF_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		String serviceCode, String dossierNo, Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_1 =
		"syncTracking.serviceCode IS NULL AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_2 =
		"syncTracking.serviceCode = ? AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_3 =
		"(syncTracking.serviceCode IS NULL OR syncTracking.serviceCode = '') AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1 =
		"syncTracking.dossierNo IS NULL AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2 =
		"syncTracking.dossierNo = ? AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3 =
		"(syncTracking.dossierNo IS NULL OR syncTracking.dossierNo = '') AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), String.class.getName(),
				String.class.getName(), Date.class.getName(),
				Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), String.class.getName(),
				String.class.getName(), Date.class.getName(),
				Date.class.getName()
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		String api, String serviceCode, String dossierNo, Date createDate,
		Date modifiedDate) {
		return findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(api,
			serviceCode, dossierNo, createDate, modifiedDate,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN;
		finderArgs = new Object[] {
				api, serviceCode, dossierNo, _getTime(createDate),
				_getTime(modifiedDate),
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (SyncTracking syncTracking : list) {
					if (!Objects.equals(api, syncTracking.getApi()) ||
							!Objects.equals(serviceCode,
								syncTracking.getServiceCode()) ||
							!Objects.equals(dossierNo,
								syncTracking.getDossierNo()) ||
		...
		if (list == null) {
			...
			if (api == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_API_1);
			}
			else if (api.equals("")) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_API_3);
			}
			else {
				bindApi = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_API_2);
			}

			boolean bindServiceCode = false;

			if (serviceCode == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_1);
			}
			else if (serviceCode.equals("")) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_3);
			}
			else {
				bindServiceCode = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_2);
			}

			boolean bindDossierNo = false;

			if (dossierNo == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1);
			}
			else if (dossierNo.equals("")) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3);
			}
			else {
				bindDossierNo = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_First(
		...
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_First(api,
				serviceCode, dossierNo, createDate, modifiedDate,
				orderByComparator);
	...
	public SyncTracking fetchByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_First(
		String api, String serviceCode, String dossierNo, Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(api,
	...
	public SyncTracking findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_Last(
		...
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_Last(api,
				serviceCode, dossierNo, createDate, modifiedDate,
				orderByComparator);
	...
	public SyncTracking fetchByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_Last(
		String api, String serviceCode, String dossierNo, Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(api,
				serviceCode, dossierNo, createDate, modifiedDate);
	...
	public SyncTracking[] findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, serviceCode, dossierNo, createDate,
					modifiedDate, orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, serviceCode, dossierNo, createDate,
					modifiedDate, orderByComparator, false);
	...
	protected SyncTracking getByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String api,
		String serviceCode, String dossierNo, Date createDate,
		Date modifiedDate, OrderByComparator<SyncTracking> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
		String api, String serviceCode, String dossierNo, Date createDate,
		Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(
	...
	public int countByF_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN(String api,
		String serviceCode, String dossierNo, Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_API_1 =
		"syncTracking.api IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_API_2 =
		"syncTracking.api = ? AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_API_3 =
		"(syncTracking.api IS NULL OR syncTracking.api = '') AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_1 =
		"syncTracking.serviceCode IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_2 =
		"syncTracking.serviceCode = ? AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_SERVICECODE_3 =
		"(syncTracking.serviceCode IS NULL OR syncTracking.serviceCode = '') AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1 =
		"syncTracking.dossierNo IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2 =
		"syncTracking.dossierNo = ? AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3 =
		"(syncTracking.dossierNo IS NULL OR syncTracking.dossierNo = '') AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_SERVICECODE_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_SERVICECODE_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByF_API_SERVICECODE_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), String.class.getName(),
				Date.class.getName(), Date.class.getName()
			});
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_API_SERVICECODE_CREATED_BETWEEN(
		String api, String serviceCode, Date createDate, Date modifiedDate) {
		return findByF_API_SERVICECODE_CREATED_BETWEEN(api, serviceCode,
	...
	public List<SyncTracking> findByF_API_SERVICECODE_CREATED_BETWEEN(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_SERVICECODE_CREATED_BETWEEN;
		finderArgs = new Object[] {
				api, serviceCode, _getTime(createDate), _getTime(modifiedDate),
		...
		if (list == null) {
			...
			if (api == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_API_1);
			}
			else if (api.equals("")) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_API_3);
			}
			else {
				bindApi = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_API_2);
			}

			boolean bindServiceCode = false;

			if (serviceCode == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_SERVICECODE_1);
			}
			else if (serviceCode.equals("")) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_SERVICECODE_3);
			}
			else {
				bindServiceCode = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_SERVICECODE_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_API_SERVICECODE_CREATED_BETWEEN_First(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_SERVICECODE_CREATED_BETWEEN_First(api,
	...
	public SyncTracking fetchByF_API_SERVICECODE_CREATED_BETWEEN_First(
		String api, String serviceCode, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_API_SERVICECODE_CREATED_BETWEEN(api,
	...
	public SyncTracking findByF_API_SERVICECODE_CREATED_BETWEEN_Last(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_SERVICECODE_CREATED_BETWEEN_Last(api,
				serviceCode, createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_API_SERVICECODE_CREATED_BETWEEN_Last(
		String api, String serviceCode, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_API_SERVICECODE_CREATED_BETWEEN(api, serviceCode,
				createDate, modifiedDate);
	...
	public SyncTracking[] findByF_API_SERVICECODE_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_API_SERVICECODE_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, serviceCode, createDate, modifiedDate,
					orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_API_SERVICECODE_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, serviceCode, createDate, modifiedDate,
					orderByComparator, false);
	...
	protected SyncTracking getByF_API_SERVICECODE_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String api,
		String serviceCode, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_API_SERVICECODE_CREATED_BETWEEN(String api,
		String serviceCode, Date createDate, Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_API_SERVICECODE_CREATED_BETWEEN(
				api, serviceCode, createDate, modifiedDate, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(syncTracking);
		}
	}
	...
	public int countByF_API_SERVICECODE_CREATED_BETWEEN(String api,
		String serviceCode, Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_SERVICECODE_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_API_1 =
		"syncTracking.api IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_API_2 =
		"syncTracking.api = ? AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_API_3 =
		"(syncTracking.api IS NULL OR syncTracking.api = '') AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_SERVICECODE_1 =
		"syncTracking.serviceCode IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_SERVICECODE_2 =
		"syncTracking.serviceCode = ? AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_SERVICECODE_3 =
		"(syncTracking.serviceCode IS NULL OR syncTracking.serviceCode = '') AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_API_SERVICECODE_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_API_DOSSIERNO_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), String.class.getName(),
				Date.class.getName(), Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_DOSSIERNO_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByF_API_DOSSIERNO_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), String.class.getName(),
				Date.class.getName(), Date.class.getName()
			});
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_API_DOSSIERNO_CREATED_BETWEEN(
		String api, String dossierNo, Date createDate, Date modifiedDate) {
		return findByF_API_DOSSIERNO_CREATED_BETWEEN(api, dossierNo,
			createDate, modifiedDate, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_API_DOSSIERNO_CREATED_BETWEEN(
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_DOSSIERNO_CREATED_BETWEEN;
		finderArgs = new Object[] {
				api, dossierNo, _getTime(createDate), _getTime(modifiedDate),
		...
		if (list == null) {
			...
			if (api == null) {
				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_API_1);
			}
			else if (api.equals("")) {
				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_API_3);
			}
			else {
				bindApi = true;

				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_API_2);
			}

			boolean bindDossierNo = false;

			if (dossierNo == null) {
				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1);
			}
			else if (dossierNo.equals("")) {
				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3);
			}
			else {
				bindDossierNo = true;

				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_API_DOSSIERNO_CREATED_BETWEEN_First(
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_DOSSIERNO_CREATED_BETWEEN_First(api,
				dossierNo, createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_API_DOSSIERNO_CREATED_BETWEEN_First(
		String api, String dossierNo, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_API_DOSSIERNO_CREATED_BETWEEN(api,
				dossierNo, createDate, modifiedDate, 0, 1, orderByComparator);
	...
	public SyncTracking findByF_API_DOSSIERNO_CREATED_BETWEEN_Last(String api,
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_DOSSIERNO_CREATED_BETWEEN_Last(api,
				dossierNo, createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_API_DOSSIERNO_CREATED_BETWEEN_Last(
		String api, String dossierNo, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_API_DOSSIERNO_CREATED_BETWEEN(api, dossierNo,
				createDate, modifiedDate);
	...
	public SyncTracking[] findByF_API_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_API_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, dossierNo, createDate, modifiedDate,
					orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_API_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, dossierNo, createDate, modifiedDate,
					orderByComparator, false);
	...
	protected SyncTracking getByF_API_DOSSIERNO_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String api,
		String dossierNo, Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_API_DOSSIERNO_CREATED_BETWEEN(String api,
		String dossierNo, Date createDate, Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_API_DOSSIERNO_CREATED_BETWEEN(
				api, dossierNo, createDate, modifiedDate, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(syncTracking);
		}
	}
	...
	public int countByF_API_DOSSIERNO_CREATED_BETWEEN(String api,
		String dossierNo, Date createDate, Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_DOSSIERNO_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_API_1 =
		"syncTracking.api IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_API_2 =
		"syncTracking.api = ? AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_API_3 =
		"(syncTracking.api IS NULL OR syncTracking.api = '') AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_1 =
		"syncTracking.dossierNo IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_2 =
		"syncTracking.dossierNo = ? AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_DOSSIERNO_3 =
		"(syncTracking.dossierNo IS NULL OR syncTracking.dossierNo = '') AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_API_DOSSIERNO_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, SyncTrackingImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByF_API_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), Date.class.getName(),
				Date.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_CREATED_BETWEEN =
		new FinderPath(SyncTrackingModelImpl.ENTITY_CACHE_ENABLED,
			SyncTrackingModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByF_API_CREATED_BETWEEN",
			new String[] {
				String.class.getName(), Date.class.getName(),
				Date.class.getName()
			});
	 ...
	 */
	@Override
	public List<SyncTracking> findByF_API_CREATED_BETWEEN(String api,
		Date createDate, Date modifiedDate) {
		return findByF_API_CREATED_BETWEEN(api, createDate, modifiedDate,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<SyncTracking> findByF_API_CREATED_BETWEEN(String api,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_API_CREATED_BETWEEN;
		finderArgs = new Object[] {
				api, _getTime(createDate), _getTime(modifiedDate),
		...
		if (list == null) {
			...
			if (api == null) {
				query.append(_FINDER_COLUMN_F_API_CREATED_BETWEEN_API_1);
			}
			else if (api.equals("")) {
				query.append(_FINDER_COLUMN_F_API_CREATED_BETWEEN_API_3);
			}
			else {
				bindApi = true;

				query.append(_FINDER_COLUMN_F_API_CREATED_BETWEEN_API_2);
			}

			boolean bindCreateDate = false;

			if (createDate == null) {
				query.append(_FINDER_COLUMN_F_API_CREATED_BETWEEN_CREATEDATE_1);
			}
			else {
				bindCreateDate = true;

				query.append(_FINDER_COLUMN_F_API_CREATED_BETWEEN_CREATEDATE_2);
			}

			boolean bindModifiedDate = false;

			if (modifiedDate == null) {
				query.append(_FINDER_COLUMN_F_API_CREATED_BETWEEN_MODIFIEDDATE_1);
			}
			else {
				bindModifiedDate = true;

				query.append(_FINDER_COLUMN_F_API_CREATED_BETWEEN_MODIFIEDDATE_2);
			}
	...
	public SyncTracking findByF_API_CREATED_BETWEEN_First(String api,
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_CREATED_BETWEEN_First(api,
				createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_API_CREATED_BETWEEN_First(String api,
		Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		List<SyncTracking> list = findByF_API_CREATED_BETWEEN(api, createDate,
				modifiedDate, 0, 1, orderByComparator);
	...
	public SyncTracking findByF_API_CREATED_BETWEEN_Last(String api,
		...
		OrderByComparator<SyncTracking> orderByComparator)
		throws NoSuchSyncTrackingException {
		SyncTracking syncTracking = fetchByF_API_CREATED_BETWEEN_Last(api,
				createDate, modifiedDate, orderByComparator);
	...
	public SyncTracking fetchByF_API_CREATED_BETWEEN_Last(String api,
		Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator) {
		int count = countByF_API_CREATED_BETWEEN(api, createDate, modifiedDate);
	...
	public SyncTracking[] findByF_API_CREATED_BETWEEN_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_API_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, createDate, modifiedDate,
					orderByComparator, true);

			array[1] = syncTracking;

			array[2] = getByF_API_CREATED_BETWEEN_PrevAndNext(session,
					syncTracking, api, createDate, modifiedDate,
					orderByComparator, false);
	...
	protected SyncTracking getByF_API_CREATED_BETWEEN_PrevAndNext(
		Session session, SyncTracking syncTracking, String api,
		Date createDate, Date modifiedDate,
		OrderByComparator<SyncTracking> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByF_API_CREATED_BETWEEN(String api, Date createDate,
		Date modifiedDate) {
		for (SyncTracking syncTracking : findByF_API_CREATED_BETWEEN(api,
	...
	public int countByF_API_CREATED_BETWEEN(String api, Date createDate,
		Date modifiedDate) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_API_CREATED_BETWEEN;
	...
	private static final String _FINDER_COLUMN_F_API_CREATED_BETWEEN_API_1 = "syncTracking.api IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_CREATED_BETWEEN_API_2 = "syncTracking.api = ? AND ";
	private static final String _FINDER_COLUMN_F_API_CREATED_BETWEEN_API_3 = "(syncTracking.api IS NULL OR syncTracking.api = '') AND ";
	private static final String _FINDER_COLUMN_F_API_CREATED_BETWEEN_CREATEDATE_1 =
		"syncTracking.createDate IS NULL AND ";
	private static final String _FINDER_COLUMN_F_API_CREATED_BETWEEN_CREATEDATE_2 =
		"syncTracking.createDate >= ? AND ";
	private static final String _FINDER_COLUMN_F_API_CREATED_BETWEEN_MODIFIEDDATE_1 =
		"syncTracking.modifiedDate IS NULL";
	private static final String _FINDER_COLUMN_F_API_CREATED_BETWEEN_MODIFIEDDATE_2 =
		"syncTracking.modifiedDate <= ?";
	...
	public void cacheResult(SyncTracking syncTracking) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_F_REFERENCEUID,
			new Object[] { syncTracking.getReferenceUid() }, syncTracking);

		finderCache.putResult(FINDER_PATH_FETCH_BY_F_DOSSIERNO,
			new Object[] { syncTracking.getDossierNo() }, syncTracking);
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] { syncTrackingModelImpl.getReferenceUid() };

		finderCache.putResult(FINDER_PATH_COUNT_BY_F_REFERENCEUID, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_F_REFERENCEUID, args,
			syncTrackingModelImpl, false);

		args = new Object[] { syncTrackingModelImpl.getDossierNo() };

		finderCache.putResult(FINDER_PATH_COUNT_BY_F_DOSSIERNO, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_F_DOSSIERNO, args,
			syncTrackingModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			Object[] args = new Object[] { syncTrackingModelImpl.getReferenceUid() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_REFERENCEUID, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_F_REFERENCEUID, args);
		}

		if ((syncTrackingModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_F_REFERENCEUID.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
		...
		if (clearCurrent) {
			Object[] args = new Object[] { syncTrackingModelImpl.getDossierNo() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_DOSSIERNO, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_F_DOSSIERNO, args);
		}

		if ((syncTrackingModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_F_DOSSIERNO.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
	...
	public SyncTracking updateImpl(SyncTracking syncTracking) {
		...
		if (!SyncTrackingModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			args = new Object[] { syncTrackingModelImpl.getProtocol() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_PROTOCOL, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_PROTOCOL_DOSSIERNO,
				args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_DOSSIERNO,
				args);
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_PROTOCOL_SERVICECODE,
				args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_SERVICECODE,
				args);
			...
			if ((syncTrackingModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
			...
			if ((syncTrackingModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_DOSSIERNO.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						syncTrackingModelImpl.getOriginalProtocol(),
						syncTrackingModelImpl.getOriginalDossierNo()
					};
			...
			if ((syncTrackingModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_PROTOCOL_SERVICECODE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						syncTrackingModelImpl.getOriginalProtocol(),
