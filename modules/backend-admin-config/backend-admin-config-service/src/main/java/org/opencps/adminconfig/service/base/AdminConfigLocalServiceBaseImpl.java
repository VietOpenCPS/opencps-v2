...
/**
 * Provides the base implementation for the admin config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.adminconfig.service.impl.AdminConfigLocalServiceImpl}.
 * </p>
 *
 * @author binhth
 ...
 */
@ProviderType
public abstract class AdminConfigLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AdminConfigLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.adminconfig.service.AdminConfigLocalServiceUtil} to access the admin config local service.
	 */
	...
	public AdminConfig addAdminConfig(AdminConfig adminConfig) {
		...
		return adminConfigPersistence.update(adminConfig);
	}
	...
	public AdminConfig createAdminConfig(long id) {
		return adminConfigPersistence.create(id);
	}
	...
	public AdminConfig deleteAdminConfig(long id) throws PortalException {
		return adminConfigPersistence.remove(id);
	}
	...
	public AdminConfig deleteAdminConfig(AdminConfig adminConfig) {
		return adminConfigPersistence.remove(adminConfig);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AdminConfig.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return adminConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return adminConfigPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return adminConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AdminConfig fetchAdminConfig(long id) {
		return adminConfigPersistence.fetchByPrimaryKey(id);
	}
	...
	public AdminConfig getAdminConfig(long id) throws PortalException {
		return adminConfigPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(adminConfigLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AdminConfig.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(adminConfigLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AdminConfig.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return adminConfigLocalService.deleteAdminConfig((AdminConfig)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return adminConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AdminConfig> getAdminConfigs(int start, int end) {
		return adminConfigPersistence.findAll(start, end);
	}
	...
	public int getAdminConfigsCount() {
		return adminConfigPersistence.countAll();
	}
	 ...
	 */
	public AdminConfigLocalService getAdminConfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.adminconfig.model.AdminConfig",
			adminConfigLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.adminconfig.model.AdminConfig");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AdminConfigLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = adminConfigPersistence.getDataSource();
	...
	@BeanReference(type = AdminConfigLocalService.class)
