...
import backend.feedback.service.action.VotingActions;
import backend.feedback.service.action.impl.VotingActionsImpl;
import backend.postal.api.rest.controller.VotingManagement;

public class VotingManagementImpl implements VotingManagement {

	Log _log = LogFactoryUtil.getLog(VotingManagement.class);
