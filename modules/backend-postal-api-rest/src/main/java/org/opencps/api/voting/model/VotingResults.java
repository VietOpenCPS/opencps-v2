 ...
 *         &lt;element name="data" type="{}VotingDataModel" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class VotingResults {
    ...
    protected List<VotingDataModel> data;
    protected Long votingCount;
     ...
     * {@link VotingDataModel }
     * 
     * 
     */
    public List<VotingDataModel> getData() {
        if (data == null) {
            data = new ArrayList<VotingDataModel>();
        }
        return this.data;
    }
