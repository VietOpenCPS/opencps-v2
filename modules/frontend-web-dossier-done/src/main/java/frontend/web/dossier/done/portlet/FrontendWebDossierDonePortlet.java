package frontend.web.dossier.done.portlet;

import frontend.web.dossier.done.constants.FrontendWebDossierDonePortletKeys;
...
@Component(
	...
	property = {
		...
		"com.liferay.portlet.display-category=category.dossierdone",
		"com.liferay.portlet.instanceable=false",
		"javax.portlet.display-name=frontend-web-dossier-done Portlet",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=/templates/view.ftl",
		"javax.portlet.name=" + FrontendWebDossierDonePortletKeys.FrontendWebDossierDone,
...
public class FrontendWebDossierDonePortlet extends FreeMarkerPortlet {
