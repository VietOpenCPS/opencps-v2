        ...
        var dossierViewJX = new VueJX({
            ...
            schema: {
                ...
                'keywordsSearchDanhSachHoSo': {
                    ...
                    'solo': true,
                    'append_icon': 'search',
                    'onKeyup': 'filterDanhSachHoSo',
                    'events': {
                        filterDanhSachHoSo: function (event) {
                            var vm = this;
...
body .table__overflow table.table th:nth-child(2) {
  width: 350px;
}
body .table__overflow table.table th:nth-child(5) {
  width: 350px;
}
