...
public class DossierSearchModel {
    ...
    @QueryParam(value = "notDossierId")
    protected String notDossierId;

	public String getNotDossierId() {
		return notDossierId;
	}

	public void setNotDossierId(String notDossierId) {
		this.notDossierId = notDossierId;
	}
