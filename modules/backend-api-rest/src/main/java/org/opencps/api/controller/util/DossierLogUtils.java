...
public class DossierLogUtils {
	...
	public static List<DossierLogModel> mappingToDossierLogData(
	        List<DossierLog> dossierLogs) {
    ...
    public static DossierLogModel mappingToDossierLogModel(
    ...
    public static List<DossierLogModel> mappingToDossierLogResultsModel(
        List<Document> documents) {

        List<DossierLogModel> outputs =
            new ArrayList<DossierLogModel>();

        for (Document document : documents) {

        	DossierLogModel model =
                new DossierLogModel();
    ...
    public static List<DossierLogSearchIdModel> mappingToDossierLogSearchByIdResultsModel(
            List<Document> documents) {

            List<DossierLogSearchIdModel> outputs =
                new ArrayList<DossierLogSearchIdModel>();

            for (Document document : documents) {

            	DossierLogSearchIdModel model =
