...
public interface SMSManagement {
	...
	public Response sendSMS(@Context HttpServletRequest request, @Context HttpHeaders header, @Context Company company,
			@Context Locale locale, @Context User user, @Context ServiceContext serviceContext,
			@FormParam("body") String body, @FormParam("toTelNo") String toTelNo);	
}
