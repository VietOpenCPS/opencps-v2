...
@XmlRootElement(name = "ApiRoleResultsModel")
public class ApiRoleResultsModel {

    protected Integer total;
    protected List<ApiRoleModel> data;
     ...
     * 
     */
    public List<ApiRoleModel> getData() {
        if (data == null) {
            data = new ArrayList<ApiRoleModel>();
        }
        return this.data;
    }
