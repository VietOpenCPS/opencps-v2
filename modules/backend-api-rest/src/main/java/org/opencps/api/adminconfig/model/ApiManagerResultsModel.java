...
@XmlRootElement(name = "ApiManagerResultsModel")
public class ApiManagerResultsModel {

    protected Integer total;
    protected List<ApiManagerModel> data;
     ...
     * {@link ApiManagerModel }
     * 
     * 
     */
    public List<ApiManagerModel> getData() {
        if (data == null) {
            data = new ArrayList<ApiManagerModel>();
        }
        return this.data;
    }
