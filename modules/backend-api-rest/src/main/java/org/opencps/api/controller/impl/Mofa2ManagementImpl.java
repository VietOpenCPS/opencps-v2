...
public class Mofa2ManagementImpl implements Mofa2Management {
    ...
    @Override
    public Response createMofa2(HttpServletRequest request, HttpHeaders header, ServiceContext serviceContext,
                                DossierInputModel dossierInputModel, long dossierId, String serverCode) {
        try {
