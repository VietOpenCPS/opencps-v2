...
<script type="text/javascript">
	...
	(function($) {
		...
		if (dictCollection_itemCode!=null && dictCollection_itemCode!="") {
			...
			console.log("dictcollection11111");
			$.ajax({
				type: 'POST',
			...
			console.log("dictcollection222222");
			$.ajax({
				type: 'POST',
...
<script type="text/javascript">
	...
	(function($) {
		...
		var _collectionSub_group_BaseUrl_detail = "${api.server}/dictcollections/${(dictCollection_dictCollection.collectionCode)!}/dictgroups",
