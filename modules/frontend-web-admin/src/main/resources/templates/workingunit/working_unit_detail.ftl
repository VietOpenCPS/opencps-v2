...
<script type="text/javascript">
	...
	(function($) {
		...
		var _workingUnitDetail_BaseUrl = "${api.server}/workingunits";
...
<script type="text/javascript">
	...
	var _workingUnitDetail_uploadLogo_BaseUrl = "${api.server}/workingunits";
...
(function($) {
	...
	if (workingUnitId!=null && workingUnitId!="" && workingUnitId > 0 ) {
		...
		getImageBlob(_workingUnitDetail_uploadLogo_BaseUrl+"/"+workingUnitId+"/logo", $("#_workingUnitDetail_logo_thumbnil"));
	}
