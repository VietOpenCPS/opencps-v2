    ...
    <div class="row">
        <div class="row-header align-middle-lg">
            ...
            <div class="text-light-gray MLA">
                <button class="btn btn-next"><i class="fa fa-envelope" aria-hidden="true"></i> Trả kết quả</button>
            </div>
        </div>
    </div>
    <div class="row">
        <table class="table table-bordered M0">
            <thead>
                <th class="fieldDossier text-center hover-pointer" width="3%"><input type="checkbox" name=""></th>
...
<script type="text/x-kendo-template" id="listTemplate">
    <tr class="rowTable">
        <td class="text-center"><input type="checkbox" value="#=dossierId#"></td>
...
<script type="text/javascript">
    console.log('test');
    $(function(){
     var releasingDossiers = new kendo.data.DataSource({
        transport:{
