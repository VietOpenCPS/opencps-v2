...
import org.opencps.backend.processmgt.model.ServiceProcessModel;
...
public class ServiceProcessModelImpl extends BaseModelImpl<ServiceProcess>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "generateDossierNo", Types.VARCHAR },
			{ "dossierNoPattern", Types.VARCHAR },
			{ "generateDueDate", Types.VARCHAR },
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(org.opencps.backend.processmgt.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.org.opencps.backend.processmgt.model.ServiceProcess"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(org.opencps.backend.processmgt.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.org.opencps.backend.processmgt.model.ServiceProcess"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(org.opencps.backend.processmgt.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.org.opencps.backend.processmgt.model.ServiceProcess"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(org.opencps.backend.processmgt.service.util.ServiceProps.get(
				"lock.expiration.time.org.opencps.backend.processmgt.model.ServiceProcess"));
	...
	public CacheModel<ServiceProcess> toCacheModel() {
		...
		String generateDossierNo = serviceProcessCacheModel.generateDossierNo;

		if ((generateDossierNo != null) && (generateDossierNo.length() == 0)) {
			serviceProcessCacheModel.generateDossierNo = null;
		}
		...
		String generateDueDate = serviceProcessCacheModel.generateDueDate;

		if ((generateDueDate != null) && (generateDueDate.length() == 0)) {
			serviceProcessCacheModel.generateDueDate = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("org.opencps.backend.processmgt.model.ServiceProcess");
