...
import backend.systemlogmgt.model.SystemLogModel;
...
public class SystemLogModelImpl extends BaseModelImpl<SystemLog>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_systemlog (uuid_ VARCHAR(75) null,logId LONG not null primary key,groupId LONG,createDate DATE null,className VARCHAR(75) null,moduleName VARCHAR(75) null,message VARCHAR(75) null,type_ VARCHAR(75) null,line INTEGER)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(backend.systemlogmgt.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.backend.systemlogmgt.model.SystemLog"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(backend.systemlogmgt.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.backend.systemlogmgt.model.SystemLog"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(backend.systemlogmgt.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.backend.systemlogmgt.model.SystemLog"),
			true);
	public static final long CLASSNAME_COLUMN_BITMASK = 1L;
	public static final long CREATEDATE_COLUMN_BITMASK = 2L;
	public static final long GROUPID_COLUMN_BITMASK = 4L;
	public static final long LINE_COLUMN_BITMASK = 8L;
	public static final long LOGID_COLUMN_BITMASK = 16L;
	public static final long MODULENAME_COLUMN_BITMASK = 32L;
	public static final long TYPE_COLUMN_BITMASK = 64L;
	public static final long UUID_COLUMN_BITMASK = 128L;
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(backend.systemlogmgt.service.util.ServiceProps.get(
				"lock.expiration.time.backend.systemlogmgt.model.SystemLog"));
	...
	public void setLogId(long logId) {
		_columnBitmask |= LOGID_COLUMN_BITMASK;

		if (!_setOriginalLogId) {
			_setOriginalLogId = true;

			_originalLogId = _logId;
		}
	...
	public void setLine(int line) {
		_columnBitmask |= LINE_COLUMN_BITMASK;

		if (!_setOriginalLine) {
			_setOriginalLine = true;
	...
	public void resetOriginalValues() {
		...
		systemLogModelImpl._originalLogId = systemLogModelImpl._logId;

		systemLogModelImpl._setOriginalLogId = false;

		systemLogModelImpl._originalGroupId = systemLogModelImpl._groupId;

		systemLogModelImpl._setOriginalGroupId = false;

		systemLogModelImpl._originalCreateDate = systemLogModelImpl._createDate;

		systemLogModelImpl._originalClassName = systemLogModelImpl._className;
		...
		systemLogModelImpl._originalLine = systemLogModelImpl._line;

		systemLogModelImpl._setOriginalLine = false;
	...
	public String toXmlString() {
		...
		sb.append("backend.systemlogmgt.model.SystemLog");
	...
	private boolean _setOriginalLogId;
	...
	private boolean _setOriginalLine;
