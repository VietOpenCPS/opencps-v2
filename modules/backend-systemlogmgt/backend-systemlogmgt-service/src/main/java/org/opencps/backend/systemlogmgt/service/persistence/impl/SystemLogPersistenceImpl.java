...
public class SystemLogPersistenceImpl extends BasePersistenceImpl<SystemLog>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_THREADID = new FinderPath(SystemLogModelImpl.ENTITY_CACHE_ENABLED,
			SystemLogModelImpl.FINDER_CACHE_ENABLED, SystemLogImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_THREADID =
		new FinderPath(SystemLogModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName() },
			SystemLogModelImpl.THREADID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_THREADID = new FinderPath(SystemLogModelImpl.ENTITY_CACHE_ENABLED,
			SystemLogModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<SystemLog> findBythreadId(String threadId) {
	 ...
	 */
	@Override
	public List<SystemLog> findBythreadId(String threadId, int start, int end) {
	...
	public List<SystemLog> findBythreadId(String threadId, int start, int end,
		...
		if (list == null) {
			...
			if (threadId == null) {
				query.append(_FINDER_COLUMN_THREADID_THREADID_1);
			}
			else if (threadId.equals("")) {
				query.append(_FINDER_COLUMN_THREADID_THREADID_3);
			}
			else {
				bindThreadId = true;
	...
	public SystemLog findBythreadId_First(String threadId,
		OrderByComparator<SystemLog> orderByComparator)
		throws NoSuchSystemLogException {
		SystemLog systemLog = fetchBythreadId_First(threadId, orderByComparator);
	...
	public SystemLog fetchBythreadId_First(String threadId,
		OrderByComparator<SystemLog> orderByComparator) {
		List<SystemLog> list = findBythreadId(threadId, 0, 1, orderByComparator);
	...
	public SystemLog findBythreadId_Last(String threadId,
		OrderByComparator<SystemLog> orderByComparator)
		throws NoSuchSystemLogException {
		SystemLog systemLog = fetchBythreadId_Last(threadId, orderByComparator);
	...
	public SystemLog fetchBythreadId_Last(String threadId,
		...
		List<SystemLog> list = findBythreadId(threadId, count - 1, count,
				orderByComparator);
	...
	public SystemLog[] findBythreadId_PrevAndNext(long logId, String threadId,
		...
		try {
			...
			array[0] = getBythreadId_PrevAndNext(session, systemLog, threadId,
					orderByComparator, true);

			array[1] = systemLog;

			array[2] = getBythreadId_PrevAndNext(session, systemLog, threadId,
					orderByComparator, false);
	...
	protected SystemLog getBythreadId_PrevAndNext(Session session,
		SystemLog systemLog, String threadId,
		OrderByComparator<SystemLog> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeBythreadId(String threadId) {
		for (SystemLog systemLog : findBythreadId(threadId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(systemLog);
		}
	}
	...
	private static final String _FINDER_COLUMN_THREADID_THREADID_1 = "systemLog.threadId IS NULL";
	private static final String _FINDER_COLUMN_THREADID_THREADID_2 = "systemLog.threadId = ?";
	private static final String _FINDER_COLUMN_THREADID_THREADID_3 = "(systemLog.threadId IS NULL OR systemLog.threadId = '')";
