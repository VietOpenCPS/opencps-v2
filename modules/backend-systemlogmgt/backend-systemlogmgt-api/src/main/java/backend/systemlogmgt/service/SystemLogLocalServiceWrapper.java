...
public class SystemLogLocalServiceWrapper implements SystemLogLocalService,
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog addSystemLog(
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog createSystemLog(long logId) {
		return _systemLogLocalService.createSystemLog(logId);
	}

	@Override
	public backend.systemlogmgt.model.SystemLog createSystemLog(long groupId,
		String className, String moduleName, String message, String type,
		int line) {
		return _systemLogLocalService.createSystemLog(groupId, className,
			moduleName, message, type, line);
	}
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog deleteSystemLog(long logId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog deleteSystemLog(
		backend.systemlogmgt.model.SystemLog systemLog) {
	...
	*/
	...
	@Override
	public backend.systemlogmgt.model.SystemLog fetchSystemLog(long logId) {
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog fetchSystemLogByUuidAndGroupId(
	...
	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getAllSystemLog() {
		return _systemLogLocalService.getAllSystemLog();
	}
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog getSystemLog(long logId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _systemLogLocalService.getSystemLog(logId);
	}

	@Override
	public backend.systemlogmgt.model.SystemLog getSystemLogByLogId(long logId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog getSystemLogByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogs(
		int start, int end) {
		return _systemLogLocalService.getSystemLogs(start, end);
	}

	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogsByClassName(
		String className) {
		return _systemLogLocalService.getSystemLogsByClassName(className);
	}

	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogsByDate(
		long fromDate, long toDate) throws java.text.ParseException {
		return _systemLogLocalService.getSystemLogsByDate(fromDate, toDate);
	}

	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogsByGroupId(
		long groupId) {
		return _systemLogLocalService.getSystemLogsByGroupId(groupId);
	}

	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogsByLine(
		int line) {
		return _systemLogLocalService.getSystemLogsByLine(line);
	}

	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogsByModuleName(
		String moduleName) {
		return _systemLogLocalService.getSystemLogsByModuleName(moduleName);
	}

	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogsByType(
		String type) {
		return _systemLogLocalService.getSystemLogsByType(type);
	}
	...
	*/
	...
	@Override
	public java.util.List<backend.systemlogmgt.model.SystemLog> getSystemLogsFromDateToDate(
		java.util.Date fromDate, java.util.Date toDate)
		throws java.text.ParseException {
		return _systemLogLocalService.getSystemLogsFromDateToDate(fromDate,
			toDate);
	}

	@Override
	public backend.systemlogmgt.model.SystemLog updateSystemLog(long logId,
		long groupId, String className, String moduleName, String message,
		String type, int line)
		throws com.liferay.portal.kernel.exception.PortalException {
		return _systemLogLocalService.updateSystemLog(logId, groupId,
			className, moduleName, message, type, line);
	}
	...
	*/
	@Override
	public backend.systemlogmgt.model.SystemLog updateSystemLog(
		backend.systemlogmgt.model.SystemLog systemLog) {
