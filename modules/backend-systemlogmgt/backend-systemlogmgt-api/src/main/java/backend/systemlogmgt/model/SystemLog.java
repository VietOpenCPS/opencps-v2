 ...
 * @see SystemLogModel
 * @see backend.systemlogmgt.model.impl.SystemLogImpl
 * @see backend.systemlogmgt.model.impl.SystemLogModelImpl
 * @generated
 */
@ImplementationClassName("backend.systemlogmgt.model.impl.SystemLogImpl")
@ProviderType
public interface SystemLog extends SystemLogModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link backend.systemlogmgt.model.impl.SystemLogImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
