...
public class kysoLocalServiceUtil {
	...
	*/
	...
	static {
		...
		ServiceTracker<kysoLocalService, kysoLocalService> serviceTracker = new ServiceTracker<kysoLocalService, kysoLocalService>(bundle.getBundleContext(),
				kysoLocalService.class, null);
