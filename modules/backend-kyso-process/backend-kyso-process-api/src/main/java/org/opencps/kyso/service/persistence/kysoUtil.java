...
public class kysoUtil {
	...
	*/
	public static kyso findByUuid_First(String uuid,
		OrderByComparator<kyso> orderByComparator)
	...
	*/
	public static kyso fetchByUuid_First(String uuid,
		OrderByComparator<kyso> orderByComparator) {
	...
	* @throws NoSuchkysoException if a matching kyso could not be found
	*/
	public static kyso findByUuid_Last(String uuid,
		OrderByComparator<kyso> orderByComparator)
		throws org.opencps.kyso.exception.NoSuchkysoException {
	...
	*/
	public static kyso fetchByUuid_Last(String uuid,
		OrderByComparator<kyso> orderByComparator) {
	...
	*/
	public static kyso[] findByUuid_PrevAndNext(long jasperId, String uuid,
		OrderByComparator<kyso> orderByComparator)
		throws org.opencps.kyso.exception.NoSuchkysoException {
		return getPersistence()
	...
	*/
	...
	static {
		...
		ServiceTracker<kysoPersistence, kysoPersistence> serviceTracker = new ServiceTracker<kysoPersistence, kysoPersistence>(bundle.getBundleContext(),
				kysoPersistence.class, null);
