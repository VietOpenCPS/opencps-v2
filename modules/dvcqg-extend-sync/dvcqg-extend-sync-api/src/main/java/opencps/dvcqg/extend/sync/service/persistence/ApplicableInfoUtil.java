 ...
 * @see opencps.dvcqg.extend.sync.service.persistence.impl.ApplicableInfoPersistenceImpl
 * @generated
 */
@ProviderType
public class ApplicableInfoUtil {
	...
	*/
	public static ApplicableInfo findByUuid_First(String uuid,
		OrderByComparator<ApplicableInfo> orderByComparator)
		throws opencps.dvcqg.extend.sync.exception.NoSuchApplicableInfoException {
