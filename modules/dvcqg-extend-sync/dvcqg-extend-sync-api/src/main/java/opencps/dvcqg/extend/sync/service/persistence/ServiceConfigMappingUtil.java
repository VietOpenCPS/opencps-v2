...
/**
 * The persistence utility for the service config mapping service. This utility wraps {@link opencps.dvcqg.extend.sync.service.persistence.impl.ServiceConfigMappingPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class ServiceConfigMappingUtil {
	...
	*/
	public static ServiceConfigMapping findByUuid_First(String uuid,
		OrderByComparator<ServiceConfigMapping> orderByComparator)
		throws opencps.dvcqg.extend.sync.exception.NoSuchServiceConfigMappingException {
