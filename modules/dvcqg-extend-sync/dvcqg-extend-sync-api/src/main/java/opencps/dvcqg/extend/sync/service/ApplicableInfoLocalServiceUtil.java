 ...
 * {@link opencps.dvcqg.extend.sync.service.impl.ApplicableInfoLocalServiceImpl} and is the
 ...
 * @see opencps.dvcqg.extend.sync.service.base.ApplicableInfoLocalServiceBaseImpl
...
public class ApplicableInfoLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link opencps.dvcqg.extend.sync.service.impl.ApplicableInfoLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo addApplicableInfo(
		opencps.dvcqg.extend.sync.model.ApplicableInfo applicableInfo) {
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo createApplicableInfo(
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo deleteApplicableInfo(
		opencps.dvcqg.extend.sync.model.ApplicableInfo applicableInfo) {
	...
	*/
	...
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo fetchApplicableInfo(
		long applicableInfoId) {
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo fetchApplicableInfoByUuidAndGroupId(
		String uuid, long groupId) {
		return getService().fetchApplicableInfoByUuidAndGroupId(uuid, groupId);
	}

	public static opencps.dvcqg.extend.sync.model.ApplicableInfo fetchByG_SC_GC_SL(
	...
	* @throws PortalException if a applicable info with the primary key could not be found
	*/
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo getApplicableInfo(
		long applicableInfoId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo getApplicableInfoByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<opencps.dvcqg.extend.sync.model.ApplicableInfo> getApplicableInfos(
		int start, int end) {
	...
	*/
	public static java.util.List<opencps.dvcqg.extend.sync.model.ApplicableInfo> getApplicableInfosByUuidAndCompanyId(
	...
	*/
	public static java.util.List<opencps.dvcqg.extend.sync.model.ApplicableInfo> getApplicableInfosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<opencps.dvcqg.extend.sync.model.ApplicableInfo> orderByComparator) {
		return getService()
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ApplicableInfo updateApplicableInfo(
		opencps.dvcqg.extend.sync.model.ApplicableInfo applicableInfo) {
