 ...
 * {@link opencps.dvcqg.extend.sync.service.impl.ServiceConfigMappingLocalServiceImpl} and is the
 ...
 * @see opencps.dvcqg.extend.sync.service.base.ServiceConfigMappingLocalServiceBaseImpl
 * @see opencps.dvcqg.extend.sync.service.impl.ServiceConfigMappingLocalServiceImpl
 * @generated
 */
@ProviderType
public class ServiceConfigMappingLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link opencps.dvcqg.extend.sync.service.impl.ServiceConfigMappingLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping addServiceConfigMaping(
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping addServiceConfigMapping(
		opencps.dvcqg.extend.sync.model.ServiceConfigMapping serviceConfigMapping) {
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping createServiceConfigMapping(
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping deleteServiceConfigMapping(
		long serviceConfigMappingId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	...
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping fetchServiceConfigMapping(
		long serviceConfigMappingId) {
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping fetchServiceConfigMappingByUuidAndGroupId(
	...
	* @throws PortalException if a service config mapping with the primary key could not be found
	*/
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping getServiceConfigMapping(
		long serviceConfigMappingId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping getServiceConfigMappingByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
	...
	*/
	public static java.util.List<opencps.dvcqg.extend.sync.model.ServiceConfigMapping> getServiceConfigMappings(
		int start, int end) {
	...
	*/
	public static java.util.List<opencps.dvcqg.extend.sync.model.ServiceConfigMapping> getServiceConfigMappingsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<opencps.dvcqg.extend.sync.model.ServiceConfigMapping> getServiceConfigMappingsByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<opencps.dvcqg.extend.sync.model.ServiceConfigMapping> orderByComparator) {
		return getService()
				   .getServiceConfigMappingsByUuidAndCompanyId(uuid, companyId,
	...
	*/
	...
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping removeServiceConfigMapping(
	...
	*/
	public static opencps.dvcqg.extend.sync.model.ServiceConfigMapping updateServiceConfigMapping(
		opencps.dvcqg.extend.sync.model.ServiceConfigMapping serviceConfigMapping) {
