...
import opencps.dvcqg.extend.sync.model.ApplicableInfoModel;
...
public class ApplicableInfoModelImpl extends BaseModelImpl<ApplicableInfo>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(dvcqg.extend.sync.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.opencps.dvcqg.extend.sync.model.ApplicableInfo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(dvcqg.extend.sync.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.opencps.dvcqg.extend.sync.model.ApplicableInfo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(dvcqg.extend.sync.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.opencps.dvcqg.extend.sync.model.ApplicableInfo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(dvcqg.extend.sync.service.util.ServiceProps.get(
				"lock.expiration.time.opencps.dvcqg.extend.sync.model.ApplicableInfo"));
	...
	public String toXmlString() {
		...
		sb.append("opencps.dvcqg.extend.sync.model.ApplicableInfo");
