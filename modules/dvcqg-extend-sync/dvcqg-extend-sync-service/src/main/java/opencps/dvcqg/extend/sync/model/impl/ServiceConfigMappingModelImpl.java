...
import opencps.dvcqg.extend.sync.model.ServiceConfigMappingModel;
...
public class ServiceConfigMappingModelImpl extends BaseModelImpl<ServiceConfigMapping>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_serviceconfigmapping (uuid_ VARCHAR(75) null,serviceConfigMappingId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,serviceConfigCode VARCHAR(255) null,serviceConfigName VARCHAR(255) null,serviceCode VARCHAR(255) null,serviceName VARCHAR(255) null,govAgencyName VARCHAR(255) null,domainName VARCHAR(255) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(dvcqg.extend.sync.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.opencps.dvcqg.extend.sync.model.ServiceConfigMapping"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(dvcqg.extend.sync.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.opencps.dvcqg.extend.sync.model.ServiceConfigMapping"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(dvcqg.extend.sync.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.opencps.dvcqg.extend.sync.model.ServiceConfigMapping"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(dvcqg.extend.sync.service.util.ServiceProps.get(
				"lock.expiration.time.opencps.dvcqg.extend.sync.model.ServiceConfigMapping"));
	...
	public String toXmlString() {
		...
		sb.append("opencps.dvcqg.extend.sync.model.ServiceConfigMapping");
