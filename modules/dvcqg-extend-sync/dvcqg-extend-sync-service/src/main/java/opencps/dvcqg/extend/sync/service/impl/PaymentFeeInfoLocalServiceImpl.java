...
import opencps.dvcqg.extend.sync.service.base.PaymentFeeInfoLocalServiceBaseImpl;

/**
 * The implementation of the payment fee info local service.
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link opencps.dvcqg.extend.sync.service.PaymentFeeInfoLocalService} interface.
 *
 * <p>
...
public class PaymentFeeInfoLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use {@link opencps.dvcqg.extend.sync.service.PaymentFeeInfoLocalServiceUtil} to access the payment fee info local service.
	 */
