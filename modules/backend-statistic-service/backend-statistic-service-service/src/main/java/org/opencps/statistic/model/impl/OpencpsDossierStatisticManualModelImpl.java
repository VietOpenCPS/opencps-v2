...
import org.opencps.statistic.model.OpencpsDossierStatisticManualModel;
...
/**
 * The base model implementation for the OpencpsDossierStatisticManual service. Represents a row in the &quot;opencps_statistic_manual&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link OpencpsDossierStatisticManualModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link OpencpsDossierStatisticManualImpl}.
 * </p>
 *
 * @author khoavu
 * @see OpencpsDossierStatisticManualImpl
 * @see OpencpsDossierStatisticManual
 * @see OpencpsDossierStatisticManualModel
 * @generated
 */
@ProviderType
public class OpencpsDossierStatisticManualModelImpl extends BaseModelImpl<OpencpsDossierStatisticManual>
	implements OpencpsDossierStatisticManualModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a opencps dossier statistic manual model instance should use the {@link OpencpsDossierStatisticManual} interface instead.
	 */
	public static final String TABLE_NAME = "opencps_statistic_manual";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(StatisticService.backend.statistic.service.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.org.opencps.statistic.model.OpencpsDossierStatisticManual"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(StatisticService.backend.statistic.service.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.org.opencps.statistic.model.OpencpsDossierStatisticManual"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(StatisticService.backend.statistic.service.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.org.opencps.statistic.model.OpencpsDossierStatisticManual"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(StatisticService.backend.statistic.service.service.util.ServiceProps.get(
				"lock.expiration.time.org.opencps.statistic.model.OpencpsDossierStatisticManual"));

	public OpencpsDossierStatisticManualModelImpl() {
	}
	...
	public StagedModelType getStagedModelType() {
		return new StagedModelType(PortalUtil.getClassNameId(
				OpencpsDossierStatisticManual.class.getName()));
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(),
			OpencpsDossierStatisticManual.class.getName(), getPrimaryKey());
	}
	...
	public OpencpsDossierStatisticManual toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (OpencpsDossierStatisticManual)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		opencpsDossierStatisticManualImpl.setUuid(getUuid());
		opencpsDossierStatisticManualImpl.setDossierStatisticId(getDossierStatisticId());
		opencpsDossierStatisticManualImpl.setCompanyId(getCompanyId());
		opencpsDossierStatisticManualImpl.setGroupId(getGroupId());
		opencpsDossierStatisticManualImpl.setUserId(getUserId());
		opencpsDossierStatisticManualImpl.setUserName(getUserName());
		opencpsDossierStatisticManualImpl.setCreateDate(getCreateDate());
		opencpsDossierStatisticManualImpl.setModifiedDate(getModifiedDate());
		opencpsDossierStatisticManualImpl.setMonth(getMonth());
		opencpsDossierStatisticManualImpl.setYear(getYear());
		opencpsDossierStatisticManualImpl.setTotalCount(getTotalCount());
		opencpsDossierStatisticManualImpl.setDeniedCount(getDeniedCount());
		opencpsDossierStatisticManualImpl.setCancelledCount(getCancelledCount());
		opencpsDossierStatisticManualImpl.setProcessCount(getProcessCount());
		opencpsDossierStatisticManualImpl.setRemainingCount(getRemainingCount());
		opencpsDossierStatisticManualImpl.setReceivedCount(getReceivedCount());
		opencpsDossierStatisticManualImpl.setOnlineCount(getOnlineCount());
		opencpsDossierStatisticManualImpl.setOnegateCount(getOnegateCount());
		opencpsDossierStatisticManualImpl.setReleaseCount(getReleaseCount());
		opencpsDossierStatisticManualImpl.setBetimesCount(getBetimesCount());
		opencpsDossierStatisticManualImpl.setOntimeCount(getOntimeCount());
		opencpsDossierStatisticManualImpl.setOvertimeCount(getOvertimeCount());
		opencpsDossierStatisticManualImpl.setDoneCount(getDoneCount());
		opencpsDossierStatisticManualImpl.setReleasingCount(getReleasingCount());
		opencpsDossierStatisticManualImpl.setUnresolvedCount(getUnresolvedCount());
		opencpsDossierStatisticManualImpl.setProcessingCount(getProcessingCount());
		opencpsDossierStatisticManualImpl.setUndueCount(getUndueCount());
		opencpsDossierStatisticManualImpl.setOverdueCount(getOverdueCount());
		opencpsDossierStatisticManualImpl.setPausingCount(getPausingCount());
		opencpsDossierStatisticManualImpl.setOntimePercentage(getOntimePercentage());
		opencpsDossierStatisticManualImpl.setGovAgencyCode(getGovAgencyCode());
		opencpsDossierStatisticManualImpl.setGroupAgencyCode(getGroupAgencyCode());
		opencpsDossierStatisticManualImpl.setGovAgencyName(getGovAgencyName());
		opencpsDossierStatisticManualImpl.setDomainCode(getDomainCode());
		opencpsDossierStatisticManualImpl.setDomainName(getDomainName());
		opencpsDossierStatisticManualImpl.setReporting(isReporting());
		opencpsDossierStatisticManualImpl.setOvertimeInside(getOvertimeInside());
		opencpsDossierStatisticManualImpl.setOvertimeOutside(getOvertimeOutside());
		opencpsDossierStatisticManualImpl.setInteroperatingCount(getInteroperatingCount());
		opencpsDossierStatisticManualImpl.setWaitingCount(getWaitingCount());
		opencpsDossierStatisticManualImpl.setOutsideCount(getOutsideCount());
		opencpsDossierStatisticManualImpl.setInsideCount(getInsideCount());
		opencpsDossierStatisticManualImpl.setSystem(getSystem());
		opencpsDossierStatisticManualImpl.setViaPostalCount(getViaPostalCount());
		opencpsDossierStatisticManualImpl.setNotViaPostalCount(getNotViaPostalCount());
		opencpsDossierStatisticManualImpl.setSaturdayCount(getSaturdayCount());
		opencpsDossierStatisticManualImpl.setDossierOnline3Count(getDossierOnline3Count());
		opencpsDossierStatisticManualImpl.setDossierOnline4Count(getDossierOnline4Count());
		opencpsDossierStatisticManualImpl.setReceiveDossierSatCount(getReceiveDossierSatCount());
		opencpsDossierStatisticManualImpl.setReleaseDossierSatCount(getReleaseDossierSatCount());
		opencpsDossierStatisticManualImpl.setFromViaPostalCount(getFromViaPostalCount());
	...
	public int compareTo(
		...
		long primaryKey = opencpsDossierStatisticManual.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof OpencpsDossierStatisticManual)) {
			return false;
		}

		OpencpsDossierStatisticManual opencpsDossierStatisticManual = (OpencpsDossierStatisticManual)obj;
	...
	public void resetOriginalValues() {
		...
		opencpsDossierStatisticManualModelImpl._originalUuid = opencpsDossierStatisticManualModelImpl._uuid;

		opencpsDossierStatisticManualModelImpl._originalCompanyId = opencpsDossierStatisticManualModelImpl._companyId;

		opencpsDossierStatisticManualModelImpl._setOriginalCompanyId = false;

		opencpsDossierStatisticManualModelImpl._originalGroupId = opencpsDossierStatisticManualModelImpl._groupId;

		opencpsDossierStatisticManualModelImpl._setOriginalGroupId = false;

		opencpsDossierStatisticManualModelImpl._originalUserId = opencpsDossierStatisticManualModelImpl._userId;

		opencpsDossierStatisticManualModelImpl._setOriginalUserId = false;

		opencpsDossierStatisticManualModelImpl._setModifiedDate = false;

		opencpsDossierStatisticManualModelImpl._originalMonth = opencpsDossierStatisticManualModelImpl._month;

		opencpsDossierStatisticManualModelImpl._setOriginalMonth = false;

		opencpsDossierStatisticManualModelImpl._originalYear = opencpsDossierStatisticManualModelImpl._year;

		opencpsDossierStatisticManualModelImpl._setOriginalYear = false;

		opencpsDossierStatisticManualModelImpl._originalGovAgencyCode = opencpsDossierStatisticManualModelImpl._govAgencyCode;

		opencpsDossierStatisticManualModelImpl._originalDomainCode = opencpsDossierStatisticManualModelImpl._domainCode;

		opencpsDossierStatisticManualModelImpl._originalReporting = opencpsDossierStatisticManualModelImpl._reporting;

		opencpsDossierStatisticManualModelImpl._setOriginalReporting = false;

		opencpsDossierStatisticManualModelImpl._originalSystem = opencpsDossierStatisticManualModelImpl._system;

		opencpsDossierStatisticManualModelImpl._columnBitmask = 0;
	}
	...
	public CacheModel<OpencpsDossierStatisticManual> toCacheModel() {
		OpencpsDossierStatisticManualCacheModel opencpsDossierStatisticManualCacheModel =
			new OpencpsDossierStatisticManualCacheModel();

		opencpsDossierStatisticManualCacheModel.uuid = getUuid();

		String uuid = opencpsDossierStatisticManualCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.uuid = null;
		}

		opencpsDossierStatisticManualCacheModel.dossierStatisticId = getDossierStatisticId();

		opencpsDossierStatisticManualCacheModel.companyId = getCompanyId();

		opencpsDossierStatisticManualCacheModel.groupId = getGroupId();

		opencpsDossierStatisticManualCacheModel.userId = getUserId();

		opencpsDossierStatisticManualCacheModel.userName = getUserName();

		String userName = opencpsDossierStatisticManualCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.userName = null;
		}

		Date createDate = getCreateDate();

		if (createDate != null) {
			opencpsDossierStatisticManualCacheModel.createDate = createDate.getTime();
		}
		else {
			opencpsDossierStatisticManualCacheModel.createDate = Long.MIN_VALUE;
		}

		Date modifiedDate = getModifiedDate();

		if (modifiedDate != null) {
			opencpsDossierStatisticManualCacheModel.modifiedDate = modifiedDate.getTime();
		}
		else {
			opencpsDossierStatisticManualCacheModel.modifiedDate = Long.MIN_VALUE;
		}

		opencpsDossierStatisticManualCacheModel.month = getMonth();

		opencpsDossierStatisticManualCacheModel.year = getYear();

		opencpsDossierStatisticManualCacheModel.totalCount = getTotalCount();

		opencpsDossierStatisticManualCacheModel.deniedCount = getDeniedCount();

		opencpsDossierStatisticManualCacheModel.cancelledCount = getCancelledCount();

		opencpsDossierStatisticManualCacheModel.processCount = getProcessCount();

		opencpsDossierStatisticManualCacheModel.remainingCount = getRemainingCount();

		opencpsDossierStatisticManualCacheModel.receivedCount = getReceivedCount();

		opencpsDossierStatisticManualCacheModel.onlineCount = getOnlineCount();

		opencpsDossierStatisticManualCacheModel.onegateCount = getOnegateCount();

		opencpsDossierStatisticManualCacheModel.releaseCount = getReleaseCount();

		opencpsDossierStatisticManualCacheModel.betimesCount = getBetimesCount();

		opencpsDossierStatisticManualCacheModel.ontimeCount = getOntimeCount();

		opencpsDossierStatisticManualCacheModel.overtimeCount = getOvertimeCount();

		opencpsDossierStatisticManualCacheModel.doneCount = getDoneCount();

		opencpsDossierStatisticManualCacheModel.releasingCount = getReleasingCount();

		opencpsDossierStatisticManualCacheModel.unresolvedCount = getUnresolvedCount();

		opencpsDossierStatisticManualCacheModel.processingCount = getProcessingCount();

		opencpsDossierStatisticManualCacheModel.undueCount = getUndueCount();

		opencpsDossierStatisticManualCacheModel.overdueCount = getOverdueCount();

		opencpsDossierStatisticManualCacheModel.pausingCount = getPausingCount();

		opencpsDossierStatisticManualCacheModel.ontimePercentage = getOntimePercentage();

		opencpsDossierStatisticManualCacheModel.govAgencyCode = getGovAgencyCode();

		String govAgencyCode = opencpsDossierStatisticManualCacheModel.govAgencyCode;

		if ((govAgencyCode != null) && (govAgencyCode.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.govAgencyCode = null;
		}

		opencpsDossierStatisticManualCacheModel.groupAgencyCode = getGroupAgencyCode();

		String groupAgencyCode = opencpsDossierStatisticManualCacheModel.groupAgencyCode;

		if ((groupAgencyCode != null) && (groupAgencyCode.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.groupAgencyCode = null;
		}

		opencpsDossierStatisticManualCacheModel.govAgencyName = getGovAgencyName();

		String govAgencyName = opencpsDossierStatisticManualCacheModel.govAgencyName;

		if ((govAgencyName != null) && (govAgencyName.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.govAgencyName = null;
		}

		opencpsDossierStatisticManualCacheModel.domainCode = getDomainCode();

		String domainCode = opencpsDossierStatisticManualCacheModel.domainCode;

		if ((domainCode != null) && (domainCode.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.domainCode = null;
		}

		opencpsDossierStatisticManualCacheModel.domainName = getDomainName();

		String domainName = opencpsDossierStatisticManualCacheModel.domainName;

		if ((domainName != null) && (domainName.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.domainName = null;
		}

		opencpsDossierStatisticManualCacheModel.reporting = isReporting();

		opencpsDossierStatisticManualCacheModel.overtimeInside = getOvertimeInside();

		opencpsDossierStatisticManualCacheModel.overtimeOutside = getOvertimeOutside();

		opencpsDossierStatisticManualCacheModel.interoperatingCount = getInteroperatingCount();

		opencpsDossierStatisticManualCacheModel.waitingCount = getWaitingCount();

		opencpsDossierStatisticManualCacheModel.outsideCount = getOutsideCount();

		opencpsDossierStatisticManualCacheModel.insideCount = getInsideCount();

		opencpsDossierStatisticManualCacheModel.system = getSystem();

		String system = opencpsDossierStatisticManualCacheModel.system;

		if ((system != null) && (system.length() == 0)) {
			opencpsDossierStatisticManualCacheModel.system = null;
		}

		opencpsDossierStatisticManualCacheModel.viaPostalCount = getViaPostalCount();

		opencpsDossierStatisticManualCacheModel.notViaPostalCount = getNotViaPostalCount();

		opencpsDossierStatisticManualCacheModel.saturdayCount = getSaturdayCount();

		opencpsDossierStatisticManualCacheModel.dossierOnline3Count = getDossierOnline3Count();

		opencpsDossierStatisticManualCacheModel.dossierOnline4Count = getDossierOnline4Count();

		opencpsDossierStatisticManualCacheModel.receiveDossierSatCount = getReceiveDossierSatCount();

		opencpsDossierStatisticManualCacheModel.releaseDossierSatCount = getReleaseDossierSatCount();

		opencpsDossierStatisticManualCacheModel.fromViaPostalCount = getFromViaPostalCount();

		return opencpsDossierStatisticManualCacheModel;
	}
	...
	public String toXmlString() {
		...
		sb.append("org.opencps.statistic.model.OpencpsDossierStatisticManual");
	...
	private static final ClassLoader _classLoader = OpencpsDossierStatisticManual.class.getClassLoader();
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
			OpencpsDossierStatisticManual.class, ModelWrapper.class
		};
	...
	private OpencpsDossierStatisticManual _escapedModel;
}