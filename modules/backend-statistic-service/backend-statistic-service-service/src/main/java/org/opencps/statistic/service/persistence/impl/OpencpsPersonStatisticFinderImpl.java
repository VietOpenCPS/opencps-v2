...
//
//	private static final String CONDITION_EMPLOYEE = "(opencps_voting_statistic.employeeId = ?) AND";
...
//	
//	@SuppressWarnings("unchecked")
//	public List<OpencpsPersonStatistic> searchPersonStatistic(long groupId, int year,
