...
create index IX_37F862A7 on opencps_person_statistic (groupId, month, year, govAgencyCode[$COLUMN_LENGTH:75$], employeeId);
...
create index IX_ACE3952E on opencps_statistic (groupId, month, year, govAgencyCode[$COLUMN_LENGTH:75$], domainCode[$COLUMN_LENGTH:75$], system[$COLUMN_LENGTH:75$]);
