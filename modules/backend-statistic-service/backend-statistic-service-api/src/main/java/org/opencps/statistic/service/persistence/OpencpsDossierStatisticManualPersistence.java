...
/**
 * The persistence interface for the opencps dossier statistic manual service.
 *
 * <p>
 ...
 * @see OpencpsDossierStatisticManualUtil
 * @generated
 */
@ProviderType
public interface OpencpsDossierStatisticManualPersistence
	extends BasePersistence<OpencpsDossierStatisticManual> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OpencpsDossierStatisticManualUtil} to access the opencps dossier statistic manual persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByUuid(String uuid);
	...
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByUuid(
	...
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OpencpsDossierStatisticManual> orderByComparator);
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByUuid_C(
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByG_UID_Y(
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByG_D_M_Y(
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByG_M_Y(
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByCID_GID_Y(
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByGID_M_Y_RP(
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByGID_MS_Y_RP(
		long groupId, int month, int year, boolean reporting);
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByG(long groupId);
	...
	* @return the matching opencps dossier statistic manuals
	*/
	public java.util.List<OpencpsDossierStatisticManual> findByG_M_Y_GC_DC(
		long groupId, int month, int year);
	...
	*/
	public void cacheResult(
		java.util.List<OpencpsDossierStatisticManual> opencpsDossierStatisticManuals);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, OpencpsDossierStatisticManual> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<OpencpsDossierStatisticManual> findAll();
	...
	*/
	public java.util.List<OpencpsDossierStatisticManual> findAll(int start,
		int end);
