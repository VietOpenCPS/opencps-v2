...
/**
 * Provides the local service interface for OpencpsDossierStatisticMgt. Methods of this
...
public interface OpencpsDossierStatisticMgtLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OpencpsDossierStatisticMgtLocalServiceUtil} to access the opencps dossier statistic mgt local service. Add custom service methods to {@link org.opencps.statistic.service.impl.OpencpsDossierStatisticMgtLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OpencpsDossierStatisticMgt addOpencpsDossierStatisticMgt(
		OpencpsDossierStatisticMgt opencpsDossierStatisticMgt);

	public OpencpsDossierStatisticMgt checkContainGroupBy(long groupId,
		int month, int year, String govAgencyCode, String domainCode,
		int groupBy);

	public OpencpsDossierStatisticMgt checkContains(long groupId, int month,
	...
	*/
	...
	public OpencpsDossierStatisticMgt createOpencpsDossierStatisticMgt(
	...
	*/
	...
	public OpencpsDossierStatisticMgt deleteOpencpsDossierStatisticMgt(
		long dossierStatisticMgtId) throws PortalException;
	...
	*/
	...
	public OpencpsDossierStatisticMgt fetchOpencpsDossierStatisticMgt(
		long dossierStatisticMgtId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticMgt fetchOpencpsDossierStatisticMgtByUuidAndGroupId(
	...
	public List<OpencpsDossierStatisticMgt> findByG_Y_ARR(long groupId,
		int[] yearArr);

	public List<OpencpsDossierStatisticMgt> findByG_Y_ARR_GB(long groupId,
		int[] yearArr, int groupBy);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticMgt getOpencpsDossierStatisticMgt(
		long dossierStatisticMgtId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticMgt getOpencpsDossierStatisticMgtByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpencpsDossierStatisticMgt> getOpencpsDossierStatisticMgts(
		int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OpencpsDossierStatisticMgt updateOpencpsDossierStatisticMgt(
		OpencpsDossierStatisticMgt opencpsDossierStatisticMgt);
}