 ...
 */
@ProviderType
public class OpencpsDossierStatisticManualSoap implements Serializable {
	public static OpencpsDossierStatisticManualSoap toSoapModel(
		OpencpsDossierStatisticManual model) {
		OpencpsDossierStatisticManualSoap soapModel = new OpencpsDossierStatisticManualSoap();
	...
	public static OpencpsDossierStatisticManualSoap[] toSoapModels(
		OpencpsDossierStatisticManual[] models) {
		OpencpsDossierStatisticManualSoap[] soapModels = new OpencpsDossierStatisticManualSoap[models.length];
	...
	public static OpencpsDossierStatisticManualSoap[][] toSoapModels(
		OpencpsDossierStatisticManual[][] models) {
		OpencpsDossierStatisticManualSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new OpencpsDossierStatisticManualSoap[models.length][models[0].length];
		}
		else {
			soapModels = new OpencpsDossierStatisticManualSoap[0][0];
		}
	...
	public static OpencpsDossierStatisticManualSoap[] toSoapModels(
		List<OpencpsDossierStatisticManual> models) {
		List<OpencpsDossierStatisticManualSoap> soapModels = new ArrayList<OpencpsDossierStatisticManualSoap>(models.size());

		for (OpencpsDossierStatisticManual model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new OpencpsDossierStatisticManualSoap[soapModels.size()]);
	}

	public OpencpsDossierStatisticManualSoap() {
	}
