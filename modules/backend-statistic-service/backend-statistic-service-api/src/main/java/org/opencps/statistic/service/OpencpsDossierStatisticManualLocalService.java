...
/**
 * Provides the local service interface for OpencpsDossierStatisticManual. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavu
 * @see OpencpsDossierStatisticManualLocalServiceUtil
...
public interface OpencpsDossierStatisticManualLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OpencpsDossierStatisticManualLocalServiceUtil} to access the opencps dossier statistic manual local service. Add custom service methods to {@link org.opencps.statistic.service.impl.OpencpsDossierStatisticManualLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OpencpsDossierStatisticManual addOpencpsDossierStatisticManual(
		OpencpsDossierStatisticManual opencpsDossierStatisticManual);

	public OpencpsDossierStatisticManual checkNotDuplicate(long groupId,
	...
	*/
	...
	public OpencpsDossierStatisticManual createOpencpsDossierStatisticManual(
	...
	*/
	...
	public OpencpsDossierStatisticManual deleteOpencpsDossierStatisticManual(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticManual fetchOpencpsDossierStatisticManualByUuidAndGroupId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticManual getByGovMonthYear(long groupId,
		String govAgencyCode, int month, int year)
		throws PortalException, SystemException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticManual getByGovMonthYearDomain(long groupId,
		String govAgencyCode, int month, int year, String domainCode,
		boolean reporting);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpencpsDossierStatisticManual> getDossierStatisticByMonthsYearAndReport(
		long groupId, int[] month, int year, boolean reporting);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpencpsDossierStatisticManual> getDossierStatisticManualByMonthYear(
		long groupId, int month, int year);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpencpsDossierStatisticManual> getDossierStatisticManualByMonthYearAndReport(
		long groupId, int month, int year, boolean reporting);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpencpsDossierStatisticManual> getDossierStatisticManualByYear(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticManual getOpencpsDossierStatisticManual(
		long dossierStatisticId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OpencpsDossierStatisticManual getOpencpsDossierStatisticManualByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpencpsDossierStatisticManual> getOpencpsDossierStatisticManuals(
		int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OpencpsDossierStatisticManual> getOpencpsDossierStatisticManualsByUuidAndCompanyId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OpencpsDossierStatisticManual updateOpencpsDossierStatisticManual(
		OpencpsDossierStatisticManual opencpsDossierStatisticManual);
