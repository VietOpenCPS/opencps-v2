			...
			<div class="content-part">
				...
				<div class="row-parts-head align-middle MT5">
					...
					<div class="actions">
						...
						<a href="javascript:;" class="text-light-blue dossier-file" data-toggle="tooltip" data-placement="top" title="Tải file lên">
							<i class="fa fa-upload" aria-hidden="true"></i>
						</a>

						<a href="javascript:;" class="dossier-component-profile" data-toggle="tooltip" data-placement="top" title="Số tệp tin">
							<span class="number-in-circle">${item.dossierFileNumber}</span>
						</a>

						<a href="javascript:;" class="text-light-gray" data-toggle="tooltip" data-placement="top" title="Xóa">
				...
				<div class="row-parts-head align-middle">
					...
					<div class="actions">
						<a href="javascript:;" class="dossier-online-form" data-pk="${item.id}">
