<div class="panel" id="completedDossierForm">
  ...
  <div class="panel-body">
    ...
    <div class="row">
      ...
      <div class="col-sm-12" id="infoDossierFiled" data-template="dossier_template" data-bind="source: dossierTemplateNo">
