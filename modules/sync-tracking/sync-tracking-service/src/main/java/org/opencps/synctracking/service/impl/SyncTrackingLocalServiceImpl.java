...
public class SyncTrackingLocalServiceImpl
	...
	public SyncTracking addSyncTracking(long groupId, String dossierNo, String referenceUid,
			String api, String fromUnit, String toUnitSingle, String bodyRequest, 
		...
		if (trackingId == 0) {
			...
			if(Validator.isNotNull(fromUnit)) {
				syncTracking.setFromUnit(fromUnit);
			}

			if(Validator.isNotNull(toUnitSingle)) {
				syncTracking.setToUnit(toUnitSingle);
			}
