...
/**
 * Provides the local service interface for SMSLookUpQueue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa
 * @see SMSLookUpQueueLocalServiceUtil
...
public interface SMSLookUpQueueLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SMSLookUpQueueLocalServiceUtil} to access the sms look up queue local service. Add custom service methods to {@link org.opencps.sms.service.impl.SMSLookUpQueueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
