...
/**
 * Provides the local service interface for PhiLePhi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see PhiLePhiLocalServiceUtil
...
public interface PhiLePhiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PhiLePhiLocalServiceUtil} to access the phi le phi local service. Add custom service methods to {@link pay.gate.integration.dvc.service.impl.PhiLePhiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
