...
public interface PushCollectionLocalService extends BaseLocalService,
	...
	public PushCollection addPushCollection(long userId, long groupId,
		String serverNo, String collectionCode, String collectionName,
	...
	*/
	...
	public PushCollection updatePushCollection(long userId, long groupId,
		long pushCollectionId, String serverNo, String collectionCode,
		String collectionName, String collectionNameEN, String description,
		String method, String dataForm, ServiceContext serviceContext)
		throws UnauthenticationException, UnauthorizationException,
			NoSuchUserException, NoSuchPushCollectionException, SystemException;
