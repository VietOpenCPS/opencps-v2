...
public class PushDictGroupLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(PushDictGroupLocalService.class);

		ServiceTracker<PushDictGroupLocalService, PushDictGroupLocalService> serviceTracker =
			new ServiceTracker<PushDictGroupLocalService, PushDictGroupLocalService>(bundle.getBundleContext(),
				PushDictGroupLocalService.class, null);
