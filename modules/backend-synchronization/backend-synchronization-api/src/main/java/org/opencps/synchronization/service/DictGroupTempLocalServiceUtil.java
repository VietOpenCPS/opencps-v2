...
public class DictGroupTempLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DictGroupTempLocalService.class);

		ServiceTracker<DictGroupTempLocalService, DictGroupTempLocalService> serviceTracker =
			new ServiceTracker<DictGroupTempLocalService, DictGroupTempLocalService>(bundle.getBundleContext(),
				DictGroupTempLocalService.class, null);
