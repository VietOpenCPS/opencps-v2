...
/**
 * Provides the local service interface for PushDictItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see PushDictItemLocalServiceUtil
...
public interface PushDictItemLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PushDictItemLocalServiceUtil} to access the push dict item local service. Add custom service methods to {@link org.opencps.synchronization.service.impl.PushDictItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public PushDictItem addPushDictItem(long userId, long groupId,
		String serverNo, String collectionCode, String itemCode,
		String itemName, String itemNameEN, String itemDescription,
		String parentItemCode, String sibling, String method, String metaData,
		ServiceContext serviceContext)
		throws UnauthenticationException, UnauthorizationException,
			NoSuchUserException, SystemException;
	...
	*/
	...
	public PushDictItem updatePushDictItem(long userId, long groupId,
		long pushDictItemId, String serverNo, String collectionCode,
		String itemCode, String itemName, String itemNameEN,
		String itemDescription, String parentItemCode, String sibling,
		String method, String metaData, ServiceContext serviceContext)
		throws UnauthenticationException, UnauthorizationException,
			NoSuchUserException, NoSuchPushDictItemException, SystemException;
