 ...
 */
@ProviderType
public class DictItemGroupTempSoap implements Serializable {
	public static DictItemGroupTempSoap toSoapModel(DictItemGroupTemp model) {
		DictItemGroupTempSoap soapModel = new DictItemGroupTempSoap();
	...
	public static DictItemGroupTempSoap[] toSoapModels(
		DictItemGroupTemp[] models) {
		DictItemGroupTempSoap[] soapModels = new DictItemGroupTempSoap[models.length];
	...
	public static DictItemGroupTempSoap[][] toSoapModels(
		DictItemGroupTemp[][] models) {
		DictItemGroupTempSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DictItemGroupTempSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DictItemGroupTempSoap[0][0];
		}
	...
	public static DictItemGroupTempSoap[] toSoapModels(
		List<DictItemGroupTemp> models) {
		List<DictItemGroupTempSoap> soapModels = new ArrayList<DictItemGroupTempSoap>(models.size());

		for (DictItemGroupTemp model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DictItemGroupTempSoap[soapModels.size()]);
	}

	public DictItemGroupTempSoap() {
	}
