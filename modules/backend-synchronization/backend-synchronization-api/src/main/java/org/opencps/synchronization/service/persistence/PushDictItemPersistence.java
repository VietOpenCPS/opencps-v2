...
public interface PushDictItemPersistence extends BasePersistence<PushDictItem> {
	...
	*/
	public java.util.List<PushDictItem> findByUuid(String uuid);
	...
	*/
	public java.util.List<PushDictItem> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching push dict items
	*/
	public java.util.List<PushDictItem> findByUuid_C(String uuid, long companyId);
	...
	* @return the range of matching push dict items
	*/
	public java.util.List<PushDictItem> findByUuid_C(String uuid,
