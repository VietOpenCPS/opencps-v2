...
public interface PushCollectionPersistence extends BasePersistence<PushCollection> {
	...
	*/
	public java.util.List<PushCollection> findByUuid(String uuid);
	...
	*/
	public java.util.List<PushCollection> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching push collections
	*/
	public java.util.List<PushCollection> findByUuid_C(String uuid,
		long companyId);
