 ...
 */
@ProviderType
public class DictItemTempSoap implements Serializable {
	public static DictItemTempSoap toSoapModel(DictItemTemp model) {
		DictItemTempSoap soapModel = new DictItemTempSoap();
	...
	public static DictItemTempSoap[] toSoapModels(DictItemTemp[] models) {
		DictItemTempSoap[] soapModels = new DictItemTempSoap[models.length];
	...
	public static DictItemTempSoap[][] toSoapModels(DictItemTemp[][] models) {
		DictItemTempSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DictItemTempSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DictItemTempSoap[0][0];
		}
	...
	public static DictItemTempSoap[] toSoapModels(List<DictItemTemp> models) {
		List<DictItemTempSoap> soapModels = new ArrayList<DictItemTempSoap>(models.size());

		for (DictItemTemp model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DictItemTempSoap[soapModels.size()]);
	}

	public DictItemTempSoap() {
	}
