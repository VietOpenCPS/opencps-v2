...
public interface PushDictGroupPersistence extends BasePersistence<PushDictGroup> {
	...
	*/
	public java.util.List<PushDictGroup> findByUuid(String uuid);
	...
	*/
	public java.util.List<PushDictGroup> findByUuid(String uuid, int start,
		int end);
	...
	* @return the matching push dict groups
	*/
	public java.util.List<PushDictGroup> findByUuid_C(String uuid,
		long companyId);
