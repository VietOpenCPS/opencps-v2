...
public interface SyncQueueLocalService extends BaseLocalService,
	 ...
	 */
	public SyncQueue addSyncQueue(long userId, long groupId, String serverNo,
		String className, String jsonObject, int status, int retryCount,
		int priority, String method, ServiceContext serviceContext)
	...
	*/
	...
	public SyncQueue updateSyncQueue(long userId, long groupId,
		long syncQueueId, String serverNo, String className, String jsonObject,
		int status, int retryCount, int priority, String method,
		ServiceContext serviceContext)
		throws UnauthenticationException, UnauthorizationException,
			NoSuchUserException, NoSuchSyncQueueException, SystemException;
