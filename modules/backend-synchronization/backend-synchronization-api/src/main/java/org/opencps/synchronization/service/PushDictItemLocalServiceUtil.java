...
public class PushDictItemLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(PushDictItemLocalService.class);

		ServiceTracker<PushDictItemLocalService, PushDictItemLocalService> serviceTracker =
			new ServiceTracker<PushDictItemLocalService, PushDictItemLocalService>(bundle.getBundleContext(),
				PushDictItemLocalService.class, null);
