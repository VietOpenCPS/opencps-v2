...
public class PushCollectionLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.synchronization.model.PushCollection findByCollectionCode_Method(
		long groupId, String collectionCode, String method)
	...
	*/
	...
	public static org.opencps.synchronization.model.PushCollection updatePushCollection(
		long userId, long groupId, long pushCollectionId, String serverNo,
		String collectionCode, String collectionName, String collectionNameEN,
		String description, String method, String dataForm,
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws org.opencps.auth.api.exception.UnauthenticationException,
			org.opencps.auth.api.exception.UnauthorizationException,
			com.liferay.portal.kernel.exception.NoSuchUserException,
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(PushCollectionLocalService.class);

		ServiceTracker<PushCollectionLocalService, PushCollectionLocalService> serviceTracker =
			new ServiceTracker<PushCollectionLocalService, PushCollectionLocalService>(bundle.getBundleContext(),
				PushCollectionLocalService.class, null);
