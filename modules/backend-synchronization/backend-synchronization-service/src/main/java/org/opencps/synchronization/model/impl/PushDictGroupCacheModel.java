...
public class PushDictGroupCacheModel implements CacheModel<PushDictGroup>,
	...
	public PushDictGroup toEntityModel() {
		...
		if (collectionCode == null) {
			pushDictGroupImpl.setCollectionCode("");
		}
		else {
		...
		if (groupCode == null) {
			pushDictGroupImpl.setGroupCode("");
		}
		else {
		...
		if (groupName == null) {
			pushDictGroupImpl.setGroupName("");
		}
		else {
		...
		if (groupNameEN == null) {
			pushDictGroupImpl.setGroupNameEN("");
		}
		else {
		...
		if (groupDescription == null) {
			pushDictGroupImpl.setGroupDescription("");
		}
		else {
