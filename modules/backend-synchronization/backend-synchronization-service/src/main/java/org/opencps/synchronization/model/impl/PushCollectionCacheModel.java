...
public class PushCollectionCacheModel implements CacheModel<PushCollection>,
	...
	public PushCollection toEntityModel() {
		...
		if (userName == null) {
			pushCollectionImpl.setUserName("");
		}
		else {
		...
		if (serverNo == null) {
			pushCollectionImpl.setServerNo("");
		}
		else {
		...
		if (collectionCode == null) {
			pushCollectionImpl.setCollectionCode("");
		}
		else {
		...
		if (collectionName == null) {
			pushCollectionImpl.setCollectionName("");
		}
		else {
		...
		if (collectionNameEN == null) {
			pushCollectionImpl.setCollectionNameEN("");
		}
		else {
		...
		if (description == null) {
			pushCollectionImpl.setDescription("");
		}
		else {
		...
		if (dataForm == null) {
			pushCollectionImpl.setDataForm("");
		}
		else {
