 ...
 * @generated
 */
@ImplementationClassName("org.opencps.communication.model.impl.LGSPTokenImpl")
@ProviderType
public interface LGSPToken extends LGSPTokenModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link org.opencps.communication.model.impl.LGSPTokenImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
