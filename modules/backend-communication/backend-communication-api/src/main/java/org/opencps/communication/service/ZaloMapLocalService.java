...
/**
 * Provides the local service interface for ZaloMap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavd
 * @see ZaloMapLocalServiceUtil
...
public interface ZaloMapLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ZaloMapLocalServiceUtil} to access the zalo map local service. Add custom service methods to {@link org.opencps.communication.service.impl.ZaloMapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
