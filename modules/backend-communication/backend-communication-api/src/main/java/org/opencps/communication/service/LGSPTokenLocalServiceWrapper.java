...
public class LGSPTokenLocalServiceWrapper implements LGSPTokenLocalService,
	...
	*/
	@Override
	public org.opencps.communication.model.LGSPToken addLGSPToken(
	...
	*/
	@Override
	public org.opencps.communication.model.LGSPToken createLGSPToken(
		long tokenId) {
	...
	*/
	@Override
	public org.opencps.communication.model.LGSPToken deleteLGSPToken(
		org.opencps.communication.model.LGSPToken lgspToken) {
	...
	*/
	...
	@Override
	public org.opencps.communication.model.LGSPToken fetchLGSPToken(
		long tokenId) {
	...
	@Override
	public java.util.List<org.opencps.communication.model.LGSPToken> getByTokenType(
		String tokenType) {
		return _lgspTokenLocalService.getByTokenType(tokenType);
	}
	...
	*/
	@Override
	public org.opencps.communication.model.LGSPToken getLGSPToken(long tokenId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	@Override
	public java.util.List<org.opencps.communication.model.LGSPToken> getLGSPTokens(
		int start, int end) {
	...
	*/
	@Override
	public org.opencps.communication.model.LGSPToken updateLGSPToken(
		org.opencps.communication.model.LGSPToken lgspToken) {
	...
	public org.opencps.communication.model.LGSPToken updateLGSPToken(
		...
		return _lgspTokenLocalService.updateLGSPToken(token, tokenType,
