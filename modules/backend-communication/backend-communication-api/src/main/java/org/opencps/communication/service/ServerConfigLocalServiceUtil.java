...
public class ServerConfigLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.communication.model.ServerConfig adminProcessData(
		com.liferay.portal.kernel.json.JSONObject objectData) {
		return getService().adminProcessData(objectData);
	}

	public static org.opencps.communication.model.ServerConfig adminProcessDelete(
		Long id) {
	...
	*/
	...
	public static void deleteByGroupId(long groupId, long userId,
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {
		getService().deleteByGroupId(groupId, userId, serviceContext);
	}
	...
	*/
	...
	public static org.opencps.communication.model.ServerConfig getByCode(
		...
		return getService().getByCode(groupId, serverNo);
	}
	...
	public static java.util.List<org.opencps.communication.model.ServerConfig> getByServerAndProtocol(
		String serverNo, String protocol) {
		return getService().getByServerAndProtocol(serverNo, protocol);
	}

	public static org.opencps.communication.model.ServerConfig getByServerNO_PROTOCOL(
		String serverNo, String protocol, long groupId) {
		return getService().getByServerNO_PROTOCOL(serverNo, protocol, groupId);
	}
	...
	public static org.opencps.communication.model.ServerConfig getByServerNoAndProtocol(
		...
		return getService()
				   .getByServerNoAndProtocol(groupId, govAgencyCode, serverNo,
			protocol);
	}
	...
	*/
	...
	public static org.opencps.communication.model.ServerConfig updateServerConfig(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateServerConfig(groupId, serverConfigId, govAgencyCode,
			serverNo, serverName, protocol, configs, lastSync, context);
	}
	...
	*/
	...
	public static org.opencps.communication.model.ServerConfig updateServerConfigDB(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateServerConfigDB(groupId, govAgencyCode, serverNo,
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(ServerConfigLocalService.class);

		ServiceTracker<ServerConfigLocalService, ServerConfigLocalService> serviceTracker =
			new ServiceTracker<ServerConfigLocalService, ServerConfigLocalService>(bundle.getBundleContext(),
				ServerConfigLocalService.class, null);
