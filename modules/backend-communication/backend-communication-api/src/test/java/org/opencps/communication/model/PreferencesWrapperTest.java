...
public class PreferencesWrapperTest {
	...
	public void equalsTest() {
		try{
			PreferencesWrapper object = new PreferencesWrapper(null);
			object.equals(null);
		}catch (Exception e) {
		}
...
//	}
//	@Test
//	public void setExpandoBridgeAttributesTest9() {
//		try{
//			PreferencesWrapper object = new PreferencesWrapper(null);
//			object.setExpandoBridgeAttributes(new ServiceContext());
//		}catch (Exception e) {
...
//	}
	...
	@Test
	public void getWrappedModelTest17() {
		try{
			PreferencesWrapper object = new PreferencesWrapper(null);
			object.getWrappedModel();
		}catch (Exception e) {
	...
	@Test
	public void setUserUuidTest() {
		try{
			PreferencesWrapper object = new PreferencesWrapper(null);
			object.setUserUuid("abcde");
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
	...
	@Test
	public void toEscapedModelTest29() {
		try{
			PreferencesWrapper object = new PreferencesWrapper(null);
			object.toEscapedModel();
		}catch (Exception e) {
	...
	@Test
	public void toUnescapedModelTest41() {
		try{
			PreferencesWrapper object = new PreferencesWrapper(null);
			object.toUnescapedModel();
		}catch (Exception e) {
	...
	@Test
	public void getStagedModelTypeTest() {
		try{
			PreferencesWrapper object = new PreferencesWrapper(null);
			object.getStagedModelType();
		}catch (Exception e) {
		}
		Assert.assertEquals(1, 1);
	}
