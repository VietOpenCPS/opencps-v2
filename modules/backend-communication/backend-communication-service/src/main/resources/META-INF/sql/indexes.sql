...
create index IX_939095A9 on opencps_notificationqueue (notificationType[$COLUMN_LENGTH:255$], publicationDate, expireDate);
create index IX_E1BA142 on opencps_notificationqueue (publicationDate, expireDate);
...
create index IX_F16BEBAB on opencps_zalomap (uId[$COLUMN_LENGTH:255$]);
