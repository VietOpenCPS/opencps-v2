...
public class NotificationtemplatePersistenceImpl extends BasePersistenceImpl<Notificationtemplate>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_INTERVAL_LIKE =
		new FinderPath(NotificationtemplateModelImpl.ENTITY_CACHE_ENABLED,
			NotificationtemplateModelImpl.FINDER_CACHE_ENABLED,
			NotificationtemplateImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_interval_Like",
			new String[] {
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_INTERVAL_LIKE =
		new FinderPath(NotificationtemplateModelImpl.ENTITY_CACHE_ENABLED,
			NotificationtemplateModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByF_interval_Like",
			new String[] { String.class.getName() });
	 ...
	 */
	@Override
	public List<Notificationtemplate> findByF_interval_Like(String interval) {
		return findByF_interval_Like(interval, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Notificationtemplate> findByF_interval_Like(String interval,
		int start, int end) {
		return findByF_interval_Like(interval, start, end, null);
	}
	...
	public List<Notificationtemplate> findByF_interval_Like(String interval,
		int start, int end,
		OrderByComparator<Notificationtemplate> orderByComparator) {
		return findByF_interval_Like(interval, start, end, orderByComparator,
			true);
	}
	...
	public List<Notificationtemplate> findByF_interval_Like(String interval,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_INTERVAL_LIKE;
		finderArgs = new Object[] { interval, start, end, orderByComparator };
			...
			if ((list != null) && !list.isEmpty()) {
				for (Notificationtemplate notificationtemplate : list) {
					if (!StringUtil.wildcardMatches(
								notificationtemplate.getInterval(), interval,
								'_', '%', '\\', true)) {
						list = null;
		...
		if (list == null) {
			...
			if (interval == null) {
				query.append(_FINDER_COLUMN_F_INTERVAL_LIKE_INTERVAL_1);
			}
			else if (interval.equals("")) {
				query.append(_FINDER_COLUMN_F_INTERVAL_LIKE_INTERVAL_3);
			}
			else {
				bindInterval = true;

				query.append(_FINDER_COLUMN_F_INTERVAL_LIKE_INTERVAL_2);
			}
	...
	public Notificationtemplate findByF_interval_Like_First(String interval,
		OrderByComparator<Notificationtemplate> orderByComparator)
		throws NoSuchNotificationtemplateException {
		Notificationtemplate notificationtemplate = fetchByF_interval_Like_First(interval,
				orderByComparator);
	...
	public Notificationtemplate fetchByF_interval_Like_First(String interval,
		OrderByComparator<Notificationtemplate> orderByComparator) {
		List<Notificationtemplate> list = findByF_interval_Like(interval, 0, 1,
				orderByComparator);
	...
	public Notificationtemplate findByF_interval_Like_Last(String interval,
		OrderByComparator<Notificationtemplate> orderByComparator)
		throws NoSuchNotificationtemplateException {
		Notificationtemplate notificationtemplate = fetchByF_interval_Like_Last(interval,
				orderByComparator);
	...
	public Notificationtemplate fetchByF_interval_Like_Last(String interval,
		OrderByComparator<Notificationtemplate> orderByComparator) {
		int count = countByF_interval_Like(interval);

		if (count == 0) {
			return null;
		}

		List<Notificationtemplate> list = findByF_interval_Like(interval,
				count - 1, count, orderByComparator);
	...
	public Notificationtemplate[] findByF_interval_Like_PrevAndNext(
		...
		try {
			...
			array[0] = getByF_interval_Like_PrevAndNext(session,
					notificationtemplate, interval, orderByComparator, true);

			array[1] = notificationtemplate;

			array[2] = getByF_interval_Like_PrevAndNext(session,
					notificationtemplate, interval, orderByComparator, false);
	...
	protected Notificationtemplate getByF_interval_Like_PrevAndNext(
		Session session, Notificationtemplate notificationtemplate,
		String interval,
		OrderByComparator<Notificationtemplate> orderByComparator,
		boolean previous) {
	...
	public void removeByF_interval_Like(String interval) {
		for (Notificationtemplate notificationtemplate : findByF_interval_Like(
				interval, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(notificationtemplate);
		}
	}
	...
	public int countByF_interval_Like(String interval) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_F_INTERVAL_LIKE;
	...
	private static final String _FINDER_COLUMN_F_INTERVAL_LIKE_INTERVAL_1 = "notificationtemplate.interval IS NULL";
	private static final String _FINDER_COLUMN_F_INTERVAL_LIKE_INTERVAL_2 = "notificationtemplate.interval LIKE ?";
	private static final String _FINDER_COLUMN_F_INTERVAL_LIKE_INTERVAL_3 = "(notificationtemplate.interval IS NULL OR notificationtemplate.interval LIKE '')";
