...
public class FifteenMinutes extends BaseMessageListener {
	...
	private void doProcessNotification(Message message) {
		...
		List<Notificationtemplate> notificationtemplates =
			_notificationTemplateLocalService.findByInterval(
				NotificationTemplateTerm.FIFTEEN_MINUTES);
...
//		  _schedulerEntryImpl.setTrigger(jobTrigger);
	...
	*/
	...
	private Log _log = LogFactoryUtil.getLog(FifteenMinutes.class);
}
