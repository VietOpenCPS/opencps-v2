...
public class ThirtyMinutes extends BaseSchedulerEntryMessageListener {
	...
	private void doProcessNotification(Message message) {
		...
		List<Notificationtemplate> notificationtemplates =
			_notificationTemplateLocalService.findByInterval(
				NotificationTemplateTerm.THIRTY_MINUTES);
	...
	private Log _log = LogFactoryUtil.getLog(ThirtyMinutes.class);
}
