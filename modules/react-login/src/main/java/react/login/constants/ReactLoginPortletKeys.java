package react.login.constants;

/**
 * @author binhth
 */
public class ReactLoginPortletKeys {
	...
	public static final String REGISTER_ENDPOINT = "opencps.open.register.endpoint";
	public static final String REGISTER_REDIRECT = "opencps.open.register.redirect";
	public static final String PROFILE_ENDPOINT = "opencps.open.profile.endpoint";
